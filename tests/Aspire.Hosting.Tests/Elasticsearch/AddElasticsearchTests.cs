...
{
    [Fact]
    public void AddElasticsearchContainerWithDefaultsAddsAnnotationMetadata()
    {
    ...
    public async Task ElasticsearchCreatesConnectionString()
    {
        ...
        Assert.Equal("http://localhost:27020", connectionString);
        Assert.Equal("http://{elasticsearch.bindings.http.host}:{elasticsearch.bindings.http.port}", connectionStringResource.ConnectionStringExpression.ValueExpression);
    }
    ...
    public async Task VerifyManifestWithDefaultsAddsAnnotationMetadata()
    {
        ...
        var expectedManifest = $$"""
            {
              "type": "container.v0",
              "connectionString": "http://{elasticsearch.bindings.http.host}:{elasticsearch.bindings.http.port}",
