...
public class AddMilvusTests
{
    ...
    public void AddMilvusWithDefaultsAddsAnnotationMetadata()
    {
        ...
        appBuilder.Configuration[$"{ParameterResourceBuilderExtensions.ConfigurationSectionKey}:apikey"] = "pass";
    ...
    public void AddMilvusWithSpecifyingPorts()
    {
        ...
        builder.Configuration[$"{ParameterResourceBuilderExtensions.ConfigurationSectionKey}:apikey"] = "pass";
