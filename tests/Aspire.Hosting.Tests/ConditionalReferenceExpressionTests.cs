...
public class ConditionalReferenceExpressionTests
{
    ...
    public async Task GetValueAsync_ReturnsTrueValue_WhenConditionIsTrue()
    {
        ...
        var expr = ReferenceExpression.CreateConditional(condition, whenTrue, whenFalse);
    ...
    public void Constructor_ThrowsOnNullCondition()
    {
        Assert.Throws<ArgumentNullException>(() =>
            ReferenceExpression.CreateConditional(null!, ReferenceExpression.Empty, ReferenceExpression.Empty));
    }
    ...
    {
        Assert.Throws<ArgumentNullException>(() =>
            ReferenceExpression.CreateConditional(new TestValueProvider(bool.TrueString), null!, ReferenceExpression.Empty));
    }
    ...
    {
        Assert.Throws<ArgumentNullException>(() =>
            ReferenceExpression.CreateConditional(new TestValueProvider(bool.TrueString), ReferenceExpression.Empty, null!));
    }

    [Fact]
    public void Name_IsAutoGeneratedFromCondition()
    {
        var expr = ReferenceExpression.CreateConditional(new TestValueProvider(bool.TrueString), ReferenceExpression.Empty, ReferenceExpression.Empty);
