...
public class AzureBicepResourceTests(ITestOutputHelper output)
{
    ...
    {
        using var builder = TestDistributedApplicationBuilder.Create();
        builder.Configuration[$"{ParameterResourceBuilderExtensions.ConfigurationSectionKey}:skuName"] = "Standard_ZRS";
    ...
    public async Task AsAzurePostgresFlexibleServerViaRunMode()
    {
        ...
        builder.Configuration[$"{ParameterResourceBuilderExtensions.ConfigurationSectionKey}:usr"] = "user";
        builder.Configuration[$"{ParameterResourceBuilderExtensions.ConfigurationSectionKey}:pwd"] = "password";
