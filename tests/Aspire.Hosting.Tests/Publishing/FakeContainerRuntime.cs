...
public sealed class FakeContainerRuntime(bool shouldFail = false) : IContainerRuntime
{
    ...
    public List<(string contextPath, string dockerfilePath, ContainerBuildOptions? options)> BuildImageCalls { get; } = [];
    ...
    public Func<string, string, ContainerBuildOptions?, Dictionary<string, string?>, Dictionary<string, string?>, string?, CancellationToken, Task>? BuildImageAsyncCallback { get; set; }
    ...
    public async Task BuildImageAsync(string contextPath, string dockerfilePath, ContainerBuildOptions? options, Dictionary<string, string?> buildArguments, Dictionary<string, string?> buildSecrets, string? stage, CancellationToken cancellationToken)
    {
