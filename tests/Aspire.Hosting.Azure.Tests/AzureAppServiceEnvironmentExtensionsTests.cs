...
public class AzureAppServiceEnvironmentExtensionsTests
{
    ...
    public void GetContainerRegistryResource_ReturnsDefaultContainerRegistry()
    {
        ...
        var registry = appServiceEnvironment.Resource.GetContainerRegistryResource();
    ...
    public void GetContainerRegistryResource_ThrowsWhenNonAzureRegistryConfigured()
    {
        ...
        var exception = Assert.Throws<InvalidOperationException>(appServiceEnvironment.Resource.GetContainerRegistryResource);
