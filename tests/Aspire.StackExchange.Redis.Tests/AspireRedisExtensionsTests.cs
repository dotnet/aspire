...
public class AspireRedisExtensionsTests : IClassFixture<RedisContainerFixture>
{
    ...
    public void ReadsFromConnectionStringsCorrectly(bool useKeyed)
    {
        ...
        builder.Configuration.AddInMemoryCollection([
            new KeyValuePair<string, string?>("ConnectionStrings:myredis", _containerFixture.GetConnectionString())
        ]);
        ...
        Assert.Contains(_containerFixture.GetConnectionString(), connection.Configuration);
    }
    ...
    public void ConnectionStringCanBeSetInCode(bool useKeyed)
    {
        ...
        void SetConnectionString(StackExchangeRedisSettings settings) => settings.ConnectionString = _containerFixture.GetConnectionString();
        if (useKeyed)
        {
    ...
    public void KeyedServiceRedisInstrumentation()
    {
        ...
        {
            settings.ConnectionString = _containerFixture.GetConnectionString();
    ...
    private void PopulateConfiguration(ConfigurationManager configuration, string? key = null) =>
        configuration.AddInMemoryCollection([
            new KeyValuePair<string, string?>(ConformanceTests.CreateConfigKey("Aspire:StackExchange:Redis", key, "ConnectionString"), _containerFixture.GetConnectionString())
        ]);
}
