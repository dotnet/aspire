...
public sealed class AzureKeyVaultDeploymentTests(ITestOutputHelper output)
{
    ...
    private async Task DeployAzureKeyVaultResourceCore(CancellationToken cancellationToken)
    {
        ...
        var recordingPath = DeploymentE2ETestHelpers.GetTestResultsRecordingPath(nameof(DeployAzureKeyVaultResource));
        ...
        try
        {
            ...
            // Step 4: Add Aspire.Hosting.Azure.KeyVault package
            output.WriteLine("Step 4: Adding Azure Key Vault hosting package...");
