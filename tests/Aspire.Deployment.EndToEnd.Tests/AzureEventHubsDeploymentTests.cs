...
public sealed class AzureEventHubsDeploymentTests(ITestOutputHelper output)
{
    ...
    private async Task DeployAzureEventHubsResourceCore(CancellationToken cancellationToken)
    {
        ...
        var recordingPath = DeploymentE2ETestHelpers.GetTestResultsRecordingPath(nameof(DeployAzureEventHubsResource));
        ...
        try
        {
            ...
            output.WriteLine("Step 4: Adding Azure Event Hubs hosting package...");
