...
public sealed class AzureStorageDeploymentTests(ITestOutputHelper output)
{
    ...
    private async Task DeployAzureStorageResourceCore(CancellationToken cancellationToken)
    {
        ...
        var recordingPath = DeploymentE2ETestHelpers.GetTestResultsRecordingPath(nameof(DeployAzureStorageResource));
        ...
        try
        {
            ...
            sequenceBuilder.Type("aspire init")
                ...
                // C# is the first option, just press Enter
            ...
            // Step 4: Add Aspire.Hosting.Azure.Storage package
