...
//#endif
    ...
    public HostingTestsRunner(TestOutputWrapper testOutput, string relativeProjectPath)
    {
    ...
    {
        var appHostDirectory = Path.Combine(BuildEnvironment.TestAssetsPath, _relativeProjectPath);
        ...
        _appHostProcess.StartInfo.Environment["TestsRunningOutsideOfRepo"] = "true";
        ...
        {
            _testOutput.WriteLine($"Building the project: {appHostDirectory}");
