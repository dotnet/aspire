...
public class MySqlDbTests : PlaygroundTestsBase, IClassFixture<MysqlPlaygroundAppFixture>
{
    private readonly MysqlPlaygroundAppFixture _testFixture;

    public MySqlDbTests(MysqlPlaygroundAppFixture testFixture, ITestOutputHelper testOutput) : base(testOutput)
    {
