...
public class QdrantTests : PlaygroundTestsBase, IClassFixture<QdrantPlaygroundFixture>
{
    private readonly MongoPlaygroundAppFixture _testFixture;

    public QdrantTests(MongoPlaygroundAppFixture testFixture, ITestOutputHelper testOutput) : base(testOutput)
    {
