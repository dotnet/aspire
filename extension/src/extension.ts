...
export async function activate(context: vscode.ExtensionContext) {
  ...
  const cliSdkGenerateCommandRegistration = vscode.commands.registerCommand('aspire-vscode.sdkGenerate', () => tryExecuteCommand('aspire-vscode.sdkGenerate', terminalProvider, sdkGenerateCommand));
  ...
  context.subscriptions.push(cliUpdateCommandRegistration, cliSdkGenerateCommandRegistration, settingsCommandRegistration, openLocalSettingsCommandRegistration, openGlobalSettingsCommandRegistration, runAppHostCommandRegistration, debugAppHostCommandRegistration);
