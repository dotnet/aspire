...
export async function activate(context: vscode.ExtensionContext) {
  ...
  const cliLogsCommandRegistration = vscode.commands.registerCommand('aspire-vscode.logs', () => tryExecuteCommand('aspire-vscode.logs', terminalProvider, logsCommand));
  ...
  context.subscriptions.push(cliAddCommandRegistration, cliNewCommandRegistration, cliInitCommandRegistration, cliDeployCommandRegistration, cliPublishCommandRegistration, cliLogsCommandRegistration, openTerminalCommandRegistration, configureLaunchJsonCommandRegistration);
