...
try {
    ...
    $InstallNuGetPkgScriptPath = "$PSScriptRoot\..\eng\pipelines\aspire-vscode-extension\Install-NuGetPackage.ps1"
    ...
    & "$PSScriptRoot\..\eng\pipelines\aspire-vscode-extension\Set-EnvVars.ps1" -Variables $EnvVars -PrependPath $PrependPath | Out-Null
}
finally {
    Pop-Location
}
