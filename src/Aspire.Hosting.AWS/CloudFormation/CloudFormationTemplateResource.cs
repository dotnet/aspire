...
internal sealed class CloudFormationTemplateResource(string name, string templatePath) : CloudFormationResource(name), ICloudFormationTemplateResource, ICloudFormationStackProvider
{
    ...
    /// <inheritdoc/>
    public IEnumerable<string> DisabledCapabilities { get; } = new List<string>();
    ...
    string ICloudFormationStackProvider.StackName => Name;

    Task<string> ICloudFormationStackProvider.GetCloudFormationTemplate(CancellationToken cancellationToken)
