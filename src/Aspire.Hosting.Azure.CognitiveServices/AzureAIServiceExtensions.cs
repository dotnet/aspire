...
public static class AzureAIServiceExtensions
{
    /// <summary>
    ...
    public static IResourceBuilder<AzureAIServicesResource> AddAzureAIServices(this IDistributedApplicationBuilder builder, [ResourceName] string name)
    {
        builder.AddAzureProvisioning();

        var configureInfrastructure = (AzureResourceInfrastructure infrastructure) =>
        {
            var hub = new AIFoundryHubCdk(infrastructure.AspireResource.GetBicepIdentifier() + "_hub")
            {
                FriendlyName = infrastructure.AspireResource.Name
            };
            infrastructure.Add(hub);

            var project = new AIFoundryProjectCdk(infrastructure.AspireResource.GetBicepIdentifier() + "_project", hub)
            {
                FriendlyName = infrastructure.AspireResource.Name
            };
            ...
            var connectionCdk = new AIFoundryConnectionCdk(
            ...
            var resource = (AzureAIServicesResource)infrastructure.AspireResource;
        ...
        var resource = new AzureAIServicesResource(name, configureInfrastructure);
    ...
    /// <returns>A reference to the <see cref="IResourceBuilder{T}"/>.</returns>
    public static IResourceBuilder<AzureAIServicesDeploymentResource> AddDeployment(this IResourceBuilder<AzureAIServicesResource> builder, [ResourceName] string name, string modelName, string modelVersion, string format)
    {
        ...
        var deployment = new AzureAIServicesDeploymentResource(name, modelName, modelVersion, format, builder.Resource);
    ...
    /// <param name="configure">A method that can be used for customizing the <see cref="AzureAIServicesDeploymentResource"/>.</param>
    /// <returns>A reference to the <see cref="IResourceBuilder{T}"/>.</returns>
    public static IResourceBuilder<AzureAIServicesDeploymentResource> WithProperties(this IResourceBuilder<AzureAIServicesDeploymentResource> builder, Action<AzureAIServicesDeploymentResource> configure)
    {
        ArgumentNullException.ThrowIfNull(builder);
