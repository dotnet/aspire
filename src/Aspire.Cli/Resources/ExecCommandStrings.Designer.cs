...
namespace Aspire.Cli.Resources {
    ...
    internal class ExecCommandStrings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The name of the target resource execute the command against. Command will be executed only after target resource starts..
        /// </summary>
