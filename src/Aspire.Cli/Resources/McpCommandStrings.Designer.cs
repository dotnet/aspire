...
namespace Aspire.Cli.Resources {
    ...
    internal class McpCommandStrings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to URL to a standalone Aspire Dashboard's MCP endpoint (e.g., http://localhost:18888/mcp). Can also be set via ASPIRE_MCP_DASHBOARD_URL environment variable..
        /// </summary>
        internal static string StartCommand_DashboardUrlDescription {
            get {
                return ResourceManager.GetString("StartCommand_DashboardUrlDescription", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to API key for Dashboard MCP authentication. Required if Dashboard uses ApiKey auth mode. Can also be set via ASPIRE_MCP_API_KEY environment variable..
        /// </summary>
        internal static string StartCommand_ApiKeyDescription {
            get {
