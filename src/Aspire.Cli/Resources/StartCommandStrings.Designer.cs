...
namespace Aspire.Cli.Resources {
    ...
    public class StartCommandStrings {
        ...
        public static string StartingResource {
            get {
                return ResourceManager.GetString("StartingResource", resourceCulture);
            }
        }

        public static string ResourceStarted {
            get {
                return ResourceManager.GetString("ResourceStarted", resourceCulture);
            }
        }

        public static string FailedToStartResource {
            get {
                return ResourceManager.GetString("FailedToStartResource", resourceCulture);
            }
        }
    }
}