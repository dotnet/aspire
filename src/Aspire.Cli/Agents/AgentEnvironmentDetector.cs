...
/// </summary>
internal sealed class AgentEnvironmentDetector(IEnumerable<IAgentEnvironmentScanner> scanners, CliExecutionContext executionContext) : IAgentEnvironmentDetector
{
    /// <inheritdoc />
