...
public class InstructionProcessor
{
    ...
    private Task<object> ExecuteCreateBuilderAsync(string instructionJson)
    {
        ...
        // typeof(DistributedApplicationOptions).GetProperty("ProjectDirectory", System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.NonPublic)?.SetValue(options, @"{{escapedAppPath}}");
