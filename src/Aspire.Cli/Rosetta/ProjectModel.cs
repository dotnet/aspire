...
internal sealed class ProjectModel
{
    ...
    {
        // Write embedded C# sources (generated by FileEmbedderGenerator)
        File.WriteAllText(Path.Combine(_projectModelPath, "InstructionModels.cs"), Embedded.EmbeddedFiles.InstructionModels);
        File.WriteAllText(Path.Combine(_projectModelPath, "InstructionProcessor.cs"), Embedded.EmbeddedFiles.InstructionProcessor);
        File.WriteAllText(Path.Combine(_projectModelPath, "JsonRpcServer.cs"), Embedded.EmbeddedFiles.JsonRpcServer);
        File.WriteAllText(Path.Combine(_projectModelPath, "Program.cs"), Embedded.EmbeddedFiles.ProgramCs);
        File.WriteAllText(Path.Combine(_projectModelPath, "OrphanDetector.cs"), Embedded.EmbeddedFiles.OrphanDetector);
