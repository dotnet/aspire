...
/// <summary>
/// Helper class for managing SDK availability UX and user interaction.
/// </summary>
internal static class SdkInstallHelper
{
    ...
    /// <param name="telemetry">The telemetry service for tracking SDK check operations.</param>
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var installResult = success ? SdkInstallResult.AlreadyInstalled : SdkInstallResult.NotInstalled;
    ...
    private static string ToTelemetryString(SdkInstallResult result) => result switch
    {
        ...
        SdkInstallResult.NotInstalled => "not_installed",
