...
/// <summary>
/// Represents the result of a single fix action in the doctor fix command.
/// </summary>
internal sealed class DoctorFixActionResult
{
    ...
    /// <summary>
    /// Gets the name of the action that was executed (e.g., "clean", "trust").
    /// </summary>
    [JsonPropertyName("action")]
    public required string Action { get; init; }

    /// <summary>
    /// Gets whether the fix action succeeded.
    /// </summary>
    ...
    /// <summary>
    /// Gets optional additional details about the outcome.
    /// </summary>
    [JsonPropertyName("details")]
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public string? Details { get; init; }
...
/// <summary>
/// Represents the JSON output for the doctor fix command.
/// </summary>
internal sealed class DoctorFixResponse
{
    /// <summary>
    /// Gets or sets the list of fix action results.
    /// </summary>
    [JsonPropertyName("fixes")]
    public required List<DoctorFixActionResult> Fixes { get; set; }

    /// <summary>
    /// Gets or sets the summary of fix results.
    /// </summary>
    [JsonPropertyName("summary")]
    public required DoctorFixSummary Summary { get; set; }
}

/// <summary>
/// Represents the summary of doctor fix results.
/// </summary>
internal sealed class DoctorFixSummary
{
    /// <summary>
    /// Gets or sets the number of successfully applied fixes.
    /// </summary>
    [JsonPropertyName("applied")]
    public int Applied { get; set; }

    /// <summary>
    /// Gets or sets the number of failed fixes.
    /// </summary>
    [JsonPropertyName("failed")]
    public int Failed { get; set; }
}
