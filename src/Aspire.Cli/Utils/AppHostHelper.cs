...
internal static class AppHostHelper
{
    ...
    internal static async Task<(bool IsCompatableAppHost, bool SupportsBackchannel)> CheckAppHostCompatabilityAsync(IDotNetCliRunner runner, FileInfo projectFile, CancellationToken cancellationToken)
    {
