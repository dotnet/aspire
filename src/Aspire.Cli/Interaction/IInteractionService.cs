...
internal interface IInteractionService
{
    ...
    Task<IReadOnlyList<T>> PromptForMultiSelectionAsync<T>(string promptText, IEnumerable<T> choices, Func<T, string> choiceFormatter, CancellationToken cancellationToken = default) where T : notnull;
