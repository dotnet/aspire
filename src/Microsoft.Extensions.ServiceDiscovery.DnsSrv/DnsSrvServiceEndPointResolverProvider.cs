    ...
    TimeProvider timeProvider) : IServiceEndPointResolverProvider
{
    ...
    public bool TryCreateResolver(string serviceName, [NotNullWhen(true)] out IServiceEndPointResolver? resolver)
    {
        ...
        {
            DnsSrvServiceEndPointResolver.Log.NoDnsSuffixFound(logger, serviceName);
            resolver = default;
            return false;
        }
        ...
        {
            DnsSrvServiceEndPointResolver.Log.ServiceNameIsNotUriOrDnsName(logger, serviceName);
            resolver = default;
            return false;
        }
        ...
        resolver = new DnsSrvServiceEndPointResolver(serviceName, hostName: parts.Host, srvQuery, options, logger, dnsClient, timeProvider);
        return true;
    }
