...
#endif
{
    ...
    /// <summary>
    /// The text content of the log entry. This is the same as <see cref="Content"/>, but without embedded links.
    /// </summary>
    ...
    public static LogEntry Create(DateTime? timestamp, string logMessage, string logTextContent, bool isErrorMessage)
    {
        return new LogEntry
        {
            Timestamp = timestamp,
