 ...
 */
export function readLaunchSettings(appHostDir) {
 ...
 */
export function getEnvironmentVariables(launchSettings, profileName = 'https') {
    if (!launchSettings) {
        return {};
    }
 ...
 * @param profileName The profile name to use (defaults to 'https')
 */
export function applyLaunchSettings(appHostDir, profileName = 'https') {
