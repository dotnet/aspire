...
public sealed class ServiceDiscoveryOptions
{
    ...
    /// </summary>
    /// <remarks>
    /// When set to <see cref="ServiceEndPointQuery.AllowAllSchemes"/>, all schemes are allowed.
    /// Schemes are not case-sensitive.
    /// </remarks>
    public string[] AllowedSchemes { get; set; } = ServiceEndPointQuery.AllowAllSchemes;
}
