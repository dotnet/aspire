...
/// </summary>
public interface IServiceDiscoveryDelegatingHttpMessageHandlerFactory
{
    /// <summary>
    ...
    HttpMessageHandler CreateServiceDiscoveryDelegatingHandler(HttpMessageHandler handler);
}
