    ...
    IConfiguration configuration) : IConfigureOptions<DcpOptions>
{
    ...
    public void Configure(DcpOptions options)
    {
        ...
        {
            options.ContainerRuntime = configuration.GetString("ASPIRE_CONTAINER_RUNTIME", "DOTNET_ASPIRE_CONTAINER_RUNTIME");
        }
        ...
        {
            options.DependencyCheckTimeout = configuration.GetValue("ASPIRE_DEPENDENCY_CHECK_TIMEOUT", "DOTNET_ASPIRE_DEPENDENCY_CHECK_TIMEOUT", options.DependencyCheckTimeout);
        }
        ...
        options.ServiceStartupWatchTimeout = configuration.GetValue("ASPIRE_SERVICE_STARTUP_WATCH_TIMEOUT", "DOTNET_ASPIRE_SERVICE_STARTUP_WATCH_TIMEOUT", options.ServiceStartupWatchTimeout);
