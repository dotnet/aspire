...
internal sealed class PublishingActivityReporter : IPublishingActivityReporter, IAsyncDisposable
{
    ...
    public async Task CompleteAsync(string? completionMessage = null, CompletionState? completionState = null, bool isDeploy = false, CancellationToken cancellationToken = default)
    {
