...
public static class ResourceBuilderExtensions
{
    ...
    /// <returns></returns>
    public static IResourceBuilder<T> WithProbe<T>(this IResourceBuilder<T> builder,
        string endpointName, ProbeType type,
        string? path = null, int initialDelaySeconds = 5, int periodSeconds = 5)
