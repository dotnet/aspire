...
public static class ResourceBuilderExtensions
{
    ...
    /// <param name="isProxied">Specifies if the endpoint will be proxied by DCP. Defaults to null, which will apply a default behavior for different resource types.</param>
    /// <returns>The <see cref="IResourceBuilder{T}"/>.</returns>
    ...
    [System.Diagnostics.CodeAnalysis.SuppressMessage("ApiDesign", "RS0026:Do not add multiple public overloads with optional parameters", Justification = "<Pending>")]
    public static IResourceBuilder<T> WithEndpoint<T>(this IResourceBuilder<T> builder, int? port = null, int? targetPort = null, string? scheme = null, [EndpointName] string? name = null, string? env = null, bool? isProxied = null, bool? isExternal = null) where T : IResourceWithEndpoints
    {
        ArgumentNullException.ThrowIfNull(builder);
