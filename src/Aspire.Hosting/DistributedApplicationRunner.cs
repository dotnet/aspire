    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        if (executionContext.IsPublishMode)
        {
            ...
            try
            {
                ...
                var operationName = publishingOptions.Value.Deploy ? "Deployment" : "Publishing";
                await activityReporter.CompletePublishAsync(completionMessage: null, completionState: null, operationName: operationName, cancellationToken: stoppingToken).ConfigureAwait(false);
            ...
            catch (Exception ex)
            {
                ...
                var operationName = publishingOptions.Value.Deploy ? "Deployment" : "Publishing";
                await activityReporter.CompletePublishAsync(completionMessage: ex.Message, completionState: CompletionState.CompletedWithError, operationName: operationName, cancellationToken: stoppingToken).ConfigureAwait(false);
