...
/// </summary>
public record HostUrl(string Url) : IValueProvider, IManifestExpressionProvider, INetworkAwareValueProvider
{
    ...
    {
        return ((INetworkAwareValueProvider)this).GetValueAsync(KnownNetworkIdentifiers.LocalhostNetwork, cancellationToken);
    }

    // Returns the url
    ValueTask<string?> INetworkAwareValueProvider.GetValueAsync(NetworkIdentifier? context, System.Threading.CancellationToken cancellationToken)
    {
