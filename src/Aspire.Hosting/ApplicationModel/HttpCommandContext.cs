...
/// <see cref="ResourceBuilderExtensions.WithHttpCommand{TResource}(IResourceBuilder{TResource}, string, string, Func{Aspire.Hosting.ApplicationModel.EndpointReference}?, HttpMethod?, string?, Func{HttpCommandRequestContext, Task}?, Func{HttpCommandResultContext, Task{ExecuteCommandResult}}?, string?, string?, string?, string?, IconVariant?, bool)"/>
/// or <see cref="ResourceBuilderExtensions.WithHttpCommand{TResource}(IResourceBuilder{TResource}, string, string, string?, HttpMethod?, string?, Func{HttpCommandRequestContext, Task}?, Func{HttpCommandResultContext, Task{ExecuteCommandResult}}?, string?, string?, string?, string?, IconVariant?, bool)"/>.
/// </summary>
