...
public sealed class EndpointAnnotation : IResourceAnnotation
{
    ...
    public EndpointAnnotation(ProtocolType protocol, string? uriScheme = null, string? transport = null, [ModelName("Endpoint")] string? name = null, int? port = null, int? targetPort = null, bool? isExternal = null, bool isProxied = true)
    {
