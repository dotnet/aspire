...
public static class LifecycleHookServiceCollectionExtensions
{
    ...
    [Obsolete("AddLifecycleHook is deprecated. Use the IDistributedApplicationEventing service and DistributedApplicationEventingExtensions extension methods instead.")]
    ...
    /// <typeparam name="T">The type of the distributed application lifecycle hook to add.</typeparam>
    /// <param name="services">The <see cref="IServiceCollection"/> to add the distributed application lifecycle hook to.</param>
    [Obsolete("TryAddLifecycleHook is deprecated. Use the IDistributedApplicationEventing service and DistributedApplicationEventingExtensions extension methods instead.")]
