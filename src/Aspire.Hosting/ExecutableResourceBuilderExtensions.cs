...
public static class ExecutableResourceBuilderExtensions
{
    ...
    /// <summary>
    /// Adds (or shares) a container-managed volume to an executable resource.
    /// </summary>
    /// <typeparam name="T">An executable resource type.</typeparam>
    ...
    /// <summary>
    /// Adds an anonymous (non-shared) volume to an executable resource.
    /// </summary>
    /// <typeparam name="T">An executable resource type.</typeparam>
    /// <param name="builder">The resource builder.</param>
    /// <param name="target">
