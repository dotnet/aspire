...
/// <summary>
/// Provides extension methods for configuring resources with ASP.NET Core HTTPS development certificates.
/// </summary>
public static class DevCertHostingExtensions
{
    ...
    /// <param name="onSuccessfulExport">An optional callback that is invoked after the certificate is successfully exported.</param>
