...
public static class ProjectResourceBuilderExtensions
{
    ...
    /// <summary>
    /// Adds (or shares) a container-managed volume to a project resource.
    /// </summary>
    /// <typeparam name="T">A project resource type.</typeparam>
    ...
    /// <summary>
    /// Adds an anonymous (non-shared) volume to a project resource.
    /// </summary>
    /// <typeparam name="T">A project resource type.</typeparam>
    /// <param name="builder">The resource builder.</param>
    /// <param name="target">
