...
/// <summary>
/// A resource that represents a Postgres database. This is a child resource of a <see cref="PostgresContainerResource"/>.
/// </summary>
/// <param name="name">The name of the resource</param>
/// <param name="postgresContainer">The postgres server resource associated with this database.</param>
