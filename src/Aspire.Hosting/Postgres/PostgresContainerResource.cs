...
/// <summary>
/// A resource that represents a Postgres container.
/// </summary>
/// <param name="name">The name of the resource.</param>
/// <param name="password">The postgres server password.</param>
public class PostgresContainerResource(string name, string password) : ContainerResource(name), IPostgresResource
{
    ...
    /// </summary>
    /// <returns>A connection string for the postgres server in the form "Host=host;Port=port;Username=postgres;Password=password".</returns>
