...
namespace Aspire.Hosting
{
    ...
    {
        public static ApplicationModel.IResourceBuilder<ConnectionStringResource> AddConnectionString(this IDistributedApplicationBuilder builder, string name, ApplicationModel.ReferenceExpression.ExpressionInterpolatedStringHandler connectionStringExpression) { throw null; }
