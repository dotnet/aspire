...
public class DistributedApplicationBuilder : IDistributedApplicationBuilder
{
    ...
    public DistributedApplicationBuilder(DistributedApplicationOptions options)
    {
        ...
        _innerBuilder.Services.AddSingleton<ContainerExecService>(s => new ContainerExecService(s.GetRequiredService<ResourceNotificationService>(), s.GetRequiredService<ResourceLoggerService>(), s.GetRequiredService<IDcpExecutor>(), s.GetRequiredService<DcpNameGenerator>()));
