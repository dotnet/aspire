...
public static class ContainerResourceBuilderExtensions
{
    ...
    /// <summary>
    /// Causes .NET Aspire to build the specified container image from a Dockerfile generated by a synchronous factory function.
    /// </summary>
    /// <typeparam name="T">Type parameter specifying any type derived from <see cref="ContainerResource"/>.</typeparam>
    /// <param name="builder">The <see cref="IResourceBuilder{T}"/>.</param>
    /// <param name="contextPath">Path to be used as the context for the container image build.</param>
    ...
    /// </example>
    /// </remarks>
    public static IResourceBuilder<T> WithDockerfile<T>(this IResourceBuilder<T> builder, string contextPath, Func<string> dockerfileFactory, string? stage = null) where T : ContainerResource
    {
        ArgumentNullException.ThrowIfNull(builder);
        ArgumentException.ThrowIfNullOrEmpty(contextPath);
        ...
        {
            DockerfileFactory = _ => Task.FromResult(dockerfileFactory())
        };
    ...
    /// <summary>
    /// Causes .NET Aspire to build the specified container image from a Dockerfile generated by an asynchronous factory function.
    /// </summary>
    /// <typeparam name="T">Type parameter specifying any type derived from <see cref="ContainerResource"/>.</typeparam>
    /// <param name="builder">The <see cref="IResourceBuilder{T}"/>.</param>
    /// <param name="contextPath">Path to be used as the context for the container image build.</param>
    ...
    ///
    /// builder.AddContainer("mycontainer", "myimage")
    ///        .WithDockerfile("path/to/context", async (ct) => 
    ///        {
    ///            var template = await File.ReadAllTextAsync("template.dockerfile", ct);
    ...
    /// </example>
    /// </remarks>
    public static IResourceBuilder<T> WithDockerfile<T>(this IResourceBuilder<T> builder, string contextPath, Func<CancellationToken, Task<string>> dockerfileFactory, string? stage = null) where T : ContainerResource
    {
        ArgumentNullException.ThrowIfNull(builder);
        ArgumentException.ThrowIfNullOrEmpty(contextPath);
        ArgumentNullException.ThrowIfNull(dockerfileFactory);
