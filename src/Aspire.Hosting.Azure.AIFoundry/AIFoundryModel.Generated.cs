...
public partial class AIFoundryModel
{
    ...
    public static partial class Microsoft
    {
        ...
        /// <summary>
        /// # Azure Content Understanding - Layout Content Understanding Layout offers rich, structure‑aware extraction that captures text, formatting, tables, figures, and geometric layout details. It’s designed for complex document understanding workflows that require positional accuracy and deeper structural insights. ## Azure Content Understanding Azure Content Understanding uses generative AI to process/ingest content of many types (documents, images, videos, and audio) into a user-defined output format. It offers a streamlined process to reason over large amounts of unstructured data, accelerating time-to-value by generating an output that can be integrated into automation and analytical workflows. ## Key capabilities  ### About this model The **Layout** model offers rich, structure‑aware analysis for documents that require deeper understanding of formatting, hierarchy, and spatial relationships. It combines textual extraction with geometric layout detection to support advanced automation and content reasoning. ### Key model capabilities - Extracts detailed content and layout elements such as **words**, **paragraphs**, **tables**, **figures**, and **sections** - Identifies **document structure**, formatting patterns, and hierarchical organization - Extracts **hyperlinks** embedded in documents - Captures **annotations** such as highlights, underlines, and strikethroughs in digital PDFs - Provides **precise positional information** for all extracted elements - Detects all figure types—**charts**, **diagrams**, **pictures**, **icons**, and other images—with bounding box details (**PDF only**) - Suitable for advanced workflows such as **document automation**, **RAG indexing**, **semantic** search, and any process demanding fine‑grained layout understanding  ## Pricing  View up-to-date pay-as-you-go pricing details here: [Azure AI Content Understanding pricing](https://azure.microsoft.com/en-us/pricing/details/content-understanding/).  ## Technical details  - **Deployment**: Deployment options may vary by service, reference the following docs for more information: [Create an Azure AI Services multi-service resource](https://learn.microsoft.com/en-us/azure/ai-services/content-understanding/how-to/create-multi-service-resource). - **Requirements**: Requirements may vary depending on the input data you are analyzing, reference the following docs for more information: [Service quotas and limits](https://learn.microsoft.com/en-us/azure/ai-services/content-understanding/service-limits). - **Support**: Support options for AI Services can be found here: [Azure AI services support and help options](https://learn.microsoft.com/en-us/azure/ai-services/cognitive-services-support-options?view=doc-intel-4.0.0).  ## More information Learn more in the full [Azure AI Content Understanding documentation](https://aka.ms/content-understanding-doc).
        /// </summary>
        ...
        /// <summary>
        /// # Azure Content Understanding - Read Content Understanding Read provides fast, reliable extraction of text and basic content elements from documents, enabling simple ingestion workflows without layout interpretation. It’s ideal for scenarios where clean text output is needed for downstream automation, classification, or search. ## Azure Content Understanding Azure Content Understanding uses generative AI to process/ingest content of many types (documents, images, videos, and audio) into a user-defined output format. It offers a streamlined process to reason over large amounts of unstructured data, accelerating time-to-value by generating an output that can be integrated into automation and analytical workflows. ## Key capabilities  ### About this model The **Read** model provides foundational text extraction capabilities for simple, fast, and reliable ingestion of document content. It focuses on capturing textual elements without performing layout or structural analysis, making it ideal for lightweight processing and downstream text-based workflows. ### Key model capabilities - Extracts fundamental content elements such as **words**, **lines**, **paragraphs**, **formulas**, and **barcodes** - Provides **basic OCR** functionality for a wide range of document types - Returns text results **without layout interpretation** - Best suited for scenarios requiring **quick ingestion**, metadata extraction, transcription, or feeding clean text into analytic or search pipelines ## Pricing  View up-to-date pay-as-you-go pricing details here: [Azure AI Content Understanding pricing](https://azure.microsoft.com/en-us/pricing/details/content-understanding/).  ## Technical details  - **Deployment**: Deployment options may vary by service, reference the following docs for more information: [Create an Azure AI Services multi-service resource](https://learn.microsoft.com/en-us/azure/ai-services/content-understanding/how-to/create-multi-service-resource). - **Requirements**: Requirements may vary depending on the input data you are analyzing, reference the following docs for more information: [Service quotas and limits](https://learn.microsoft.com/en-us/azure/ai-services/content-understanding/service-limits). - **Support**: Support options for AI Services can be found here: [Azure AI services support and help options](https://learn.microsoft.com/en-us/azure/ai-services/cognitive-services-support-options?view=doc-intel-4.0.0).  ## More information Learn more in the full [Azure AI Content Understanding documentation](https://aka.ms/content-understanding-doc).
        /// </summary>
