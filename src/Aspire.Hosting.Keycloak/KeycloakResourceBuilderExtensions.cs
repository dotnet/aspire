        ...
        var keycloak = builder
            ...
            .WithEnvironment(context =>
            {
                ...
                if (port == HttpsContainerPort) {
                    ...
                    context.EnvironmentVariables[HttpPortEnvVarName] = HttpsContainerPort.ToString(CultureInfo.InvariantCulture);
                    context.EnvironmentVariables[HttpEnabledEnvVarName] = "true";
                    context.EnvironmentVariables[HostNamePortEnvVarName] = HttpsContainerPort.ToString(CultureInfo.InvariantCulture);
