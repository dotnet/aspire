...
public static class MilvusBuilderExtensions
{
    ...
    [global::Aspire.Hosting.AspireExport("addMilvus", Description = "Exports AddMilvus for polyglot app hosts.")]
    ...
    /// <returns>The <see cref="IResourceBuilder{T}"/>.</returns>
    [global::Aspire.Hosting.AspireExport("withConfigurationFile", Description = "Exports WithConfigurationFile for polyglot app hosts.")]
