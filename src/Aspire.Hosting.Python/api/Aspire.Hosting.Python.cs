...
namespace Aspire.Hosting
{
    public static partial class PythonAppResourceBuilderExtensions
    {
        ...
        public static ApplicationModel.IResourceBuilder<T> WithVirtualEnvironment<T>(this ApplicationModel.IResourceBuilder<T> builder, string virtualEnvironmentPath)
            where T : Python.PythonAppResource { throw null; }
    }
}
