...
namespace Aspire.Hosting
{
    public static partial class PythonAppResourceBuilderExtensions
    {
        ...
        public static ApplicationModel.IResourceBuilder<Python.PythonAppResource> AddUvicornApp(this IDistributedApplicationBuilder builder, string name, string appDirectory, string app) { throw null; }
