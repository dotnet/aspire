...
public sealed partial class ConfigSchemaGenerator
{
    internal sealed partial class Parser(ConfigSchemaAttributeInfo configSchemaInfo, KnownTypeSymbols typeSymbols)
    {
        private readonly KnownTypeSymbols _typeSymbols = typeSymbols;
