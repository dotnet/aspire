...
internal static class AzureAppServiceEnvironmentUtility
{
    ...
    private static readonly ProvisioningParameter s_dashboardHostNameParameter = new ProvisioningParameter($"aspireDashboardHostName", typeof(string));

    public static BicepValue<string> GetDashboardWebSiteName(string aspireResourceName)
    {
    ...
    /// <summary>
    /// Gets the dashboard host name parameter value for use in Bicep templates.
    /// </summary>
    /// <returns>A BicepValue representing the dashboard host name parameter.</returns>
    public static BicepValue<string> GetDashboardHostName()
    {
        return s_dashboardHostNameParameter;
    }

    /// <summary>
    /// Sets dashboard host name parameter
    /// </summary>
    /// <param name="hostName"></param>
    public static void SetDashboardHostName(string hostName)
    {
        s_dashboardHostNameParameter.Value = hostName;
    }
        ...
        bool enableRegionalDns)
    {
        ...
        var dashboard = new WebSite("dashboard")
        {
            ...
            Name = GetDashboardWebSiteName(infra.AspireResource.Name),
