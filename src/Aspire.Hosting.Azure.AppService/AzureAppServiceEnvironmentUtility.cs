...
internal static class AzureAppServiceEnvironmentUtility
{
    ...
    public static BicepValue<string> GetDashboardWebSiteName(string aspireResourceName, bool enableRegionalDnl)
    {
        ...
        bool enableRegionalDnl)
    {
        ...
        var dashboard = new WebSite("dashboard")
        {
            ...
            Name = GetDashboardWebSiteName(infra.AspireResource.Name, enableRegionalDnl),
