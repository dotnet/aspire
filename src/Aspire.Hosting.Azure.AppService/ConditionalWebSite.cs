...
/// <summary>
/// A <see cref="WebSite"/> that adds the @onlyIfNotExists() decorator to its bicep output.
/// </summary>
/// <remarks>
...
/// </remarks>
internal sealed class ConditionalWebSite : WebSite
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ConditionalWebSite"/> class.
    /// </summary>
    /// <param name="bicepIdentifier">The bicep identifier for this resource.</param>
    public ConditionalWebSite(string bicepIdentifier) : base(bicepIdentifier)
    {
    }
