...
{
    internal Dictionary<string, Action<IResourceBuilder<AzureWebPubSubResource>, ResourceModuleConstruct, WebPubSubHub>> HubSettings { get; } = new(StringComparer.OrdinalIgnoreCase);
