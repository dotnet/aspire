...
public static class GarnetBuilderExtensions
{
    ...
    /// <returns></returns>
    public static IResourceBuilder<GarnetResource> WithRedisCommander(this IResourceBuilder<GarnetResource> builder, Action<IResourceBuilder<RedisCommanderResource>>? configureContainer = null, string? containerName = null)
    {
