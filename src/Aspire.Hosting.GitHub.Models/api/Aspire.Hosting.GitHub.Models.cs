...
namespace Aspire.Hosting.GitHub.Models
{
    ...
    {
        public GitHubModelResource(string name, string model, ApplicationModel.ParameterResource? organization) : base(default!) { }

        public ApplicationModel.ReferenceExpression ConnectionStringExpression { get { throw null; } }

        public ApplicationModel.ParameterResource Key { get { throw null; } set { } }
