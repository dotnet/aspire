...
internal static class DashboardUrls
{
    ...
    public static string ParametersUrl(string? resource = null, string? view = null, string? hiddenTypes = null, string? hiddenStates = null, string? hiddenHealthStates = null)
    {
