...
namespace Aspire.Dashboard.Resources {
    ...
    public class Dialogs {
        ...
        /// <summary>
        ///   Looks up a localized string similar to To use VS Code with Aspire MCP, configure the MCP endpoint to use HTTP instead of HTTPS—for example, by launching the app host with the &lt;code&gt;http&lt;/code&gt; profile.
        /// </summary>
