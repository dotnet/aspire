...
internal static class AspireIcons
{
    ...
    {
        internal sealed class GitHubCopilot : Icon
        {
            // The official SVG used in VSC only comes in 16x16, so we need to scale this up to 24x24.
            public GitHubCopilot() : base("GitHubCopilot", IconVariant.Regular, IconSize.Size24,
                @"<path transform=""scale(1.5)"" d=""M6.25 9.016C6.66421 9.016 7 9.35089 7 9.76399V11.26C7 11.6731 6.66421 12.008 6.25 12.008C5.83579 12.008 5.5 11.6731 5.5 11.26V9.76399C5.5 9.35089 5.83579 9.016 6.25 9.016Z""/>
                  <path transform=""scale(1.5)"" d=""M10.5 9.76399C10.5 9.35089 10.1642 9.016 9.75 9.016C9.33579 9.016 9 9.35089 9 9.76399V11.26C9 11.6731 9.33579 12.008 9.75 12.008C10.1642 12.008 10.5 11.6731 10.5 11.26V9.76399Z""/>
...
") { } }
        internal sealed class McpIcon : Icon { public McpIcon() : base("McpIcon", IconVariant.Regular, IconSize.Size24, @"
            <svg fill=""currentColor"" fill-rule=""evenodd"" height=""24"" style=""flex:none;line-height:1"" viewBox=""0 0 24 24"" width=""24"" preserveAspectRatio=""xMidYMid meet""><title>ModelContextProtocol</title><path transform=""scale(0.80833) translate(5 5)"" d=""M15.688 2.343a2.588 2.588 0 00-3.61 0l-9.626 9.44a.863.863 0 01-1.203 0 .823.823 0 010-1.18l9.626-9.44a4.313 4.313 0 016.016 0 4.116 4.116 0 011.204 3.54 4.3 4.3 0 013.609 1.18l.05.05a4.115 4.115 0 010 5.9l-8.706 8.537a.274.274 0 000 .393l1.788 1.754a.823.823 0 010 1.18.863.863 0 01-1.203 0l-1.788-1.753a1.92 1.92 0 010-2.754l8.706-8.538a2.47 2.47 0 000-3.54l-.05-.049a2.588 2.588 0 00-3.607-.003l-7.172 7.034-.002.002-.098.097a.863.863 0 01-1.204 0 .823.823 0 010-1.18l7.273-7.133a2.47 2.47 0 00-.003-3.537z"" /><path transform=""scale(0.80833) translate(5 5)"" d=""M14.485 4.703a.823.823 0 000-1.18.863.863 0 00-1.204 0l-7.119 6.982a4.115 4.115 0 000 5.9 4.314 4.314 0 006.016 0l7.12-6.982a.823.823 0 000-1.18.863.863 0 00-1.204 0l-7.119 6.982a2.588 2.588 0 01-3.61 0 2.47 2.47 0 010-3.54l7.12-6.982z"" /></svg>
        ") { } }
    }
    ...
    internal static class Size48
    {
        internal sealed class GitHubCopilot : Icon
        {
            public GitHubCopilot() : base("GitHubCopilot", IconVariant.Regular, IconSize.Size48,
