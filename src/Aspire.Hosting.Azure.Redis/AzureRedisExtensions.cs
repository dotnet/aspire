...
public static class AzureRedisExtensions
{
    ...
    [Obsolete($"This method is obsolete and will be removed in a future version. Use {nameof(AzureRedisEnterpriseExtensions.AddAzureManagedRedis)} instead which provisions Azure Managed Redis.")]
