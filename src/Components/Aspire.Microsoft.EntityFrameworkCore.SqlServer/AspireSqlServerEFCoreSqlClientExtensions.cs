...
public static class AspireSqlServerEFCoreSqlClientExtensions
{
    ...
    {
        builder.AddSqlServerDbContext<TContext>(connectionName,  null, null, null);
    }
    ...
    {
        builder.AddSqlServerDbContext<TContext>(connectionName, configureSettings, null, null);
    }
    ...
    {
        builder.AddSqlServerDbContext<TContext>(connectionName, null, configureDbContextOptions, null);
    }
    ...
    public static void AddSqlServerDbContext<[DynamicallyAccessedMembers(RequiredByEF)] TContext>(
        this IHostApplicationBuilder builder,
        string connectionName,
        Action<SqlServerDbContextOptionsBuilder>? sqlServerOptionsAction) where TContext : DbContext
    {
        builder.AddSqlServerDbContext<TContext>(connectionName, null, null, sqlServerOptionsAction);
    }
