...
public static class AspireQueueStorageExtensions
{
    ...
    [Obsolete($"This method is obsolete and will be removed in a future version. Use {nameof(AddAzureQueueServiceClient)} instead.")]
    ...
    /// <exception cref="InvalidOperationException">Thrown when neither <see cref="AzureStorageQueuesSettings.ConnectionString"/> nor <see cref="AzureStorageQueuesSettings.ServiceUri"/> is provided.</exception>
    [Obsolete($"This method is obsolete and will be removed in a future version. Use {nameof(AddKeyedAzureQueueServiceClient)} instead.")]
