...
internal sealed class EventProcessorClientComponent : EventHubsComponent<EventProcessorClient, EventProcessorClientOptions>
{
...
#pragma warning restore IDE0200
    ...
    {
        return azureFactoryBuilder.RegisterClientFactory<EventProcessorClient, EventProcessorClientOptions>((options, cred) =>
        {
            ...
            return !string.IsNullOrEmpty(connectionString) ?
                new EventProcessorClient(blobClient, settings.ConsumerGroup, connectionString) :
                new EventProcessorClient(blobClient, settings.ConsumerGroup, settings.Namespace,
