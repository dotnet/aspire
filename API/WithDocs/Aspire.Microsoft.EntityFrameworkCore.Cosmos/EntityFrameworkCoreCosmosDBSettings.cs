...
public sealed class EntityFrameworkCoreCosmosDBSettings
{
    ...
    /// <summary>
    /// A <see cref="T:System.Uri" /> referencing the Azure Cosmos DB Endpoint.
    /// This is likely to be similar to "https://{account_name}.queue.core.windows.net".
    /// </summary>
    /// <remarks>
    /// Must not contain shared access signature.
    /// Used along with <see cref="P:Aspire.Microsoft.EntityFrameworkCore.Cosmos.EntityFrameworkCoreCosmosDBSettings.Credential" /> to establish the connection.
    /// </remarks>
