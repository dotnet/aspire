...
public sealed class AzureStorageBlobsSettings : IConnectionStringSettings
{
    ...
    /// </summary>
    /// <remarks>
    /// If <see cref="P:Aspire.Azure.Storage.Blobs.AzureStorageBlobsSettings.ConnectionString" /> is set, it overrides <see cref="P:Aspire.Azure.Storage.Blobs.AzureStorageBlobsSettings.ServiceUri" /> and <see cref="P:Aspire.Azure.Storage.Blobs.AzureStorageBlobsSettings.Credential" />.
    /// </remarks>
    public string? ConnectionString { get; set; }

    /// <summary>
    /// A <see cref="T:System.Uri" /> referencing the blob service.
    /// This is likely to be similar to "https://{account_name}.blob.core.windows.net".
    /// </summary>
    /// <remarks>
    /// Must not contain shared access signature.
    /// Used along with <see cref="P:Aspire.Azure.Storage.Blobs.AzureStorageBlobsSettings.Credential" /> to establish the connection.
    /// </remarks>
