...
declare -a FEED_URLS=(
    "https://pkgs.dev.azure.com/dnceng/internal/_packaging/darc-int-dotnet-aspire-5440536d/nuget/v3/index.json"
    ...
    "https://pkgs.dev.azure.com/dnceng/internal/_packaging/darc-int-dotnet-extensions-05fe7a56/nuget/v3/index.json"
