...
/** GitHubModelName enum. */
enum GitHubModelName implements WireValueEnum {
    AI21_JAMBA15_LARGE("AI21Jamba15Large"),
    COHERE_COMMAND_A("CohereCommandA"),
    COHERE_COMMAND_R082024("CohereCommandR082024"),
    COHERE_COMMAND_RPLUS082024("CohereCommandRPlus082024"),
    DEEP_SEEK_R1("DeepSeekR1"),
    DEEP_SEEK_R10528("DeepSeekR10528"),
    DEEP_SEEK_V30324("DeepSeekV30324"),
    LLAMA4_MAVERICK17_B128_EINSTRUCT_FP8("Llama4Maverick17B128EInstructFP8"),
    LLAMA4_SCOUT17_B16_EINSTRUCT("Llama4Scout17B16EInstruct"),
    LLAMA3211_BVISION_INSTRUCT("Llama3211BVisionInstruct"),
    LLAMA3290_BVISION_INSTRUCT("Llama3290BVisionInstruct"),
    LLAMA3370_BINSTRUCT("Llama3370BInstruct"),
    META_LLAMA31405_BINSTRUCT("MetaLlama31405BInstruct"),
    META_LLAMA318_BINSTRUCT("MetaLlama318BInstruct"),
    MAI_DSR1("MaiDSR1"),
    PHI4("Phi4"),
    PHI4_MINI_INSTRUCT("Phi4MiniInstruct"),
    PHI4_MINI_REASONING("Phi4MiniReasoning"),
    PHI4_MULTIMODAL_INSTRUCT("Phi4MultimodalInstruct"),
    PHI4_REASONING("Phi4Reasoning"),
    CODESTRAL2501("Codestral2501"),
    MINISTRAL3_B("Ministral3B"),
    MISTRAL_MEDIUM32505("MistralMedium32505"),
    MISTRAL_SMALL31("MistralSmall31"),
    OPEN_AIGPT41("OpenAIGpt41"),
    OPEN_AIGPT41_MINI("OpenAIGpt41Mini"),
    OPEN_AIGPT41_NANO("OpenAIGpt41Nano"),
    OPEN_AIGPT4O("OpenAIGpt4o"),
    OPEN_AIGPT4O_MINI("OpenAIGpt4oMini"),
    OPEN_AIGPT5("OpenAIGpt5"),
    OPEN_AIGPT5_CHAT_PREVIEW("OpenAIGpt5ChatPreview"),
    OPEN_AIGPT5_MINI("OpenAIGpt5Mini"),
    OPEN_AIGPT5_NANO("OpenAIGpt5Nano"),
    OPEN_AIO1("OpenAIO1"),
    OPEN_AIO1_MINI("OpenAIO1Mini"),
    OPEN_AIO1_PREVIEW("OpenAIO1Preview"),
    OPEN_AIO3("OpenAIO3"),
    OPEN_AIO3_MINI("OpenAIO3Mini"),
    OPEN_AIO4_MINI("OpenAIO4Mini"),
    OPEN_AITEXT_EMBEDDING3_LARGE("OpenAITextEmbedding3Large"),
    OPEN_AITEXT_EMBEDDING3_SMALL("OpenAITextEmbedding3Small"),
    GROK3("Grok3"),
    ...
    public static GitHubModelName fromValue(String value) {
        for (GitHubModelName e : values()) {
            if (e.value.equals(value)) return e;
        }
        throw new IllegalArgumentException("Unknown value: " + value);
    }
...
/** Wrapper for Aspire.Hosting.GitHub.Models/Aspire.Hosting.GitHub.Models.GitHubModelResource. */
class GitHubModelResource extends ResourceBuilderBase {
    GitHubModelResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public GitHubModelResource withApiKey(ParameterResource apiKey) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("apiKey", AspireClient.serializeValue(apiKey));
        return (GitHubModelResource) getClient().invokeCapability("Aspire.Hosting.GitHub.Models/withApiKey", reqArgs);
    }

    /** Adds a health check for the GitHub Model resource. */
    public GitHubModelResource enableHealthCheck() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        return (GitHubModelResource) getClient().invokeCapability("Aspire.Hosting.GitHub.Models/enableHealthCheck", reqArgs);
    }
...
class IDistributedApplicationBuilder extends HandleWrapperBase {
    ...
    public GitHubModelResource addGitHubModel(String name, GitHubModelName model) {
        return addGitHubModel(name, model, null);
    }

    /** Adds a GitHub Model resource to the distributed application model. */
    public GitHubModelResource addGitHubModel(String name, GitHubModelName model, ParameterResource organization) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        reqArgs.put("model", AspireClient.serializeValue(model));
        if (organization != null) {
            reqArgs.put("organization", AspireClient.serializeValue(organization));
        }
        return (GitHubModelResource) getClient().invokeCapability("Aspire.Hosting.GitHub.Models/addGitHubModel", reqArgs);
    }

    public GitHubModelResource addGitHubModelById(String name, String modelId) {
        return addGitHubModelById(name, modelId, null);
    }

    /** Adds a GitHub Model resource using a model identifier string. */
    public GitHubModelResource addGitHubModelById(String name, String modelId, ParameterResource organization) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        reqArgs.put("modelId", AspireClient.serializeValue(modelId));
        if (organization != null) {
            reqArgs.put("organization", AspireClient.serializeValue(organization));
        }
        return (GitHubModelResource) getClient().invokeCapability("Aspire.Hosting.GitHub.Models/addGitHubModelById", reqArgs);
    }
...
class AspireRegistrations {
    static {
        ...
        AspireClient.registerHandleWrapper("Aspire.Hosting.GitHub.Models/Aspire.Hosting.GitHub.Models.GitHubModelResource", (h, c) -> new GitHubModelResource(h, c));
