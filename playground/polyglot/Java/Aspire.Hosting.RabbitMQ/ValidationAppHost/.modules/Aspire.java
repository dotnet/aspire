...
/** Options for AddRabbitMQ. */
final class AddRabbitMQOptions {
    private ParameterResource userName;
    private ParameterResource password;
    private Double port;

    public ParameterResource getUserName() { return userName; }
    public AddRabbitMQOptions userName(ParameterResource value) {
        this.userName = value;
        return this;
    }

    public ParameterResource getPassword() { return password; }
    public AddRabbitMQOptions password(ParameterResource value) {
        this.password = value;
        return this;
    }

    public Double getPort() { return port; }
    public AddRabbitMQOptions port(Double value) {
        this.port = value;
        return this;
    }
...
class IDistributedApplicationBuilder extends HandleWrapperBase {
    ...
    public RabbitMQServerResource addRabbitMQ(String name, AddRabbitMQOptions options) {
        var userName = options == null ? null : options.getUserName();
        var password = options == null ? null : options.getPassword();
        var port = options == null ? null : options.getPort();
        return addRabbitMQImpl(name, userName, password, port);
    }

    public RabbitMQServerResource addRabbitMQ(String name) {
        return addRabbitMQ(name, null);
    }

    /** Adds a RabbitMQ container resource */
    private RabbitMQServerResource addRabbitMQImpl(String name, ParameterResource userName, ParameterResource password, Double port) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        if (userName != null) {
        ...
        return (RabbitMQServerResource) getClient().invokeCapability("Aspire.Hosting.RabbitMQ/addRabbitMQ", reqArgs);
    }
...
/** Wrapper for Aspire.Hosting.RabbitMQ/Aspire.Hosting.ApplicationModel.RabbitMQServerResource. */
class RabbitMQServerResource extends ResourceBuilderBase {
    RabbitMQServerResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public RabbitMQServerResource withDataVolume(WithDataVolumeOptions options) {
        var name = options == null ? null : options.getName();
        var isReadOnly = options == null ? null : options.isReadOnly();
        return withDataVolumeImpl(name, isReadOnly);
    }

    public RabbitMQServerResource withDataVolume() {
        return withDataVolume(null);
    }

    /** Adds a data volume to the RabbitMQ container */
    private RabbitMQServerResource withDataVolumeImpl(String name, Boolean isReadOnly) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        if (name != null) {
            reqArgs.put("name", AspireClient.serializeValue(name));
        ...
        return (RabbitMQServerResource) getClient().invokeCapability("Aspire.Hosting.RabbitMQ/withDataVolume", reqArgs);
    }

    public RabbitMQServerResource withDataBindMount(String source) {
        return withDataBindMount(source, null);
    }

    /** Adds a data bind mount to the RabbitMQ container */
    public RabbitMQServerResource withDataBindMount(String source, Boolean isReadOnly) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("source", AspireClient.serializeValue(source));
        if (isReadOnly != null) {
        ...
        return (RabbitMQServerResource) getClient().invokeCapability("Aspire.Hosting.RabbitMQ/withDataBindMount", reqArgs);
    }

    /** Enables the RabbitMQ management plugin */
    public RabbitMQServerResource withManagementPlugin() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        return (RabbitMQServerResource) getClient().invokeCapability("Aspire.Hosting.RabbitMQ/withManagementPlugin", reqArgs);
    }

    public RabbitMQServerResource withManagementPluginWithPort() {
        return withManagementPluginWithPort(null);
    }

    /** Enables the RabbitMQ management plugin with a specific port */
    public RabbitMQServerResource withManagementPluginWithPort(Double port) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        if (port != null) {
            reqArgs.put("port", AspireClient.serializeValue(port));
        }
        return (RabbitMQServerResource) getClient().invokeCapability("Aspire.Hosting.RabbitMQ/withManagementPluginWithPort", reqArgs);
    }
    ...
    public EndpointReference primaryEndpoint() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (EndpointReference) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/RabbitMQServerResource.primaryEndpoint", reqArgs);
    }

    /** Gets the ManagementEndpoint property */
    public EndpointReference managementEndpoint() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (EndpointReference) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/RabbitMQServerResource.managementEndpoint", reqArgs);
    }
    ...
    public EndpointReferenceExpression host() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (EndpointReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/RabbitMQServerResource.host", reqArgs);
    }
    ...
    public EndpointReferenceExpression port() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (EndpointReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/RabbitMQServerResource.port", reqArgs);
    }
    ...
    public ParameterResource userNameParameter() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ParameterResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/RabbitMQServerResource.userNameParameter", reqArgs);
    }
    ...
    public ReferenceExpression userNameReference() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/RabbitMQServerResource.userNameReference", reqArgs);
    }
    ...
    public ParameterResource passwordParameter() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ParameterResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/RabbitMQServerResource.passwordParameter", reqArgs);
    }
    ...
    public ReferenceExpression connectionStringExpression() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/RabbitMQServerResource.connectionStringExpression", reqArgs);
    }
    ...
    public ReferenceExpression uriExpression() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/RabbitMQServerResource.uriExpression", reqArgs);
    }
    ...
    public String entrypoint() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/RabbitMQServerResource.entrypoint", reqArgs);
    }

    /** Sets the Entrypoint property */
    public RabbitMQServerResource setEntrypoint(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (RabbitMQServerResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/RabbitMQServerResource.setEntrypoint", reqArgs);
    }
    ...
    public boolean shellExecution() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (boolean) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/RabbitMQServerResource.shellExecution", reqArgs);
    }

    /** Sets the ShellExecution property */
    public RabbitMQServerResource setShellExecution(boolean value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (RabbitMQServerResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/RabbitMQServerResource.setShellExecution", reqArgs);
    }
    ...
    public String name() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/RabbitMQServerResource.name", reqArgs);
    }
...
class AspireRegistrations {
    static {
        ...
        AspireClient.registerHandleWrapper("Aspire.Hosting.RabbitMQ/Aspire.Hosting.ApplicationModel.RabbitMQServerResource", (h, c) -> new RabbitMQServerResource(h, c));
