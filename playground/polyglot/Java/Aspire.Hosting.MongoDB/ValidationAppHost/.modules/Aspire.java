...
/** Options for AddMongoDB. */
final class AddMongoDBOptions {
    private Double port;
    private ParameterResource userName;
    private ParameterResource password;

    public Double getPort() { return port; }
    public AddMongoDBOptions port(Double value) {
        this.port = value;
        return this;
    }

    public ParameterResource getUserName() { return userName; }
    public AddMongoDBOptions userName(ParameterResource value) {
        this.userName = value;
        return this;
    }

    public ParameterResource getPassword() { return password; }
    public AddMongoDBOptions password(ParameterResource value) {
        this.password = value;
        return this;
    }
...
/** Options for WithMongoExpress. */
final class WithMongoExpressOptions {
    private AspireAction1<MongoExpressContainerResource> configureContainer;
    private String containerName;

    public AspireAction1<MongoExpressContainerResource> getConfigureContainer() { return configureContainer; }
    public WithMongoExpressOptions configureContainer(AspireAction1<MongoExpressContainerResource> value) {
        this.configureContainer = value;
        return this;
    }

    public String getContainerName() { return containerName; }
    public WithMongoExpressOptions containerName(String value) {
...
class IDistributedApplicationBuilder extends HandleWrapperBase {
    ...
    public MongoDBServerResource addMongoDB(String name, AddMongoDBOptions options) {
        var port = options == null ? null : options.getPort();
        var userName = options == null ? null : options.getUserName();
        var password = options == null ? null : options.getPassword();
        return addMongoDBImpl(name, port, userName, password);
    }

    public MongoDBServerResource addMongoDB(String name) {
        return addMongoDB(name, null);
    }

    /** Adds a MongoDB container resource */
    private MongoDBServerResource addMongoDBImpl(String name, Double port, ParameterResource userName, ParameterResource password) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        if (port != null) {
        ...
        return (MongoDBServerResource) getClient().invokeCapability("Aspire.Hosting.MongoDB/addMongoDB", reqArgs);
    }
...
/** Wrapper for Aspire.Hosting.MongoDB/Aspire.Hosting.ApplicationModel.MongoDBDatabaseResource. */
class MongoDBDatabaseResource extends ResourceBuilderBase {
    MongoDBDatabaseResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public ReferenceExpression connectionStringExpression() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/MongoDBDatabaseResource.connectionStringExpression", reqArgs);
    }
    ...
    public ReferenceExpression uriExpression() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/MongoDBDatabaseResource.uriExpression", reqArgs);
    }

    /** Gets the Parent property */
    public MongoDBServerResource parent() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (MongoDBServerResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/MongoDBDatabaseResource.parent", reqArgs);
    }
    ...
    public String databaseName() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/MongoDBDatabaseResource.databaseName", reqArgs);
    }
    ...
    public String name() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/MongoDBDatabaseResource.name", reqArgs);
    }

}

/** Wrapper for Aspire.Hosting.MongoDB/Aspire.Hosting.ApplicationModel.MongoDBServerResource. */
class MongoDBServerResource extends ResourceBuilderBase {
    MongoDBServerResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public MongoDBDatabaseResource addDatabase(String name) {
        return addDatabase(name, null);
    }

    /** Adds a MongoDB database resource */
    public MongoDBDatabaseResource addDatabase(String name, String databaseName) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        ...
        return (MongoDBDatabaseResource) getClient().invokeCapability("Aspire.Hosting.MongoDB/addDatabase", reqArgs);
    }

    /** Adds a MongoExpress administration platform for MongoDB */
    public MongoDBServerResource withMongoExpress(WithMongoExpressOptions options) {
        ...
        return withMongoExpressImpl(configureContainer, containerName);
    }

    public MongoDBServerResource withMongoExpress() {
        return withMongoExpress(null);
    }

    /** Adds a MongoExpress administration platform for MongoDB */
    private MongoDBServerResource withMongoExpressImpl(AspireAction1<MongoExpressContainerResource> configureContainer, String containerName) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        var configureContainerId = configureContainer == null ? null : getClient().registerCallback(args -> {
            var obj = (MongoExpressContainerResource) args[0];
        ...
        return (MongoDBServerResource) getClient().invokeCapability("Aspire.Hosting.MongoDB/withMongoExpress", reqArgs);
    }

    /** Adds a named volume for the MongoDB data folder */
    public MongoDBServerResource withDataVolume(WithDataVolumeOptions options) {
        var name = options == null ? null : options.getName();
        var isReadOnly = options == null ? null : options.isReadOnly();
        return withDataVolumeImpl(name, isReadOnly);
    }

    public MongoDBServerResource withDataVolume() {
        return withDataVolume(null);
    }

    /** Adds a named volume for the MongoDB data folder */
    private MongoDBServerResource withDataVolumeImpl(String name, Boolean isReadOnly) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        if (name != null) {
            reqArgs.put("name", AspireClient.serializeValue(name));
        ...
        return (MongoDBServerResource) getClient().invokeCapability("Aspire.Hosting.MongoDB/withDataVolume", reqArgs);
    }

    public MongoDBServerResource withDataBindMount(String source) {
        return withDataBindMount(source, null);
    }

    /** Adds a bind mount for the MongoDB data folder */
    public MongoDBServerResource withDataBindMount(String source, Boolean isReadOnly) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("source", AspireClient.serializeValue(source));
        if (isReadOnly != null) {
        ...
        return (MongoDBServerResource) getClient().invokeCapability("Aspire.Hosting.MongoDB/withDataBindMount", reqArgs);
    }

    /** Copies init files into a MongoDB container */
    public MongoDBServerResource withInitFiles(String source) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("source", AspireClient.serializeValue(source));
        return (MongoDBServerResource) getClient().invokeCapability("Aspire.Hosting.MongoDB/withInitFiles", reqArgs);
    }
    ...
    public EndpointReference primaryEndpoint() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (EndpointReference) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/MongoDBServerResource.primaryEndpoint", reqArgs);
    }
    ...
    public EndpointReferenceExpression host() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (EndpointReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/MongoDBServerResource.host", reqArgs);
    }
    ...
    public EndpointReferenceExpression port() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (EndpointReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/MongoDBServerResource.port", reqArgs);
    }
    ...
    public ParameterResource passwordParameter() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ParameterResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/MongoDBServerResource.passwordParameter", reqArgs);
    }
    ...
    public ParameterResource userNameParameter() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ParameterResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/MongoDBServerResource.userNameParameter", reqArgs);
    }
    ...
    public ReferenceExpression userNameReference() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/MongoDBServerResource.userNameReference", reqArgs);
    }
    ...
    public ReferenceExpression connectionStringExpression() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/MongoDBServerResource.connectionStringExpression", reqArgs);
    }
    ...
    public ReferenceExpression uriExpression() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/MongoDBServerResource.uriExpression", reqArgs);
    }
    ...
    public AspireDict<String, String> databases() {
        if (databasesField == null) {
            databasesField = new AspireDict<>(getHandle(), getClient(), "Aspire.Hosting.ApplicationModel/MongoDBServerResource.databases");
        }
    ...
    public String entrypoint() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/MongoDBServerResource.entrypoint", reqArgs);
    }

    /** Sets the Entrypoint property */
    public MongoDBServerResource setEntrypoint(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (MongoDBServerResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/MongoDBServerResource.setEntrypoint", reqArgs);
    }
    ...
    public boolean shellExecution() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (boolean) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/MongoDBServerResource.shellExecution", reqArgs);
    }

    /** Sets the ShellExecution property */
    public MongoDBServerResource setShellExecution(boolean value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (MongoDBServerResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/MongoDBServerResource.setShellExecution", reqArgs);
    }
    ...
    public String name() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/MongoDBServerResource.name", reqArgs);
    }

}

/** Wrapper for Aspire.Hosting.MongoDB/Aspire.Hosting.MongoDB.MongoExpressContainerResource. */
class MongoExpressContainerResource extends ResourceBuilderBase {
    MongoExpressContainerResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public MongoExpressContainerResource withHostPort() {
        return withHostPort(null);
    }

    /** Sets the host port for the Mongo Express resource */
    public MongoExpressContainerResource withHostPort(Double port) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        if (port != null) {
            reqArgs.put("port", AspireClient.serializeValue(port));
        }
        return (MongoExpressContainerResource) getClient().invokeCapability("Aspire.Hosting.MongoDB/withHostPort", reqArgs);
    }
...
class AspireRegistrations {
    static {
        ...
        AspireClient.registerHandleWrapper("Aspire.Hosting.MongoDB/Aspire.Hosting.ApplicationModel.MongoDBDatabaseResource", (h, c) -> new MongoDBDatabaseResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.MongoDB/Aspire.Hosting.ApplicationModel.MongoDBServerResource", (h, c) -> new MongoDBServerResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.MongoDB/Aspire.Hosting.MongoDB.MongoExpressContainerResource", (h, c) -> new MongoExpressContainerResource(h, c));
