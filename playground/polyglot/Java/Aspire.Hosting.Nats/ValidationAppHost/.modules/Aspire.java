...
class IDistributedApplicationBuilder extends HandleWrapperBase {
    ...
    public NatsServerResource addNats(String name, AddNatsOptions options) {
        var port = options == null ? null : options.getPort();
        var userName = options == null ? null : options.getUserName();
        var password = options == null ? null : options.getPassword();
        return addNatsImpl(name, port, userName, password);
    }

    public NatsServerResource addNats(String name) {
        return addNats(name, null);
    }

    /** Adds a NATS server resource to the application model. */
    private NatsServerResource addNatsImpl(String name, Double port, ParameterResource userName, ParameterResource password) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        if (port != null) {
        ...
        return (NatsServerResource) getClient().invokeCapability("Aspire.Hosting.Nats/addNats", reqArgs);
    }
...
/** Wrapper for Aspire.Hosting.Nats/Aspire.Hosting.ApplicationModel.NatsServerResource. */
class NatsServerResource extends ResourceBuilderBase {
    NatsServerResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public NatsServerResource withJetStream() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        return (NatsServerResource) getClient().invokeCapability("Aspire.Hosting.Nats/withJetStream", reqArgs);
    }

    /** Adds a persistent data volume to the NATS resource. */
    public NatsServerResource withDataVolume(WithDataVolumeOptions options) {
        var name = options == null ? null : options.getName();
        var isReadOnly = options == null ? null : options.isReadOnly();
        return withDataVolumeImpl(name, isReadOnly);
    }

    public NatsServerResource withDataVolume() {
        return withDataVolume(null);
    }

    /** Adds a persistent data volume to the NATS resource. */
    private NatsServerResource withDataVolumeImpl(String name, Boolean isReadOnly) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        if (name != null) {
            reqArgs.put("name", AspireClient.serializeValue(name));
        ...
        return (NatsServerResource) getClient().invokeCapability("Aspire.Hosting.Nats/withDataVolume", reqArgs);
    }

    public NatsServerResource withDataBindMount(String source) {
        return withDataBindMount(source, null);
    }

    /** Mounts a host directory as the NATS data directory. */
    public NatsServerResource withDataBindMount(String source, Boolean isReadOnly) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("source", AspireClient.serializeValue(source));
        if (isReadOnly != null) {
        ...
        return (NatsServerResource) getClient().invokeCapability("Aspire.Hosting.Nats/withDataBindMount", reqArgs);
    }
    ...
    public EndpointReference primaryEndpoint() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (EndpointReference) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/NatsServerResource.primaryEndpoint", reqArgs);
    }
    ...
    public EndpointReferenceExpression host() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (EndpointReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/NatsServerResource.host", reqArgs);
    }
    ...
    public EndpointReferenceExpression port() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (EndpointReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/NatsServerResource.port", reqArgs);
    }
    ...
    public ParameterResource userNameParameter() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ParameterResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/NatsServerResource.userNameParameter", reqArgs);
    }

    /** Sets the UserNameParameter property */
    public NatsServerResource setUserNameParameter(ParameterResource value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (NatsServerResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/NatsServerResource.setUserNameParameter", reqArgs);
    }
    ...
    public ReferenceExpression userNameReference() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/NatsServerResource.userNameReference", reqArgs);
    }
    ...
    public ParameterResource passwordParameter() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ParameterResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/NatsServerResource.passwordParameter", reqArgs);
    }

    /** Sets the PasswordParameter property */
    public NatsServerResource setPasswordParameter(ParameterResource value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (NatsServerResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/NatsServerResource.setPasswordParameter", reqArgs);
    }
    ...
    public ReferenceExpression connectionStringExpression() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/NatsServerResource.connectionStringExpression", reqArgs);
    }
    ...
    public ReferenceExpression uriExpression() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/NatsServerResource.uriExpression", reqArgs);
    }
    ...
    public String entrypoint() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/NatsServerResource.entrypoint", reqArgs);
    }

    /** Sets the Entrypoint property */
    public NatsServerResource setEntrypoint(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (NatsServerResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/NatsServerResource.setEntrypoint", reqArgs);
    }
    ...
    public boolean shellExecution() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (boolean) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/NatsServerResource.shellExecution", reqArgs);
    }

    /** Sets the ShellExecution property */
    public NatsServerResource setShellExecution(boolean value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (NatsServerResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/NatsServerResource.setShellExecution", reqArgs);
    }
    ...
    public String name() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/NatsServerResource.name", reqArgs);
    }
...
class AspireRegistrations {
    static {
        ...
        AspireClient.registerHandleWrapper("Aspire.Hosting.Nats/Aspire.Hosting.ApplicationModel.NatsServerResource", (h, c) -> new NatsServerResource(h, c));
