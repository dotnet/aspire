...
/** AzureSignalRRole enum. */
enum AzureSignalRRole implements WireValueEnum {
    SIGNAL_RCONTRIBUTOR("SignalRContributor"),
    SIGNAL_RAPP_SERVER("SignalRAppServer"),
    SIGNAL_RREST_API_OWNER("SignalRRestApiOwner");

    private final String value;

    AzureSignalRRole(String value) {
        this.value = value;
    }

    public String getValue() { return value; }

    public static AzureSignalRRole fromValue(String value) {
        for (AzureSignalRRole e : values()) {
            if (e.value.equals(value)) return e;
        }
        throw new IllegalArgumentException("Unknown value: " + value);
    }
...
class AzureBicepResource extends ResourceBuilderBase {
    ...
    public IResource withSignalRRoleAssignments(AzureSignalRResource target, AzureSignalRRole[] roles) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("target", AspireClient.serializeValue(target));
        reqArgs.put("roles", AspireClient.serializeValue(roles));
        return (IResource) getClient().invokeCapability("Aspire.Hosting.Azure.SignalR/withSignalRRoleAssignments", reqArgs);
    }
...
/** Wrapper for Aspire.Hosting.Azure.SignalR/Aspire.Hosting.Azure.AzureSignalREmulatorResource. */
class AzureSignalREmulatorResource extends ResourceBuilderBase {
    AzureSignalREmulatorResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
...
/** Wrapper for Aspire.Hosting.Azure.SignalR/Aspire.Hosting.ApplicationModel.AzureSignalRResource. */
class AzureSignalRResource extends ResourceBuilderBase {
    AzureSignalRResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public AzureSignalRResource runAsEmulator() {
    ...
    public AzureSignalRResource runAsEmulator(AspireAction1<AzureSignalREmulatorResource> configureContainer) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        var configureContainerId = configureContainer == null ? null : getClient().registerCallback(args -> {
            var obj = (AzureSignalREmulatorResource) args[0];
        ...
        return (AzureSignalRResource) getClient().invokeCapability("Aspire.Hosting.Azure.SignalR/runAsEmulator", reqArgs);
    }
...
class IDistributedApplicationBuilder extends HandleWrapperBase {
    ...
    public AzureSignalRResource addAzureSignalR(String name) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        return (AzureSignalRResource) getClient().invokeCapability("Aspire.Hosting.Azure.SignalR/addAzureSignalR", reqArgs);
    }
...
class AspireRegistrations {
    static {
        ...
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure.SignalR/Aspire.Hosting.ApplicationModel.AzureSignalRResource", (h, c) -> new AzureSignalRResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure.SignalR/Aspire.Hosting.Azure.AzureSignalREmulatorResource", (h, c) -> new AzureSignalREmulatorResource(h, c));
