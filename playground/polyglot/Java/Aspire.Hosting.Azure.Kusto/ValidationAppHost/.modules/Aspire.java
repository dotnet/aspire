...
/** Wrapper for Aspire.Hosting.Azure.Kusto/Aspire.Hosting.Azure.AzureKustoClusterResource. */
class AzureKustoClusterResource extends ResourceBuilderBase {
    AzureKustoClusterResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public AzureKustoReadWriteDatabaseResource addReadWriteDatabase(String name) {
        return addReadWriteDatabase(name, null);
    }

    /** Adds a Kusto read-write database resource */
    public AzureKustoReadWriteDatabaseResource addReadWriteDatabase(String name, String databaseName) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        ...
        return (AzureKustoReadWriteDatabaseResource) getClient().invokeCapability("Aspire.Hosting.Azure.Kusto/addReadWriteDatabase", reqArgs);
    }

    public AzureKustoClusterResource runAsEmulator() {
        return runAsEmulator(null);
    }

    /** Configures the Kusto cluster to run using the local emulator */
    public AzureKustoClusterResource runAsEmulator(AspireAction1<AzureKustoEmulatorResource> configureContainer) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        var configureContainerId = configureContainer == null ? null : getClient().registerCallback(args -> {
            var obj = (AzureKustoEmulatorResource) args[0];
        ...
        return (AzureKustoClusterResource) getClient().invokeCapability("Aspire.Hosting.Azure.Kusto/runAsEmulator", reqArgs);
    }
    ...
    public boolean isEmulator() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (boolean) getClient().invokeCapability("Aspire.Hosting.Azure/AzureKustoClusterResource.isEmulator", reqArgs);
    }
    ...
    public ReferenceExpression uriExpression() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.Azure/AzureKustoClusterResource.uriExpression", reqArgs);
    }
    ...
    public ReferenceExpression connectionStringExpression() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.Azure/AzureKustoClusterResource.connectionStringExpression", reqArgs);
    }
    ...
    public AspireDict<String, Object> parameters() {
        if (parametersField == null) {
            parametersField = new AspireDict<>(getHandle(), getClient(), "Aspire.Hosting.Azure/AzureKustoClusterResource.parameters");
        }
    ...
    public AspireDict<String, Object> outputs() {
        if (outputsField == null) {
            outputsField = new AspireDict<>(getHandle(), getClient(), "Aspire.Hosting.Azure/AzureKustoClusterResource.outputs");
        }
        return outputsField;
    }
    ...
    public AspireDict<String, String> secretOutputs() {
        if (secretOutputsField == null) {
            secretOutputsField = new AspireDict<>(getHandle(), getClient(), "Aspire.Hosting.Azure/AzureKustoClusterResource.secretOutputs");
        }
    ...
    public String name() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Azure/AzureKustoClusterResource.name", reqArgs);
    }
...
/** Wrapper for Aspire.Hosting.Azure.Kusto/Aspire.Hosting.Azure.AzureKustoEmulatorResource. */
class AzureKustoEmulatorResource extends ResourceBuilderBase {
    AzureKustoEmulatorResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public AzureKustoEmulatorResource withHostPort(double port) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("port", AspireClient.serializeValue(port));
        return (AzureKustoEmulatorResource) getClient().invokeCapability("Aspire.Hosting.Azure.Kusto/withHostPort", reqArgs);
    }
...
/** Wrapper for Aspire.Hosting.Azure.Kusto/Aspire.Hosting.Azure.AzureKustoReadWriteDatabaseResource. */
class AzureKustoReadWriteDatabaseResource extends ResourceBuilderBase {
    AzureKustoReadWriteDatabaseResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public AzureKustoReadWriteDatabaseResource withCreationScript(String script) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("script", AspireClient.serializeValue(script));
        return (AzureKustoReadWriteDatabaseResource) getClient().invokeCapability("Aspire.Hosting.Azure.Kusto/withCreationScript", reqArgs);
    }

    /** Gets the Parent property */
    public AzureKustoClusterResource parent() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (AzureKustoClusterResource) getClient().invokeCapability("Aspire.Hosting.Azure/AzureKustoReadWriteDatabaseResource.parent", reqArgs);
    }
    ...
    public ReferenceExpression connectionStringExpression() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.Azure/AzureKustoReadWriteDatabaseResource.connectionStringExpression", reqArgs);
    }
    ...
    public String databaseName() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Azure/AzureKustoReadWriteDatabaseResource.databaseName", reqArgs);
    }
    ...
    public String name() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Azure/AzureKustoReadWriteDatabaseResource.name", reqArgs);
    }

    /** Gets the KQL script used to create the database. */
    public String getDatabaseCreationScript() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("databaseResource", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Azure.Kusto/getDatabaseCreationScript", reqArgs);
    }
...
class IDistributedApplicationBuilder extends HandleWrapperBase {
    ...
    public AzureKustoClusterResource addAzureKustoCluster(String name) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        return (AzureKustoClusterResource) getClient().invokeCapability("Aspire.Hosting.Azure.Kusto/addAzureKustoCluster", reqArgs);
    }
...
class AspireRegistrations {
    static {
        ...
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure.Kusto/Aspire.Hosting.Azure.AzureKustoClusterResource", (h, c) -> new AzureKustoClusterResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure.Kusto/Aspire.Hosting.Azure.AzureKustoReadWriteDatabaseResource", (h, c) -> new AzureKustoReadWriteDatabaseResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure.Kusto/Aspire.Hosting.Azure.AzureKustoEmulatorResource", (h, c) -> new AzureKustoEmulatorResource(h, c));
