...
/** Options for AddGarnet. */
final class AddGarnetOptions {
    private Double port;
    private ParameterResource password;

    public Double getPort() { return port; }
    public AddGarnetOptions port(Double value) {
        this.port = value;
        return this;
    }

    public ParameterResource getPassword() { return password; }
    public AddGarnetOptions password(ParameterResource value) {
        this.password = value;
        return this;
    }
...
/** Wrapper for Aspire.Hosting.Garnet/Aspire.Hosting.ApplicationModel.GarnetResource. */
class GarnetResource extends ResourceBuilderBase {
    GarnetResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public GarnetResource withDataVolume(WithDataVolumeOptions options) {
        var name = options == null ? null : options.getName();
        var isReadOnly = options == null ? null : options.isReadOnly();
        return withDataVolumeImpl(name, isReadOnly);
    }

    public GarnetResource withDataVolume() {
        return withDataVolume(null);
    }

    /** Adds a persistent data volume to the Garnet resource. */
    private GarnetResource withDataVolumeImpl(String name, Boolean isReadOnly) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        if (name != null) {
            reqArgs.put("name", AspireClient.serializeValue(name));
        ...
        return (GarnetResource) getClient().invokeCapability("Aspire.Hosting.Garnet/withDataVolume", reqArgs);
    }

    public GarnetResource withDataBindMount(String source) {
        return withDataBindMount(source, null);
    }

    /** Mounts a host directory as the Garnet data directory. */
    public GarnetResource withDataBindMount(String source, Boolean isReadOnly) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("source", AspireClient.serializeValue(source));
        if (isReadOnly != null) {
        ...
        return (GarnetResource) getClient().invokeCapability("Aspire.Hosting.Garnet/withDataBindMount", reqArgs);
    }

    public GarnetResource withPersistence() {
        return withPersistence(null);
    }

    /** Configures snapshot persistence for the Garnet resource. */
    public GarnetResource withPersistence(Double interval) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        if (interval != null) {
            reqArgs.put("interval", AspireClient.serializeValue(interval));
        }
        return (GarnetResource) getClient().invokeCapability("Aspire.Hosting.Garnet/withPersistence", reqArgs);
    }
    ...
    public EndpointReference primaryEndpoint() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (EndpointReference) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/GarnetResource.primaryEndpoint", reqArgs);
    }
    ...
    public EndpointReferenceExpression host() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (EndpointReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/GarnetResource.host", reqArgs);
    }
    ...
    public EndpointReferenceExpression port() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (EndpointReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/GarnetResource.port", reqArgs);
    }
    ...
    public ParameterResource passwordParameter() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ParameterResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/GarnetResource.passwordParameter", reqArgs);
    }
    ...
    public ReferenceExpression connectionStringExpression() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/GarnetResource.connectionStringExpression", reqArgs);
    }
    ...
    public ReferenceExpression uriExpression() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/GarnetResource.uriExpression", reqArgs);
    }
    ...
    public String entrypoint() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/GarnetResource.entrypoint", reqArgs);
    }

    /** Sets the Entrypoint property */
    public GarnetResource setEntrypoint(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (GarnetResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/GarnetResource.setEntrypoint", reqArgs);
    }
    ...
    public boolean shellExecution() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (boolean) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/GarnetResource.shellExecution", reqArgs);
    }

    /** Sets the ShellExecution property */
    public GarnetResource setShellExecution(boolean value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (GarnetResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/GarnetResource.setShellExecution", reqArgs);
    }
    ...
    public String name() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/GarnetResource.name", reqArgs);
    }
...
class IDistributedApplicationBuilder extends HandleWrapperBase {
    ...
    public GarnetResource addGarnet(String name, AddGarnetOptions options) {
        var port = options == null ? null : options.getPort();
        var password = options == null ? null : options.getPassword();
        return addGarnetImpl(name, port, password);
    }

    public GarnetResource addGarnet(String name) {
        return addGarnet(name, null);
    }

    /** Adds a Garnet container resource to the application model. */
    private GarnetResource addGarnetImpl(String name, Double port, ParameterResource password) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        if (port != null) {
        ...
        return (GarnetResource) getClient().invokeCapability("Aspire.Hosting.Garnet/addGarnet", reqArgs);
    }
...
class AspireRegistrations {
    static {
        ...
        AspireClient.registerHandleWrapper("Aspire.Hosting.Garnet/Aspire.Hosting.ApplicationModel.GarnetResource", (h, c) -> new GarnetResource(h, c));
