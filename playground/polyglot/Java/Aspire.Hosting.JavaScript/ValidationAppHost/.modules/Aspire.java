...
/** Options for WithNpm. */
final class WithNpmOptions {
    private Boolean install;
    private String installCommand;
    private String[] installArgs;

    public Boolean getInstall() { return install; }
    public WithNpmOptions install(Boolean value) {
        this.install = value;
        return this;
    }

    public String getInstallCommand() { return installCommand; }
    public WithNpmOptions installCommand(String value) {
        this.installCommand = value;
        return this;
    }

    public String[] getInstallArgs() { return installArgs; }
    public WithNpmOptions installArgs(String[] value) {
        this.installArgs = value;
        return this;
    }
...
/** Options for WithPnpm. */
final class WithPnpmOptions {
    private Boolean install;
    private String[] installArgs;

    public Boolean getInstall() { return install; }
    public WithPnpmOptions install(Boolean value) {
        this.install = value;
        return this;
    }

    public String[] getInstallArgs() { return installArgs; }
    public WithPnpmOptions installArgs(String[] value) {
        this.installArgs = value;
        return this;
    }
...
/** Options for WithYarn. */
final class WithYarnOptions {
    private Boolean install;
    private String[] installArgs;

    public Boolean getInstall() { return install; }
    public WithYarnOptions install(Boolean value) {
        this.install = value;
        return this;
    }

    public String[] getInstallArgs() { return installArgs; }
    public WithYarnOptions installArgs(String[] value) {
        this.installArgs = value;
        return this;
    }
...
class IDistributedApplicationBuilder extends HandleWrapperBase {
    ...
    public NodeAppResource addNodeApp(String name, String appDirectory, String scriptPath) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        ...
        return (NodeAppResource) getClient().invokeCapability("Aspire.Hosting.JavaScript/addNodeApp", reqArgs);
    }

    public JavaScriptAppResource addJavaScriptApp(String name, String appDirectory) {
        return addJavaScriptApp(name, appDirectory, null);
    }

    /** Adds a JavaScript application resource */
    public JavaScriptAppResource addJavaScriptApp(String name, String appDirectory, String runScriptName) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        reqArgs.put("appDirectory", AspireClient.serializeValue(appDirectory));
        if (runScriptName != null) {
            reqArgs.put("runScriptName", AspireClient.serializeValue(runScriptName));
        }
        return (JavaScriptAppResource) getClient().invokeCapability("Aspire.Hosting.JavaScript/addJavaScriptApp", reqArgs);
    }

    public ViteAppResource addViteApp(String name, String appDirectory) {
        return addViteApp(name, appDirectory, null);
    }

    /** Adds a Vite application resource */
    public ViteAppResource addViteApp(String name, String appDirectory, String runScriptName) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        reqArgs.put("appDirectory", AspireClient.serializeValue(appDirectory));
        ...
        return (ViteAppResource) getClient().invokeCapability("Aspire.Hosting.JavaScript/addViteApp", reqArgs);
    }
...
/** Wrapper for Aspire.Hosting.JavaScript/Aspire.Hosting.JavaScript.JavaScriptAppResource. */
class JavaScriptAppResource extends ResourceBuilderBase {
    JavaScriptAppResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public JavaScriptAppResource withNpm(WithNpmOptions options) {
        var install = options == null ? null : options.getInstall();
        var installCommand = options == null ? null : options.getInstallCommand();
        var installArgs = options == null ? null : options.getInstallArgs();
        return withNpmImpl(install, installCommand, installArgs);
    }

    public JavaScriptAppResource withNpm() {
        return withNpm(null);
    }

    /** Configures npm as the package manager */
    private JavaScriptAppResource withNpmImpl(Boolean install, String installCommand, String[] installArgs) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("resource", AspireClient.serializeValue(getHandle()));
        if (install != null) {
        ...
        if (installCommand != null) {
            reqArgs.put("installCommand", AspireClient.serializeValue(installCommand));
        }
        if (installArgs != null) {
            reqArgs.put("installArgs", AspireClient.serializeValue(installArgs));
        }
        return (JavaScriptAppResource) getClient().invokeCapability("Aspire.Hosting.JavaScript/withNpm", reqArgs);
    }

    /** Configures Bun as the package manager */
    public JavaScriptAppResource withBun(WithBunOptions options) {
        var install = options == null ? null : options.getInstall();
        var installArgs = options == null ? null : options.getInstallArgs();
        return withBunImpl(install, installArgs);
    }

    public JavaScriptAppResource withBun() {
        return withBun(null);
    }

    /** Configures Bun as the package manager */
    private JavaScriptAppResource withBunImpl(Boolean install, String[] installArgs) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("resource", AspireClient.serializeValue(getHandle()));
        if (install != null) {
            reqArgs.put("install", AspireClient.serializeValue(install));
        ...
        return (JavaScriptAppResource) getClient().invokeCapability("Aspire.Hosting.JavaScript/withBun", reqArgs);
    }

    /** Configures yarn as the package manager */
    public JavaScriptAppResource withYarn(WithYarnOptions options) {
        var install = options == null ? null : options.getInstall();
        var installArgs = options == null ? null : options.getInstallArgs();
        return withYarnImpl(install, installArgs);
    }

    public JavaScriptAppResource withYarn() {
        return withYarn(null);
    }

    /** Configures yarn as the package manager */
    private JavaScriptAppResource withYarnImpl(Boolean install, String[] installArgs) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("resource", AspireClient.serializeValue(getHandle()));
        if (install != null) {
            reqArgs.put("install", AspireClient.serializeValue(install));
        ...
        return (JavaScriptAppResource) getClient().invokeCapability("Aspire.Hosting.JavaScript/withYarn", reqArgs);
    }

    /** Configures pnpm as the package manager */
    public JavaScriptAppResource withPnpm(WithPnpmOptions options) {
        var install = options == null ? null : options.getInstall();
        var installArgs = options == null ? null : options.getInstallArgs();
        return withPnpmImpl(install, installArgs);
    }

    public JavaScriptAppResource withPnpm() {
        return withPnpm(null);
    }

    /** Configures pnpm as the package manager */
    private JavaScriptAppResource withPnpmImpl(Boolean install, String[] installArgs) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("resource", AspireClient.serializeValue(getHandle()));
        if (install != null) {
            reqArgs.put("install", AspireClient.serializeValue(install));
        ...
        return (JavaScriptAppResource) getClient().invokeCapability("Aspire.Hosting.JavaScript/withPnpm", reqArgs);
    }

    public JavaScriptAppResource withBuildScript(String scriptName) {
        return withBuildScript(scriptName, null);
    }

    /** Specifies an npm script to run before starting the application */
    public JavaScriptAppResource withBuildScript(String scriptName, String[] args) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("resource", AspireClient.serializeValue(getHandle()));
        reqArgs.put("scriptName", AspireClient.serializeValue(scriptName));
        if (args != null) {
            reqArgs.put("args", AspireClient.serializeValue(args));
        }
        return (JavaScriptAppResource) getClient().invokeCapability("Aspire.Hosting.JavaScript/withBuildScript", reqArgs);
    }

    public JavaScriptAppResource withRunScript(String scriptName) {
        return withRunScript(scriptName, null);
    }

    /** Specifies an npm script to run during development */
    public JavaScriptAppResource withRunScript(String scriptName, String[] args) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("resource", AspireClient.serializeValue(getHandle()));
        reqArgs.put("scriptName", AspireClient.serializeValue(scriptName));
        if (args != null) {
        ...
        return (JavaScriptAppResource) getClient().invokeCapability("Aspire.Hosting.JavaScript/withRunScript", reqArgs);
    }

    public JavaScriptAppResource withBrowserDebugger() {
        return withBrowserDebugger(null);
    }

    /** Configures a browser debugger for the JavaScript application */
    public JavaScriptAppResource withBrowserDebugger(String browser) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        if (browser != null) {
            reqArgs.put("browser", AspireClient.serializeValue(browser));
        }
        return (JavaScriptAppResource) getClient().invokeCapability("Aspire.Hosting.JavaScript/withBrowserDebugger", reqArgs);
    }
    ...
    public String command() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.JavaScript/JavaScriptAppResource.command", reqArgs);
    }
    ...
    public String workingDirectory() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.JavaScript/JavaScriptAppResource.workingDirectory", reqArgs);
    }
    ...
    public String name() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.JavaScript/JavaScriptAppResource.name", reqArgs);
    }

}

/** Wrapper for Aspire.Hosting.JavaScript/Aspire.Hosting.JavaScript.NodeAppResource. */
class NodeAppResource extends ResourceBuilderBase {
    NodeAppResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
...
/** Wrapper for Aspire.Hosting.JavaScript/Aspire.Hosting.JavaScript.ViteAppResource. */
class ViteAppResource extends ResourceBuilderBase {
    ViteAppResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public ViteAppResource withViteConfig(String configPath) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("configPath", AspireClient.serializeValue(configPath));
        return (ViteAppResource) getClient().invokeCapability("Aspire.Hosting.JavaScript/withViteConfig", reqArgs);
    }
...
class AspireRegistrations {
    static {
        ...
        AspireClient.registerHandleWrapper("Aspire.Hosting.JavaScript/Aspire.Hosting.JavaScript.JavaScriptAppResource", (h, c) -> new JavaScriptAppResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.JavaScript/Aspire.Hosting.JavaScript.NodeAppResource", (h, c) -> new NodeAppResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.JavaScript/Aspire.Hosting.JavaScript.ViteAppResource", (h, c) -> new ViteAppResource(h, c));
