...
/** Wrapper for Aspire.Hosting.Azure.Redis/Aspire.Hosting.Azure.AzureManagedRedisResource. */
class AzureManagedRedisResource extends ResourceBuilderBase {
    AzureManagedRedisResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public AzureManagedRedisResource runAsContainer() {
        return runAsContainer(null);
    }

    /** Configures Azure Managed Redis to run in a local container */
    public AzureManagedRedisResource runAsContainer(AspireAction1<RedisResource> configureContainer) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        var configureContainerId = configureContainer == null ? null : getClient().registerCallback(args -> {
            var obj = (RedisResource) args[0];
        ...
        return (AzureManagedRedisResource) getClient().invokeCapability("Aspire.Hosting.Azure.Redis/runAsContainer", reqArgs);
    }

    /** Configures Azure Managed Redis to use access key authentication */
    public AzureManagedRedisResource withAccessKeyAuthentication() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        return (AzureManagedRedisResource) getClient().invokeCapability("Aspire.Hosting.Azure.Redis/withAccessKeyAuthentication", reqArgs);
    }

    /** Configures Azure Managed Redis to use access key authentication with a specific Key Vault */
    public AzureManagedRedisResource withAccessKeyAuthenticationWithKeyVault(IAzureKeyVaultResource keyVaultBuilder) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("keyVaultBuilder", AspireClient.serializeValue(keyVaultBuilder));
        return (AzureManagedRedisResource) getClient().invokeCapability("Aspire.Hosting.Azure.Redis/withAccessKeyAuthenticationWithKeyVault", reqArgs);
    }

    public AzureManagedRedisResource withAccessKeyAuthenticationWithKeyVault(ResourceBuilderBase keyVaultBuilder) {
    ...
    public boolean useAccessKeyAuthentication() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (boolean) getClient().invokeCapability("Aspire.Hosting.Azure/AzureManagedRedisResource.useAccessKeyAuthentication", reqArgs);
    }
    ...
    public ReferenceExpression connectionStringExpression() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.Azure/AzureManagedRedisResource.connectionStringExpression", reqArgs);
    }
    ...
    public ReferenceExpression hostName() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.Azure/AzureManagedRedisResource.hostName", reqArgs);
    }
    ...
    public ReferenceExpression port() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.Azure/AzureManagedRedisResource.port", reqArgs);
    }
    ...
    public ReferenceExpression password() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.Azure/AzureManagedRedisResource.password", reqArgs);
    }
    ...
    public ReferenceExpression uriExpression() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.Azure/AzureManagedRedisResource.uriExpression", reqArgs);
    }

    /** Gets the Parameters property */
    private AspireDict<String, Object> parametersField;
    public AspireDict<String, Object> parameters() {
        if (parametersField == null) {
            parametersField = new AspireDict<>(getHandle(), getClient(), "Aspire.Hosting.Azure/AzureManagedRedisResource.parameters");
        }
        return parametersField;
    }

    /** Gets the Outputs property */
    private AspireDict<String, Object> outputsField;
    public AspireDict<String, Object> outputs() {
        if (outputsField == null) {
            outputsField = new AspireDict<>(getHandle(), getClient(), "Aspire.Hosting.Azure/AzureManagedRedisResource.outputs");
        }
        return outputsField;
    }

    /** Gets the SecretOutputs property */
    private AspireDict<String, String> secretOutputsField;
    public AspireDict<String, String> secretOutputs() {
        if (secretOutputsField == null) {
            secretOutputsField = new AspireDict<>(getHandle(), getClient(), "Aspire.Hosting.Azure/AzureManagedRedisResource.secretOutputs");
        }
        return secretOutputsField;
    }
    ...
    public String name() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Azure/AzureManagedRedisResource.name", reqArgs);
    }
...
class IDistributedApplicationBuilder extends HandleWrapperBase {
    ...
    public AzureManagedRedisResource addAzureManagedRedis(String name) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        return (AzureManagedRedisResource) getClient().invokeCapability("Aspire.Hosting.Azure.Redis/addAzureManagedRedis", reqArgs);
    }
...
class AspireRegistrations {
    static {
        ...
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure.Redis/Aspire.Hosting.Azure.AzureManagedRedisResource", (h, c) -> new AzureManagedRedisResource(h, c));
