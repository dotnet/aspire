...
/** Options for AddMySql. */
final class AddMySqlOptions {
    private ParameterResource password;
    private Double port;

    public ParameterResource getPassword() { return password; }
    public AddMySqlOptions password(ParameterResource value) {
        this.password = value;
        return this;
    }

    public Double getPort() { return port; }
    public AddMySqlOptions port(Double value) {
        this.port = value;
        return this;
    }
...
/** Options for WithPhpMyAdmin. */
final class WithPhpMyAdminOptions {
    private AspireAction1<PhpMyAdminContainerResource> configureContainer;
    private String containerName;

    public AspireAction1<PhpMyAdminContainerResource> getConfigureContainer() { return configureContainer; }
    public WithPhpMyAdminOptions configureContainer(AspireAction1<PhpMyAdminContainerResource> value) {
        this.configureContainer = value;
        return this;
    }

    public String getContainerName() { return containerName; }
    public WithPhpMyAdminOptions containerName(String value) {
...
class IDistributedApplicationBuilder extends HandleWrapperBase {
    ...
    public MySqlServerResource addMySql(String name, AddMySqlOptions options) {
        var password = options == null ? null : options.getPassword();
        var port = options == null ? null : options.getPort();
        return addMySqlImpl(name, password, port);
    }

    public MySqlServerResource addMySql(String name) {
        return addMySql(name, null);
    }

    /** Adds a MySQL server resource */
    private MySqlServerResource addMySqlImpl(String name, ParameterResource password, Double port) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        if (password != null) {
        ...
        return (MySqlServerResource) getClient().invokeCapability("Aspire.Hosting.MySql/addMySql", reqArgs);
    }
...
/** Wrapper for Aspire.Hosting.MySql/Aspire.Hosting.ApplicationModel.MySqlDatabaseResource. */
class MySqlDatabaseResource extends ResourceBuilderBase {
    MySqlDatabaseResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public MySqlDatabaseResource withCreationScript(String script) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("script", AspireClient.serializeValue(script));
        return (MySqlDatabaseResource) getClient().invokeCapability("Aspire.Hosting.MySql/withCreationScript", reqArgs);
    }

    /** Gets the Parent property */
    public MySqlServerResource parent() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (MySqlServerResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/MySqlDatabaseResource.parent", reqArgs);
    }
    ...
    public ReferenceExpression connectionStringExpression() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/MySqlDatabaseResource.connectionStringExpression", reqArgs);
    }
    ...
    public ReferenceExpression uriExpression() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/MySqlDatabaseResource.uriExpression", reqArgs);
    }
    ...
    public ReferenceExpression jdbcConnectionString() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/MySqlDatabaseResource.jdbcConnectionString", reqArgs);
    }
    ...
    public String databaseName() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/MySqlDatabaseResource.databaseName", reqArgs);
    }
    ...
    public String name() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/MySqlDatabaseResource.name", reqArgs);
    }

}

/** Wrapper for Aspire.Hosting.MySql/Aspire.Hosting.ApplicationModel.MySqlServerResource. */
class MySqlServerResource extends ResourceBuilderBase {
    MySqlServerResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public MySqlDatabaseResource addDatabase(String name) {
        return addDatabase(name, null);
    }

    /** Adds a MySQL database */
    public MySqlDatabaseResource addDatabase(String name, String databaseName) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        ...
        return (MySqlDatabaseResource) getClient().invokeCapability("Aspire.Hosting.MySql/addDatabase", reqArgs);
    }

    /** Configures the MySQL password */
    public MySqlServerResource withPassword(ParameterResource password) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("password", AspireClient.serializeValue(password));
        return (MySqlServerResource) getClient().invokeCapability("Aspire.Hosting.MySql/withPassword", reqArgs);
    }

    /** Adds phpMyAdmin management UI */
    public MySqlServerResource withPhpMyAdmin(WithPhpMyAdminOptions options) {
        ...
        return withPhpMyAdminImpl(configureContainer, containerName);
    }

    public MySqlServerResource withPhpMyAdmin() {
        return withPhpMyAdmin(null);
    }

    /** Adds phpMyAdmin management UI */
    private MySqlServerResource withPhpMyAdminImpl(AspireAction1<PhpMyAdminContainerResource> configureContainer, String containerName) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        var configureContainerId = configureContainer == null ? null : getClient().registerCallback(args -> {
            var obj = (PhpMyAdminContainerResource) args[0];
        ...
        return (MySqlServerResource) getClient().invokeCapability("Aspire.Hosting.MySql/withPhpMyAdmin", reqArgs);
    }

    /** Adds a data volume for MySQL */
    public MySqlServerResource withDataVolume(WithDataVolumeOptions options) {
        var name = options == null ? null : options.getName();
        var isReadOnly = options == null ? null : options.isReadOnly();
        return withDataVolumeImpl(name, isReadOnly);
    }

    public MySqlServerResource withDataVolume() {
        return withDataVolume(null);
    }

    /** Adds a data volume for MySQL */
    private MySqlServerResource withDataVolumeImpl(String name, Boolean isReadOnly) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        if (name != null) {
            reqArgs.put("name", AspireClient.serializeValue(name));
        ...
        return (MySqlServerResource) getClient().invokeCapability("Aspire.Hosting.MySql/withDataVolume", reqArgs);
    }

    public MySqlServerResource withDataBindMount(String source) {
        return withDataBindMount(source, null);
    }

    /** Adds a data bind mount for MySQL */
    public MySqlServerResource withDataBindMount(String source, Boolean isReadOnly) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("source", AspireClient.serializeValue(source));
        if (isReadOnly != null) {
        ...
        return (MySqlServerResource) getClient().invokeCapability("Aspire.Hosting.MySql/withDataBindMount", reqArgs);
    }

    /** Copies init files to MySQL */
    public MySqlServerResource withInitFiles(String source) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("source", AspireClient.serializeValue(source));
        return (MySqlServerResource) getClient().invokeCapability("Aspire.Hosting.MySql/withInitFiles", reqArgs);
    }
    ...
    public EndpointReference primaryEndpoint() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (EndpointReference) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/MySqlServerResource.primaryEndpoint", reqArgs);
    }
    ...
    public EndpointReferenceExpression host() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (EndpointReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/MySqlServerResource.host", reqArgs);
    }
    ...
    public EndpointReferenceExpression port() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (EndpointReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/MySqlServerResource.port", reqArgs);
    }
    ...
    public ParameterResource passwordParameter() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ParameterResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/MySqlServerResource.passwordParameter", reqArgs);
    }

    /** Sets the PasswordParameter property */
    public MySqlServerResource setPasswordParameter(ParameterResource value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (MySqlServerResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/MySqlServerResource.setPasswordParameter", reqArgs);
    }
    ...
    public ReferenceExpression connectionStringExpression() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/MySqlServerResource.connectionStringExpression", reqArgs);
    }
    ...
    public ReferenceExpression uriExpression() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/MySqlServerResource.uriExpression", reqArgs);
    }
    ...
    public ReferenceExpression jdbcConnectionString() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/MySqlServerResource.jdbcConnectionString", reqArgs);
    }
    ...
    public AspireDict<String, String> databases() {
        if (databasesField == null) {
            databasesField = new AspireDict<>(getHandle(), getClient(), "Aspire.Hosting.ApplicationModel/MySqlServerResource.databases");
        }
    ...
    public String entrypoint() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/MySqlServerResource.entrypoint", reqArgs);
    }

    /** Sets the Entrypoint property */
    public MySqlServerResource setEntrypoint(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (MySqlServerResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/MySqlServerResource.setEntrypoint", reqArgs);
    }
    ...
    public boolean shellExecution() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (boolean) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/MySqlServerResource.shellExecution", reqArgs);
    }

    /** Sets the ShellExecution property */
    public MySqlServerResource setShellExecution(boolean value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (MySqlServerResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/MySqlServerResource.setShellExecution", reqArgs);
    }
    ...
    public String name() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/MySqlServerResource.name", reqArgs);
    }
...
/** Wrapper for Aspire.Hosting.MySql/Aspire.Hosting.MySql.PhpMyAdminContainerResource. */
class PhpMyAdminContainerResource extends ResourceBuilderBase {
    PhpMyAdminContainerResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public PhpMyAdminContainerResource withHostPort() {
        return withHostPort(null);
    }

    /** Sets the host port for phpMyAdmin */
    public PhpMyAdminContainerResource withHostPort(Double port) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        if (port != null) {
            reqArgs.put("port", AspireClient.serializeValue(port));
        }
        return (PhpMyAdminContainerResource) getClient().invokeCapability("Aspire.Hosting.MySql/withHostPort", reqArgs);
    }
...
class AspireRegistrations {
    static {
        ...
        AspireClient.registerHandleWrapper("Aspire.Hosting.MySql/Aspire.Hosting.ApplicationModel.MySqlDatabaseResource", (h, c) -> new MySqlDatabaseResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.MySql/Aspire.Hosting.ApplicationModel.MySqlServerResource", (h, c) -> new MySqlServerResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.MySql/Aspire.Hosting.MySql.PhpMyAdminContainerResource", (h, c) -> new PhpMyAdminContainerResource(h, c));
