...
/** Options for AddMilvus. */
final class AddMilvusOptions {
    private ParameterResource apiKey;
    private Double grpcPort;

    public ParameterResource getApiKey() { return apiKey; }
    public AddMilvusOptions apiKey(ParameterResource value) {
        this.apiKey = value;
        return this;
    }

    public Double getGrpcPort() { return grpcPort; }
    public AddMilvusOptions grpcPort(Double value) {
        this.grpcPort = value;
        return this;
    }
...
/** Options for WithAttu. */
final class WithAttuOptions {
    private AspireAction1<AttuResource> configureContainer;
    private String containerName;

    public AspireAction1<AttuResource> getConfigureContainer() { return configureContainer; }
    public WithAttuOptions configureContainer(AspireAction1<AttuResource> value) {
        this.configureContainer = value;
        return this;
    }

    public String getContainerName() { return containerName; }
    public WithAttuOptions containerName(String value) {
...
/** Wrapper for Aspire.Hosting.Milvus/Aspire.Hosting.Milvus.AttuResource. */
class AttuResource extends ResourceBuilderBase {
    AttuResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
...
class IDistributedApplicationBuilder extends HandleWrapperBase {
    ...
    public MilvusServerResource addMilvus(String name, AddMilvusOptions options) {
        var apiKey = options == null ? null : options.getApiKey();
        var grpcPort = options == null ? null : options.getGrpcPort();
        return addMilvusImpl(name, apiKey, grpcPort);
    }

    public MilvusServerResource addMilvus(String name) {
        return addMilvus(name, null);
    }

    /** Adds a Milvus server resource to the distributed application model. */
    private MilvusServerResource addMilvusImpl(String name, ParameterResource apiKey, Double grpcPort) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        if (apiKey != null) {
            reqArgs.put("apiKey", AspireClient.serializeValue(apiKey));
        }
        if (grpcPort != null) {
            reqArgs.put("grpcPort", AspireClient.serializeValue(grpcPort));
        }
        return (MilvusServerResource) getClient().invokeCapability("Aspire.Hosting.Milvus/addMilvus", reqArgs);
    }
...
/** Wrapper for Aspire.Hosting.Milvus/Aspire.Hosting.ApplicationModel.MilvusDatabaseResource. */
class MilvusDatabaseResource extends ResourceBuilderBase {
    MilvusDatabaseResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public MilvusServerResource parent() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (MilvusServerResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/MilvusDatabaseResource.parent", reqArgs);
    }
    ...
    public ReferenceExpression connectionStringExpression() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/MilvusDatabaseResource.connectionStringExpression", reqArgs);
    }
    ...
    public String databaseName() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/MilvusDatabaseResource.databaseName", reqArgs);
    }
    ...
    public String name() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/MilvusDatabaseResource.name", reqArgs);
    }

}

/** Wrapper for Aspire.Hosting.Milvus/Aspire.Hosting.Milvus.MilvusServerResource. */
class MilvusServerResource extends ResourceBuilderBase {
    MilvusServerResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public MilvusDatabaseResource addDatabase(String name) {
        return addDatabase(name, null);
    }

    /** Adds a Milvus database resource to a Milvus server resource. */
    public MilvusDatabaseResource addDatabase(String name, String databaseName) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        ...
        return (MilvusDatabaseResource) getClient().invokeCapability("Aspire.Hosting.Milvus/addDatabase", reqArgs);
    }

    /** Adds the Attu administration tool for Milvus. */
    public MilvusServerResource withAttu(WithAttuOptions options) {
        ...
        return withAttuImpl(configureContainer, containerName);
    }

    public MilvusServerResource withAttu() {
        return withAttu(null);
    }

    /** Adds the Attu administration tool for Milvus. */
    private MilvusServerResource withAttuImpl(AspireAction1<AttuResource> configureContainer, String containerName) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        var configureContainerId = configureContainer == null ? null : getClient().registerCallback(args -> {
            var obj = (AttuResource) args[0];
        ...
        return (MilvusServerResource) getClient().invokeCapability("Aspire.Hosting.Milvus/withAttu", reqArgs);
    }

    /** Adds a persistent data volume to the Milvus server resource. */
    public MilvusServerResource withDataVolume(WithDataVolumeOptions options) {
        var name = options == null ? null : options.getName();
        var isReadOnly = options == null ? null : options.isReadOnly();
        return withDataVolumeImpl(name, isReadOnly);
    }

    public MilvusServerResource withDataVolume() {
        return withDataVolume(null);
    }

    /** Adds a persistent data volume to the Milvus server resource. */
    private MilvusServerResource withDataVolumeImpl(String name, Boolean isReadOnly) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        if (name != null) {
            reqArgs.put("name", AspireClient.serializeValue(name));
        ...
        return (MilvusServerResource) getClient().invokeCapability("Aspire.Hosting.Milvus/withDataVolume", reqArgs);
    }

    public MilvusServerResource withDataBindMount(String source) {
        return withDataBindMount(source, null);
    }

    /** Mounts a host directory as the Milvus data directory. */
    public MilvusServerResource withDataBindMount(String source, Boolean isReadOnly) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("source", AspireClient.serializeValue(source));
        if (isReadOnly != null) {
        ...
        return (MilvusServerResource) getClient().invokeCapability("Aspire.Hosting.Milvus/withDataBindMount", reqArgs);
    }

    /** Copies a Milvus configuration file into the container. */
    public MilvusServerResource withConfigurationFile(String configurationFilePath) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("configurationFilePath", AspireClient.serializeValue(configurationFilePath));
        return (MilvusServerResource) getClient().invokeCapability("Aspire.Hosting.Milvus/withConfigurationFile", reqArgs);
    }

    /** Gets the ApiKeyParameter property */
    public ParameterResource apiKeyParameter() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ParameterResource) getClient().invokeCapability("Aspire.Hosting.Milvus/MilvusServerResource.apiKeyParameter", reqArgs);
    }
    ...
    public EndpointReference primaryEndpoint() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (EndpointReference) getClient().invokeCapability("Aspire.Hosting.Milvus/MilvusServerResource.primaryEndpoint", reqArgs);
    }
    ...
    public EndpointReferenceExpression host() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (EndpointReferenceExpression) getClient().invokeCapability("Aspire.Hosting.Milvus/MilvusServerResource.host", reqArgs);
    }
    ...
    public EndpointReferenceExpression port() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (EndpointReferenceExpression) getClient().invokeCapability("Aspire.Hosting.Milvus/MilvusServerResource.port", reqArgs);
    }

    /** Gets the Token property */
    public ReferenceExpression token() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.Milvus/MilvusServerResource.token", reqArgs);
    }
    ...
    public ReferenceExpression connectionStringExpression() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.Milvus/MilvusServerResource.connectionStringExpression", reqArgs);
    }
    ...
    public ReferenceExpression uriExpression() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.Milvus/MilvusServerResource.uriExpression", reqArgs);
    }
    ...
    public AspireDict<String, String> databases() {
        if (databasesField == null) {
            databasesField = new AspireDict<>(getHandle(), getClient(), "Aspire.Hosting.Milvus/MilvusServerResource.databases");
        }
    ...
    public String entrypoint() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Milvus/MilvusServerResource.entrypoint", reqArgs);
    }

    /** Sets the Entrypoint property */
    public MilvusServerResource setEntrypoint(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (MilvusServerResource) getClient().invokeCapability("Aspire.Hosting.Milvus/MilvusServerResource.setEntrypoint", reqArgs);
    }
    ...
    public boolean shellExecution() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (boolean) getClient().invokeCapability("Aspire.Hosting.Milvus/MilvusServerResource.shellExecution", reqArgs);
    }

    /** Sets the ShellExecution property */
    public MilvusServerResource setShellExecution(boolean value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (MilvusServerResource) getClient().invokeCapability("Aspire.Hosting.Milvus/MilvusServerResource.setShellExecution", reqArgs);
    }
    ...
    public String name() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Milvus/MilvusServerResource.name", reqArgs);
    }
...
class AspireRegistrations {
    static {
        ...
        AspireClient.registerHandleWrapper("Aspire.Hosting.Milvus/Aspire.Hosting.ApplicationModel.MilvusDatabaseResource", (h, c) -> new MilvusDatabaseResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Milvus/Aspire.Hosting.Milvus.MilvusServerResource", (h, c) -> new MilvusServerResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Milvus/Aspire.Hosting.Milvus.AttuResource", (h, c) -> new AttuResource(h, c));
