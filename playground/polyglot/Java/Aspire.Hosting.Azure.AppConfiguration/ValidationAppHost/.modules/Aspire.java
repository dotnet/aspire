...
/** AzureAppConfigurationRole enum. */
enum AzureAppConfigurationRole implements WireValueEnum {
    APP_CONFIGURATION_DATA_OWNER("AppConfigurationDataOwner"),
    APP_CONFIGURATION_DATA_READER("AppConfigurationDataReader");

    private final String value;

    AzureAppConfigurationRole(String value) {
        this.value = value;
    }

    public String getValue() { return value; }

    public static AzureAppConfigurationRole fromValue(String value) {
        for (AzureAppConfigurationRole e : values()) {
            if (e.value.equals(value)) return e;
        }
        throw new IllegalArgumentException("Unknown value: " + value);
    }
...
/** Wrapper for Aspire.Hosting.Azure.AppConfiguration/Aspire.Hosting.Azure.AzureAppConfigurationEmulatorResource. */
class AzureAppConfigurationEmulatorResource extends ResourceBuilderBase {
    AzureAppConfigurationEmulatorResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public AzureAppConfigurationEmulatorResource withDataBindMount() {
        return withDataBindMount(null);
    }

    /** Adds a data bind mount for the App Configuration emulator */
    public AzureAppConfigurationEmulatorResource withDataBindMount(String path) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        if (path != null) {
            reqArgs.put("path", AspireClient.serializeValue(path));
        }
        return (AzureAppConfigurationEmulatorResource) getClient().invokeCapability("Aspire.Hosting.Azure.AppConfiguration/withDataBindMount", reqArgs);
    }

    public AzureAppConfigurationEmulatorResource withDataVolume() {
        return withDataVolume(null);
    }

    /** Adds a data volume for the App Configuration emulator */
    public AzureAppConfigurationEmulatorResource withDataVolume(String name) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        if (name != null) {
            reqArgs.put("name", AspireClient.serializeValue(name));
        }
        return (AzureAppConfigurationEmulatorResource) getClient().invokeCapability("Aspire.Hosting.Azure.AppConfiguration/withDataVolume", reqArgs);
    }

    public AzureAppConfigurationEmulatorResource withHostPort() {
        return withHostPort(null);
    }

    /** Sets the host port for the App Configuration emulator */
    public AzureAppConfigurationEmulatorResource withHostPort(Double port) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        if (port != null) {
            reqArgs.put("port", AspireClient.serializeValue(port));
        }
        return (AzureAppConfigurationEmulatorResource) getClient().invokeCapability("Aspire.Hosting.Azure.AppConfiguration/withHostPort", reqArgs);
    }

    /** Assigns App Configuration roles to a resource */
    public IResource withAppConfigurationRoleAssignments(AzureAppConfigurationResource target, AzureAppConfigurationRole[] roles) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("target", AspireClient.serializeValue(target));
        reqArgs.put("roles", AspireClient.serializeValue(roles));
        return (IResource) getClient().invokeCapability("Aspire.Hosting.Azure.AppConfiguration/withAppConfigurationRoleAssignments", reqArgs);
    }
...
/** Wrapper for Aspire.Hosting.Azure.AppConfiguration/Aspire.Hosting.Azure.AzureAppConfigurationResource. */
class AzureAppConfigurationResource extends ResourceBuilderBase {
    AzureAppConfigurationResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public AzureAppConfigurationResource runAsEmulator() {
        return runAsEmulator(null);
    }

    /** Configures Azure App Configuration to run with the local emulator */
    public AzureAppConfigurationResource runAsEmulator(AspireAction1<AzureAppConfigurationEmulatorResource> configureEmulator) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        var configureEmulatorId = configureEmulator == null ? null : getClient().registerCallback(args -> {
            var obj = (AzureAppConfigurationEmulatorResource) args[0];
            configureEmulator.invoke(obj);
            return null;
        });
        if (configureEmulatorId != null) {
            reqArgs.put("configureEmulator", configureEmulatorId);
        }
        return (AzureAppConfigurationResource) getClient().invokeCapability("Aspire.Hosting.Azure.AppConfiguration/runAsEmulator", reqArgs);
    }
...
class IDistributedApplicationBuilder extends HandleWrapperBase {
    ...
    public AzureAppConfigurationResource addAzureAppConfiguration(String name) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        return (AzureAppConfigurationResource) getClient().invokeCapability("Aspire.Hosting.Azure.AppConfiguration/addAzureAppConfiguration", reqArgs);
    }
...
class AspireRegistrations {
    static {
        ...
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure.AppConfiguration/Aspire.Hosting.Azure.AzureAppConfigurationResource", (h, c) -> new AzureAppConfigurationResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure.AppConfiguration/Aspire.Hosting.Azure.AzureAppConfigurationEmulatorResource", (h, c) -> new AzureAppConfigurationEmulatorResource(h, c));
