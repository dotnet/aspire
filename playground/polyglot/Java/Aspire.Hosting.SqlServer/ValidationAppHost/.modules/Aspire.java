...
/** Options for AddSqlServer. */
final class AddSqlServerOptions {
    private ParameterResource password;
    private Double port;

    public ParameterResource getPassword() { return password; }
    public AddSqlServerOptions password(ParameterResource value) {
        this.password = value;
        return this;
    }

    public Double getPort() { return port; }
    public AddSqlServerOptions port(Double value) {
        this.port = value;
        return this;
    }
...
class IDistributedApplicationBuilder extends HandleWrapperBase {
    ...
    public SqlServerServerResource addSqlServer(String name, AddSqlServerOptions options) {
        var password = options == null ? null : options.getPassword();
        var port = options == null ? null : options.getPort();
        return addSqlServerImpl(name, password, port);
    }

    public SqlServerServerResource addSqlServer(String name) {
        return addSqlServer(name, null);
    }

    /** Adds a SQL Server container resource */
    private SqlServerServerResource addSqlServerImpl(String name, ParameterResource password, Double port) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        if (password != null) {
        ...
        return (SqlServerServerResource) getClient().invokeCapability("Aspire.Hosting.SqlServer/addSqlServer", reqArgs);
    }
...
/** Wrapper for Aspire.Hosting.SqlServer/Aspire.Hosting.ApplicationModel.SqlServerDatabaseResource. */
class SqlServerDatabaseResource extends ResourceBuilderBase {
    SqlServerDatabaseResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public SqlServerDatabaseResource withCreationScript(String script) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("script", AspireClient.serializeValue(script));
        return (SqlServerDatabaseResource) getClient().invokeCapability("Aspire.Hosting.SqlServer/withCreationScript", reqArgs);
    }

    /** Gets the Parent property */
    public SqlServerServerResource parent() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (SqlServerServerResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/SqlServerDatabaseResource.parent", reqArgs);
    }
    ...
    public ReferenceExpression connectionStringExpression() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/SqlServerDatabaseResource.connectionStringExpression", reqArgs);
    }
    ...
    public ReferenceExpression uriExpression() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/SqlServerDatabaseResource.uriExpression", reqArgs);
    }
    ...
    public ReferenceExpression jdbcConnectionString() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/SqlServerDatabaseResource.jdbcConnectionString", reqArgs);
    }
    ...
    public String databaseName() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/SqlServerDatabaseResource.databaseName", reqArgs);
    }
    ...
    public String name() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/SqlServerDatabaseResource.name", reqArgs);
    }

}

/** Wrapper for Aspire.Hosting.SqlServer/Aspire.Hosting.ApplicationModel.SqlServerServerResource. */
class SqlServerServerResource extends ResourceBuilderBase {
    SqlServerServerResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public SqlServerDatabaseResource addDatabase(String name) {
        return addDatabase(name, null);
    }

    /** Adds a SQL Server database resource */
    public SqlServerDatabaseResource addDatabase(String name, String databaseName) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        ...
        return (SqlServerDatabaseResource) getClient().invokeCapability("Aspire.Hosting.SqlServer/addDatabase", reqArgs);
    }

    /** Adds a named volume for the SQL Server data folder */
    public SqlServerServerResource withDataVolume(WithDataVolumeOptions options) {
        var name = options == null ? null : options.getName();
        var isReadOnly = options == null ? null : options.isReadOnly();
        return withDataVolumeImpl(name, isReadOnly);
    }

    public SqlServerServerResource withDataVolume() {
        return withDataVolume(null);
    }

    /** Adds a named volume for the SQL Server data folder */
    private SqlServerServerResource withDataVolumeImpl(String name, Boolean isReadOnly) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        if (name != null) {
            reqArgs.put("name", AspireClient.serializeValue(name));
        ...
        return (SqlServerServerResource) getClient().invokeCapability("Aspire.Hosting.SqlServer/withDataVolume", reqArgs);
    }

    public SqlServerServerResource withDataBindMount(String source) {
        return withDataBindMount(source, null);
    }

    /** Adds a bind mount for the SQL Server data folder */
    public SqlServerServerResource withDataBindMount(String source, Boolean isReadOnly) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("source", AspireClient.serializeValue(source));
        if (isReadOnly != null) {
        ...
        return (SqlServerServerResource) getClient().invokeCapability("Aspire.Hosting.SqlServer/withDataBindMount", reqArgs);
    }
    ...
    public SqlServerServerResource withPassword(ParameterResource password) {
        ...
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("password", AspireClient.serializeValue(password));
        return (SqlServerServerResource) getClient().invokeCapability("Aspire.Hosting.SqlServer/withPassword", reqArgs);
    }

    public SqlServerServerResource withHostPort() {
        return withHostPort(null);
    }

    /** Sets the host port for the SQL Server resource */
    public SqlServerServerResource withHostPort(Double port) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        if (port != null) {
            reqArgs.put("port", AspireClient.serializeValue(port));
        }
        return (SqlServerServerResource) getClient().invokeCapability("Aspire.Hosting.SqlServer/withHostPort", reqArgs);
    }
    ...
    public EndpointReference primaryEndpoint() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (EndpointReference) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/SqlServerServerResource.primaryEndpoint", reqArgs);
    }
    ...
    public EndpointReferenceExpression host() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (EndpointReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/SqlServerServerResource.host", reqArgs);
    }
    ...
    public EndpointReferenceExpression port() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (EndpointReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/SqlServerServerResource.port", reqArgs);
    }
    ...
    public ParameterResource passwordParameter() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ParameterResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/SqlServerServerResource.passwordParameter", reqArgs);
    }

    /** Sets the PasswordParameter property */
    public SqlServerServerResource setPasswordParameter(ParameterResource value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (SqlServerServerResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/SqlServerServerResource.setPasswordParameter", reqArgs);
    }
    ...
    public ReferenceExpression userNameReference() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/SqlServerServerResource.userNameReference", reqArgs);
    }
    ...
    public ReferenceExpression uriExpression() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/SqlServerServerResource.uriExpression", reqArgs);
    }
    ...
    public ReferenceExpression jdbcConnectionString() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/SqlServerServerResource.jdbcConnectionString", reqArgs);
    }
    ...
    public ReferenceExpression connectionStringExpression() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/SqlServerServerResource.connectionStringExpression", reqArgs);
    }
    ...
    public AspireDict<String, String> databases() {
        if (databasesField == null) {
            databasesField = new AspireDict<>(getHandle(), getClient(), "Aspire.Hosting.ApplicationModel/SqlServerServerResource.databases");
        }
    ...
    public String entrypoint() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/SqlServerServerResource.entrypoint", reqArgs);
    }

    /** Sets the Entrypoint property */
    public SqlServerServerResource setEntrypoint(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (SqlServerServerResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/SqlServerServerResource.setEntrypoint", reqArgs);
    }
    ...
    public boolean shellExecution() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (boolean) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/SqlServerServerResource.shellExecution", reqArgs);
    }

    /** Sets the ShellExecution property */
    public SqlServerServerResource setShellExecution(boolean value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (SqlServerServerResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/SqlServerServerResource.setShellExecution", reqArgs);
    }
    ...
    public String name() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/SqlServerServerResource.name", reqArgs);
    }
...
class AspireRegistrations {
    static {
        ...
        AspireClient.registerHandleWrapper("Aspire.Hosting.SqlServer/Aspire.Hosting.ApplicationModel.SqlServerDatabaseResource", (h, c) -> new SqlServerDatabaseResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.SqlServer/Aspire.Hosting.ApplicationModel.SqlServerServerResource", (h, c) -> new SqlServerServerResource(h, c));
