...
/** AzureKeyVaultRole enum. */
enum AzureKeyVaultRole implements WireValueEnum {
    KEY_VAULT_ADMINISTRATOR("KeyVaultAdministrator"),
    KEY_VAULT_CERTIFICATE_USER("KeyVaultCertificateUser"),
    KEY_VAULT_CERTIFICATES_OFFICER("KeyVaultCertificatesOfficer"),
    KEY_VAULT_CONTRIBUTOR("KeyVaultContributor"),
    KEY_VAULT_CRYPTO_OFFICER("KeyVaultCryptoOfficer"),
    KEY_VAULT_CRYPTO_SERVICE_ENCRYPTION_USER("KeyVaultCryptoServiceEncryptionUser"),
    KEY_VAULT_CRYPTO_SERVICE_RELEASE_USER("KeyVaultCryptoServiceReleaseUser"),
    KEY_VAULT_CRYPTO_USER("KeyVaultCryptoUser"),
    KEY_VAULT_DATA_ACCESS_ADMINISTRATOR("KeyVaultDataAccessAdministrator"),
    KEY_VAULT_READER("KeyVaultReader"),
    KEY_VAULT_SECRETS_OFFICER("KeyVaultSecretsOfficer"),
    KEY_VAULT_SECRETS_USER("KeyVaultSecretsUser"),
    MANAGED_HSM_CONTRIBUTOR("ManagedHsmContributor");

    private final String value;

    AzureKeyVaultRole(String value) {
        this.value = value;
    }

    public String getValue() { return value; }

    public static AzureKeyVaultRole fromValue(String value) {
        for (AzureKeyVaultRole e : values()) {
            if (e.value.equals(value)) return e;
        }
        throw new IllegalArgumentException("Unknown value: " + value);
    }
...
class AzureBicepResource extends ResourceBuilderBase {
    ...
    public IResource withKeyVaultRoleAssignments(AzureKeyVaultResource target, AzureKeyVaultRole[] roles) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("target", AspireClient.serializeValue(target));
        reqArgs.put("roles", AspireClient.serializeValue(roles));
        return (IResource) getClient().invokeCapability("Aspire.Hosting.Azure.KeyVault/withKeyVaultRoleAssignments", reqArgs);
    }
...
/** Wrapper for Aspire.Hosting.Azure.CosmosDB/Aspire.Hosting.Azure.AzureCosmosDBContainerResource. */
class AzureCosmosDBContainerResource extends ResourceBuilderBase {
    AzureCosmosDBContainerResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
...
/** Wrapper for Aspire.Hosting.Azure.CosmosDB/Aspire.Hosting.Azure.AzureCosmosDBDatabaseResource. */
class AzureCosmosDBDatabaseResource extends ResourceBuilderBase {
    AzureCosmosDBDatabaseResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public AzureCosmosDBContainerResource addContainer(String name, String partitionKeyPath) {
        return addContainer(name, partitionKeyPath, null);
    }

    /** Adds an Azure Cosmos DB container resource */
    public AzureCosmosDBContainerResource addContainer(String name, String partitionKeyPath, String containerName) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        reqArgs.put("partitionKeyPath", AspireClient.serializeValue(partitionKeyPath));
        if (containerName != null) {
            reqArgs.put("containerName", AspireClient.serializeValue(containerName));
        }
        return (AzureCosmosDBContainerResource) getClient().invokeCapability("Aspire.Hosting.Azure.CosmosDB/addContainer", reqArgs);
    }

    public AzureCosmosDBContainerResource addContainerWithPartitionKeyPaths(String name, String[] partitionKeyPaths) {
        return addContainerWithPartitionKeyPaths(name, partitionKeyPaths, null);
    }

    /** Adds an Azure Cosmos DB container resource with hierarchical partition keys */
    public AzureCosmosDBContainerResource addContainerWithPartitionKeyPaths(String name, String[] partitionKeyPaths, String containerName) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        reqArgs.put("partitionKeyPaths", AspireClient.serializeValue(partitionKeyPaths));
        if (containerName != null) {
            reqArgs.put("containerName", AspireClient.serializeValue(containerName));
        }
        return (AzureCosmosDBContainerResource) getClient().invokeCapability("Aspire.Hosting.Azure.CosmosDB/addContainerWithPartitionKeyPaths", reqArgs);
    }
...
/** Wrapper for Aspire.Hosting.Azure.CosmosDB/Aspire.Hosting.Azure.AzureCosmosDBEmulatorResource. */
class AzureCosmosDBEmulatorResource extends ResourceBuilderBase {
    AzureCosmosDBEmulatorResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public AzureCosmosDBEmulatorResource withDataVolume() {
        return withDataVolume(null);
    }

    /** Adds a named volume for the data folder to an Azure Cosmos DB emulator resource */
    public AzureCosmosDBEmulatorResource withDataVolume(String name) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        if (name != null) {
            reqArgs.put("name", AspireClient.serializeValue(name));
        }
        return (AzureCosmosDBEmulatorResource) getClient().invokeCapability("Aspire.Hosting.Azure.CosmosDB/withDataVolume", reqArgs);
    }

    public AzureCosmosDBEmulatorResource withGatewayPort() {
        return withGatewayPort(null);
    }

    /** Sets the host port for the Cosmos DB emulator gateway endpoint */
    public AzureCosmosDBEmulatorResource withGatewayPort(Double port) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        if (port != null) {
            reqArgs.put("port", AspireClient.serializeValue(port));
        }
        return (AzureCosmosDBEmulatorResource) getClient().invokeCapability("Aspire.Hosting.Azure.CosmosDB/withGatewayPort", reqArgs);
    }

    /** Sets the partition count for the Azure Cosmos DB emulator */
    public AzureCosmosDBEmulatorResource withPartitionCount(double count) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("count", AspireClient.serializeValue(count));
        return (AzureCosmosDBEmulatorResource) getClient().invokeCapability("Aspire.Hosting.Azure.CosmosDB/withPartitionCount", reqArgs);
    }

    public AzureCosmosDBEmulatorResource withDataExplorer() {
        return withDataExplorer(null);
    }

    /** Exposes the Data Explorer endpoint for the preview emulator */
    public AzureCosmosDBEmulatorResource withDataExplorer(Double port) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        if (port != null) {
            reqArgs.put("port", AspireClient.serializeValue(port));
        }
        return (AzureCosmosDBEmulatorResource) getClient().invokeCapability("Aspire.Hosting.Azure.CosmosDB/withDataExplorer", reqArgs);
    }
...
/** Wrapper for Aspire.Hosting.Azure.CosmosDB/Aspire.Hosting.AzureCosmosDBResource. */
class AzureCosmosDBResource extends ResourceBuilderBase {
    AzureCosmosDBResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public AzureCosmosDBResource runAsEmulator() {
        return runAsEmulator(null);
    }

    /** Configures the Azure Cosmos DB resource to run using the local emulator */
    public AzureCosmosDBResource runAsEmulator(AspireAction1<AzureCosmosDBEmulatorResource> configureContainer) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        var configureContainerId = configureContainer == null ? null : getClient().registerCallback(args -> {
            var obj = (AzureCosmosDBEmulatorResource) args[0];
        ...
        return (AzureCosmosDBResource) getClient().invokeCapability("Aspire.Hosting.Azure.CosmosDB/runAsEmulator", reqArgs);
    }

    public AzureCosmosDBResource runAsPreviewEmulator() {
        return runAsPreviewEmulator(null);
    }

    /** Configures the Azure Cosmos DB resource to run using the preview emulator */
    public AzureCosmosDBResource runAsPreviewEmulator(AspireAction1<AzureCosmosDBEmulatorResource> configureContainer) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        var configureContainerId = configureContainer == null ? null : getClient().registerCallback(args -> {
            var obj = (AzureCosmosDBEmulatorResource) args[0];
        ...
        return (AzureCosmosDBResource) getClient().invokeCapability("Aspire.Hosting.Azure.CosmosDB/runAsPreviewEmulator", reqArgs);
    }

    public AzureCosmosDBDatabaseResource addCosmosDatabase(String name) {
        return addCosmosDatabase(name, null);
    }

    /** Adds an Azure Cosmos DB database resource */
    public AzureCosmosDBDatabaseResource addCosmosDatabase(String name, String databaseName) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        ...
        return (AzureCosmosDBDatabaseResource) getClient().invokeCapability("Aspire.Hosting.Azure.CosmosDB/addCosmosDatabase", reqArgs);
    }

    /** Configures Azure Cosmos DB to use the default Azure SKU */
    public AzureCosmosDBResource withDefaultAzureSku() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        return (AzureCosmosDBResource) getClient().invokeCapability("Aspire.Hosting.Azure.CosmosDB/withDefaultAzureSku", reqArgs);
    }

    /** Configures Azure Cosmos DB to use access key authentication */
    public AzureCosmosDBResource withAccessKeyAuthentication() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        return (AzureCosmosDBResource) getClient().invokeCapability("Aspire.Hosting.Azure.CosmosDB/withAccessKeyAuthentication", reqArgs);
    }

    /** Configures Azure Cosmos DB access key authentication using a specified Azure Key Vault resource */
    public AzureCosmosDBResource withAccessKeyAuthenticationWithKeyVault(IAzureKeyVaultResource keyVaultBuilder) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("keyVaultBuilder", AspireClient.serializeValue(keyVaultBuilder));
        return (AzureCosmosDBResource) getClient().invokeCapability("Aspire.Hosting.Azure.CosmosDB/withAccessKeyAuthenticationWithKeyVault", reqArgs);
    }

    public AzureCosmosDBResource withAccessKeyAuthenticationWithKeyVault(ResourceBuilderBase keyVaultBuilder) {
        return withAccessKeyAuthenticationWithKeyVault(new IAzureKeyVaultResource(keyVaultBuilder.getHandle(), keyVaultBuilder.getClient()));
    }
...
/** Wrapper for Aspire.Hosting.Azure.KeyVault/Aspire.Hosting.Azure.AzureKeyVaultResource. */
class AzureKeyVaultResource extends ResourceBuilderBase {
    AzureKeyVaultResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public IAzureKeyVaultSecretReference getSecret(String secretName) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("secretName", AspireClient.serializeValue(secretName));
        return (IAzureKeyVaultSecretReference) getClient().invokeCapability("Aspire.Hosting.Azure.KeyVault/getSecret", reqArgs);
    }

    /** Adds a secret to the Azure Key Vault from a parameter resource */
    public AzureKeyVaultSecretResource addSecret(String name, ParameterResource parameterResource) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        reqArgs.put("parameterResource", AspireClient.serializeValue(parameterResource));
        return (AzureKeyVaultSecretResource) getClient().invokeCapability("Aspire.Hosting.Azure.KeyVault/addSecret", reqArgs);
    }

    /** Adds a secret to the Azure Key Vault from a reference expression */
    public AzureKeyVaultSecretResource addSecretFromExpression(String name, ReferenceExpression value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (AzureKeyVaultSecretResource) getClient().invokeCapability("Aspire.Hosting.Azure.KeyVault/addSecretFromExpression", reqArgs);
    }

    /** Adds a named secret to the Azure Key Vault from a parameter resource */
    public AzureKeyVaultSecretResource addSecretWithName(String name, String secretName, ParameterResource parameterResource) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        reqArgs.put("secretName", AspireClient.serializeValue(secretName));
        reqArgs.put("parameterResource", AspireClient.serializeValue(parameterResource));
        return (AzureKeyVaultSecretResource) getClient().invokeCapability("Aspire.Hosting.Azure.KeyVault/addSecretWithName", reqArgs);
    }

    /** Adds a named secret to the Azure Key Vault from a reference expression */
    public AzureKeyVaultSecretResource addSecretWithNameFromExpression(String name, String secretName, ReferenceExpression value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        reqArgs.put("secretName", AspireClient.serializeValue(secretName));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (AzureKeyVaultSecretResource) getClient().invokeCapability("Aspire.Hosting.Azure.KeyVault/addSecretWithNameFromExpression", reqArgs);
    }
...
/** Wrapper for Aspire.Hosting.Azure.KeyVault/Aspire.Hosting.Azure.AzureKeyVaultSecretResource. */
class AzureKeyVaultSecretResource extends ResourceBuilderBase {
    AzureKeyVaultSecretResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
...
class IDistributedApplicationBuilder extends HandleWrapperBase {
    ...
    public AzureCosmosDBResource addAzureCosmosDB(String name) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        return (AzureCosmosDBResource) getClient().invokeCapability("Aspire.Hosting.Azure.CosmosDB/addAzureCosmosDB", reqArgs);
    }
    ...
    public AzureKeyVaultResource addAzureKeyVault(String name) {
        ...
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        return (AzureKeyVaultResource) getClient().invokeCapability("Aspire.Hosting.Azure.KeyVault/addAzureKeyVault", reqArgs);
    }
...
class AspireRegistrations {
    static {
        ...
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure.CosmosDB/Aspire.Hosting.AzureCosmosDBResource", (h, c) -> new AzureCosmosDBResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure.CosmosDB/Aspire.Hosting.Azure.AzureCosmosDBEmulatorResource", (h, c) -> new AzureCosmosDBEmulatorResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure.CosmosDB/Aspire.Hosting.Azure.AzureCosmosDBDatabaseResource", (h, c) -> new AzureCosmosDBDatabaseResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure.CosmosDB/Aspire.Hosting.Azure.AzureCosmosDBContainerResource", (h, c) -> new AzureCosmosDBContainerResource(h, c));
        ...
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure.KeyVault/Aspire.Hosting.Azure.AzureKeyVaultResource", (h, c) -> new AzureKeyVaultResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure.KeyVault/Aspire.Hosting.Azure.AzureKeyVaultSecretResource", (h, c) -> new AzureKeyVaultSecretResource(h, c));
