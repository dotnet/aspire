...
class CSharpAppResource extends ResourceBuilderBase {
    ...
    public IComputeResource publishAsKubernetesService(AspireAction1<KubernetesResource> configure) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        var configureId = getClient().registerCallback(args -> {
            var obj = (KubernetesResource) args[0];
            configure.invoke(obj);
            return null;
        });
        if (configureId != null) {
        ...
        return (IComputeResource) getClient().invokeCapability("Aspire.Hosting.Kubernetes/publishAsKubernetesService", reqArgs);
    }
...
class IDistributedApplicationBuilder extends HandleWrapperBase {
    ...
    public KubernetesEnvironmentResource addKubernetesEnvironment(String name) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        return (KubernetesEnvironmentResource) getClient().invokeCapability("Aspire.Hosting.Kubernetes/addKubernetesEnvironment", reqArgs);
    }
...
/** Wrapper for Aspire.Hosting.Kubernetes/Aspire.Hosting.Kubernetes.KubernetesEnvironmentResource. */
class KubernetesEnvironmentResource extends ResourceBuilderBase {
    KubernetesEnvironmentResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public KubernetesEnvironmentResource withProperties(AspireAction1<KubernetesEnvironmentResource> configure) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        var configureId = getClient().registerCallback(args -> {
            var obj = (KubernetesEnvironmentResource) args[0];
            configure.invoke(obj);
            return null;
        });
        if (configureId != null) {
        ...
        return (KubernetesEnvironmentResource) getClient().invokeCapability("Aspire.Hosting.Kubernetes/withProperties", reqArgs);
    }

    /** Gets the HelmChartName property */
    public String helmChartName() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Kubernetes/KubernetesEnvironmentResource.helmChartName", reqArgs);
    }

    /** Sets the HelmChartName property */
    public KubernetesEnvironmentResource setHelmChartName(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (KubernetesEnvironmentResource) getClient().invokeCapability("Aspire.Hosting.Kubernetes/KubernetesEnvironmentResource.setHelmChartName", reqArgs);
    }
    ...
    public String helmChartVersion() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Kubernetes/KubernetesEnvironmentResource.helmChartVersion", reqArgs);
    }

    /** Sets the HelmChartVersion property */
    public KubernetesEnvironmentResource setHelmChartVersion(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (KubernetesEnvironmentResource) getClient().invokeCapability("Aspire.Hosting.Kubernetes/KubernetesEnvironmentResource.setHelmChartVersion", reqArgs);
    }

    /** Gets the HelmChartDescription property */
    public String helmChartDescription() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Kubernetes/KubernetesEnvironmentResource.helmChartDescription", reqArgs);
    }

    /** Sets the HelmChartDescription property */
    public KubernetesEnvironmentResource setHelmChartDescription(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (KubernetesEnvironmentResource) getClient().invokeCapability("Aspire.Hosting.Kubernetes/KubernetesEnvironmentResource.setHelmChartDescription", reqArgs);
    }
    ...
    public String defaultStorageType() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Kubernetes/KubernetesEnvironmentResource.defaultStorageType", reqArgs);
    }

    /** Sets the DefaultStorageType property */
    public KubernetesEnvironmentResource setDefaultStorageType(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (KubernetesEnvironmentResource) getClient().invokeCapability("Aspire.Hosting.Kubernetes/KubernetesEnvironmentResource.setDefaultStorageType", reqArgs);
    }

    /** Gets the DefaultStorageClassName property */
    public String defaultStorageClassName() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Kubernetes/KubernetesEnvironmentResource.defaultStorageClassName", reqArgs);
    }

    /** Sets the DefaultStorageClassName property */
    public KubernetesEnvironmentResource setDefaultStorageClassName(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (KubernetesEnvironmentResource) getClient().invokeCapability("Aspire.Hosting.Kubernetes/KubernetesEnvironmentResource.setDefaultStorageClassName", reqArgs);
    }

    /** Gets the DefaultStorageSize property */
    public String defaultStorageSize() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Kubernetes/KubernetesEnvironmentResource.defaultStorageSize", reqArgs);
    }

    /** Sets the DefaultStorageSize property */
    public KubernetesEnvironmentResource setDefaultStorageSize(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (KubernetesEnvironmentResource) getClient().invokeCapability("Aspire.Hosting.Kubernetes/KubernetesEnvironmentResource.setDefaultStorageSize", reqArgs);
    }

    /** Gets the DefaultStorageReadWritePolicy property */
    public String defaultStorageReadWritePolicy() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Kubernetes/KubernetesEnvironmentResource.defaultStorageReadWritePolicy", reqArgs);
    }

    /** Sets the DefaultStorageReadWritePolicy property */
    public KubernetesEnvironmentResource setDefaultStorageReadWritePolicy(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (KubernetesEnvironmentResource) getClient().invokeCapability("Aspire.Hosting.Kubernetes/KubernetesEnvironmentResource.setDefaultStorageReadWritePolicy", reqArgs);
    }

    /** Gets the DefaultImagePullPolicy property */
    public String defaultImagePullPolicy() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Kubernetes/KubernetesEnvironmentResource.defaultImagePullPolicy", reqArgs);
    }

    /** Sets the DefaultImagePullPolicy property */
    public KubernetesEnvironmentResource setDefaultImagePullPolicy(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (KubernetesEnvironmentResource) getClient().invokeCapability("Aspire.Hosting.Kubernetes/KubernetesEnvironmentResource.setDefaultImagePullPolicy", reqArgs);
    }
    ...
    public String defaultServiceType() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Kubernetes/KubernetesEnvironmentResource.defaultServiceType", reqArgs);
    }

    /** Sets the DefaultServiceType property */
    public KubernetesEnvironmentResource setDefaultServiceType(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (KubernetesEnvironmentResource) getClient().invokeCapability("Aspire.Hosting.Kubernetes/KubernetesEnvironmentResource.setDefaultServiceType", reqArgs);
    }
    ...
    public String name() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Kubernetes/KubernetesEnvironmentResource.name", reqArgs);
    }

}

/** Wrapper for Aspire.Hosting.Kubernetes/Aspire.Hosting.Kubernetes.KubernetesResource. */
class KubernetesResource extends ResourceBuilderBase {
    KubernetesResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public KubernetesEnvironmentResource parent() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (KubernetesEnvironmentResource) getClient().invokeCapability("Aspire.Hosting.Kubernetes/KubernetesResource.parent", reqArgs);
    }
    ...
    public String name() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Kubernetes/KubernetesResource.name", reqArgs);
    }
...
class AspireRegistrations {
    static {
        ...
        AspireClient.registerHandleWrapper("Aspire.Hosting.Kubernetes/Aspire.Hosting.Kubernetes.KubernetesEnvironmentResource", (h, c) -> new KubernetesEnvironmentResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Kubernetes/Aspire.Hosting.Kubernetes.KubernetesResource", (h, c) -> new KubernetesResource(h, c));
