...
/** Options for AddPostgres. */
final class AddPostgresOptions {
    private ParameterResource userName;
    private ParameterResource password;
    private Double port;

    public ParameterResource getUserName() { return userName; }
    public AddPostgresOptions userName(ParameterResource value) {
        this.userName = value;
        return this;
    }

    public ParameterResource getPassword() { return password; }
    public AddPostgresOptions password(ParameterResource value) {
        this.password = value;
        return this;
    }

    public Double getPort() { return port; }
    public AddPostgresOptions port(Double value) {
        this.port = value;
        return this;
    }
...
/** Options for WithPgAdmin. */
final class WithPgAdminOptions {
    private AspireAction1<PgAdminContainerResource> configureContainer;
    private String containerName;

    public AspireAction1<PgAdminContainerResource> getConfigureContainer() { return configureContainer; }
    public WithPgAdminOptions configureContainer(AspireAction1<PgAdminContainerResource> value) {
        this.configureContainer = value;
        return this;
    }

    public String getContainerName() { return containerName; }
    public WithPgAdminOptions containerName(String value) {
...
/** Options for WithPgWeb. */
final class WithPgWebOptions {
    private AspireAction1<PgWebContainerResource> configureContainer;
    private String containerName;

    public AspireAction1<PgWebContainerResource> getConfigureContainer() { return configureContainer; }
    public WithPgWebOptions configureContainer(AspireAction1<PgWebContainerResource> value) {
        this.configureContainer = value;
        return this;
    }

    public String getContainerName() { return containerName; }
    public WithPgWebOptions containerName(String value) {
        this.containerName = value;
        return this;
    }
...
/** Options for WithPostgresMcp. */
final class WithPostgresMcpOptions {
    private AspireAction1<PostgresMcpContainerResource> configureContainer;
    private String containerName;

    public AspireAction1<PostgresMcpContainerResource> getConfigureContainer() { return configureContainer; }
    public WithPostgresMcpOptions configureContainer(AspireAction1<PostgresMcpContainerResource> value) {
        this.configureContainer = value;
        return this;
    }

    public String getContainerName() { return containerName; }
    public WithPostgresMcpOptions containerName(String value) {
        this.containerName = value;
        return this;
    }
...
class IDistributedApplicationBuilder extends HandleWrapperBase {
    ...
    public PostgresServerResource addPostgres(String name, AddPostgresOptions options) {
        var userName = options == null ? null : options.getUserName();
        var password = options == null ? null : options.getPassword();
        var port = options == null ? null : options.getPort();
        return addPostgresImpl(name, userName, password, port);
    }

    public PostgresServerResource addPostgres(String name) {
        return addPostgres(name, null);
    }

    /** Adds a PostgreSQL server resource */
    private PostgresServerResource addPostgresImpl(String name, ParameterResource userName, ParameterResource password, Double port) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        if (userName != null) {
            reqArgs.put("userName", AspireClient.serializeValue(userName));
        }
        if (password != null) {
            reqArgs.put("password", AspireClient.serializeValue(password));
        }
        ...
        return (PostgresServerResource) getClient().invokeCapability("Aspire.Hosting.PostgreSQL/addPostgres", reqArgs);
    }
...
/** Wrapper for Aspire.Hosting.PostgreSQL/Aspire.Hosting.Postgres.PgAdminContainerResource. */
class PgAdminContainerResource extends ResourceBuilderBase {
    PgAdminContainerResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public PgAdminContainerResource withHostPort() {
        return withHostPort(null);
    }

    /** Sets the host port for pgAdmin */
    public PgAdminContainerResource withHostPort(Double port) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        if (port != null) {
            reqArgs.put("port", AspireClient.serializeValue(port));
        }
        return (PgAdminContainerResource) getClient().invokeCapability("Aspire.Hosting.PostgreSQL/withPgAdminHostPort", reqArgs);
    }

}

/** Wrapper for Aspire.Hosting.PostgreSQL/Aspire.Hosting.Postgres.PgWebContainerResource. */
class PgWebContainerResource extends ResourceBuilderBase {
    PgWebContainerResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public PgWebContainerResource withHostPort() {
        return withHostPort(null);
    }

    /** Sets the host port for pgweb */
    public PgWebContainerResource withHostPort(Double port) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        if (port != null) {
            reqArgs.put("port", AspireClient.serializeValue(port));
        }
        return (PgWebContainerResource) getClient().invokeCapability("Aspire.Hosting.PostgreSQL/withPgWebHostPort", reqArgs);
    }
...
/** Wrapper for Aspire.Hosting.PostgreSQL/Aspire.Hosting.ApplicationModel.PostgresDatabaseResource. */
class PostgresDatabaseResource extends ResourceBuilderBase {
    PostgresDatabaseResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public PostgresDatabaseResource withPostgresMcp(WithPostgresMcpOptions options) {
        ...
        return withPostgresMcpImpl(configureContainer, containerName);
    }

    public PostgresDatabaseResource withPostgresMcp() {
        return withPostgresMcp(null);
    }

    /** Adds Postgres MCP server */
    private PostgresDatabaseResource withPostgresMcpImpl(AspireAction1<PostgresMcpContainerResource> configureContainer, String containerName) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        var configureContainerId = configureContainer == null ? null : getClient().registerCallback(args -> {
            var obj = (PostgresMcpContainerResource) args[0];
        ...
        return (PostgresDatabaseResource) getClient().invokeCapability("Aspire.Hosting.PostgreSQL/withPostgresMcp", reqArgs);
    }

    /** Defines the SQL script for database creation */
    public PostgresDatabaseResource withCreationScript(String script) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("script", AspireClient.serializeValue(script));
        return (PostgresDatabaseResource) getClient().invokeCapability("Aspire.Hosting.PostgreSQL/withCreationScript", reqArgs);
    }

    /** Gets the Parent property */
    public PostgresServerResource parent() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (PostgresServerResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/PostgresDatabaseResource.parent", reqArgs);
    }
    ...
    public ReferenceExpression connectionStringExpression() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/PostgresDatabaseResource.connectionStringExpression", reqArgs);
    }
    ...
    public String databaseName() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/PostgresDatabaseResource.databaseName", reqArgs);
    }
    ...
    public ReferenceExpression uriExpression() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/PostgresDatabaseResource.uriExpression", reqArgs);
    }
    ...
    public ReferenceExpression jdbcConnectionString() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/PostgresDatabaseResource.jdbcConnectionString", reqArgs);
    }
    ...
    public String name() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/PostgresDatabaseResource.name", reqArgs);
    }

}

/** Wrapper for Aspire.Hosting.PostgreSQL/Aspire.Hosting.Postgres.PostgresMcpContainerResource. */
class PostgresMcpContainerResource extends ResourceBuilderBase {
    PostgresMcpContainerResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
...
/** Wrapper for Aspire.Hosting.PostgreSQL/Aspire.Hosting.ApplicationModel.PostgresServerResource. */
class PostgresServerResource extends ResourceBuilderBase {
    PostgresServerResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public PostgresDatabaseResource addDatabase(String name) {
        return addDatabase(name, null);
    }

    /** Adds a PostgreSQL database */
    public PostgresDatabaseResource addDatabase(String name, String databaseName) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        ...
        return (PostgresDatabaseResource) getClient().invokeCapability("Aspire.Hosting.PostgreSQL/addDatabase", reqArgs);
    }

    /** Adds pgAdmin 4 management UI */
    public PostgresServerResource withPgAdmin(WithPgAdminOptions options) {
        var configureContainer = options == null ? null : options.getConfigureContainer();
        var containerName = options == null ? null : options.getContainerName();
        return withPgAdminImpl(configureContainer, containerName);
    }

    public PostgresServerResource withPgAdmin() {
        return withPgAdmin(null);
    }

    /** Adds pgAdmin 4 management UI */
    private PostgresServerResource withPgAdminImpl(AspireAction1<PgAdminContainerResource> configureContainer, String containerName) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        var configureContainerId = configureContainer == null ? null : getClient().registerCallback(args -> {
            var obj = (PgAdminContainerResource) args[0];
            configureContainer.invoke(obj);
            return null;
        });
        if (configureContainerId != null) {
        ...
        return (PostgresServerResource) getClient().invokeCapability("Aspire.Hosting.PostgreSQL/withPgAdmin", reqArgs);
    }

    /** Adds pgweb management UI */
    public PostgresServerResource withPgWeb(WithPgWebOptions options) {
        var configureContainer = options == null ? null : options.getConfigureContainer();
        var containerName = options == null ? null : options.getContainerName();
        return withPgWebImpl(configureContainer, containerName);
    }

    public PostgresServerResource withPgWeb() {
        return withPgWeb(null);
    }

    /** Adds pgweb management UI */
    private PostgresServerResource withPgWebImpl(AspireAction1<PgWebContainerResource> configureContainer, String containerName) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        var configureContainerId = configureContainer == null ? null : getClient().registerCallback(args -> {
            var obj = (PgWebContainerResource) args[0];
            configureContainer.invoke(obj);
            return null;
        });
        if (configureContainerId != null) {
        ...
        return (PostgresServerResource) getClient().invokeCapability("Aspire.Hosting.PostgreSQL/withPgWeb", reqArgs);
    }

    /** Adds a data volume for PostgreSQL */
    public PostgresServerResource withDataVolume(WithDataVolumeOptions options) {
        var name = options == null ? null : options.getName();
        var isReadOnly = options == null ? null : options.isReadOnly();
        return withDataVolumeImpl(name, isReadOnly);
    }

    public PostgresServerResource withDataVolume() {
        return withDataVolume(null);
    }

    /** Adds a data volume for PostgreSQL */
    private PostgresServerResource withDataVolumeImpl(String name, Boolean isReadOnly) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        if (name != null) {
            reqArgs.put("name", AspireClient.serializeValue(name));
        ...
        return (PostgresServerResource) getClient().invokeCapability("Aspire.Hosting.PostgreSQL/withDataVolume", reqArgs);
    }

    public PostgresServerResource withDataBindMount(String source) {
        return withDataBindMount(source, null);
    }

    /** Adds a data bind mount for PostgreSQL */
    public PostgresServerResource withDataBindMount(String source, Boolean isReadOnly) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("source", AspireClient.serializeValue(source));
        if (isReadOnly != null) {
        ...
        return (PostgresServerResource) getClient().invokeCapability("Aspire.Hosting.PostgreSQL/withDataBindMount", reqArgs);
    }

    /** Copies init files to PostgreSQL */
    public PostgresServerResource withInitFiles(String source) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("source", AspireClient.serializeValue(source));
        return (PostgresServerResource) getClient().invokeCapability("Aspire.Hosting.PostgreSQL/withInitFiles", reqArgs);
    }

    /** Configures the PostgreSQL password */
    public PostgresServerResource withPassword(ParameterResource password) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("password", AspireClient.serializeValue(password));
        return (PostgresServerResource) getClient().invokeCapability("Aspire.Hosting.PostgreSQL/withPassword", reqArgs);
    }

    /** Configures the PostgreSQL user name */
    public PostgresServerResource withUserName(ParameterResource userName) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("userName", AspireClient.serializeValue(userName));
        return (PostgresServerResource) getClient().invokeCapability("Aspire.Hosting.PostgreSQL/withUserName", reqArgs);
    }

    public PostgresServerResource withHostPort() {
        return withHostPort(null);
    }

    /** Sets the host port for PostgreSQL */
    public PostgresServerResource withHostPort(Double port) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        if (port != null) {
            reqArgs.put("port", AspireClient.serializeValue(port));
        }
        return (PostgresServerResource) getClient().invokeCapability("Aspire.Hosting.PostgreSQL/withPostgresHostPort", reqArgs);
    }
    ...
    public EndpointReference primaryEndpoint() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (EndpointReference) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/PostgresServerResource.primaryEndpoint", reqArgs);
    }

    /** Gets the UserNameParameter property */
    public ParameterResource userNameParameter() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ParameterResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/PostgresServerResource.userNameParameter", reqArgs);
    }

    /** Sets the UserNameParameter property */
    public PostgresServerResource setUserNameParameter(ParameterResource value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (PostgresServerResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/PostgresServerResource.setUserNameParameter", reqArgs);
    }
    ...
    public ReferenceExpression userNameReference() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/PostgresServerResource.userNameReference", reqArgs);
    }
    ...
    public ParameterResource passwordParameter() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ParameterResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/PostgresServerResource.passwordParameter", reqArgs);
    }

    /** Sets the PasswordParameter property */
    public PostgresServerResource setPasswordParameter(ParameterResource value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (PostgresServerResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/PostgresServerResource.setPasswordParameter", reqArgs);
    }
    ...
    public ReferenceExpression connectionStringExpression() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/PostgresServerResource.connectionStringExpression", reqArgs);
    }

    /** Gets the Databases property */
    private AspireDict<String, String> databasesField;
    public AspireDict<String, String> databases() {
        if (databasesField == null) {
            databasesField = new AspireDict<>(getHandle(), getClient(), "Aspire.Hosting.ApplicationModel/PostgresServerResource.databases");
        }
    ...
    public EndpointReferenceExpression host() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (EndpointReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/PostgresServerResource.host", reqArgs);
    }
    ...
    public EndpointReferenceExpression port() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (EndpointReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/PostgresServerResource.port", reqArgs);
    }
    ...
    public ReferenceExpression uriExpression() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/PostgresServerResource.uriExpression", reqArgs);
    }
    ...
    public ReferenceExpression jdbcConnectionString() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/PostgresServerResource.jdbcConnectionString", reqArgs);
    }
    ...
    public String entrypoint() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/PostgresServerResource.entrypoint", reqArgs);
    }

    /** Sets the Entrypoint property */
    public PostgresServerResource setEntrypoint(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (PostgresServerResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/PostgresServerResource.setEntrypoint", reqArgs);
    }
    ...
    public boolean shellExecution() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (boolean) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/PostgresServerResource.shellExecution", reqArgs);
    }

    /** Sets the ShellExecution property */
    public PostgresServerResource setShellExecution(boolean value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (PostgresServerResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/PostgresServerResource.setShellExecution", reqArgs);
    }
    ...
    public String name() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/PostgresServerResource.name", reqArgs);
    }
...
class AspireRegistrations {
    static {
        ...
        AspireClient.registerHandleWrapper("Aspire.Hosting.PostgreSQL/Aspire.Hosting.ApplicationModel.PostgresDatabaseResource", (h, c) -> new PostgresDatabaseResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.PostgreSQL/Aspire.Hosting.ApplicationModel.PostgresServerResource", (h, c) -> new PostgresServerResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.PostgreSQL/Aspire.Hosting.Postgres.PgAdminContainerResource", (h, c) -> new PgAdminContainerResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.PostgreSQL/Aspire.Hosting.Postgres.PgWebContainerResource", (h, c) -> new PgWebContainerResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.PostgreSQL/Aspire.Hosting.Postgres.PostgresMcpContainerResource", (h, c) -> new PostgresMcpContainerResource(h, c));
