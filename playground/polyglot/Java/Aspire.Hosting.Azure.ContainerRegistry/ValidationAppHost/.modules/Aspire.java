...
/** Wrapper for Aspire.Hosting.Azure.AppContainers/Aspire.Hosting.Azure.AppContainers.AzureContainerAppEnvironmentResource. */
class AzureContainerAppEnvironmentResource extends ResourceBuilderBase {
    AzureContainerAppEnvironmentResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public AzureContainerAppEnvironmentResource withAzdResourceNaming() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        return (AzureContainerAppEnvironmentResource) getClient().invokeCapability("Aspire.Hosting.Azure.AppContainers/withAzdResourceNaming", reqArgs);
    }

    /** Configures resources to use compact naming for length-constrained Azure resources */
    public AzureContainerAppEnvironmentResource withCompactResourceNaming() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        return (AzureContainerAppEnvironmentResource) getClient().invokeCapability("Aspire.Hosting.Azure.AppContainers/withCompactResourceNaming", reqArgs);
    }

    public AzureContainerAppEnvironmentResource withDashboard() {
        return withDashboard(null);
    }

    /** Configures whether the Aspire dashboard is included in the container app environment */
    public AzureContainerAppEnvironmentResource withDashboard(Boolean enable) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        if (enable != null) {
            reqArgs.put("enable", AspireClient.serializeValue(enable));
        }
        return (AzureContainerAppEnvironmentResource) getClient().invokeCapability("Aspire.Hosting.Azure.AppContainers/withDashboard", reqArgs);
    }

    public AzureContainerAppEnvironmentResource withHttpsUpgrade() {
        return withHttpsUpgrade(null);
    }

    /** Configures whether HTTP endpoints are upgraded to HTTPS */
    public AzureContainerAppEnvironmentResource withHttpsUpgrade(Boolean upgrade) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        if (upgrade != null) {
            reqArgs.put("upgrade", AspireClient.serializeValue(upgrade));
        }
        return (AzureContainerAppEnvironmentResource) getClient().invokeCapability("Aspire.Hosting.Azure.AppContainers/withHttpsUpgrade", reqArgs);
    }

    /** Configures the container app environment to use a specific Log Analytics Workspace */
    public AzureContainerAppEnvironmentResource withAzureLogAnalyticsWorkspace(AzureLogAnalyticsWorkspaceResource workspaceBuilder) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("workspaceBuilder", AspireClient.serializeValue(workspaceBuilder));
        return (AzureContainerAppEnvironmentResource) getClient().invokeCapability("Aspire.Hosting.Azure.AppContainers/withAzureLogAnalyticsWorkspace", reqArgs);
    }
...
class CSharpAppResource extends ResourceBuilderBase {
    ...
    public ProjectResource publishAsAzureContainerApp(AspireAction2<AzureResourceInfrastructure, ContainerApp> configure) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("project", AspireClient.serializeValue(getHandle()));
        var configureId = getClient().registerCallback(args -> {
            var arg1 = (AzureResourceInfrastructure) args[0];
            var arg2 = (ContainerApp) args[1];
        ...
        return (ProjectResource) getClient().invokeCapability("Aspire.Hosting.Azure.AppContainers/publishProjectAsAzureContainerApp", reqArgs);
    }

    /** Configures the compute resource as an Azure Container App Job with custom configuration */
    public IComputeResource publishAsConfiguredAzureContainerAppJob(AspireAction2<AzureResourceInfrastructure, ContainerAppJob> configure) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("resource", AspireClient.serializeValue(getHandle()));
        var configureId = getClient().registerCallback(args -> {
            var arg1 = (AzureResourceInfrastructure) args[0];
            var arg2 = (ContainerAppJob) args[1];
            configure.invoke(arg1, arg2);
            return null;
        });
        if (configureId != null) {
        ...
        return (IComputeResource) getClient().invokeCapability("Aspire.Hosting.Azure.AppContainers/publishAsConfiguredAzureContainerAppJob", reqArgs);
    }

    /** Configures the compute resource as a manually triggered Azure Container App Job */
    public IComputeResource publishAsAzureContainerAppJob() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("resource", AspireClient.serializeValue(getHandle()));
        return (IComputeResource) getClient().invokeCapability("Aspire.Hosting.Azure.AppContainers/publishAsAzureContainerAppJob", reqArgs);
    }

    public IComputeResource publishAsConfiguredScheduledAzureContainerAppJob(String cronExpression) {
        return publishAsConfiguredScheduledAzureContainerAppJob(cronExpression, null);
    }

    /** Configures the compute resource as a scheduled Azure Container App Job with custom configuration */
    public IComputeResource publishAsConfiguredScheduledAzureContainerAppJob(String cronExpression, AspireAction2<AzureResourceInfrastructure, ContainerAppJob> configure) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("resource", AspireClient.serializeValue(getHandle()));
        reqArgs.put("cronExpression", AspireClient.serializeValue(cronExpression));
        var configureId = configure == null ? null : getClient().registerCallback(args -> {
            var arg1 = (AzureResourceInfrastructure) args[0];
            var arg2 = (ContainerAppJob) args[1];
            configure.invoke(arg1, arg2);
        ...
        return (IComputeResource) getClient().invokeCapability("Aspire.Hosting.Azure.AppContainers/publishAsConfiguredScheduledAzureContainerAppJob", reqArgs);
    }

    /** Configures the compute resource as a scheduled Azure Container App Job */
    public IComputeResource publishAsScheduledAzureContainerAppJob(String cronExpression) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("resource", AspireClient.serializeValue(getHandle()));
        reqArgs.put("cronExpression", AspireClient.serializeValue(cronExpression));
        return (IComputeResource) getClient().invokeCapability("Aspire.Hosting.Azure.AppContainers/publishAsScheduledAzureContainerAppJob", reqArgs);
    }
...
/** Wrapper for Azure.Provisioning.AppContainers/Azure.Provisioning.AppContainers.ContainerApp. */
class ContainerApp extends HandleWrapperBase {
    ContainerApp(Handle handle, AspireClient client) {
        super(handle, client);
    }

}

/** Wrapper for Azure.Provisioning.AppContainers/Azure.Provisioning.AppContainers.ContainerAppJob. */
class ContainerAppJob extends HandleWrapperBase {
    ContainerAppJob(Handle handle, AspireClient client) {
        super(handle, client);
    }
...
class ContainerResource extends ResourceBuilderBase {
    ...
    public ContainerResource publishAsAzureContainerApp(AspireAction2<AzureResourceInfrastructure, ContainerApp> configure) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("container", AspireClient.serializeValue(getHandle()));
        var configureId = getClient().registerCallback(args -> {
            var arg1 = (AzureResourceInfrastructure) args[0];
            var arg2 = (ContainerApp) args[1];
            configure.invoke(arg1, arg2);
        ...
        return (ContainerResource) getClient().invokeCapability("Aspire.Hosting.Azure.AppContainers/publishContainerAsAzureContainerApp", reqArgs);
    }
...
class DotnetToolResource extends ResourceBuilderBase {
    ...
    public ExecutableResource publishAsAzureContainerApp(AspireAction2<AzureResourceInfrastructure, ContainerApp> configure) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("executable", AspireClient.serializeValue(getHandle()));
        var configureId = getClient().registerCallback(args -> {
            var arg1 = (AzureResourceInfrastructure) args[0];
            var arg2 = (ContainerApp) args[1];
            configure.invoke(arg1, arg2);
        ...
        return (ExecutableResource) getClient().invokeCapability("Aspire.Hosting.Azure.AppContainers/publishExecutableAsAzureContainerApp", reqArgs);
    }
...
class IDistributedApplicationBuilder extends HandleWrapperBase {
    ...
    public AzureContainerAppEnvironmentResource addAzureContainerAppEnvironment(String name) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        return (AzureContainerAppEnvironmentResource) getClient().invokeCapability("Aspire.Hosting.Azure.AppContainers/addAzureContainerAppEnvironment", reqArgs);
    }
...
class AspireRegistrations {
    static {
        ...
        AspireClient.registerHandleWrapper("Azure.Provisioning.AppContainers/Azure.Provisioning.AppContainers.ContainerApp", (h, c) -> new ContainerApp(h, c));
        AspireClient.registerHandleWrapper("Azure.Provisioning.AppContainers/Azure.Provisioning.AppContainers.ContainerAppJob", (h, c) -> new ContainerAppJob(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure.AppContainers/Aspire.Hosting.Azure.AppContainers.AzureContainerAppEnvironmentResource", (h, c) -> new AzureContainerAppEnvironmentResource(h, c));
