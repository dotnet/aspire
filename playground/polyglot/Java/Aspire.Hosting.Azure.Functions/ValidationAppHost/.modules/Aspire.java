...
/** AzureStorageRole enum. */
enum AzureStorageRole implements WireValueEnum {
    CLASSIC_STORAGE_ACCOUNT_CONTRIBUTOR("ClassicStorageAccountContributor"),
    CLASSIC_STORAGE_ACCOUNT_KEY_OPERATOR_SERVICE_ROLE("ClassicStorageAccountKeyOperatorServiceRole"),
    STORAGE_ACCOUNT_BACKUP_CONTRIBUTOR("StorageAccountBackupContributor"),
    STORAGE_ACCOUNT_CONTRIBUTOR("StorageAccountContributor"),
    STORAGE_ACCOUNT_KEY_OPERATOR_SERVICE_ROLE("StorageAccountKeyOperatorServiceRole"),
    STORAGE_BLOB_DATA_CONTRIBUTOR("StorageBlobDataContributor"),
    STORAGE_BLOB_DATA_OWNER("StorageBlobDataOwner"),
    STORAGE_BLOB_DATA_READER("StorageBlobDataReader"),
    STORAGE_BLOB_DELEGATOR("StorageBlobDelegator"),
    STORAGE_FILE_DATA_PRIVILEGED_CONTRIBUTOR("StorageFileDataPrivilegedContributor"),
    STORAGE_FILE_DATA_PRIVILEGED_READER("StorageFileDataPrivilegedReader"),
    ...
    STORAGE_QUEUE_DATA_CONTRIBUTOR("StorageQueueDataContributor"),
    STORAGE_QUEUE_DATA_READER("StorageQueueDataReader"),
    STORAGE_QUEUE_DATA_MESSAGE_SENDER("StorageQueueDataMessageSender"),
    STORAGE_QUEUE_DATA_MESSAGE_PROCESSOR("StorageQueueDataMessageProcessor"),
    STORAGE_TABLE_DATA_CONTRIBUTOR("StorageTableDataContributor"),
    STORAGE_TABLE_DATA_READER("StorageTableDataReader");

    private final String value;

    AzureStorageRole(String value) {
        this.value = value;
    }

    public String getValue() { return value; }

    public static AzureStorageRole fromValue(String value) {
        for (AzureStorageRole e : values()) {
            if (e.value.equals(value)) return e;
        }
        throw new IllegalArgumentException("Unknown value: " + value);
    }
...
/** Options for WithDataBindMount. */
final class WithDataBindMountOptions {
    private String path;
    private Boolean isReadOnly;

    public String getPath() { return path; }
    public WithDataBindMountOptions path(String value) {
        this.path = value;
        return this;
    }

    public Boolean isReadOnly() { return isReadOnly; }
    public WithDataBindMountOptions isReadOnly(Boolean value) {
...
class AzureBicepResource extends ResourceBuilderBase {
    ...
    public IResource withStorageRoleAssignments(AzureStorageResource target, AzureStorageRole[] roles) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("target", AspireClient.serializeValue(target));
        reqArgs.put("roles", AspireClient.serializeValue(roles));
        return (IResource) getClient().invokeCapability("Aspire.Hosting.Azure.Storage/withStorageRoleAssignments", reqArgs);
    }
...
/** Wrapper for Aspire.Hosting.Azure.Storage/Aspire.Hosting.Azure.AzureBlobStorageContainerResource. */
class AzureBlobStorageContainerResource extends ResourceBuilderBase {
    AzureBlobStorageContainerResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
...
/** Wrapper for Aspire.Hosting.Azure.Storage/Aspire.Hosting.Azure.AzureBlobStorageResource. */
class AzureBlobStorageResource extends ResourceBuilderBase {
    AzureBlobStorageResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
...
/** Wrapper for Aspire.Hosting.Azure.Storage/Aspire.Hosting.Azure.AzureDataLakeStorageFileSystemResource. */
class AzureDataLakeStorageFileSystemResource extends ResourceBuilderBase {
    AzureDataLakeStorageFileSystemResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
...
/** Wrapper for Aspire.Hosting.Azure.Storage/Aspire.Hosting.Azure.AzureDataLakeStorageResource. */
class AzureDataLakeStorageResource extends ResourceBuilderBase {
    AzureDataLakeStorageResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
...
/** Wrapper for Aspire.Hosting.Azure.Functions/Aspire.Hosting.Azure.AzureFunctionsProjectResource. */
class AzureFunctionsProjectResource extends ResourceBuilderBase {
    AzureFunctionsProjectResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public AzureFunctionsProjectResource withHostStorage(AzureStorageResource storage) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("storage", AspireClient.serializeValue(storage));
        return (AzureFunctionsProjectResource) getClient().invokeCapability("Aspire.Hosting.Azure.Functions/withHostStorage", reqArgs);
    }
...
/** Wrapper for Aspire.Hosting.Azure.Storage/Aspire.Hosting.Azure.AzureQueueStorageQueueResource. */
class AzureQueueStorageQueueResource extends ResourceBuilderBase {
    AzureQueueStorageQueueResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
...
/** Wrapper for Aspire.Hosting.Azure.Storage/Aspire.Hosting.Azure.AzureQueueStorageResource. */
class AzureQueueStorageResource extends ResourceBuilderBase {
    AzureQueueStorageResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
...
/** Wrapper for Aspire.Hosting.Azure.Storage/Aspire.Hosting.Azure.AzureStorageEmulatorResource. */
class AzureStorageEmulatorResource extends ResourceBuilderBase {
    AzureStorageEmulatorResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public AzureStorageEmulatorResource withDataBindMount(WithDataBindMountOptions options) {
        var path = options == null ? null : options.getPath();
        var isReadOnly = options == null ? null : options.isReadOnly();
        return withDataBindMountImpl(path, isReadOnly);
    }

    public AzureStorageEmulatorResource withDataBindMount() {
        return withDataBindMount(null);
    }

    /** Adds a bind mount for the data folder to an Azure Storage emulator resource */
    private AzureStorageEmulatorResource withDataBindMountImpl(String path, Boolean isReadOnly) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        if (path != null) {
            reqArgs.put("path", AspireClient.serializeValue(path));
        ...
        return (AzureStorageEmulatorResource) getClient().invokeCapability("Aspire.Hosting.Azure.Storage/withDataBindMount", reqArgs);
    }

    /** Adds a named volume for the data folder to an Azure Storage emulator resource */
    public AzureStorageEmulatorResource withDataVolume(WithDataVolumeOptions options) {
        var name = options == null ? null : options.getName();
        var isReadOnly = options == null ? null : options.isReadOnly();
        return withDataVolumeImpl(name, isReadOnly);
    }

    public AzureStorageEmulatorResource withDataVolume() {
        return withDataVolume(null);
    }

    /** Adds a named volume for the data folder to an Azure Storage emulator resource */
    private AzureStorageEmulatorResource withDataVolumeImpl(String name, Boolean isReadOnly) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        if (name != null) {
            reqArgs.put("name", AspireClient.serializeValue(name));
        ...
        return (AzureStorageEmulatorResource) getClient().invokeCapability("Aspire.Hosting.Azure.Storage/withDataVolume", reqArgs);
    }

    /** Sets the host port for blob requests on the storage emulator */
    public AzureStorageEmulatorResource withBlobPort(double port) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("port", AspireClient.serializeValue(port));
        return (AzureStorageEmulatorResource) getClient().invokeCapability("Aspire.Hosting.Azure.Storage/withBlobPort", reqArgs);
    }

    /** Sets the host port for queue requests on the storage emulator */
    public AzureStorageEmulatorResource withQueuePort(double port) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("port", AspireClient.serializeValue(port));
        return (AzureStorageEmulatorResource) getClient().invokeCapability("Aspire.Hosting.Azure.Storage/withQueuePort", reqArgs);
    }

    /** Sets the host port for table requests on the storage emulator */
    public AzureStorageEmulatorResource withTablePort(double port) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("port", AspireClient.serializeValue(port));
        return (AzureStorageEmulatorResource) getClient().invokeCapability("Aspire.Hosting.Azure.Storage/withTablePort", reqArgs);
    }

    public AzureStorageEmulatorResource withApiVersionCheck() {
        return withApiVersionCheck(null);
    }

    /** Configures whether the emulator checks API version validity */
    public AzureStorageEmulatorResource withApiVersionCheck(Boolean enable) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        if (enable != null) {
            reqArgs.put("enable", AspireClient.serializeValue(enable));
        }
        return (AzureStorageEmulatorResource) getClient().invokeCapability("Aspire.Hosting.Azure.Storage/withApiVersionCheck", reqArgs);
    }
...
/** Wrapper for Aspire.Hosting.Azure.Storage/Aspire.Hosting.Azure.AzureStorageResource. */
class AzureStorageResource extends ResourceBuilderBase {
    AzureStorageResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public AzureStorageResource runAsEmulator() {
        return runAsEmulator(null);
    }

    /** Configures the Azure Storage resource to be emulated using Azurite */
    public AzureStorageResource runAsEmulator(AspireAction1<AzureStorageEmulatorResource> configureContainer) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        var configureContainerId = configureContainer == null ? null : getClient().registerCallback(args -> {
            var obj = (AzureStorageEmulatorResource) args[0];
        ...
        return (AzureStorageResource) getClient().invokeCapability("Aspire.Hosting.Azure.Storage/runAsEmulator", reqArgs);
    }

    /** Adds an Azure Blob Storage resource */
    public AzureBlobStorageResource addBlobs(String name) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        return (AzureBlobStorageResource) getClient().invokeCapability("Aspire.Hosting.Azure.Storage/addBlobs", reqArgs);
    }

    /** Adds an Azure Data Lake Storage resource */
    public AzureDataLakeStorageResource addDataLake(String name) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        return (AzureDataLakeStorageResource) getClient().invokeCapability("Aspire.Hosting.Azure.Storage/addDataLake", reqArgs);
    }

    public AzureBlobStorageContainerResource addBlobContainer(String name) {
        return addBlobContainer(name, null);
    }

    /** Adds an Azure Blob Storage container resource */
    public AzureBlobStorageContainerResource addBlobContainer(String name, String blobContainerName) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        if (blobContainerName != null) {
            reqArgs.put("blobContainerName", AspireClient.serializeValue(blobContainerName));
        }
        return (AzureBlobStorageContainerResource) getClient().invokeCapability("Aspire.Hosting.Azure.Storage/addBlobContainer", reqArgs);
    }

    public AzureDataLakeStorageFileSystemResource addDataLakeFileSystem(String name) {
        return addDataLakeFileSystem(name, null);
    }

    /** Adds an Azure Data Lake Storage file system resource */
    public AzureDataLakeStorageFileSystemResource addDataLakeFileSystem(String name, String dataLakeFileSystemName) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        if (dataLakeFileSystemName != null) {
            reqArgs.put("dataLakeFileSystemName", AspireClient.serializeValue(dataLakeFileSystemName));
        }
        return (AzureDataLakeStorageFileSystemResource) getClient().invokeCapability("Aspire.Hosting.Azure.Storage/addDataLakeFileSystem", reqArgs);
    }

    /** Adds an Azure Table Storage resource */
    public AzureTableStorageResource addTables(String name) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        return (AzureTableStorageResource) getClient().invokeCapability("Aspire.Hosting.Azure.Storage/addTables", reqArgs);
    }

    /** Adds an Azure Queue Storage resource */
    public AzureQueueStorageResource addQueues(String name) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        return (AzureQueueStorageResource) getClient().invokeCapability("Aspire.Hosting.Azure.Storage/addQueues", reqArgs);
    }

    public AzureQueueStorageQueueResource addQueue(String name) {
        return addQueue(name, null);
    }

    /** Adds an Azure Storage queue resource */
    public AzureQueueStorageQueueResource addQueue(String name, String queueName) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        if (queueName != null) {
        ...
        return (AzureQueueStorageQueueResource) getClient().invokeCapability("Aspire.Hosting.Azure.Storage/addQueue", reqArgs);
    }
...
/** Wrapper for Aspire.Hosting.Azure.Storage/Aspire.Hosting.Azure.AzureTableStorageResource. */
class AzureTableStorageResource extends ResourceBuilderBase {
    AzureTableStorageResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
...
class IDistributedApplicationBuilder extends HandleWrapperBase {
    ...
    public AzureFunctionsProjectResource addAzureFunctionsProject(String name, String projectPath) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        reqArgs.put("projectPath", AspireClient.serializeValue(projectPath));
        return (AzureFunctionsProjectResource) getClient().invokeCapability("Aspire.Hosting.Azure.Functions/addAzureFunctionsProject", reqArgs);
    }
    ...
    public AzureStorageResource addAzureStorage(String name) {
        ...
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        return (AzureStorageResource) getClient().invokeCapability("Aspire.Hosting.Azure.Storage/addAzureStorage", reqArgs);
    }
...
class AspireRegistrations {
    static {
        ...
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure.Functions/Aspire.Hosting.Azure.AzureFunctionsProjectResource", (h, c) -> new AzureFunctionsProjectResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure.Storage/Aspire.Hosting.Azure.AzureStorageResource", (h, c) -> new AzureStorageResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure.Storage/Aspire.Hosting.Azure.AzureStorageEmulatorResource", (h, c) -> new AzureStorageEmulatorResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure.Storage/Aspire.Hosting.Azure.AzureBlobStorageResource", (h, c) -> new AzureBlobStorageResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure.Storage/Aspire.Hosting.Azure.AzureDataLakeStorageResource", (h, c) -> new AzureDataLakeStorageResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure.Storage/Aspire.Hosting.Azure.AzureBlobStorageContainerResource", (h, c) -> new AzureBlobStorageContainerResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure.Storage/Aspire.Hosting.Azure.AzureDataLakeStorageFileSystemResource", (h, c) -> new AzureDataLakeStorageFileSystemResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure.Storage/Aspire.Hosting.Azure.AzureTableStorageResource", (h, c) -> new AzureTableStorageResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure.Storage/Aspire.Hosting.Azure.AzureQueueStorageResource", (h, c) -> new AzureQueueStorageResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure.Storage/Aspire.Hosting.Azure.AzureQueueStorageQueueResource", (h, c) -> new AzureQueueStorageQueueResource(h, c));
