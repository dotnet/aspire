...
/** Options for AddKeycloak. */
final class AddKeycloakOptions {
    private Double port;
    private ParameterResource adminUsername;
    private ParameterResource adminPassword;

    public Double getPort() { return port; }
    public AddKeycloakOptions port(Double value) {
        this.port = value;
        return this;
    }

    public ParameterResource getAdminUsername() { return adminUsername; }
    public AddKeycloakOptions adminUsername(ParameterResource value) {
        this.adminUsername = value;
        return this;
    }

    public ParameterResource getAdminPassword() { return adminPassword; }
    public AddKeycloakOptions adminPassword(ParameterResource value) {
...
class IDistributedApplicationBuilder extends HandleWrapperBase {
    ...
    public KeycloakResource addKeycloak(String name, AddKeycloakOptions options) {
        var port = options == null ? null : options.getPort();
        var adminUsername = options == null ? null : options.getAdminUsername();
        var adminPassword = options == null ? null : options.getAdminPassword();
        return addKeycloakImpl(name, port, adminUsername, adminPassword);
    }

    public KeycloakResource addKeycloak(String name) {
        return addKeycloak(name, null);
    }

    /** Adds a Keycloak container resource */
    private KeycloakResource addKeycloakImpl(String name, Double port, ParameterResource adminUsername, ParameterResource adminPassword) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        if (port != null) {
        ...
        if (adminUsername != null) {
            reqArgs.put("adminUsername", AspireClient.serializeValue(adminUsername));
        }
        if (adminPassword != null) {
            reqArgs.put("adminPassword", AspireClient.serializeValue(adminPassword));
        }
        return (KeycloakResource) getClient().invokeCapability("Aspire.Hosting.Keycloak/addKeycloak", reqArgs);
    }
...
/** Wrapper for Aspire.Hosting.Keycloak/Aspire.Hosting.ApplicationModel.KeycloakResource. */
class KeycloakResource extends ResourceBuilderBase {
    KeycloakResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public KeycloakResource withDataVolume() {
        return withDataVolume(null);
    }

    /** Adds a data volume for Keycloak */
    public KeycloakResource withDataVolume(String name) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        if (name != null) {
            reqArgs.put("name", AspireClient.serializeValue(name));
        }
        return (KeycloakResource) getClient().invokeCapability("Aspire.Hosting.Keycloak/withDataVolume", reqArgs);
    }

    /** Adds a data bind mount for Keycloak */
    public KeycloakResource withDataBindMount(String source) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("source", AspireClient.serializeValue(source));
        return (KeycloakResource) getClient().invokeCapability("Aspire.Hosting.Keycloak/withDataBindMount", reqArgs);
    }

    /** Enables Keycloak features */
    public KeycloakResource withEnabledFeatures(String[] features) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("features", AspireClient.serializeValue(features));
        return (KeycloakResource) getClient().invokeCapability("Aspire.Hosting.Keycloak/withEnabledFeatures", reqArgs);
    }

    /** Disables Keycloak features */
    public KeycloakResource withDisabledFeatures(String[] features) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("features", AspireClient.serializeValue(features));
        return (KeycloakResource) getClient().invokeCapability("Aspire.Hosting.Keycloak/withDisabledFeatures", reqArgs);
    }

    /** Configures the OTLP exporter for Keycloak */
    public KeycloakResource withOtlpExporter() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        return (KeycloakResource) getClient().invokeCapability("Aspire.Hosting.Keycloak/withOtlpExporter", reqArgs);
    }

    /** Configures the OTLP exporter for Keycloak with a specific protocol */
    public KeycloakResource withOtlpExporterWithProtocol(OtlpProtocol protocol) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("protocol", AspireClient.serializeValue(protocol));
        return (KeycloakResource) getClient().invokeCapability("Aspire.Hosting.Keycloak/withOtlpExporterWithProtocol", reqArgs);
    }

    /** Imports a Keycloak realm configuration */
    public KeycloakResource withRealmImport(String importPath) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("importPath", AspireClient.serializeValue(importPath));
        return (KeycloakResource) getClient().invokeCapability("Aspire.Hosting.Keycloak/withRealmImport", reqArgs);
    }

    /** Gets the AdminUserNameParameter property */
    public ParameterResource adminUserNameParameter() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ParameterResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/KeycloakResource.adminUserNameParameter", reqArgs);
    }

    /** Gets the AdminPasswordParameter property */
    public ParameterResource adminPasswordParameter() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ParameterResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/KeycloakResource.adminPasswordParameter", reqArgs);
    }
    ...
    public String entrypoint() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/KeycloakResource.entrypoint", reqArgs);
    }

    /** Sets the Entrypoint property */
    public KeycloakResource setEntrypoint(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (KeycloakResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/KeycloakResource.setEntrypoint", reqArgs);
    }
    ...
    public boolean shellExecution() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (boolean) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/KeycloakResource.shellExecution", reqArgs);
    }

    /** Sets the ShellExecution property */
    public KeycloakResource setShellExecution(boolean value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (KeycloakResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/KeycloakResource.setShellExecution", reqArgs);
    }
    ...
    public String name() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/KeycloakResource.name", reqArgs);
    }
...
class AspireRegistrations {
    static {
        ...
        AspireClient.registerHandleWrapper("Aspire.Hosting.Keycloak/Aspire.Hosting.ApplicationModel.KeycloakResource", (h, c) -> new KeycloakResource(h, c));
