...
/** Options for AddDevTunnel. */
final class AddDevTunnelOptions {
    ...
    public AddDevTunnelOptions tunnelId(String value) {
        this.tunnelId = value;
        return this;
    }

    public Boolean getAllowAnonymous() { return allowAnonymous; }
    public AddDevTunnelOptions allowAnonymous(Boolean value) {
        this.allowAnonymous = value;
        return this;
    }

    public String getDescription() { return description; }
    public AddDevTunnelOptions description(String value) {
        this.description = value;
        return this;
    }

    public String[] getLabels() { return labels; }
    public AddDevTunnelOptions labels(String[] value) {
        this.labels = value;
        return this;
    }
...
/** Wrapper for Aspire.Hosting.DevTunnels/Aspire.Hosting.DevTunnels.DevTunnelResource. */
class DevTunnelResource extends ResourceBuilderBase {
    DevTunnelResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public DevTunnelResource withTunnelReferenceAll(IResourceWithEndpoints resourceBuilder, boolean allowAnonymous) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("tunnelBuilder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("resourceBuilder", AspireClient.serializeValue(resourceBuilder));
        reqArgs.put("allowAnonymous", AspireClient.serializeValue(allowAnonymous));
        return (DevTunnelResource) getClient().invokeCapability("Aspire.Hosting.DevTunnels/withReferenceResourceAnonymous", reqArgs);
    }

    public DevTunnelResource withTunnelReferenceAll(ResourceBuilderBase resourceBuilder, boolean allowAnonymous) {
        return withTunnelReferenceAll(new IResourceWithEndpoints(resourceBuilder.getHandle(), resourceBuilder.getClient()), allowAnonymous);
    }

    /** Configures the dev tunnel to expose a target endpoint. */
    public DevTunnelResource withTunnelReference(EndpointReference targetEndpoint) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("tunnelBuilder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("targetEndpoint", AspireClient.serializeValue(targetEndpoint));
        return (DevTunnelResource) getClient().invokeCapability("Aspire.Hosting.DevTunnels/withReferenceEndpoint", reqArgs);
    }

    /** Configures the dev tunnel to expose a target endpoint with access control. */
    public DevTunnelResource withTunnelReferenceAnonymous(EndpointReference targetEndpoint, boolean allowAnonymous) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("tunnelBuilder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("targetEndpoint", AspireClient.serializeValue(targetEndpoint));
        reqArgs.put("allowAnonymous", AspireClient.serializeValue(allowAnonymous));
        return (DevTunnelResource) getClient().invokeCapability("Aspire.Hosting.DevTunnels/withReferenceEndpointAnonymous", reqArgs);
    }

    /** Configures the dev tunnel to allow anonymous access. */
    public DevTunnelResource withAnonymousAccess() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("tunnelBuilder", AspireClient.serializeValue(getHandle()));
        return (DevTunnelResource) getClient().invokeCapability("Aspire.Hosting.DevTunnels/withAnonymousAccess", reqArgs);
    }

    /** Gets the public endpoint exposed by the dev tunnel. */
    public EndpointReference getTunnelEndpoint(EndpointReference targetEndpointReference) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("tunnelBuilder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("targetEndpointReference", AspireClient.serializeValue(targetEndpointReference));
        return (EndpointReference) getClient().invokeCapability("Aspire.Hosting.DevTunnels/getEndpointByEndpointReference", reqArgs);
    }
...
class IDistributedApplicationBuilder extends HandleWrapperBase {
    ...
    public MauiProjectResource addMauiProject(String name, String projectPath) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        reqArgs.put("projectPath", AspireClient.serializeValue(projectPath));
        return (MauiProjectResource) getClient().invokeCapability("Aspire.Hosting.Maui/addMauiProject", reqArgs);
    }

    /** Adds a Dev Tunnel resource to the distributed application model. */
    public DevTunnelResource addDevTunnel(String name, AddDevTunnelOptions options) {
        var tunnelId = options == null ? null : options.getTunnelId();
        var allowAnonymous = options == null ? null : options.getAllowAnonymous();
        var description = options == null ? null : options.getDescription();
        var labels = options == null ? null : options.getLabels();
        return addDevTunnelImpl(name, tunnelId, allowAnonymous, description, labels);
    }

    public DevTunnelResource addDevTunnel(String name) {
        return addDevTunnel(name, null);
    }

    /** Adds a Dev Tunnel resource to the distributed application model. */
    private DevTunnelResource addDevTunnelImpl(String name, String tunnelId, Boolean allowAnonymous, String description, String[] labels) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        if (tunnelId != null) {
            reqArgs.put("tunnelId", AspireClient.serializeValue(tunnelId));
        }
        ...
        if (labels != null) {
            reqArgs.put("labels", AspireClient.serializeValue(labels));
        }
        return (DevTunnelResource) getClient().invokeCapability("Aspire.Hosting.DevTunnels/addDevTunnel", reqArgs);
    }
...
/** Wrapper for Aspire.Hosting.Maui/Aspire.Hosting.Maui.IMauiPlatformResource. */
class IMauiPlatformResource extends HandleWrapperBase {
    IMauiPlatformResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
...
/** Wrapper for Aspire.Hosting.Maui/Aspire.Hosting.Maui.MauiAndroidDeviceResource. */
class MauiAndroidDeviceResource extends ResourceBuilderBase {
    MauiAndroidDeviceResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public IMauiPlatformResource withOtlpDevTunnel() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        return (IMauiPlatformResource) getClient().invokeCapability("Aspire.Hosting.Maui/withOtlpDevTunnel", reqArgs);
    }

}

/** Wrapper for Aspire.Hosting.Maui/Aspire.Hosting.Maui.MauiAndroidEmulatorResource. */
class MauiAndroidEmulatorResource extends ResourceBuilderBase {
    MauiAndroidEmulatorResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
...
/** Wrapper for Aspire.Hosting.Maui/Aspire.Hosting.Maui.MauiMacCatalystPlatformResource. */
class MauiMacCatalystPlatformResource extends ResourceBuilderBase {
    MauiMacCatalystPlatformResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
...
/** Wrapper for Aspire.Hosting.Maui/Aspire.Hosting.Maui.MauiProjectResource. */
class MauiProjectResource extends ResourceBuilderBase {
    MauiProjectResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public MauiAndroidDeviceResource addAndroidDevice(String name) {
        return addAndroidDevice(name, null);
    }

    /** Adds an Android device resource for a .NET MAUI project. */
    public MauiAndroidDeviceResource addAndroidDevice(String name, String deviceId) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        if (deviceId != null) {
            reqArgs.put("deviceId", AspireClient.serializeValue(deviceId));
        }
        return (MauiAndroidDeviceResource) getClient().invokeCapability("Aspire.Hosting.Maui/addAndroidDevice", reqArgs);
    }

    public MauiAndroidEmulatorResource addAndroidEmulator(String name) {
        return addAndroidEmulator(name, null);
    }

    /** Adds an Android emulator resource for a .NET MAUI project. */
    public MauiAndroidEmulatorResource addAndroidEmulator(String name, String emulatorId) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        if (emulatorId != null) {
            reqArgs.put("emulatorId", AspireClient.serializeValue(emulatorId));
        }
        return (MauiAndroidEmulatorResource) getClient().invokeCapability("Aspire.Hosting.Maui/addAndroidEmulator", reqArgs);
    }

    public MauiiOSDeviceResource addiOSDevice(String name) {
        return addiOSDevice(name, null);
    }

    /** Adds an iOS device resource for a .NET MAUI project. */
    public MauiiOSDeviceResource addiOSDevice(String name, String deviceId) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        if (deviceId != null) {
        ...
        return (MauiiOSDeviceResource) getClient().invokeCapability("Aspire.Hosting.Maui/addiOSDevice", reqArgs);
    }

    public MauiiOSSimulatorResource addiOSSimulator(String name) {
        return addiOSSimulator(name, null);
    }

    /** Adds an iOS simulator resource for a .NET MAUI project. */
    public MauiiOSSimulatorResource addiOSSimulator(String name, String simulatorId) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        if (simulatorId != null) {
            reqArgs.put("simulatorId", AspireClient.serializeValue(simulatorId));
        }
        return (MauiiOSSimulatorResource) getClient().invokeCapability("Aspire.Hosting.Maui/addiOSSimulator", reqArgs);
    }

    /** Adds a Mac Catalyst platform resource for a .NET MAUI project. */
    public MauiMacCatalystPlatformResource addMacCatalystDevice(String name) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        return (MauiMacCatalystPlatformResource) getClient().invokeCapability("Aspire.Hosting.Maui/addMacCatalystDevice", reqArgs);
    }

    /** Adds a Windows platform resource for a .NET MAUI project. */
    public MauiWindowsPlatformResource addWindowsDevice(String name) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        return (MauiWindowsPlatformResource) getClient().invokeCapability("Aspire.Hosting.Maui/addWindowsDevice", reqArgs);
    }

}

/** Wrapper for Aspire.Hosting.Maui/Aspire.Hosting.Maui.MauiWindowsPlatformResource. */
class MauiWindowsPlatformResource extends ResourceBuilderBase {
    MauiWindowsPlatformResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
...
/** Wrapper for Aspire.Hosting.Maui/Aspire.Hosting.Maui.MauiiOSDeviceResource. */
class MauiiOSDeviceResource extends ResourceBuilderBase {
    MauiiOSDeviceResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
...
/** Wrapper for Aspire.Hosting.Maui/Aspire.Hosting.Maui.MauiiOSSimulatorResource. */
class MauiiOSSimulatorResource extends ResourceBuilderBase {
    MauiiOSSimulatorResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
...
class AspireRegistrations {
    static {
        ...
        AspireClient.registerHandleWrapper("Aspire.Hosting.Maui/Aspire.Hosting.Maui.MauiProjectResource", (h, c) -> new MauiProjectResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Maui/Aspire.Hosting.Maui.MauiAndroidDeviceResource", (h, c) -> new MauiAndroidDeviceResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Maui/Aspire.Hosting.Maui.MauiAndroidEmulatorResource", (h, c) -> new MauiAndroidEmulatorResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Maui/Aspire.Hosting.Maui.MauiiOSDeviceResource", (h, c) -> new MauiiOSDeviceResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Maui/Aspire.Hosting.Maui.MauiiOSSimulatorResource", (h, c) -> new MauiiOSSimulatorResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Maui/Aspire.Hosting.Maui.MauiMacCatalystPlatformResource", (h, c) -> new MauiMacCatalystPlatformResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Maui/Aspire.Hosting.Maui.MauiWindowsPlatformResource", (h, c) -> new MauiWindowsPlatformResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.DevTunnels/Aspire.Hosting.DevTunnels.DevTunnelResource", (h, c) -> new DevTunnelResource(h, c));
        ...
        AspireClient.registerHandleWrapper("Aspire.Hosting.Maui/Aspire.Hosting.Maui.IMauiPlatformResource", (h, c) -> new IMauiPlatformResource(h, c));
