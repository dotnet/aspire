...
/** AzureContainerRegistryRole enum. */
enum AzureContainerRegistryRole implements WireValueEnum {
    ACR_DELETE("AcrDelete"),
    ACR_IMAGE_SIGNER("AcrImageSigner"),
    ACR_PULL("AcrPull"),
    ACR_PUSH("AcrPush"),
    ACR_QUARANTINE_READER("AcrQuarantineReader"),
    ACR_QUARANTINE_WRITER("AcrQuarantineWriter");

    private final String value;

    AzureContainerRegistryRole(String value) {
        this.value = value;
    }

    public String getValue() { return value; }

    public static AzureContainerRegistryRole fromValue(String value) {
        for (AzureContainerRegistryRole e : values()) {
            if (e.value.equals(value)) return e;
        }
        throw new IllegalArgumentException("Unknown value: " + value);
    }
...
/** Options for PublishAsAzureAppServiceWebsite. */
final class PublishAsAzureAppServiceWebsiteOptions {
    private AspireAction2<AzureResourceInfrastructure, WebSite> configure;
    private AspireAction2<AzureResourceInfrastructure, WebSiteSlot> configureSlot;

    public AspireAction2<AzureResourceInfrastructure, WebSite> getConfigure() { return configure; }
    public PublishAsAzureAppServiceWebsiteOptions configure(AspireAction2<AzureResourceInfrastructure, WebSite> value) {
        this.configure = value;
        return this;
    }

    public AspireAction2<AzureResourceInfrastructure, WebSiteSlot> getConfigureSlot() { return configureSlot; }
    public PublishAsAzureAppServiceWebsiteOptions configureSlot(AspireAction2<AzureResourceInfrastructure, WebSiteSlot> value) {
        this.configureSlot = value;
        return this;
    }
...
/** Options for WithPurgeTask. */
final class WithPurgeTaskOptions {
    ...
    public WithPurgeTaskOptions filter(String value) {
        this.filter = value;
        return this;
    }

    public Double getAgo() { return ago; }
    public WithPurgeTaskOptions ago(Double value) {
        this.ago = value;
        return this;
    }

    public Double getKeep() { return keep; }
    public WithPurgeTaskOptions keep(Double value) {
        this.keep = value;
        return this;
    }

    public String getTaskName() { return taskName; }
    public WithPurgeTaskOptions taskName(String value) {
        this.taskName = value;
        return this;
    }
...
/** Wrapper for Aspire.Hosting.Azure.AppService/Aspire.Hosting.Azure.AzureAppServiceEnvironmentResource. */
class AzureAppServiceEnvironmentResource extends ResourceBuilderBase {
    AzureAppServiceEnvironmentResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public AzureAppServiceEnvironmentResource withDashboard() {
        return withDashboard(null);
    }

    /** Configures whether the Aspire dashboard is included in the Azure App Service environment */
    public AzureAppServiceEnvironmentResource withDashboard(Boolean enable) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        if (enable != null) {
            reqArgs.put("enable", AspireClient.serializeValue(enable));
        }
        return (AzureAppServiceEnvironmentResource) getClient().invokeCapability("Aspire.Hosting.Azure.AppService/withDashboard", reqArgs);
    }

    /** Enables Azure Application Insights for the Azure App Service environment */
    public AzureAppServiceEnvironmentResource withAzureApplicationInsights() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        return (AzureAppServiceEnvironmentResource) getClient().invokeCapability("Aspire.Hosting.Azure.AppService/withAzureApplicationInsights", reqArgs);
    }

    /** Enables Azure Application Insights for the Azure App Service environment with a specific location */
    public AzureAppServiceEnvironmentResource withAzureApplicationInsightsLocation(String applicationInsightsLocation) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("applicationInsightsLocation", AspireClient.serializeValue(applicationInsightsLocation));
        return (AzureAppServiceEnvironmentResource) getClient().invokeCapability("Aspire.Hosting.Azure.AppService/withAzureApplicationInsightsLocation", reqArgs);
    }

    /** Enables Azure Application Insights for the Azure App Service environment using a location parameter */
    public AzureAppServiceEnvironmentResource withAzureApplicationInsightsLocationParameter(ParameterResource applicationInsightsLocation) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("applicationInsightsLocation", AspireClient.serializeValue(applicationInsightsLocation));
        return (AzureAppServiceEnvironmentResource) getClient().invokeCapability("Aspire.Hosting.Azure.AppService/withAzureApplicationInsightsLocationParameter", reqArgs);
    }

    /** Enables Azure Application Insights for the Azure App Service environment using an existing Application Insights resource */
    public AzureAppServiceEnvironmentResource withAzureApplicationInsightsResource(AzureApplicationInsightsResource applicationInsightsBuilder) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("applicationInsightsBuilder", AspireClient.serializeValue(applicationInsightsBuilder));
        return (AzureAppServiceEnvironmentResource) getClient().invokeCapability("Aspire.Hosting.Azure.AppService/withAzureApplicationInsightsResource", reqArgs);
    }

    /** Configures the deployment slot for all Azure App Services in the environment using a parameter */
    public AzureAppServiceEnvironmentResource withDeploymentSlotParameter(ParameterResource deploymentSlot) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("deploymentSlot", AspireClient.serializeValue(deploymentSlot));
        return (AzureAppServiceEnvironmentResource) getClient().invokeCapability("Aspire.Hosting.Azure.AppService/withDeploymentSlotParameter", reqArgs);
    }

    /** Configures the deployment slot for all Azure App Services in the environment */
    public AzureAppServiceEnvironmentResource withDeploymentSlot(String deploymentSlot) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("deploymentSlot", AspireClient.serializeValue(deploymentSlot));
        return (AzureAppServiceEnvironmentResource) getClient().invokeCapability("Aspire.Hosting.Azure.AppService/withDeploymentSlot", reqArgs);
    }
    ...
    public IResource withAzureContainerRegistry(AzureContainerRegistryResource registryBuilder) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("registryBuilder", AspireClient.serializeValue(registryBuilder));
        return (IResource) getClient().invokeCapability("Aspire.Hosting.Azure.ContainerRegistry/withContainerRegistryAzureContainerRegistry", reqArgs);
    }

    /** Gets the Azure Container Registry associated with a compute environment resource. */
    public AzureContainerRegistryResource getAzureContainerRegistry() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        return (AzureContainerRegistryResource) getClient().invokeCapability("Aspire.Hosting.Azure.ContainerRegistry/getAzureContainerRegistry", reqArgs);
    }

    /** Assigns Azure Container Registry roles to a resource. */
    public IResource withContainerRegistryRoleAssignments(AzureContainerRegistryResource target, AzureContainerRegistryRole[] roles) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("target", AspireClient.serializeValue(target));
        reqArgs.put("roles", AspireClient.serializeValue(roles));
        return (IResource) getClient().invokeCapability("Aspire.Hosting.Azure.ContainerRegistry/withContainerRegistryRoleAssignments", reqArgs);
    }

}

/** Wrapper for Aspire.Hosting.Azure.ApplicationInsights/Aspire.Hosting.Azure.AzureApplicationInsightsResource. */
class AzureApplicationInsightsResource extends ResourceBuilderBase {
    AzureApplicationInsightsResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public AzureApplicationInsightsResource withLogAnalyticsWorkspace(AzureLogAnalyticsWorkspaceResource logAnalyticsWorkspace) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("logAnalyticsWorkspace", AspireClient.serializeValue(logAnalyticsWorkspace));
        return (AzureApplicationInsightsResource) getClient().invokeCapability("Aspire.Hosting.Azure.ApplicationInsights/withLogAnalyticsWorkspace", reqArgs);
    }
...
/** Wrapper for Aspire.Hosting.Azure.ContainerRegistry/Aspire.Hosting.Azure.AzureContainerRegistryResource. */
class AzureContainerRegistryResource extends ResourceBuilderBase {
    AzureContainerRegistryResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public AzureContainerRegistryResource withPurgeTask(String schedule, WithPurgeTaskOptions options) {
        var filter = options == null ? null : options.getFilter();
        var ago = options == null ? null : options.getAgo();
        var keep = options == null ? null : options.getKeep();
        var taskName = options == null ? null : options.getTaskName();
        return withPurgeTaskImpl(schedule, filter, ago, keep, taskName);
    }

    public AzureContainerRegistryResource withPurgeTask(String schedule) {
        return withPurgeTask(schedule, null);
    }

    /** Configures a purge task for the Azure Container Registry resource. */
    private AzureContainerRegistryResource withPurgeTaskImpl(String schedule, String filter, Double ago, Double keep, String taskName) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("schedule", AspireClient.serializeValue(schedule));
        if (filter != null) {
            reqArgs.put("filter", AspireClient.serializeValue(filter));
        }
        if (ago != null) {
            reqArgs.put("ago", AspireClient.serializeValue(ago));
        }
        if (keep != null) {
            reqArgs.put("keep", AspireClient.serializeValue(keep));
        }
        if (taskName != null) {
            reqArgs.put("taskName", AspireClient.serializeValue(taskName));
        }
        return (AzureContainerRegistryResource) getClient().invokeCapability("Aspire.Hosting.Azure.ContainerRegistry/withPurgeTask", reqArgs);
    }
...
/** Wrapper for Aspire.Hosting.Azure.OperationalInsights/Aspire.Hosting.Azure.AzureLogAnalyticsWorkspaceResource. */
class AzureLogAnalyticsWorkspaceResource extends ResourceBuilderBase {
    AzureLogAnalyticsWorkspaceResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
...
class CSharpAppResource extends ResourceBuilderBase {
    ...
    public IComputeResource publishAsAzureAppServiceWebsite(PublishAsAzureAppServiceWebsiteOptions options) {
        var configure = options == null ? null : options.getConfigure();
        var configureSlot = options == null ? null : options.getConfigureSlot();
        return publishAsAzureAppServiceWebsiteImpl(configure, configureSlot);
    }

    public IComputeResource publishAsAzureAppServiceWebsite() {
        return publishAsAzureAppServiceWebsite(null);
    }

    /** Publishes the compute resource as an Azure App Service website or deployment slot */
    private IComputeResource publishAsAzureAppServiceWebsiteImpl(AspireAction2<AzureResourceInfrastructure, WebSite> configure, AspireAction2<AzureResourceInfrastructure, WebSiteSlot> configureSlot) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        var configureId = configure == null ? null : getClient().registerCallback(args -> {
            var arg1 = (AzureResourceInfrastructure) args[0];
            var arg2 = (WebSite) args[1];
            configure.invoke(arg1, arg2);
            return null;
        });
        if (configureId != null) {
            reqArgs.put("configure", configureId);
        }
        var configureSlotId = configureSlot == null ? null : getClient().registerCallback(args -> {
            var arg1 = (AzureResourceInfrastructure) args[0];
            var arg2 = (WebSiteSlot) args[1];
            configureSlot.invoke(arg1, arg2);
            return null;
        });
        if (configureSlotId != null) {
            reqArgs.put("configureSlot", configureSlotId);
        }
        return (IComputeResource) getClient().invokeCapability("Aspire.Hosting.Azure.AppService/publishAsAzureAppServiceWebsite", reqArgs);
    }

    /** Skips Azure App Service environment variable name validation for the compute resource */
    public IComputeResource skipEnvironmentVariableNameChecks() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        return (IComputeResource) getClient().invokeCapability("Aspire.Hosting.Azure.AppService/skipEnvironmentVariableNameChecks", reqArgs);
    }
...
class IDistributedApplicationBuilder extends HandleWrapperBase {
    ...
    public AzureAppServiceEnvironmentResource addAzureAppServiceEnvironment(String name) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        return (AzureAppServiceEnvironmentResource) getClient().invokeCapability("Aspire.Hosting.Azure.AppService/addAzureAppServiceEnvironment", reqArgs);
    }
    ...
    public AzureApplicationInsightsResource addAzureApplicationInsights(String name) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        return (AzureApplicationInsightsResource) getClient().invokeCapability("Aspire.Hosting.Azure.ApplicationInsights/addAzureApplicationInsights", reqArgs);
    }

    /** Adds an Azure Container Registry resource to the distributed application model. */
    public AzureContainerRegistryResource addAzureContainerRegistry(String name) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        return (AzureContainerRegistryResource) getClient().invokeCapability("Aspire.Hosting.Azure.ContainerRegistry/addAzureContainerRegistry", reqArgs);
    }

    /** Adds an Azure Log Analytics Workspace resource */
    public AzureLogAnalyticsWorkspaceResource addAzureLogAnalyticsWorkspace(String name) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        return (AzureLogAnalyticsWorkspaceResource) getClient().invokeCapability("Aspire.Hosting.Azure.OperationalInsights/addAzureLogAnalyticsWorkspace", reqArgs);
    }
...
/** Wrapper for Azure.Provisioning.AppService/Azure.Provisioning.AppService.WebSite. */
class WebSite extends HandleWrapperBase {
    WebSite(Handle handle, AspireClient client) {
        super(handle, client);
    }

}

/** Wrapper for Azure.Provisioning.AppService/Azure.Provisioning.AppService.WebSiteSlot. */
class WebSiteSlot extends HandleWrapperBase {
    WebSiteSlot(Handle handle, AspireClient client) {
        super(handle, client);
    }
...
class AspireRegistrations {
    static {
        ...
        AspireClient.registerHandleWrapper("Azure.Provisioning.AppService/Azure.Provisioning.AppService.WebSite", (h, c) -> new WebSite(h, c));
        AspireClient.registerHandleWrapper("Azure.Provisioning.AppService/Azure.Provisioning.AppService.WebSiteSlot", (h, c) -> new WebSiteSlot(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure.AppService/Aspire.Hosting.Azure.AzureAppServiceEnvironmentResource", (h, c) -> new AzureAppServiceEnvironmentResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure.ApplicationInsights/Aspire.Hosting.Azure.AzureApplicationInsightsResource", (h, c) -> new AzureApplicationInsightsResource(h, c));
        ...
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure.OperationalInsights/Aspire.Hosting.Azure.AzureLogAnalyticsWorkspaceResource", (h, c) -> new AzureLogAnalyticsWorkspaceResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure.ContainerRegistry/Aspire.Hosting.Azure.AzureContainerRegistryResource", (h, c) -> new AzureContainerRegistryResource(h, c));
