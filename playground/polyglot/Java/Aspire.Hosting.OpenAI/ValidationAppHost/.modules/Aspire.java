...
class IDistributedApplicationBuilder extends HandleWrapperBase {
    ...
    public OpenAIResource addOpenAI(String name) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        return (OpenAIResource) getClient().invokeCapability("Aspire.Hosting.OpenAI/addOpenAI", reqArgs);
    }
...
/** Wrapper for Aspire.Hosting.OpenAI/Aspire.Hosting.OpenAI.OpenAIModelResource. */
class OpenAIModelResource extends ResourceBuilderBase {
    OpenAIModelResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public OpenAIModelResource withHealthCheck() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        return (OpenAIModelResource) getClient().invokeCapability("Aspire.Hosting.OpenAI/withHealthCheck", reqArgs);
    }

}

/** Wrapper for Aspire.Hosting.OpenAI/Aspire.Hosting.OpenAI.OpenAIResource. */
class OpenAIResource extends ResourceBuilderBase {
    OpenAIResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public OpenAIModelResource addModel(String name, String model) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        reqArgs.put("model", AspireClient.serializeValue(model));
        return (OpenAIModelResource) getClient().invokeCapability("Aspire.Hosting.OpenAI/addModel", reqArgs);
    }

    /** Configures the endpoint URI for the OpenAI resource. */
    public OpenAIResource withEndpoint(String endpoint) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("endpoint", AspireClient.serializeValue(endpoint));
        return (OpenAIResource) getClient().invokeCapability("Aspire.Hosting.OpenAI/withEndpoint", reqArgs);
    }

    /** Configures the API key for the OpenAI resource. */
    public OpenAIResource withApiKey(ParameterResource apiKey) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("apiKey", AspireClient.serializeValue(apiKey));
        return (OpenAIResource) getClient().invokeCapability("Aspire.Hosting.OpenAI/withApiKey", reqArgs);
    }
...
class AspireRegistrations {
    static {
        ...
        AspireClient.registerHandleWrapper("Aspire.Hosting.OpenAI/Aspire.Hosting.OpenAI.OpenAIResource", (h, c) -> new OpenAIResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.OpenAI/Aspire.Hosting.OpenAI.OpenAIModelResource", (h, c) -> new OpenAIModelResource(h, c));
