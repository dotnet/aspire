...
/** AzureWebPubSubRole enum. */
enum AzureWebPubSubRole implements WireValueEnum {
    WEB_PUB_SUB_CONTRIBUTOR("WebPubSubContributor"),
    WEB_PUB_SUB_SERVICE_OWNER("WebPubSubServiceOwner"),
    WEB_PUB_SUB_SERVICE_READER("WebPubSubServiceReader");

    private final String value;

    AzureWebPubSubRole(String value) {
        this.value = value;
    }

    public String getValue() { return value; }

    public static AzureWebPubSubRole fromValue(String value) {
        for (AzureWebPubSubRole e : values()) {
            if (e.value.equals(value)) return e;
        }
        throw new IllegalArgumentException("Unknown value: " + value);
    }
...
/** Options for AddEventHandler. */
final class AddEventHandlerOptions {
    private String userEventPattern;
    private String[] systemEvents;

    public String getUserEventPattern() { return userEventPattern; }
    public AddEventHandlerOptions userEventPattern(String value) {
        this.userEventPattern = value;
        return this;
    }

    public String[] getSystemEvents() { return systemEvents; }
    public AddEventHandlerOptions systemEvents(String[] value) {
...
class AzureBicepResource extends ResourceBuilderBase {
    ...
    public IResource withWebPubSubRoleAssignments(AzureWebPubSubResource target, AzureWebPubSubRole[] roles) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("target", AspireClient.serializeValue(target));
        reqArgs.put("roles", AspireClient.serializeValue(roles));
        return (IResource) getClient().invokeCapability("Aspire.Hosting.Azure.WebPubSub/withWebPubSubRoleAssignments", reqArgs);
    }
...
/** Wrapper for Aspire.Hosting.Azure.WebPubSub/Aspire.Hosting.ApplicationModel.AzureWebPubSubHubResource. */
class AzureWebPubSubHubResource extends ResourceBuilderBase {
    AzureWebPubSubHubResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public AzureWebPubSubHubResource addEventHandler(ReferenceExpression urlExpression, AddEventHandlerOptions options) {
        var userEventPattern = options == null ? null : options.getUserEventPattern();
        var systemEvents = options == null ? null : options.getSystemEvents();
        return addEventHandlerImpl(urlExpression, userEventPattern, systemEvents);
    }

    public AzureWebPubSubHubResource addEventHandler(ReferenceExpression urlExpression) {
        return addEventHandler(urlExpression, null);
    }

    /** Adds an event handler to an Azure Web PubSub hub. */
    private AzureWebPubSubHubResource addEventHandlerImpl(ReferenceExpression urlExpression, String userEventPattern, String[] systemEvents) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("urlExpression", AspireClient.serializeValue(urlExpression));
        if (userEventPattern != null) {
            reqArgs.put("userEventPattern", AspireClient.serializeValue(userEventPattern));
        }
        if (systemEvents != null) {
            reqArgs.put("systemEvents", AspireClient.serializeValue(systemEvents));
        }
        return (AzureWebPubSubHubResource) getClient().invokeCapability("Aspire.Hosting.Azure.WebPubSub/addEventHandlerWithoutAuth", reqArgs);
    }
...
/** Wrapper for Aspire.Hosting.Azure.WebPubSub/Aspire.Hosting.ApplicationModel.AzureWebPubSubResource. */
class AzureWebPubSubResource extends ResourceBuilderBase {
    AzureWebPubSubResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public AzureWebPubSubHubResource addHub(String name) {
        return addHub(name, null);
    }

    /** Adds a hub to the Azure Web PubSub resource. */
    public AzureWebPubSubHubResource addHub(String name, String hubName) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        if (hubName != null) {
            reqArgs.put("hubName", AspireClient.serializeValue(hubName));
        }
        return (AzureWebPubSubHubResource) getClient().invokeCapability("Aspire.Hosting.Azure.WebPubSub/addHub", reqArgs);
    }
...
class IDistributedApplicationBuilder extends HandleWrapperBase {
    ...
    public AzureWebPubSubResource addAzureWebPubSub(String name) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        return (AzureWebPubSubResource) getClient().invokeCapability("Aspire.Hosting.Azure.WebPubSub/addAzureWebPubSub", reqArgs);
    }
...
class AspireRegistrations {
    static {
        ...
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure.WebPubSub/Aspire.Hosting.ApplicationModel.AzureWebPubSubResource", (h, c) -> new AzureWebPubSubResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure.WebPubSub/Aspire.Hosting.ApplicationModel.AzureWebPubSubHubResource", (h, c) -> new AzureWebPubSubHubResource(h, c));
