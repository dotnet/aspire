...
/** Options for WithKafkaUI. */
final class WithKafkaUIOptions {
    private AspireAction1<KafkaUIContainerResource> configureContainer;
    private String containerName;

    public AspireAction1<KafkaUIContainerResource> getConfigureContainer() { return configureContainer; }
    public WithKafkaUIOptions configureContainer(AspireAction1<KafkaUIContainerResource> value) {
        this.configureContainer = value;
        return this;
    }

    public String getContainerName() { return containerName; }
    public WithKafkaUIOptions containerName(String value) {
...
class IDistributedApplicationBuilder extends HandleWrapperBase {
    ...
    public KafkaServerResource addKafka(String name) {
        return addKafka(name, null);
    }

    /** Adds a Kafka container resource */
    public KafkaServerResource addKafka(String name, Double port) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        if (port != null) {
        ...
        return (KafkaServerResource) getClient().invokeCapability("Aspire.Hosting.Kafka/addKafka", reqArgs);
    }
...
/** Wrapper for Aspire.Hosting.Kafka/Aspire.Hosting.KafkaServerResource. */
class KafkaServerResource extends ResourceBuilderBase {
    KafkaServerResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public KafkaServerResource withKafkaUI(WithKafkaUIOptions options) {
        ...
        return withKafkaUIImpl(configureContainer, containerName);
    }

    public KafkaServerResource withKafkaUI() {
        return withKafkaUI(null);
    }

    /** Adds a Kafka UI container to manage the Kafka resource */
    private KafkaServerResource withKafkaUIImpl(AspireAction1<KafkaUIContainerResource> configureContainer, String containerName) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        var configureContainerId = configureContainer == null ? null : getClient().registerCallback(args -> {
            var obj = (KafkaUIContainerResource) args[0];
        ...
        return (KafkaServerResource) getClient().invokeCapability("Aspire.Hosting.Kafka/withKafkaUI", reqArgs);
    }

    /** Adds a data volume to the Kafka container */
    public KafkaServerResource withDataVolume(WithDataVolumeOptions options) {
        var name = options == null ? null : options.getName();
        var isReadOnly = options == null ? null : options.isReadOnly();
        return withDataVolumeImpl(name, isReadOnly);
    }

    public KafkaServerResource withDataVolume() {
        return withDataVolume(null);
    }

    /** Adds a data volume to the Kafka container */
    private KafkaServerResource withDataVolumeImpl(String name, Boolean isReadOnly) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        if (name != null) {
            reqArgs.put("name", AspireClient.serializeValue(name));
        ...
        return (KafkaServerResource) getClient().invokeCapability("Aspire.Hosting.Kafka/withDataVolume", reqArgs);
    }

    public KafkaServerResource withDataBindMount(String source) {
        return withDataBindMount(source, null);
    }

    /** Adds a data bind mount to the Kafka container */
    public KafkaServerResource withDataBindMount(String source, Boolean isReadOnly) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("source", AspireClient.serializeValue(source));
        if (isReadOnly != null) {
        ...
        return (KafkaServerResource) getClient().invokeCapability("Aspire.Hosting.Kafka/withDataBindMount", reqArgs);
    }
    ...
    public EndpointReference primaryEndpoint() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (EndpointReference) getClient().invokeCapability("Aspire.Hosting/KafkaServerResource.primaryEndpoint", reqArgs);
    }
    ...
    public EndpointReferenceExpression host() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (EndpointReferenceExpression) getClient().invokeCapability("Aspire.Hosting/KafkaServerResource.host", reqArgs);
    }
    ...
    public EndpointReferenceExpression port() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (EndpointReferenceExpression) getClient().invokeCapability("Aspire.Hosting/KafkaServerResource.port", reqArgs);
    }
    ...
    public EndpointReference internalEndpoint() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (EndpointReference) getClient().invokeCapability("Aspire.Hosting/KafkaServerResource.internalEndpoint", reqArgs);
    }
    ...
    public ReferenceExpression connectionStringExpression() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting/KafkaServerResource.connectionStringExpression", reqArgs);
    }
    ...
    public String entrypoint() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting/KafkaServerResource.entrypoint", reqArgs);
    }

    /** Sets the Entrypoint property */
    public KafkaServerResource setEntrypoint(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (KafkaServerResource) getClient().invokeCapability("Aspire.Hosting/KafkaServerResource.setEntrypoint", reqArgs);
    }
    ...
    public boolean shellExecution() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (boolean) getClient().invokeCapability("Aspire.Hosting/KafkaServerResource.shellExecution", reqArgs);
    }

    /** Sets the ShellExecution property */
    public KafkaServerResource setShellExecution(boolean value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (KafkaServerResource) getClient().invokeCapability("Aspire.Hosting/KafkaServerResource.setShellExecution", reqArgs);
    }
    ...
    public String name() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting/KafkaServerResource.name", reqArgs);
    }

}

/** Wrapper for Aspire.Hosting.Kafka/Aspire.Hosting.KafkaUIContainerResource. */
class KafkaUIContainerResource extends ResourceBuilderBase {
    KafkaUIContainerResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public KafkaUIContainerResource withHostPort() {
        return withHostPort(null);
    }

    /** Sets the host port for the Kafka UI container */
    public KafkaUIContainerResource withHostPort(Double port) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        if (port != null) {
            reqArgs.put("port", AspireClient.serializeValue(port));
        }
        return (KafkaUIContainerResource) getClient().invokeCapability("Aspire.Hosting.Kafka/withHostPort", reqArgs);
    }
...
class AspireRegistrations {
    static {
        ...
        AspireClient.registerHandleWrapper("Aspire.Hosting.Kafka/Aspire.Hosting.KafkaServerResource", (h, c) -> new KafkaServerResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Kafka/Aspire.Hosting.KafkaUIContainerResource", (h, c) -> new KafkaUIContainerResource(h, c));
