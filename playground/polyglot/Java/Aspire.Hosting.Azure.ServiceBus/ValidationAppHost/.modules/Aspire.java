...
/** AzureServiceBusRole enum. */
enum AzureServiceBusRole implements WireValueEnum {
    AZURE_SERVICE_BUS_DATA_OWNER("AzureServiceBusDataOwner"),
    AZURE_SERVICE_BUS_DATA_RECEIVER("AzureServiceBusDataReceiver"),
    AZURE_SERVICE_BUS_DATA_SENDER("AzureServiceBusDataSender");

    private final String value;

    AzureServiceBusRole(String value) {
        this.value = value;
    }

    public String getValue() { return value; }

    public static AzureServiceBusRole fromValue(String value) {
        for (AzureServiceBusRole e : values()) {
            if (e.value.equals(value)) return e;
        }
        throw new IllegalArgumentException("Unknown value: " + value);
    }
...
/** AzureServiceBusFilterType enum. */
enum AzureServiceBusFilterType implements WireValueEnum {
    SQL_FILTER("SqlFilter"),
    CORRELATION_FILTER("CorrelationFilter");

    private final String value;

    AzureServiceBusFilterType(String value) {
        this.value = value;
    }

    public String getValue() { return value; }

    public static AzureServiceBusFilterType fromValue(String value) {
        for (AzureServiceBusFilterType e : values()) {
            if (e.value.equals(value)) return e;
        }
        throw new IllegalArgumentException("Unknown value: " + value);
    }
...
/** DeploymentScope enum. */
enum DeploymentScope implements WireValueEnum {
    ...
    DeploymentScope(String value) {
        this.value = value;
    }

    public String getValue() { return value; }

    public static DeploymentScope fromValue(String value) {
        for (DeploymentScope e : values()) {
            if (e.value.equals(value)) return e;
        }
        throw new IllegalArgumentException("Unknown value: " + value);
    }
...
/** AzureServiceBusCorrelationFilter DTO. */
class AzureServiceBusCorrelationFilter {
    private AspireDict<String, Object> properties;
    ...
    public AspireDict<String, Object> getProperties() { return properties; }
    public void setProperties(AspireDict<String, Object> value) { this.properties = value; }
    ...
    public void setSendTo(String value) { this.sendTo = value; }
    ...
    public String getReplyToSessionId() { return replyToSessionId; }
    public void setReplyToSessionId(String value) { this.replyToSessionId = value; }
    public String getContentType() { return contentType; }
    public void setContentType(String value) { this.contentType = value; }
    public boolean getRequiresPreprocessing() { return requiresPreprocessing; }
    public void setRequiresPreprocessing(boolean value) { this.requiresPreprocessing = value; }

    public Map<String, Object> toMap() {
        Map<String, Object> map = new HashMap<>();
        map.put("Properties", AspireClient.serializeValue(properties));
        map.put("CorrelationId", AspireClient.serializeValue(correlationId));
        map.put("MessageId", AspireClient.serializeValue(messageId));
        map.put("SendTo", AspireClient.serializeValue(sendTo));
        map.put("ReplyTo", AspireClient.serializeValue(replyTo));
        map.put("Subject", AspireClient.serializeValue(subject));
        map.put("SessionId", AspireClient.serializeValue(sessionId));
        map.put("ReplyToSessionId", AspireClient.serializeValue(replyToSessionId));
        map.put("ContentType", AspireClient.serializeValue(contentType));
        map.put("RequiresPreprocessing", AspireClient.serializeValue(requiresPreprocessing));
        return map;
    }
}

/** AzureServiceBusRule DTO. */
class AzureServiceBusRule {
    private String name;
    private AzureServiceBusCorrelationFilter correlationFilter;
    private AzureServiceBusFilterType filterType;

    public String getName() { return name; }
    public void setName(String value) { this.name = value; }
    public AzureServiceBusCorrelationFilter getCorrelationFilter() { return correlationFilter; }
    public void setCorrelationFilter(AzureServiceBusCorrelationFilter value) { this.correlationFilter = value; }
    public AzureServiceBusFilterType getFilterType() { return filterType; }
    public void setFilterType(AzureServiceBusFilterType value) { this.filterType = value; }

    public Map<String, Object> toMap() {
        Map<String, Object> map = new HashMap<>();
        map.put("Name", AspireClient.serializeValue(name));
        map.put("CorrelationFilter", AspireClient.serializeValue(correlationFilter));
        map.put("FilterType", AspireClient.serializeValue(filterType));
        return map;
    }
}
...
/** Wrapper for Aspire.Hosting.Azure/Aspire.Hosting.Azure.AzureBicepResource. */
class AzureBicepResource extends ResourceBuilderBase {
    AzureBicepResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public IResource withServiceBusRoleAssignments(AzureServiceBusResource target, AzureServiceBusRole[] roles) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("target", AspireClient.serializeValue(target));
        reqArgs.put("roles", AspireClient.serializeValue(roles));
        return (IResource) getClient().invokeCapability("Aspire.Hosting.Azure.ServiceBus/withServiceBusRoleAssignments", reqArgs);
    }

    /** Gets an output reference from an Azure Bicep template resource */
    public BicepOutputReference getOutput(String name) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        return (BicepOutputReference) getClient().invokeCapability("Aspire.Hosting.Azure/getOutput", reqArgs);
    }

    /** Adds a Bicep parameter without a value */
    public AzureBicepResource withParameter(String name) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        return (AzureBicepResource) getClient().invokeCapability("Aspire.Hosting.Azure/withParameter", reqArgs);
    }

    /** Adds a Bicep parameter with a string value */
    public AzureBicepResource withParameterStringValue(String name, String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (AzureBicepResource) getClient().invokeCapability("Aspire.Hosting.Azure/withParameterStringValue", reqArgs);
    }

    /** Adds a Bicep parameter with a string list value */
    public AzureBicepResource withParameterStringValues(String name, String[] value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (AzureBicepResource) getClient().invokeCapability("Aspire.Hosting.Azure/withParameterStringValues", reqArgs);
    }

    /** Adds a Bicep parameter from a parameter resource builder */
    public AzureBicepResource withParameterFromParameter(String name, ParameterResource value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (AzureBicepResource) getClient().invokeCapability("Aspire.Hosting.Azure/withParameterFromParameter", reqArgs);
    }

    /** Adds a Bicep parameter from a connection string resource builder */
    public AzureBicepResource withParameterFromConnectionString(String name, IResourceWithConnectionString value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (AzureBicepResource) getClient().invokeCapability("Aspire.Hosting.Azure/withParameterFromConnectionString", reqArgs);
    }

    public AzureBicepResource withParameterFromConnectionString(String name, ResourceBuilderBase value) {
        return withParameterFromConnectionString(name, new IResourceWithConnectionString(value.getHandle(), value.getClient()));
    }

    /** Adds a Bicep parameter from another Bicep output reference */
    public AzureBicepResource withParameterFromOutput(String name, BicepOutputReference value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (AzureBicepResource) getClient().invokeCapability("Aspire.Hosting.Azure/withParameterFromOutput", reqArgs);
    }

    /** Adds a Bicep parameter from a reference expression */
    public AzureBicepResource withParameterFromReferenceExpression(String name, ReferenceExpression value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (AzureBicepResource) getClient().invokeCapability("Aspire.Hosting.Azure/withParameterFromReferenceExpression", reqArgs);
    }

    /** Adds a Bicep parameter from an endpoint reference */
    public AzureBicepResource withParameterFromEndpoint(String name, EndpointReference value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (AzureBicepResource) getClient().invokeCapability("Aspire.Hosting.Azure/withParameterFromEndpoint", reqArgs);
    }

    /** Publishes an Azure resource to the manifest as a connection string */
    public IAzureResource publishAsConnectionString() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        return (IAzureResource) getClient().invokeCapability("Aspire.Hosting.Azure/publishAsConnectionString", reqArgs);
    }

    /** Gets the normalized Bicep identifier for an Azure resource */
    public String getBicepIdentifier() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("resource", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Azure/getBicepIdentifier", reqArgs);
    }

    /** Clears the default Azure role assignments from a resource */
    public IAzureResource clearDefaultRoleAssignments() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        return (IAzureResource) getClient().invokeCapability("Aspire.Hosting.Azure/clearDefaultRoleAssignments", reqArgs);
    }
    ...
    public boolean isExisting() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("resource", AspireClient.serializeValue(getHandle()));
        return (boolean) getClient().invokeCapability("Aspire.Hosting.Azure/isExisting", reqArgs);
    }

    /** Marks an Azure resource as existing in run mode by using parameter resources */
    public IAzureResource runAsExistingFromParameters(ParameterResource nameParameter, ParameterResource resourceGroupParameter) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("nameParameter", AspireClient.serializeValue(nameParameter));
        reqArgs.put("resourceGroupParameter", AspireClient.serializeValue(resourceGroupParameter));
        return (IAzureResource) getClient().invokeCapability("Aspire.Hosting.Azure/runAsExistingFromParameters", reqArgs);
    }

    /** Marks an Azure resource as existing in run mode */
    public IAzureResource runAsExisting(String name, String resourceGroup) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        reqArgs.put("resourceGroup", AspireClient.serializeValue(resourceGroup));
        return (IAzureResource) getClient().invokeCapability("Aspire.Hosting.Azure/runAsExisting", reqArgs);
    }

    /** Marks an Azure resource as existing in publish mode by using parameter resources */
    public IAzureResource publishAsExistingFromParameters(ParameterResource nameParameter, ParameterResource resourceGroupParameter) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("nameParameter", AspireClient.serializeValue(nameParameter));
        reqArgs.put("resourceGroupParameter", AspireClient.serializeValue(resourceGroupParameter));
        return (IAzureResource) getClient().invokeCapability("Aspire.Hosting.Azure/publishAsExistingFromParameters", reqArgs);
    }

    /** Marks an Azure resource as existing in publish mode */
    public IAzureResource publishAsExisting(String name, String resourceGroup) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        reqArgs.put("resourceGroup", AspireClient.serializeValue(resourceGroup));
        return (IAzureResource) getClient().invokeCapability("Aspire.Hosting.Azure/publishAsExisting", reqArgs);
    }

    /** Marks an Azure resource as existing in both run and publish modes by using parameter resources */
    public IAzureResource asExisting(ParameterResource nameParameter, ParameterResource resourceGroupParameter) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("nameParameter", AspireClient.serializeValue(nameParameter));
        reqArgs.put("resourceGroupParameter", AspireClient.serializeValue(resourceGroupParameter));
        return (IAzureResource) getClient().invokeCapability("Aspire.Hosting.Azure/asExistingFromParameters", reqArgs);
    }

}

/** Wrapper for Aspire.Hosting.Azure/Aspire.Hosting.Azure.AzureEnvironmentResource. */
class AzureEnvironmentResource extends ResourceBuilderBase {
    AzureEnvironmentResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public AzureEnvironmentResource withLocation(ParameterResource location) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("location", AspireClient.serializeValue(location));
        return (AzureEnvironmentResource) getClient().invokeCapability("Aspire.Hosting.Azure/withLocation", reqArgs);
    }

    /** Sets the Azure resource group for the shared Azure environment resource */
    public AzureEnvironmentResource withResourceGroup(ParameterResource resourceGroup) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("resourceGroup", AspireClient.serializeValue(resourceGroup));
        return (AzureEnvironmentResource) getClient().invokeCapability("Aspire.Hosting.Azure/withResourceGroup", reqArgs);
    }

}

/** Wrapper for Aspire.Hosting.Azure/Aspire.Hosting.Azure.AzureProvisioningResource. */
class AzureProvisioningResource extends ResourceBuilderBase {
    AzureProvisioningResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public AzureProvisioningResource configureInfrastructure(AspireAction1<AzureResourceInfrastructure> configure) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        var configureId = getClient().registerCallback(args -> {
            var obj = (AzureResourceInfrastructure) args[0];
        ...
        return (AzureProvisioningResource) getClient().invokeCapability("Aspire.Hosting.Azure/configureInfrastructure", reqArgs);
    }
...
/** Wrapper for Aspire.Hosting.Azure/Aspire.Hosting.Azure.AzureResourceInfrastructure. */
class AzureResourceInfrastructure extends HandleWrapperBase {
    AzureResourceInfrastructure(Handle handle, AspireClient client) {
        super(handle, client);
    }

    /** Gets the BicepName property */
    public String bicepName() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Azure/AzureResourceInfrastructure.bicepName", reqArgs);
    }

    /** Gets the TargetScope property */
    public DeploymentScope targetScope() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (DeploymentScope) getClient().invokeCapability("Aspire.Hosting.Azure/AzureResourceInfrastructure.targetScope", reqArgs);
    }

    /** Sets the TargetScope property */
    public AzureResourceInfrastructure setTargetScope(DeploymentScope value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (AzureResourceInfrastructure) getClient().invokeCapability("Aspire.Hosting.Azure/AzureResourceInfrastructure.setTargetScope", reqArgs);
    }

}

/** Wrapper for Aspire.Hosting.Azure.ServiceBus/Aspire.Hosting.Azure.AzureServiceBusEmulatorResource. */
class AzureServiceBusEmulatorResource extends ResourceBuilderBase {
    AzureServiceBusEmulatorResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public AzureServiceBusEmulatorResource withConfigurationFile(String path) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("path", AspireClient.serializeValue(path));
        return (AzureServiceBusEmulatorResource) getClient().invokeCapability("Aspire.Hosting.Azure.ServiceBus/withConfigurationFile", reqArgs);
    }

    public AzureServiceBusEmulatorResource withHostPort() {
        return withHostPort(null);
    }

    /** Sets the host port for the Service Bus emulator endpoint */
    public AzureServiceBusEmulatorResource withHostPort(Double port) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        if (port != null) {
            reqArgs.put("port", AspireClient.serializeValue(port));
        }
        return (AzureServiceBusEmulatorResource) getClient().invokeCapability("Aspire.Hosting.Azure.ServiceBus/withHostPort", reqArgs);
    }
    ...
    public IResourceWithEnvironment withEnvironmentFromOutput(String name, BicepOutputReference bicepOutputReference) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        reqArgs.put("bicepOutputReference", AspireClient.serializeValue(bicepOutputReference));
        return (IResourceWithEnvironment) getClient().invokeCapability("Aspire.Hosting.Azure/withEnvironmentFromOutput", reqArgs);
    }

    /** Sets an environment variable from an Azure Key Vault secret reference */
    public IResourceWithEnvironment withEnvironmentFromKeyVaultSecret(String name, IAzureKeyVaultSecretReference secretReference) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        reqArgs.put("secretReference", AspireClient.serializeValue(secretReference));
        return (IResourceWithEnvironment) getClient().invokeCapability("Aspire.Hosting.Azure/withEnvironmentFromKeyVaultSecret", reqArgs);
    }

    /** Associates an Azure user-assigned identity with a compute resource */
    public IComputeResource withAzureUserAssignedIdentity(AzureUserAssignedIdentityResource identityResourceBuilder) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("identityResourceBuilder", AspireClient.serializeValue(identityResourceBuilder));
        return (IComputeResource) getClient().invokeCapability("Aspire.Hosting.Azure/withUserAssignedIdentityAzureUserAssignedIdentity", reqArgs);
    }

}

/** Wrapper for Aspire.Hosting.Azure.ServiceBus/Aspire.Hosting.Azure.AzureServiceBusQueueResource. */
class AzureServiceBusQueueResource extends ResourceBuilderBase {
    AzureServiceBusQueueResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public AzureServiceBusQueueResource withProperties(AspireAction1<AzureServiceBusQueueResource> configure) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        var configureId = getClient().registerCallback(args -> {
            var obj = (AzureServiceBusQueueResource) args[0];
            configure.invoke(obj);
            return null;
        });
        if (configureId != null) {
        ...
        return (AzureServiceBusQueueResource) getClient().invokeCapability("Aspire.Hosting.Azure.ServiceBus/withQueueProperties", reqArgs);
    }
    ...
    public String queueName() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusQueueResource.queueName", reqArgs);
    }

    /** Sets the QueueName property */
    public AzureServiceBusQueueResource setQueueName(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (AzureServiceBusQueueResource) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusQueueResource.setQueueName", reqArgs);
    }
    ...
    public boolean deadLetteringOnMessageExpiration() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (boolean) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusQueueResource.deadLetteringOnMessageExpiration", reqArgs);
    }

    /** Sets the DeadLetteringOnMessageExpiration property */
    public AzureServiceBusQueueResource setDeadLetteringOnMessageExpiration(boolean value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (AzureServiceBusQueueResource) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusQueueResource.setDeadLetteringOnMessageExpiration", reqArgs);
    }

    /** Gets the DefaultMessageTimeToLive property */
    public double defaultMessageTimeToLive() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (double) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusQueueResource.defaultMessageTimeToLive", reqArgs);
    }

    /** Sets the DefaultMessageTimeToLive property */
    public AzureServiceBusQueueResource setDefaultMessageTimeToLive(double value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (AzureServiceBusQueueResource) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusQueueResource.setDefaultMessageTimeToLive", reqArgs);
    }

    /** Gets the DuplicateDetectionHistoryTimeWindow property */
    public double duplicateDetectionHistoryTimeWindow() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (double) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusQueueResource.duplicateDetectionHistoryTimeWindow", reqArgs);
    }

    /** Sets the DuplicateDetectionHistoryTimeWindow property */
    public AzureServiceBusQueueResource setDuplicateDetectionHistoryTimeWindow(double value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (AzureServiceBusQueueResource) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusQueueResource.setDuplicateDetectionHistoryTimeWindow", reqArgs);
    }
    ...
    public String forwardDeadLetteredMessagesTo() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusQueueResource.forwardDeadLetteredMessagesTo", reqArgs);
    }

    /** Sets the ForwardDeadLetteredMessagesTo property */
    public AzureServiceBusQueueResource setForwardDeadLetteredMessagesTo(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (AzureServiceBusQueueResource) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusQueueResource.setForwardDeadLetteredMessagesTo", reqArgs);
    }
    ...
    public String forwardTo() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusQueueResource.forwardTo", reqArgs);
    }

    /** Sets the ForwardTo property */
    public AzureServiceBusQueueResource setForwardTo(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (AzureServiceBusQueueResource) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusQueueResource.setForwardTo", reqArgs);
    }
    ...
    public double lockDuration() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (double) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusQueueResource.lockDuration", reqArgs);
    }

    /** Sets the LockDuration property */
    public AzureServiceBusQueueResource setLockDuration(double value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (AzureServiceBusQueueResource) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusQueueResource.setLockDuration", reqArgs);
    }
    ...
    public double maxDeliveryCount() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (double) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusQueueResource.maxDeliveryCount", reqArgs);
    }

    /** Sets the MaxDeliveryCount property */
    public AzureServiceBusQueueResource setMaxDeliveryCount(double value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (AzureServiceBusQueueResource) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusQueueResource.setMaxDeliveryCount", reqArgs);
    }
    ...
    public boolean requiresDuplicateDetection() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (boolean) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusQueueResource.requiresDuplicateDetection", reqArgs);
    }

    /** Sets the RequiresDuplicateDetection property */
    public AzureServiceBusQueueResource setRequiresDuplicateDetection(boolean value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (AzureServiceBusQueueResource) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusQueueResource.setRequiresDuplicateDetection", reqArgs);
    }
    ...
    public boolean requiresSession() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (boolean) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusQueueResource.requiresSession", reqArgs);
    }

    /** Sets the RequiresSession property */
    public AzureServiceBusQueueResource setRequiresSession(boolean value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (AzureServiceBusQueueResource) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusQueueResource.setRequiresSession", reqArgs);
    }
    ...
    public String name() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusQueueResource.name", reqArgs);
    }

}

/** Wrapper for Aspire.Hosting.Azure.ServiceBus/Aspire.Hosting.Azure.AzureServiceBusResource. */
class AzureServiceBusResource extends ResourceBuilderBase {
    AzureServiceBusResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public AzureServiceBusQueueResource addServiceBusQueue(String name) {
        return addServiceBusQueue(name, null);
    }

    /** Adds an Azure Service Bus queue resource */
    public AzureServiceBusQueueResource addServiceBusQueue(String name, String queueName) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        if (queueName != null) {
            reqArgs.put("queueName", AspireClient.serializeValue(queueName));
        }
        return (AzureServiceBusQueueResource) getClient().invokeCapability("Aspire.Hosting.Azure.ServiceBus/addServiceBusQueue", reqArgs);
    }

    public AzureServiceBusTopicResource addServiceBusTopic(String name) {
        return addServiceBusTopic(name, null);
    }

    /** Adds an Azure Service Bus topic resource */
    public AzureServiceBusTopicResource addServiceBusTopic(String name, String topicName) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        if (topicName != null) {
            reqArgs.put("topicName", AspireClient.serializeValue(topicName));
        }
        return (AzureServiceBusTopicResource) getClient().invokeCapability("Aspire.Hosting.Azure.ServiceBus/addServiceBusTopic", reqArgs);
    }

    public AzureServiceBusResource runAsEmulator() {
        return runAsEmulator(null);
    }

    /** Configures the Azure Service Bus resource to run with the local emulator */
    public AzureServiceBusResource runAsEmulator(AspireAction1<AzureServiceBusEmulatorResource> configureContainer) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        var configureContainerId = configureContainer == null ? null : getClient().registerCallback(args -> {
            var obj = (AzureServiceBusEmulatorResource) args[0];
        ...
        return (AzureServiceBusResource) getClient().invokeCapability("Aspire.Hosting.Azure.ServiceBus/runAsEmulator", reqArgs);
    }
...
/** Wrapper for Aspire.Hosting.Azure.ServiceBus/Aspire.Hosting.Azure.AzureServiceBusSubscriptionResource. */
class AzureServiceBusSubscriptionResource extends ResourceBuilderBase {
    AzureServiceBusSubscriptionResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public AzureServiceBusSubscriptionResource withProperties(AspireAction1<AzureServiceBusSubscriptionResource> configure) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        var configureId = getClient().registerCallback(args -> {
            var obj = (AzureServiceBusSubscriptionResource) args[0];
            configure.invoke(obj);
            return null;
        });
        if (configureId != null) {
        ...
        return (AzureServiceBusSubscriptionResource) getClient().invokeCapability("Aspire.Hosting.Azure.ServiceBus/withSubscriptionProperties", reqArgs);
    }
    ...
    public String subscriptionName() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusSubscriptionResource.subscriptionName", reqArgs);
    }

    /** Sets the SubscriptionName property */
    public AzureServiceBusSubscriptionResource setSubscriptionName(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (AzureServiceBusSubscriptionResource) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusSubscriptionResource.setSubscriptionName", reqArgs);
    }
    ...
    public boolean deadLetteringOnMessageExpiration() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (boolean) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusSubscriptionResource.deadLetteringOnMessageExpiration", reqArgs);
    }

    /** Sets the DeadLetteringOnMessageExpiration property */
    public AzureServiceBusSubscriptionResource setDeadLetteringOnMessageExpiration(boolean value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (AzureServiceBusSubscriptionResource) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusSubscriptionResource.setDeadLetteringOnMessageExpiration", reqArgs);
    }
    ...
    public double defaultMessageTimeToLive() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (double) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusSubscriptionResource.defaultMessageTimeToLive", reqArgs);
    }

    /** Sets the DefaultMessageTimeToLive property */
    public AzureServiceBusSubscriptionResource setDefaultMessageTimeToLive(double value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (AzureServiceBusSubscriptionResource) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusSubscriptionResource.setDefaultMessageTimeToLive", reqArgs);
    }
    ...
    public String forwardDeadLetteredMessagesTo() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusSubscriptionResource.forwardDeadLetteredMessagesTo", reqArgs);
    }

    /** Sets the ForwardDeadLetteredMessagesTo property */
    public AzureServiceBusSubscriptionResource setForwardDeadLetteredMessagesTo(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (AzureServiceBusSubscriptionResource) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusSubscriptionResource.setForwardDeadLetteredMessagesTo", reqArgs);
    }
    ...
    public String forwardTo() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusSubscriptionResource.forwardTo", reqArgs);
    }

    /** Sets the ForwardTo property */
    public AzureServiceBusSubscriptionResource setForwardTo(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (AzureServiceBusSubscriptionResource) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusSubscriptionResource.setForwardTo", reqArgs);
    }
    ...
    public double lockDuration() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (double) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusSubscriptionResource.lockDuration", reqArgs);
    }

    /** Sets the LockDuration property */
    public AzureServiceBusSubscriptionResource setLockDuration(double value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (AzureServiceBusSubscriptionResource) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusSubscriptionResource.setLockDuration", reqArgs);
    }
    ...
    public double maxDeliveryCount() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (double) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusSubscriptionResource.maxDeliveryCount", reqArgs);
    }

    /** Sets the MaxDeliveryCount property */
    public AzureServiceBusSubscriptionResource setMaxDeliveryCount(double value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (AzureServiceBusSubscriptionResource) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusSubscriptionResource.setMaxDeliveryCount", reqArgs);
    }
    ...
    public boolean requiresSession() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (boolean) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusSubscriptionResource.requiresSession", reqArgs);
    }

    /** Sets the RequiresSession property */
    public AzureServiceBusSubscriptionResource setRequiresSession(boolean value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (AzureServiceBusSubscriptionResource) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusSubscriptionResource.setRequiresSession", reqArgs);
    }

    /** Gets the Rules property */
    private AspireList<AzureServiceBusRule> rulesField;
    public AspireList<AzureServiceBusRule> rules() {
        if (rulesField == null) {
            rulesField = new AspireList<>(getHandle(), getClient(), "Aspire.Hosting.Azure/AzureServiceBusSubscriptionResource.rules");
        }
        return rulesField;
    }
    ...
    public String name() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusSubscriptionResource.name", reqArgs);
    }

}

/** Wrapper for Aspire.Hosting.Azure.ServiceBus/Aspire.Hosting.Azure.AzureServiceBusTopicResource. */
class AzureServiceBusTopicResource extends ResourceBuilderBase {
    AzureServiceBusTopicResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public AzureServiceBusTopicResource withProperties(AspireAction1<AzureServiceBusTopicResource> configure) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        var configureId = getClient().registerCallback(args -> {
            var obj = (AzureServiceBusTopicResource) args[0];
            configure.invoke(obj);
            return null;
        });
        if (configureId != null) {
        ...
        return (AzureServiceBusTopicResource) getClient().invokeCapability("Aspire.Hosting.Azure.ServiceBus/withTopicProperties", reqArgs);
    }

    public AzureServiceBusSubscriptionResource addServiceBusSubscription(String name) {
        return addServiceBusSubscription(name, null);
    }

    /** Adds an Azure Service Bus subscription resource */
    public AzureServiceBusSubscriptionResource addServiceBusSubscription(String name, String subscriptionName) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        if (subscriptionName != null) {
            reqArgs.put("subscriptionName", AspireClient.serializeValue(subscriptionName));
        }
        return (AzureServiceBusSubscriptionResource) getClient().invokeCapability("Aspire.Hosting.Azure.ServiceBus/addServiceBusSubscription", reqArgs);
    }
    ...
    public String topicName() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusTopicResource.topicName", reqArgs);
    }

    /** Sets the TopicName property */
    public AzureServiceBusTopicResource setTopicName(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (AzureServiceBusTopicResource) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusTopicResource.setTopicName", reqArgs);
    }
    ...
    public double defaultMessageTimeToLive() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (double) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusTopicResource.defaultMessageTimeToLive", reqArgs);
    }

    /** Sets the DefaultMessageTimeToLive property */
    public AzureServiceBusTopicResource setDefaultMessageTimeToLive(double value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (AzureServiceBusTopicResource) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusTopicResource.setDefaultMessageTimeToLive", reqArgs);
    }
    ...
    public double duplicateDetectionHistoryTimeWindow() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (double) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusTopicResource.duplicateDetectionHistoryTimeWindow", reqArgs);
    }

    /** Sets the DuplicateDetectionHistoryTimeWindow property */
    public AzureServiceBusTopicResource setDuplicateDetectionHistoryTimeWindow(double value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (AzureServiceBusTopicResource) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusTopicResource.setDuplicateDetectionHistoryTimeWindow", reqArgs);
    }
    ...
    public boolean requiresDuplicateDetection() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (boolean) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusTopicResource.requiresDuplicateDetection", reqArgs);
    }

    /** Sets the RequiresDuplicateDetection property */
    public AzureServiceBusTopicResource setRequiresDuplicateDetection(boolean value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (AzureServiceBusTopicResource) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusTopicResource.setRequiresDuplicateDetection", reqArgs);
    }
    ...
    public String name() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Azure/AzureServiceBusTopicResource.name", reqArgs);
    }

}

/** Wrapper for Aspire.Hosting.Azure/Aspire.Hosting.Azure.AzureUserAssignedIdentityResource. */
class AzureUserAssignedIdentityResource extends ResourceBuilderBase {
    AzureUserAssignedIdentityResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
...
/** Wrapper for Aspire.Hosting.Azure/Aspire.Hosting.Azure.BicepOutputReference. */
class BicepOutputReference extends HandleWrapperBase {
    BicepOutputReference(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public String name() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Azure/BicepOutputReference.name", reqArgs);
    }
    ...
    public String value() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Azure/BicepOutputReference.value", reqArgs);
    }
    ...
    public String valueExpression() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Azure/BicepOutputReference.valueExpression", reqArgs);
    }
...
/** Wrapper for Aspire.Hosting.Azure/Aspire.Hosting.Azure.IAzureKeyVaultResource. */
class IAzureKeyVaultResource extends ResourceBuilderBase {
    IAzureKeyVaultResource(Handle handle, AspireClient client) {
        super(handle, client);
    }

}

/** Wrapper for Aspire.Hosting.Azure/Aspire.Hosting.Azure.IAzureKeyVaultSecretReference. */
class IAzureKeyVaultSecretReference extends HandleWrapperBase {
    IAzureKeyVaultSecretReference(Handle handle, AspireClient client) {
        super(handle, client);
    }

}

/** Wrapper for Aspire.Hosting.Azure/Aspire.Hosting.ApplicationModel.IAzureResource. */
class IAzureResource extends ResourceBuilderBase {
    IAzureResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
...
class IDistributedApplicationBuilder extends HandleWrapperBase {
    ...
    public AzureServiceBusResource addAzureServiceBus(String name) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        return (AzureServiceBusResource) getClient().invokeCapability("Aspire.Hosting.Azure.ServiceBus/addAzureServiceBus", reqArgs);
    }

    /** Adds an Azure Bicep template resource from a file */
    public AzureBicepResource addBicepTemplate(String name, String bicepFile) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        reqArgs.put("bicepFile", AspireClient.serializeValue(bicepFile));
        return (AzureBicepResource) getClient().invokeCapability("Aspire.Hosting.Azure/addBicepTemplate", reqArgs);
    }

    /** Adds an Azure Bicep template resource from inline Bicep content */
    public AzureBicepResource addBicepTemplateString(String name, String bicepContent) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        reqArgs.put("bicepContent", AspireClient.serializeValue(bicepContent));
        return (AzureBicepResource) getClient().invokeCapability("Aspire.Hosting.Azure/addBicepTemplateString", reqArgs);
    }

    /** Adds an Azure provisioning resource to the application model */
    public AzureProvisioningResource addAzureInfrastructure(String name, AspireAction1<AzureResourceInfrastructure> configureInfrastructure) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        var configureInfrastructureId = getClient().registerCallback(args -> {
            var obj = (AzureResourceInfrastructure) args[0];
            configureInfrastructure.invoke(obj);
            return null;
        });
        if (configureInfrastructureId != null) {
            reqArgs.put("configureInfrastructure", configureInfrastructureId);
        }
        return (AzureProvisioningResource) getClient().invokeCapability("Aspire.Hosting.Azure/addAzureInfrastructure", reqArgs);
    }

    /** Adds Azure provisioning services to the distributed application builder */
    public IDistributedApplicationBuilder addAzureProvisioning() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        return (IDistributedApplicationBuilder) getClient().invokeCapability("Aspire.Hosting.Azure/addAzureProvisioning", reqArgs);
    }

    /** Adds the shared Azure environment resource to the application model */
    public AzureEnvironmentResource addAzureEnvironment() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        return (AzureEnvironmentResource) getClient().invokeCapability("Aspire.Hosting.Azure/addAzureEnvironment", reqArgs);
    }

    /** Adds an Azure user-assigned identity resource */
    public AzureUserAssignedIdentityResource addAzureUserAssignedIdentity(String name) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        return (AzureUserAssignedIdentityResource) getClient().invokeCapability("Aspire.Hosting.Azure/addAzureUserAssignedIdentity", reqArgs);
    }
...
class AspireRegistrations {
    static {
        ...
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure.ServiceBus/Aspire.Hosting.Azure.AzureServiceBusQueueResource", (h, c) -> new AzureServiceBusQueueResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure.ServiceBus/Aspire.Hosting.Azure.AzureServiceBusSubscriptionResource", (h, c) -> new AzureServiceBusSubscriptionResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure.ServiceBus/Aspire.Hosting.Azure.AzureServiceBusTopicResource", (h, c) -> new AzureServiceBusTopicResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure.ServiceBus/Aspire.Hosting.Azure.AzureServiceBusResource", (h, c) -> new AzureServiceBusResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure.ServiceBus/Aspire.Hosting.Azure.AzureServiceBusEmulatorResource", (h, c) -> new AzureServiceBusEmulatorResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure/Aspire.Hosting.ApplicationModel.IAzureResource", (h, c) -> new IAzureResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure/Aspire.Hosting.Azure.BicepOutputReference", (h, c) -> new BicepOutputReference(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure/Aspire.Hosting.Azure.AzureResourceInfrastructure", (h, c) -> new AzureResourceInfrastructure(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure/Aspire.Hosting.Azure.IAzureKeyVaultResource", (h, c) -> new IAzureKeyVaultResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure/Aspire.Hosting.Azure.IAzureKeyVaultSecretReference", (h, c) -> new IAzureKeyVaultSecretReference(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure/Aspire.Hosting.Azure.AzureBicepResource", (h, c) -> new AzureBicepResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure/Aspire.Hosting.Azure.AzureProvisioningResource", (h, c) -> new AzureProvisioningResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure/Aspire.Hosting.Azure.AzureEnvironmentResource", (h, c) -> new AzureEnvironmentResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure/Aspire.Hosting.Azure.AzureUserAssignedIdentityResource", (h, c) -> new AzureUserAssignedIdentityResource(h, c));
        ...
        AspireClient.registerHandleWrapper("Aspire.Hosting/List<Aspire.Hosting.Azure.ServiceBus/Aspire.Hosting.Azure.AzureServiceBusRule>", (h, c) -> new AspireList(h, c));
    }
