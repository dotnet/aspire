...
/** Options for AddValkey. */
final class AddValkeyOptions {
    private Double port;
    private ParameterResource password;

    public Double getPort() { return port; }
    public AddValkeyOptions port(Double value) {
        this.port = value;
        return this;
    }

    public ParameterResource getPassword() { return password; }
    public AddValkeyOptions password(ParameterResource value) {
        this.password = value;
        return this;
    }
...
class IDistributedApplicationBuilder extends HandleWrapperBase {
    ...
    public ValkeyResource addValkey(String name, AddValkeyOptions options) {
        var port = options == null ? null : options.getPort();
        var password = options == null ? null : options.getPassword();
        return addValkeyImpl(name, port, password);
    }

    public ValkeyResource addValkey(String name) {
        return addValkey(name, null);
    }

    /** Adds a Valkey container resource */
    private ValkeyResource addValkeyImpl(String name, Double port, ParameterResource password) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        if (port != null) {
        ...
        return (ValkeyResource) getClient().invokeCapability("Aspire.Hosting.Valkey/addValkey", reqArgs);
    }
...
/** Wrapper for Aspire.Hosting.Valkey/Aspire.Hosting.ApplicationModel.ValkeyResource. */
class ValkeyResource extends ResourceBuilderBase {
    ValkeyResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public ValkeyResource withDataVolume(WithDataVolumeOptions options) {
        var name = options == null ? null : options.getName();
        var isReadOnly = options == null ? null : options.isReadOnly();
        return withDataVolumeImpl(name, isReadOnly);
    }

    public ValkeyResource withDataVolume() {
        return withDataVolume(null);
    }

    /** Adds a data volume for Valkey and enables persistence */
    private ValkeyResource withDataVolumeImpl(String name, Boolean isReadOnly) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        if (name != null) {
            reqArgs.put("name", AspireClient.serializeValue(name));
        ...
        return (ValkeyResource) getClient().invokeCapability("Aspire.Hosting.Valkey/withDataVolume", reqArgs);
    }

    public ValkeyResource withDataBindMount(String source) {
        return withDataBindMount(source, null);
    }

    /** Adds a data bind mount for Valkey and enables persistence */
    public ValkeyResource withDataBindMount(String source, Boolean isReadOnly) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("source", AspireClient.serializeValue(source));
        if (isReadOnly != null) {
        ...
        return (ValkeyResource) getClient().invokeCapability("Aspire.Hosting.Valkey/withDataBindMount", reqArgs);
    }

    /** Configures Valkey persistence */
    public ValkeyResource withPersistence(WithPersistenceOptions options) {
    ...
    public ValkeyResource withPersistence() {
        return withPersistence(null);
    }

    /** Configures Valkey persistence */
    private ValkeyResource withPersistenceImpl(Double interval, Double keysChangedThreshold) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        if (interval != null) {
        ...
        return (ValkeyResource) getClient().invokeCapability("Aspire.Hosting.Valkey/withPersistence", reqArgs);
    }
    ...
    public ParameterResource passwordParameter() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ParameterResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/ValkeyResource.passwordParameter", reqArgs);
    }
    ...
    public EndpointReference primaryEndpoint() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (EndpointReference) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/ValkeyResource.primaryEndpoint", reqArgs);
    }
    ...
    public EndpointReferenceExpression host() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (EndpointReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/ValkeyResource.host", reqArgs);
    }
    ...
    public EndpointReferenceExpression port() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (EndpointReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/ValkeyResource.port", reqArgs);
    }
    ...
    public ReferenceExpression connectionStringExpression() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/ValkeyResource.connectionStringExpression", reqArgs);
    }
    ...
    public ReferenceExpression uriExpression() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/ValkeyResource.uriExpression", reqArgs);
    }
    ...
    public String entrypoint() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/ValkeyResource.entrypoint", reqArgs);
    }

    /** Sets the Entrypoint property */
    public ValkeyResource setEntrypoint(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (ValkeyResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/ValkeyResource.setEntrypoint", reqArgs);
    }
    ...
    public boolean shellExecution() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (boolean) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/ValkeyResource.shellExecution", reqArgs);
    }

    /** Sets the ShellExecution property */
    public ValkeyResource setShellExecution(boolean value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (ValkeyResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/ValkeyResource.setShellExecution", reqArgs);
    }
    ...
    public String name() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/ValkeyResource.name", reqArgs);
    }
...
class AspireRegistrations {
    static {
        ...
        AspireClient.registerHandleWrapper("Aspire.Hosting.Valkey/Aspire.Hosting.ApplicationModel.ValkeyResource", (h, c) -> new ValkeyResource(h, c));
