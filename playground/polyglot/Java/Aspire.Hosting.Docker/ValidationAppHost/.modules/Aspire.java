...
class CSharpAppResource extends ResourceBuilderBase {
    ...
    public IComputeResource publishAsDockerComposeService(AspireAction2<DockerComposeServiceResource, Service> configure) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        var configureId = getClient().registerCallback(args -> {
            var arg1 = (DockerComposeServiceResource) args[0];
            var arg2 = (Service) args[1];
        ...
        return (IComputeResource) getClient().invokeCapability("Aspire.Hosting.Docker/publishAsDockerComposeService", reqArgs);
    }
...
/** Wrapper for Aspire.Hosting.Docker/Aspire.Hosting.Docker.DockerComposeAspireDashboardResource. */
class DockerComposeAspireDashboardResource extends ResourceBuilderBase {
    DockerComposeAspireDashboardResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public DockerComposeAspireDashboardResource withHostPort() {
        return withHostPort(null);
    }

    /** Sets the host port for the Aspire dashboard */
    public DockerComposeAspireDashboardResource withHostPort(Double port) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        if (port != null) {
            reqArgs.put("port", AspireClient.serializeValue(port));
        }
        return (DockerComposeAspireDashboardResource) getClient().invokeCapability("Aspire.Hosting.Docker/withHostPort", reqArgs);
    }

    public DockerComposeAspireDashboardResource withForwardedHeaders() {
        return withForwardedHeaders(null);
    }

    /** Enables or disables forwarded headers support for the Aspire dashboard */
    public DockerComposeAspireDashboardResource withForwardedHeaders(Boolean enabled) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        if (enabled != null) {
            reqArgs.put("enabled", AspireClient.serializeValue(enabled));
        }
        return (DockerComposeAspireDashboardResource) getClient().invokeCapability("Aspire.Hosting.Docker/withForwardedHeaders", reqArgs);
    }
    ...
    public EndpointReference primaryEndpoint() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (EndpointReference) getClient().invokeCapability("Aspire.Hosting.Docker/DockerComposeAspireDashboardResource.primaryEndpoint", reqArgs);
    }
    ...
    public EndpointReference otlpGrpcEndpoint() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (EndpointReference) getClient().invokeCapability("Aspire.Hosting.Docker/DockerComposeAspireDashboardResource.otlpGrpcEndpoint", reqArgs);
    }
    ...
    public String entrypoint() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Docker/DockerComposeAspireDashboardResource.entrypoint", reqArgs);
    }

    /** Sets the Entrypoint property */
    public DockerComposeAspireDashboardResource setEntrypoint(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (DockerComposeAspireDashboardResource) getClient().invokeCapability("Aspire.Hosting.Docker/DockerComposeAspireDashboardResource.setEntrypoint", reqArgs);
    }
    ...
    public boolean shellExecution() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (boolean) getClient().invokeCapability("Aspire.Hosting.Docker/DockerComposeAspireDashboardResource.shellExecution", reqArgs);
    }

    /** Sets the ShellExecution property */
    public DockerComposeAspireDashboardResource setShellExecution(boolean value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (DockerComposeAspireDashboardResource) getClient().invokeCapability("Aspire.Hosting.Docker/DockerComposeAspireDashboardResource.setShellExecution", reqArgs);
    }
    ...
    public String name() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Docker/DockerComposeAspireDashboardResource.name", reqArgs);
    }

}

/** Wrapper for Aspire.Hosting.Docker/Aspire.Hosting.Docker.DockerComposeEnvironmentResource. */
class DockerComposeEnvironmentResource extends ResourceBuilderBase {
    DockerComposeEnvironmentResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public DockerComposeEnvironmentResource withProperties(AspireAction1<DockerComposeEnvironmentResource> configure) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        var configureId = getClient().registerCallback(args -> {
            var obj = (DockerComposeEnvironmentResource) args[0];
            configure.invoke(obj);
            return null;
        });
        if (configureId != null) {
        ...
        return (DockerComposeEnvironmentResource) getClient().invokeCapability("Aspire.Hosting.Docker/withProperties", reqArgs);
    }

    public DockerComposeEnvironmentResource withDashboard() {
        return withDashboard(null);
    }

    /** Enables or disables the Aspire dashboard for the Docker Compose environment */
    public DockerComposeEnvironmentResource withDashboard(Boolean enabled) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        if (enabled != null) {
            reqArgs.put("enabled", AspireClient.serializeValue(enabled));
        }
        return (DockerComposeEnvironmentResource) getClient().invokeCapability("Aspire.Hosting.Docker/withDashboard", reqArgs);
    }

    /** Configures the Aspire dashboard resource for the Docker Compose environment */
    public DockerComposeEnvironmentResource configureDashboard(AspireAction1<DockerComposeAspireDashboardResource> configure) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        var configureId = getClient().registerCallback(args -> {
            var obj = (DockerComposeAspireDashboardResource) args[0];
            configure.invoke(obj);
            return null;
        });
        if (configureId != null) {
        ...
        return (DockerComposeEnvironmentResource) getClient().invokeCapability("Aspire.Hosting.Docker/configureDashboard", reqArgs);
    }
    ...
    public String defaultNetworkName() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Docker/DockerComposeEnvironmentResource.defaultNetworkName", reqArgs);
    }

    /** Sets the DefaultNetworkName property */
    public DockerComposeEnvironmentResource setDefaultNetworkName(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (DockerComposeEnvironmentResource) getClient().invokeCapability("Aspire.Hosting.Docker/DockerComposeEnvironmentResource.setDefaultNetworkName", reqArgs);
    }
    ...
    public boolean dashboardEnabled() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (boolean) getClient().invokeCapability("Aspire.Hosting.Docker/DockerComposeEnvironmentResource.dashboardEnabled", reqArgs);
    }

    /** Sets the DashboardEnabled property */
    public DockerComposeEnvironmentResource setDashboardEnabled(boolean value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (DockerComposeEnvironmentResource) getClient().invokeCapability("Aspire.Hosting.Docker/DockerComposeEnvironmentResource.setDashboardEnabled", reqArgs);
    }
    ...
    public String name() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Docker/DockerComposeEnvironmentResource.name", reqArgs);
    }

}

/** Wrapper for Aspire.Hosting.Docker/Aspire.Hosting.Docker.DockerComposeServiceResource. */
class DockerComposeServiceResource extends ResourceBuilderBase {
    DockerComposeServiceResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public DockerComposeEnvironmentResource parent() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (DockerComposeEnvironmentResource) getClient().invokeCapability("Aspire.Hosting.Docker/DockerComposeServiceResource.parent", reqArgs);
    }
    ...
    public String name() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Docker/DockerComposeServiceResource.name", reqArgs);
    }
...
class IDistributedApplicationBuilder extends HandleWrapperBase {
    ...
    public DockerComposeEnvironmentResource addDockerComposeEnvironment(String name) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        return (DockerComposeEnvironmentResource) getClient().invokeCapability("Aspire.Hosting.Docker/addDockerComposeEnvironment", reqArgs);
    }
...
/** Wrapper for Aspire.Hosting.Docker/Aspire.Hosting.Docker.Resources.ComposeNodes.Service. */
class Service extends HandleWrapperBase {
    Service(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public String image() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.image", reqArgs);
    }

    /** Sets the Image property */
    public Service setImage(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (Service) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.setImage", reqArgs);
    }
    ...
    public String pullPolicy() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.pullPolicy", reqArgs);
    }

    /** Sets the PullPolicy property */
    public Service setPullPolicy(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (Service) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.setPullPolicy", reqArgs);
    }
    ...
    public String containerName() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.containerName", reqArgs);
    }

    /** Sets the ContainerName property */
    public Service setContainerName(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (Service) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.setContainerName", reqArgs);
    }

    /** Gets the Command property */
    private AspireList<String> commandField;
    public AspireList<String> command() {
        if (commandField == null) {
            commandField = new AspireList<>(getHandle(), getClient(), "Aspire.Hosting.Docker.Resources.ComposeNodes/Service.command");
        }
        return commandField;
    }

    /** Sets the Command property */
    public Service setCommand(AspireList<String> value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (Service) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.setCommand", reqArgs);
    }

    /** Gets the Entrypoint property */
    private AspireList<String> entrypointField;
    public AspireList<String> entrypoint() {
        if (entrypointField == null) {
            entrypointField = new AspireList<>(getHandle(), getClient(), "Aspire.Hosting.Docker.Resources.ComposeNodes/Service.entrypoint");
        }
        return entrypointField;
    }

    /** Sets the Entrypoint property */
    public Service setEntrypoint(AspireList<String> value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (Service) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.setEntrypoint", reqArgs);
    }

    /** Gets the Environment property */
    private AspireDict<String, String> environmentField;
    public AspireDict<String, String> environment() {
        if (environmentField == null) {
            environmentField = new AspireDict<>(getHandle(), getClient(), "Aspire.Hosting.Docker.Resources.ComposeNodes/Service.environment");
        }
        return environmentField;
    }

    /** Sets the Environment property */
    public Service setEnvironment(AspireDict<String, String> value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (Service) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.setEnvironment", reqArgs);
    }

    /** Gets the EnvFile property */
    private AspireList<String> envFileField;
    public AspireList<String> envFile() {
        if (envFileField == null) {
            envFileField = new AspireList<>(getHandle(), getClient(), "Aspire.Hosting.Docker.Resources.ComposeNodes/Service.envFile");
        }
        return envFileField;
    }

    /** Sets the EnvFile property */
    public Service setEnvFile(AspireList<String> value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (Service) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.setEnvFile", reqArgs);
    }
    ...
    public String workingDir() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.workingDir", reqArgs);
    }

    /** Sets the WorkingDir property */
    public Service setWorkingDir(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (Service) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.setWorkingDir", reqArgs);
    }

    /** Gets the Ports property */
    private AspireList<String> portsField;
    public AspireList<String> ports() {
        if (portsField == null) {
            portsField = new AspireList<>(getHandle(), getClient(), "Aspire.Hosting.Docker.Resources.ComposeNodes/Service.ports");
        }
        return portsField;
    }

    /** Sets the Ports property */
    public Service setPorts(AspireList<String> value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (Service) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.setPorts", reqArgs);
    }

    /** Gets the Expose property */
    private AspireList<String> exposeField;
    public AspireList<String> expose() {
        if (exposeField == null) {
            exposeField = new AspireList<>(getHandle(), getClient(), "Aspire.Hosting.Docker.Resources.ComposeNodes/Service.expose");
        }
        return exposeField;
    }

    /** Sets the Expose property */
    public Service setExpose(AspireList<String> value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (Service) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.setExpose", reqArgs);
    }
    ...
    public String user() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.user", reqArgs);
    }

    /** Sets the User property */
    public Service setUser(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (Service) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.setUser", reqArgs);
    }

    /** Gets the Networks property */
    private AspireList<String> networksField;
    public AspireList<String> networks() {
        if (networksField == null) {
            networksField = new AspireList<>(getHandle(), getClient(), "Aspire.Hosting.Docker.Resources.ComposeNodes/Service.networks");
        }
        return networksField;
    }

    /** Sets the Networks property */
    public Service setNetworks(AspireList<String> value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (Service) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.setNetworks", reqArgs);
    }
    ...
    public String restart() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.restart", reqArgs);
    }

    /** Sets the Restart property */
    public Service setRestart(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (Service) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.setRestart", reqArgs);
    }

    /** Gets the Labels property */
    private AspireDict<String, String> labelsField;
    public AspireDict<String, String> labels() {
        if (labelsField == null) {
            labelsField = new AspireDict<>(getHandle(), getClient(), "Aspire.Hosting.Docker.Resources.ComposeNodes/Service.labels");
        }
        return labelsField;
    }

    /** Sets the Labels property */
    public Service setLabels(AspireDict<String, String> value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (Service) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.setLabels", reqArgs);
    }
    ...
    public String domainName() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.domainName", reqArgs);
    }

    /** Sets the DomainName property */
    public Service setDomainName(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (Service) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.setDomainName", reqArgs);
    }
    ...
    public String hostname() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.hostname", reqArgs);
    }

    /** Sets the Hostname property */
    public Service setHostname(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (Service) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.setHostname", reqArgs);
    }
    ...
    public String isolation() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.isolation", reqArgs);
    }

    /** Sets the Isolation property */
    public Service setIsolation(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (Service) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.setIsolation", reqArgs);
    }
    ...
    public String ipc() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.ipc", reqArgs);
    }

    /** Sets the Ipc property */
    public Service setIpc(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (Service) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.setIpc", reqArgs);
    }
    ...
    public String macAddress() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.macAddress", reqArgs);
    }

    /** Sets the MacAddress property */
    public Service setMacAddress(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (Service) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.setMacAddress", reqArgs);
    }
    ...
    public String pid() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.pid", reqArgs);
    }

    /** Sets the Pid property */
    public Service setPid(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (Service) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.setPid", reqArgs);
    }

    /** Gets the CapAdd property */
    private AspireList<String> capAddField;
    public AspireList<String> capAdd() {
        if (capAddField == null) {
            capAddField = new AspireList<>(getHandle(), getClient(), "Aspire.Hosting.Docker.Resources.ComposeNodes/Service.capAdd");
        }
        return capAddField;
    }

    /** Sets the CapAdd property */
    public Service setCapAdd(AspireList<String> value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (Service) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.setCapAdd", reqArgs);
    }

    /** Gets the CapDrop property */
    private AspireList<String> capDropField;
    public AspireList<String> capDrop() {
        if (capDropField == null) {
            capDropField = new AspireList<>(getHandle(), getClient(), "Aspire.Hosting.Docker.Resources.ComposeNodes/Service.capDrop");
        }
        return capDropField;
    }

    /** Sets the CapDrop property */
    public Service setCapDrop(AspireList<String> value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (Service) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.setCapDrop", reqArgs);
    }
    ...
    public String cgroupParent() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.cgroupParent", reqArgs);
    }

    /** Sets the CgroupParent property */
    public Service setCgroupParent(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (Service) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.setCgroupParent", reqArgs);
    }

    /** Gets the Devices property */
    private AspireList<String> devicesField;
    public AspireList<String> devices() {
        if (devicesField == null) {
            devicesField = new AspireList<>(getHandle(), getClient(), "Aspire.Hosting.Docker.Resources.ComposeNodes/Service.devices");
        }
        return devicesField;
    }

    /** Sets the Devices property */
    public Service setDevices(AspireList<String> value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (Service) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.setDevices", reqArgs);
    }

    /** Gets the Dns property */
    private AspireList<String> dnsField;
    public AspireList<String> dns() {
        if (dnsField == null) {
            dnsField = new AspireList<>(getHandle(), getClient(), "Aspire.Hosting.Docker.Resources.ComposeNodes/Service.dns");
        }
        return dnsField;
    }

    /** Sets the Dns property */
    public Service setDns(AspireList<String> value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (Service) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.setDns", reqArgs);
    }

    /** Gets the DnsSearch property */
    private AspireList<String> dnsSearchField;
    public AspireList<String> dnsSearch() {
        if (dnsSearchField == null) {
            dnsSearchField = new AspireList<>(getHandle(), getClient(), "Aspire.Hosting.Docker.Resources.ComposeNodes/Service.dnsSearch");
        }
        return dnsSearchField;
    }

    /** Sets the DnsSearch property */
    public Service setDnsSearch(AspireList<String> value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (Service) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.setDnsSearch", reqArgs);
    }

    /** Gets the ExtraHosts property */
    private AspireDict<String, String> extraHostsField;
    public AspireDict<String, String> extraHosts() {
        if (extraHostsField == null) {
            extraHostsField = new AspireDict<>(getHandle(), getClient(), "Aspire.Hosting.Docker.Resources.ComposeNodes/Service.extraHosts");
        }
        return extraHostsField;
    }

    /** Sets the ExtraHosts property */
    public Service setExtraHosts(AspireDict<String, String> value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (Service) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.setExtraHosts", reqArgs);
    }

    /** Gets the GroupAdd property */
    private AspireList<String> groupAddField;
    public AspireList<String> groupAdd() {
        if (groupAddField == null) {
            groupAddField = new AspireList<>(getHandle(), getClient(), "Aspire.Hosting.Docker.Resources.ComposeNodes/Service.groupAdd");
        }
        return groupAddField;
    }

    /** Sets the GroupAdd property */
    public Service setGroupAdd(AspireList<String> value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (Service) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.setGroupAdd", reqArgs);
    }
    ...
    public boolean init() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (boolean) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.init", reqArgs);
    }

    /** Sets the Init property */
    public Service setInit(boolean value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (Service) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.setInit", reqArgs);
    }

    /** Gets the Links property */
    private AspireList<String> linksField;
    public AspireList<String> links() {
        if (linksField == null) {
            linksField = new AspireList<>(getHandle(), getClient(), "Aspire.Hosting.Docker.Resources.ComposeNodes/Service.links");
        }
        return linksField;
    }

    /** Sets the Links property */
    public Service setLinks(AspireList<String> value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (Service) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.setLinks", reqArgs);
    }

    /** Gets the ExternalLinks property */
    private AspireList<String> externalLinksField;
    public AspireList<String> externalLinks() {
        if (externalLinksField == null) {
            externalLinksField = new AspireList<>(getHandle(), getClient(), "Aspire.Hosting.Docker.Resources.ComposeNodes/Service.externalLinks");
        }
        return externalLinksField;
    }

    /** Sets the ExternalLinks property */
    public Service setExternalLinks(AspireList<String> value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (Service) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.setExternalLinks", reqArgs);
    }
    ...
    public String networkMode() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.networkMode", reqArgs);
    }

    /** Sets the NetworkMode property */
    public Service setNetworkMode(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (Service) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.setNetworkMode", reqArgs);
    }

    /** Gets the Profiles property */
    private AspireList<String> profilesField;
    public AspireList<String> profiles() {
        if (profilesField == null) {
            profilesField = new AspireList<>(getHandle(), getClient(), "Aspire.Hosting.Docker.Resources.ComposeNodes/Service.profiles");
        }
        return profilesField;
    }

    /** Sets the Profiles property */
    public Service setProfiles(AspireList<String> value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (Service) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.setProfiles", reqArgs);
    }
    ...
    public boolean readOnly() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (boolean) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.readOnly", reqArgs);
    }

    /** Sets the ReadOnly property */
    public Service setReadOnly(boolean value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (Service) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.setReadOnly", reqArgs);
    }

    /** Gets the SecurityOpt property */
    private AspireList<String> securityOptField;
    public AspireList<String> securityOpt() {
        if (securityOptField == null) {
            securityOptField = new AspireList<>(getHandle(), getClient(), "Aspire.Hosting.Docker.Resources.ComposeNodes/Service.securityOpt");
        }
        return securityOptField;
    }

    /** Sets the SecurityOpt property */
    public Service setSecurityOpt(AspireList<String> value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (Service) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.setSecurityOpt", reqArgs);
    }
    ...
    public String stopGracePeriod() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.stopGracePeriod", reqArgs);
    }

    /** Sets the StopGracePeriod property */
    public Service setStopGracePeriod(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (Service) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.setStopGracePeriod", reqArgs);
    }
    ...
    public String stopSignal() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.stopSignal", reqArgs);
    }

    /** Sets the StopSignal property */
    public Service setStopSignal(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (Service) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.setStopSignal", reqArgs);
    }

    /** Gets the Sysctls property */
    private AspireDict<String, String> sysctlsField;
    public AspireDict<String, String> sysctls() {
        if (sysctlsField == null) {
            sysctlsField = new AspireDict<>(getHandle(), getClient(), "Aspire.Hosting.Docker.Resources.ComposeNodes/Service.sysctls");
        }
        return sysctlsField;
    }

    /** Sets the Sysctls property */
    public Service setSysctls(AspireDict<String, String> value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (Service) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.setSysctls", reqArgs);
    }

    /** Gets the Tmpfs property */
    private AspireList<String> tmpfsField;
    public AspireList<String> tmpfs() {
        if (tmpfsField == null) {
            tmpfsField = new AspireList<>(getHandle(), getClient(), "Aspire.Hosting.Docker.Resources.ComposeNodes/Service.tmpfs");
        }
        return tmpfsField;
    }

    /** Sets the Tmpfs property */
    public Service setTmpfs(AspireList<String> value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (Service) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.setTmpfs", reqArgs);
    }
    ...
    public boolean stdinOpen() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (boolean) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.stdinOpen", reqArgs);
    }

    /** Sets the StdinOpen property */
    public Service setStdinOpen(boolean value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (Service) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.setStdinOpen", reqArgs);
    }
    ...
    public boolean tty() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (boolean) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.tty", reqArgs);
    }

    /** Sets the Tty property */
    public Service setTty(boolean value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (Service) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.setTty", reqArgs);
    }
    ...
    public String name() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.name", reqArgs);
    }

    /** Sets the Name property */
    public Service setName(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (Service) getClient().invokeCapability("Aspire.Hosting.Docker.Resources.ComposeNodes/Service.setName", reqArgs);
    }
...
class AspireRegistrations {
    static {
        ...
        AspireClient.registerHandleWrapper("Aspire.Hosting.Docker/Aspire.Hosting.Docker.DockerComposeAspireDashboardResource", (h, c) -> new DockerComposeAspireDashboardResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Docker/Aspire.Hosting.Docker.DockerComposeEnvironmentResource", (h, c) -> new DockerComposeEnvironmentResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Docker/Aspire.Hosting.Docker.DockerComposeServiceResource", (h, c) -> new DockerComposeServiceResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Docker/Aspire.Hosting.Docker.Resources.ComposeNodes.Service", (h, c) -> new Service(h, c));
