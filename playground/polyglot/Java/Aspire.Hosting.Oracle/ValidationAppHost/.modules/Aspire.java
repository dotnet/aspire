...
/** Options for AddOracle. */
final class AddOracleOptions {
    private ParameterResource password;
    private Double port;

    public ParameterResource getPassword() { return password; }
    public AddOracleOptions password(ParameterResource value) {
        this.password = value;
        return this;
    }

    public Double getPort() { return port; }
    public AddOracleOptions port(Double value) {
        this.port = value;
        return this;
    }
...
class IDistributedApplicationBuilder extends HandleWrapperBase {
    ...
    public OracleDatabaseServerResource addOracle(String name, AddOracleOptions options) {
        var password = options == null ? null : options.getPassword();
        var port = options == null ? null : options.getPort();
        return addOracleImpl(name, password, port);
    }

    public OracleDatabaseServerResource addOracle(String name) {
        return addOracle(name, null);
    }

    /** Adds an Oracle server resource to the distributed application model. */
    private OracleDatabaseServerResource addOracleImpl(String name, ParameterResource password, Double port) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        if (password != null) {
        ...
        return (OracleDatabaseServerResource) getClient().invokeCapability("Aspire.Hosting.Oracle/addOracle", reqArgs);
    }
...
/** Wrapper for Aspire.Hosting.Oracle/Aspire.Hosting.ApplicationModel.OracleDatabaseResource. */
class OracleDatabaseResource extends ResourceBuilderBase {
    OracleDatabaseResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public OracleDatabaseServerResource parent() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (OracleDatabaseServerResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/OracleDatabaseResource.parent", reqArgs);
    }
    ...
    public ReferenceExpression connectionStringExpression() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/OracleDatabaseResource.connectionStringExpression", reqArgs);
    }
    ...
    public ReferenceExpression uriExpression() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/OracleDatabaseResource.uriExpression", reqArgs);
    }
    ...
    public ReferenceExpression jdbcConnectionString() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/OracleDatabaseResource.jdbcConnectionString", reqArgs);
    }
    ...
    public String databaseName() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/OracleDatabaseResource.databaseName", reqArgs);
    }
    ...
    public String name() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/OracleDatabaseResource.name", reqArgs);
    }

}

/** Wrapper for Aspire.Hosting.Oracle/Aspire.Hosting.ApplicationModel.OracleDatabaseServerResource. */
class OracleDatabaseServerResource extends ResourceBuilderBase {
    OracleDatabaseServerResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public OracleDatabaseResource addDatabase(String name) {
        return addDatabase(name, null);
    }

    /** Adds an Oracle database resource to an Oracle server resource. */
    public OracleDatabaseResource addDatabase(String name, String databaseName) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        ...
        return (OracleDatabaseResource) getClient().invokeCapability("Aspire.Hosting.Oracle/addDatabase", reqArgs);
    }

    public OracleDatabaseServerResource withDataVolume() {
        return withDataVolume(null);
    }

    /** Adds a persistent data volume to the Oracle server resource. */
    public OracleDatabaseServerResource withDataVolume(String name) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        if (name != null) {
            reqArgs.put("name", AspireClient.serializeValue(name));
        }
        return (OracleDatabaseServerResource) getClient().invokeCapability("Aspire.Hosting.Oracle/withDataVolume", reqArgs);
    }

    /** Mounts a host directory as the Oracle data directory. */
    public OracleDatabaseServerResource withDataBindMount(String source) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("source", AspireClient.serializeValue(source));
        return (OracleDatabaseServerResource) getClient().invokeCapability("Aspire.Hosting.Oracle/withDataBindMount", reqArgs);
    }

    /** Copies initialization files into the Oracle container. */
    public OracleDatabaseServerResource withInitFiles(String source) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("source", AspireClient.serializeValue(source));
        return (OracleDatabaseServerResource) getClient().invokeCapability("Aspire.Hosting.Oracle/withInitFiles", reqArgs);
    }

    /** Mounts a host directory as the Oracle DB setup directory. */
    public OracleDatabaseServerResource withDbSetupBindMount(String source) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("source", AspireClient.serializeValue(source));
        return (OracleDatabaseServerResource) getClient().invokeCapability("Aspire.Hosting.Oracle/withDbSetupBindMount", reqArgs);
    }
    ...
    public EndpointReference primaryEndpoint() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (EndpointReference) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/OracleDatabaseServerResource.primaryEndpoint", reqArgs);
    }
    ...
    public EndpointReferenceExpression host() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (EndpointReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/OracleDatabaseServerResource.host", reqArgs);
    }
    ...
    public EndpointReferenceExpression port() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (EndpointReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/OracleDatabaseServerResource.port", reqArgs);
    }
    ...
    public ParameterResource passwordParameter() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ParameterResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/OracleDatabaseServerResource.passwordParameter", reqArgs);
    }
    ...
    public ReferenceExpression connectionStringExpression() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/OracleDatabaseServerResource.connectionStringExpression", reqArgs);
    }
    ...
    public ReferenceExpression userNameReference() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/OracleDatabaseServerResource.userNameReference", reqArgs);
    }
    ...
    public ReferenceExpression uriExpression() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/OracleDatabaseServerResource.uriExpression", reqArgs);
    }
    ...
    public ReferenceExpression jdbcConnectionString() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/OracleDatabaseServerResource.jdbcConnectionString", reqArgs);
    }
    ...
    public AspireDict<String, String> databases() {
        if (databasesField == null) {
            databasesField = new AspireDict<>(getHandle(), getClient(), "Aspire.Hosting.ApplicationModel/OracleDatabaseServerResource.databases");
        }
    ...
    public String entrypoint() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/OracleDatabaseServerResource.entrypoint", reqArgs);
    }

    /** Sets the Entrypoint property */
    public OracleDatabaseServerResource setEntrypoint(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (OracleDatabaseServerResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/OracleDatabaseServerResource.setEntrypoint", reqArgs);
    }
    ...
    public boolean shellExecution() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (boolean) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/OracleDatabaseServerResource.shellExecution", reqArgs);
    }

    /** Sets the ShellExecution property */
    public OracleDatabaseServerResource setShellExecution(boolean value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (OracleDatabaseServerResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/OracleDatabaseServerResource.setShellExecution", reqArgs);
    }
    ...
    public String name() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/OracleDatabaseServerResource.name", reqArgs);
    }
...
class AspireRegistrations {
    static {
        ...
        AspireClient.registerHandleWrapper("Aspire.Hosting.Oracle/Aspire.Hosting.ApplicationModel.OracleDatabaseResource", (h, c) -> new OracleDatabaseResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Oracle/Aspire.Hosting.ApplicationModel.OracleDatabaseServerResource", (h, c) -> new OracleDatabaseServerResource(h, c));
