...
/** Options for AddQdrant. */
final class AddQdrantOptions {
    ...
    public AddQdrantOptions apiKey(ParameterResource value) {
        this.apiKey = value;
        return this;
    }

    public Double getGrpcPort() { return grpcPort; }
    public AddQdrantOptions grpcPort(Double value) {
        this.grpcPort = value;
        return this;
    }

    public Double getHttpPort() { return httpPort; }
    public AddQdrantOptions httpPort(Double value) {
        this.httpPort = value;
        return this;
    }
...
class IDistributedApplicationBuilder extends HandleWrapperBase {
    ...
    public QdrantServerResource addQdrant(String name, AddQdrantOptions options) {
        var apiKey = options == null ? null : options.getApiKey();
        var grpcPort = options == null ? null : options.getGrpcPort();
        var httpPort = options == null ? null : options.getHttpPort();
        return addQdrantImpl(name, apiKey, grpcPort, httpPort);
    }

    public QdrantServerResource addQdrant(String name) {
        return addQdrant(name, null);
    }

    /** Adds a Qdrant resource to the application. A container is used for local development. */
    private QdrantServerResource addQdrantImpl(String name, ParameterResource apiKey, Double grpcPort, Double httpPort) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        if (apiKey != null) {
        ...
        if (httpPort != null) {
            reqArgs.put("httpPort", AspireClient.serializeValue(httpPort));
        }
        return (QdrantServerResource) getClient().invokeCapability("Aspire.Hosting.Qdrant/addQdrant", reqArgs);
    }
...
/** Wrapper for Aspire.Hosting.Qdrant/Aspire.Hosting.ApplicationModel.QdrantServerResource. */
class QdrantServerResource extends ResourceBuilderBase {
    QdrantServerResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public QdrantServerResource withDataVolume(WithDataVolumeOptions options) {
        var name = options == null ? null : options.getName();
        var isReadOnly = options == null ? null : options.isReadOnly();
        return withDataVolumeImpl(name, isReadOnly);
    }

    public QdrantServerResource withDataVolume() {
        return withDataVolume(null);
    }

    /** Adds a named volume for the data folder to a Qdrant container resource. */
    private QdrantServerResource withDataVolumeImpl(String name, Boolean isReadOnly) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        if (name != null) {
            reqArgs.put("name", AspireClient.serializeValue(name));
        ...
        return (QdrantServerResource) getClient().invokeCapability("Aspire.Hosting.Qdrant/withDataVolume", reqArgs);
    }

    public QdrantServerResource withDataBindMount(String source) {
        return withDataBindMount(source, null);
    }

    /** Adds a bind mount for the data folder to a Qdrant container resource. */
    public QdrantServerResource withDataBindMount(String source, Boolean isReadOnly) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("source", AspireClient.serializeValue(source));
        if (isReadOnly != null) {
        ...
        return (QdrantServerResource) getClient().invokeCapability("Aspire.Hosting.Qdrant/withDataBindMount", reqArgs);
    }
    ...
    public ParameterResource apiKeyParameter() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ParameterResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/QdrantServerResource.apiKeyParameter", reqArgs);
    }
    ...
    public EndpointReference primaryEndpoint() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (EndpointReference) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/QdrantServerResource.primaryEndpoint", reqArgs);
    }

    /** Gets the GrpcHost property */
    public EndpointReferenceExpression grpcHost() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (EndpointReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/QdrantServerResource.grpcHost", reqArgs);
    }

    /** Gets the GrpcPort property */
    public EndpointReferenceExpression grpcPort() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (EndpointReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/QdrantServerResource.grpcPort", reqArgs);
    }
    ...
    public EndpointReference httpEndpoint() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (EndpointReference) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/QdrantServerResource.httpEndpoint", reqArgs);
    }
    ...
    public EndpointReferenceExpression httpHost() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (EndpointReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/QdrantServerResource.httpHost", reqArgs);
    }
    ...
    public EndpointReferenceExpression httpPort() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (EndpointReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/QdrantServerResource.httpPort", reqArgs);
    }
    ...
    public ReferenceExpression connectionStringExpression() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/QdrantServerResource.connectionStringExpression", reqArgs);
    }
    ...
    public ReferenceExpression uriExpression() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/QdrantServerResource.uriExpression", reqArgs);
    }
    ...
    public ReferenceExpression httpConnectionStringExpression() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/QdrantServerResource.httpConnectionStringExpression", reqArgs);
    }

    /** Gets the HttpUriExpression property */
    public ReferenceExpression httpUriExpression() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (ReferenceExpression) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/QdrantServerResource.httpUriExpression", reqArgs);
    }
    ...
    public String entrypoint() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/QdrantServerResource.entrypoint", reqArgs);
    }

    /** Sets the Entrypoint property */
    public QdrantServerResource setEntrypoint(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (QdrantServerResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/QdrantServerResource.setEntrypoint", reqArgs);
    }
    ...
    public boolean shellExecution() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (boolean) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/QdrantServerResource.shellExecution", reqArgs);
    }

    /** Sets the ShellExecution property */
    public QdrantServerResource setShellExecution(boolean value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (QdrantServerResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/QdrantServerResource.setShellExecution", reqArgs);
    }
    ...
    public String name() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/QdrantServerResource.name", reqArgs);
    }
...
class AspireRegistrations {
    static {
        ...
        AspireClient.registerHandleWrapper("Aspire.Hosting.Qdrant/Aspire.Hosting.ApplicationModel.QdrantServerResource", (h, c) -> new QdrantServerResource(h, c));
