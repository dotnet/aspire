...
/** AzureOpenAIRole enum. */
enum AzureOpenAIRole implements WireValueEnum {
    COGNITIVE_SERVICES_OPEN_AICONTRIBUTOR("CognitiveServicesOpenAIContributor"),
    COGNITIVE_SERVICES_OPEN_AIUSER("CognitiveServicesOpenAIUser"),
    COGNITIVE_SERVICES_USER("CognitiveServicesUser");

    private final String value;

    AzureOpenAIRole(String value) {
        this.value = value;
    }

    public String getValue() { return value; }

    public static AzureOpenAIRole fromValue(String value) {
        for (AzureOpenAIRole e : values()) {
            if (e.value.equals(value)) return e;
        }
        throw new IllegalArgumentException("Unknown value: " + value);
    }
...
class AzureBicepResource extends ResourceBuilderBase {
    ...
    public IResource withCognitiveServicesRoleAssignments(AzureOpenAIResource target, AzureOpenAIRole[] roles) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("target", AspireClient.serializeValue(target));
        reqArgs.put("roles", AspireClient.serializeValue(roles));
        return (IResource) getClient().invokeCapability("Aspire.Hosting.Azure.CognitiveServices/withCognitiveServicesRoleAssignments", reqArgs);
    }
...
/** Wrapper for Aspire.Hosting.Azure.CognitiveServices/Aspire.Hosting.ApplicationModel.AzureOpenAIDeploymentResource. */
class AzureOpenAIDeploymentResource extends ResourceBuilderBase {
    AzureOpenAIDeploymentResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public AzureOpenAIDeploymentResource withProperties(AspireAction1<AzureOpenAIDeploymentResource> configure) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        var configureId = getClient().registerCallback(args -> {
            var obj = (AzureOpenAIDeploymentResource) args[0];
        ...
        return (AzureOpenAIDeploymentResource) getClient().invokeCapability("Aspire.Hosting.Azure.CognitiveServices/withProperties", reqArgs);
    }
    ...
    public String deploymentName() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/AzureOpenAIDeploymentResource.deploymentName", reqArgs);
    }

    /** Sets the DeploymentName property */
    public AzureOpenAIDeploymentResource setDeploymentName(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (AzureOpenAIDeploymentResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/AzureOpenAIDeploymentResource.setDeploymentName", reqArgs);
    }
    ...
    public String modelName() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/AzureOpenAIDeploymentResource.modelName", reqArgs);
    }

    /** Sets the ModelName property */
    public AzureOpenAIDeploymentResource setModelName(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (AzureOpenAIDeploymentResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/AzureOpenAIDeploymentResource.setModelName", reqArgs);
    }
    ...
    public String modelVersion() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/AzureOpenAIDeploymentResource.modelVersion", reqArgs);
    }

    /** Sets the ModelVersion property */
    public AzureOpenAIDeploymentResource setModelVersion(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (AzureOpenAIDeploymentResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/AzureOpenAIDeploymentResource.setModelVersion", reqArgs);
    }
    ...
    public String skuName() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/AzureOpenAIDeploymentResource.skuName", reqArgs);
    }

    /** Sets the SkuName property */
    public AzureOpenAIDeploymentResource setSkuName(String value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (AzureOpenAIDeploymentResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/AzureOpenAIDeploymentResource.setSkuName", reqArgs);
    }

    /** Gets the SkuCapacity property */
    public double skuCapacity() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (double) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/AzureOpenAIDeploymentResource.skuCapacity", reqArgs);
    }

    /** Sets the SkuCapacity property */
    public AzureOpenAIDeploymentResource setSkuCapacity(double value) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        reqArgs.put("value", AspireClient.serializeValue(value));
        return (AzureOpenAIDeploymentResource) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/AzureOpenAIDeploymentResource.setSkuCapacity", reqArgs);
    }
    ...
    public String name() {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("context", AspireClient.serializeValue(getHandle()));
        return (String) getClient().invokeCapability("Aspire.Hosting.ApplicationModel/AzureOpenAIDeploymentResource.name", reqArgs);
    }

}

/** Wrapper for Aspire.Hosting.Azure.CognitiveServices/Aspire.Hosting.ApplicationModel.AzureOpenAIResource. */
class AzureOpenAIResource extends ResourceBuilderBase {
    AzureOpenAIResource(Handle handle, AspireClient client) {
        super(handle, client);
    }
    ...
    public AzureOpenAIDeploymentResource addDeployment(String name, String modelName, String modelVersion) {
        Map<String, Object> reqArgs = new HashMap<>();
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        reqArgs.put("modelName", AspireClient.serializeValue(modelName));
        reqArgs.put("modelVersion", AspireClient.serializeValue(modelVersion));
        return (AzureOpenAIDeploymentResource) getClient().invokeCapability("Aspire.Hosting.Azure.CognitiveServices/addDeployment", reqArgs);
    }
...
class IDistributedApplicationBuilder extends HandleWrapperBase {
    ...
    public AzureOpenAIResource addAzureOpenAI(String name) {
        ...
        reqArgs.put("builder", AspireClient.serializeValue(getHandle()));
        reqArgs.put("name", AspireClient.serializeValue(name));
        return (AzureOpenAIResource) getClient().invokeCapability("Aspire.Hosting.Azure.CognitiveServices/addAzureOpenAI", reqArgs);
    }
...
class AspireRegistrations {
    static {
        ...
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure.CognitiveServices/Aspire.Hosting.ApplicationModel.AzureOpenAIDeploymentResource", (h, c) -> new AzureOpenAIDeploymentResource(h, c));
        AspireClient.registerHandleWrapper("Aspire.Hosting.Azure.CognitiveServices/Aspire.Hosting.ApplicationModel.AzureOpenAIResource", (h, c) -> new AzureOpenAIResource(h, c));
