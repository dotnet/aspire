...
/** Handle to AzureApplicationInsightsResource */
type AzureApplicationInsightsResourceHandle = Handle<'Aspire.Hosting.Azure.ApplicationInsights/Aspire.Hosting.Azure.AzureApplicationInsightsResource'>;

/** Handle to AzureAppServiceEnvironmentResource */
type AzureAppServiceEnvironmentResourceHandle = Handle<'Aspire.Hosting.Azure.AppService/Aspire.Hosting.Azure.AzureAppServiceEnvironmentResource'>;
...
/** Handle to WebSite */
type WebSiteHandle = Handle<'Azure.Provisioning.AppService/Azure.Provisioning.AppService.WebSite'>;

/** Handle to WebSiteSlot */
type WebSiteSlotHandle = Handle<'Azure.Provisioning.AppService/Azure.Provisioning.AppService.WebSiteSlot'>;
...
export interface PublishAsAzureAppServiceWebsiteOptions {
    configure?: (arg1: AzureResourceInfrastructure, arg2: WebSiteHandle) => Promise<void>;
    configureSlot?: (arg1: AzureResourceInfrastructure, arg2: WebSiteSlotHandle) => Promise<void>;
}
...
export class DistributedApplicationBuilder {
    ...
    /** @internal */
    async _addAzureAppServiceEnvironmentInternal(name: string): Promise<AzureAppServiceEnvironmentResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name };
        const result = await this._client.invokeCapability<AzureAppServiceEnvironmentResourceHandle>(
            'Aspire.Hosting.Azure.AppService/addAzureAppServiceEnvironment',
            rpcArgs
        );
        return new AzureAppServiceEnvironmentResource(result, this._client);
    }

    addAzureAppServiceEnvironment(name: string): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._addAzureAppServiceEnvironmentInternal(name));
    }
    ...
    /** @internal */
    async _addAzureApplicationInsightsInternal(name: string): Promise<AzureApplicationInsightsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name };
        const result = await this._client.invokeCapability<AzureApplicationInsightsResourceHandle>(
            'Aspire.Hosting.Azure.ApplicationInsights/addAzureApplicationInsights',
            rpcArgs
        );
        return new AzureApplicationInsightsResource(result, this._client);
    }

    addAzureApplicationInsights(name: string): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._addAzureApplicationInsightsInternal(name));
    }
...
export class DistributedApplicationBuilderPromise implements PromiseLike<DistributedApplicationBuilder> {
    ...
    /** Adds an Azure App Service environment resource */
    addAzureAppServiceEnvironment(name: string): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._promise.then(obj => obj.addAzureAppServiceEnvironment(name)));
    }
    ...
    /** Adds an Azure Application Insights resource */
    addAzureApplicationInsights(name: string): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._promise.then(obj => obj.addAzureApplicationInsights(name)));
    }
...
export class AzureApplicationInsightsResource extends ResourceBuilderBase<AzureApplicationInsightsResourceHandle> {
    constructor(handle: AzureApplicationInsightsResourceHandle, client: AspireClientRpc) {
        super(handle, client);
    }

    /** @internal */
    private async _withUrlsCallbackInternal(callback: (obj: ResourceUrlsCallbackContext) => Promise<void>): Promise<AzureApplicationInsightsResource> {
    ...
    withUrlsCallback(callback: (obj: ResourceUrlsCallbackContext) => Promise<void>): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._withUrlsCallbackInternal(callback));
    }

    /** @internal */
    private async _withUrlsCallbackAsyncInternal(callback: (arg: ResourceUrlsCallbackContext) => Promise<void>): Promise<AzureApplicationInsightsResource> {
    ...
    withUrlsCallbackAsync(callback: (arg: ResourceUrlsCallbackContext) => Promise<void>): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._withUrlsCallbackAsyncInternal(callback));
    }

    /** @internal */
    private async _withUrlInternal(url: string, displayText?: string): Promise<AzureApplicationInsightsResource> {
    ...
    withUrl(url: string, options?: WithUrlOptions): AzureApplicationInsightsResourcePromise {
        const displayText = options?.displayText;
        return new AzureApplicationInsightsResourcePromise(this._withUrlInternal(url, displayText));
    }

    /** @internal */
    private async _withUrlExpressionInternal(url: ReferenceExpression, displayText?: string): Promise<AzureApplicationInsightsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, url };
        if (displayText !== undefined) rpcArgs.displayText = displayText;
        const result = await this._client.invokeCapability<AzureApplicationInsightsResourceHandle>(
    ...
    withUrlExpression(url: ReferenceExpression, options?: WithUrlExpressionOptions): AzureApplicationInsightsResourcePromise {
        const displayText = options?.displayText;
        return new AzureApplicationInsightsResourcePromise(this._withUrlExpressionInternal(url, displayText));
    }

    /** @internal */
    private async _withUrlForEndpointInternal(endpointName: string, callback: (obj: ResourceUrlAnnotation) => Promise<void>): Promise<AzureApplicationInsightsResource> {
        const callbackId = registerCallback(async (objData: unknown) => {
    ...
    withUrlForEndpoint(endpointName: string, callback: (obj: ResourceUrlAnnotation) => Promise<void>): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._withUrlForEndpointInternal(endpointName, callback));
    }

    /** @internal */
    private async _withExplicitStartInternal(): Promise<AzureApplicationInsightsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<AzureApplicationInsightsResourceHandle>(
    ...
    withExplicitStart(): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._withExplicitStartInternal());
    }

    /** @internal */
    private async _withHealthCheckInternal(key: string): Promise<AzureApplicationInsightsResource> {
    ...
    withHealthCheck(key: string): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._withHealthCheckInternal(key));
    }

    /** @internal */
    private async _withCommandInternal(name: string, displayName: string, executeCommand: (arg: ExecuteCommandContext) => Promise<ExecuteCommandResult>, commandOptions?: CommandOptions): Promise<AzureApplicationInsightsResource> {
    ...
    withCommand(name: string, displayName: string, executeCommand: (arg: ExecuteCommandContext) => Promise<ExecuteCommandResult>, options?: WithCommandOptions): AzureApplicationInsightsResourcePromise {
        const commandOptions = options?.commandOptions;
        return new AzureApplicationInsightsResourcePromise(this._withCommandInternal(name, displayName, executeCommand, commandOptions));
    }

    /** @internal */
    private async _withParentRelationshipInternal(parent: ResourceBuilderBase): Promise<AzureApplicationInsightsResource> {
    ...
    /** @internal */
    private async _withParameterInternal(name: string): Promise<AzureApplicationInsightsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name };
        const result = await this._client.invokeCapability<AzureApplicationInsightsResourceHandle>(
    ...
    withParameter(name: string): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._withParameterInternal(name));
    }

    /** @internal */
    private async _withParameterStringValueInternal(name: string, value: string): Promise<AzureApplicationInsightsResource> {
    ...
    withParameterStringValue(name: string, value: string): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._withParameterStringValueInternal(name, value));
    }

    /** @internal */
    private async _withParameterStringValuesInternal(name: string, value: string[]): Promise<AzureApplicationInsightsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, value };
        const result = await this._client.invokeCapability<AzureApplicationInsightsResourceHandle>(
    ...
    withParameterStringValues(name: string, value: string[]): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._withParameterStringValuesInternal(name, value));
    }

    /** @internal */
    private async _withParameterFromParameterInternal(name: string, value: ParameterResource): Promise<AzureApplicationInsightsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, value };
        const result = await this._client.invokeCapability<AzureApplicationInsightsResourceHandle>(
    ...
    withParameterFromParameter(name: string, value: ParameterResource): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._withParameterFromParameterInternal(name, value));
    }

    /** @internal */
    private async _withParameterFromConnectionStringInternal(name: string, value: ResourceBuilderBase): Promise<AzureApplicationInsightsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, value };
        const result = await this._client.invokeCapability<AzureApplicationInsightsResourceHandle>(
    ...
    withParameterFromConnectionString(name: string, value: ResourceBuilderBase): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._withParameterFromConnectionStringInternal(name, value));
    }

    /** @internal */
    private async _withParameterFromOutputInternal(name: string, value: BicepOutputReference): Promise<AzureApplicationInsightsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, value };
        const result = await this._client.invokeCapability<AzureApplicationInsightsResourceHandle>(
    ...
    withParameterFromOutput(name: string, value: BicepOutputReference): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._withParameterFromOutputInternal(name, value));
    }

    /** @internal */
    private async _withParameterFromReferenceExpressionInternal(name: string, value: ReferenceExpression): Promise<AzureApplicationInsightsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, value };
        const result = await this._client.invokeCapability<AzureApplicationInsightsResourceHandle>(
    ...
    withParameterFromReferenceExpression(name: string, value: ReferenceExpression): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._withParameterFromReferenceExpressionInternal(name, value));
    }

    /** @internal */
    private async _withParameterFromEndpointInternal(name: string, value: EndpointReference): Promise<AzureApplicationInsightsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, value };
        const result = await this._client.invokeCapability<AzureApplicationInsightsResourceHandle>(
    ...
    withParameterFromEndpoint(name: string, value: EndpointReference): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._withParameterFromEndpointInternal(name, value));
    }

    /** @internal */
    private async _configureInfrastructureInternal(configure: (obj: AzureResourceInfrastructure) => Promise<void>): Promise<AzureApplicationInsightsResource> {
    ...
    configureInfrastructure(configure: (obj: AzureResourceInfrastructure) => Promise<void>): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._configureInfrastructureInternal(configure));
    }

    /** @internal */
    private async _publishAsConnectionStringInternal(): Promise<AzureApplicationInsightsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<AzureApplicationInsightsResourceHandle>(
    ...
    publishAsConnectionString(): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._publishAsConnectionStringInternal());
    }
    ...
    /** @internal */
    private async _clearDefaultRoleAssignmentsInternal(): Promise<AzureApplicationInsightsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<AzureApplicationInsightsResourceHandle>(
    ...
    clearDefaultRoleAssignments(): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._clearDefaultRoleAssignmentsInternal());
    }
    ...
    /** @internal */
    private async _runAsExistingFromParametersInternal(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): Promise<AzureApplicationInsightsResource> {
    ...
    runAsExistingFromParameters(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._runAsExistingFromParametersInternal(nameParameter, resourceGroupParameter));
    }

    /** @internal */
    private async _runAsExistingInternal(name: string, resourceGroup: string): Promise<AzureApplicationInsightsResource> {
    ...
    runAsExisting(name: string, resourceGroup: string): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._runAsExistingInternal(name, resourceGroup));
    }

    /** @internal */
    private async _publishAsExistingFromParametersInternal(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): Promise<AzureApplicationInsightsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, nameParameter, resourceGroupParameter };
        const result = await this._client.invokeCapability<AzureApplicationInsightsResourceHandle>(
    ...
    publishAsExistingFromParameters(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._publishAsExistingFromParametersInternal(nameParameter, resourceGroupParameter));
    }

    /** @internal */
    private async _publishAsExistingInternal(name: string, resourceGroup: string): Promise<AzureApplicationInsightsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, resourceGroup };
        const result = await this._client.invokeCapability<AzureApplicationInsightsResourceHandle>(
    ...
    publishAsExisting(name: string, resourceGroup: string): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._publishAsExistingInternal(name, resourceGroup));
    }

    /** @internal */
    private async _asExistingInternal(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): Promise<AzureApplicationInsightsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, nameParameter, resourceGroupParameter };
        const result = await this._client.invokeCapability<AzureApplicationInsightsResourceHandle>(
    ...
    asExisting(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._asExistingInternal(nameParameter, resourceGroupParameter));
    }

    /** @internal */
    private async _withLogAnalyticsWorkspaceInternal(logAnalyticsWorkspace: AzureLogAnalyticsWorkspaceResource): Promise<AzureApplicationInsightsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, logAnalyticsWorkspace };
        const result = await this._client.invokeCapability<AzureApplicationInsightsResourceHandle>(
            'Aspire.Hosting.Azure.ApplicationInsights/withLogAnalyticsWorkspace',
            rpcArgs
        );
        return new AzureApplicationInsightsResource(result, this._client);
    }
    ...
    withLogAnalyticsWorkspace(logAnalyticsWorkspace: AzureLogAnalyticsWorkspaceResource): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._withLogAnalyticsWorkspaceInternal(logAnalyticsWorkspace));
    }

    /** @internal */
    private async _withAzureContainerRegistryInternal(registryBuilder: AzureContainerRegistryResource): Promise<AzureApplicationInsightsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, registryBuilder };
        const result = await this._client.invokeCapability<AzureApplicationInsightsResourceHandle>(
            'Aspire.Hosting.Azure.ContainerRegistry/withAzureContainerRegistry',
            rpcArgs
        );
        return new AzureApplicationInsightsResource(result, this._client);
    }
    ...
    withAzureContainerRegistry(registryBuilder: AzureContainerRegistryResource): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._withAzureContainerRegistryInternal(registryBuilder));
    }
 ...
 */
export class AzureApplicationInsightsResourcePromise implements PromiseLike<AzureApplicationInsightsResource> {
    constructor(private _promise: Promise<AzureApplicationInsightsResource>) {}

    then<TResult1 = AzureApplicationInsightsResource, TResult2 = never>(
        onfulfilled?: ((value: AzureApplicationInsightsResource) => TResult1 | PromiseLike<TResult1>) | null,
        onrejected?: ((reason: unknown) => TResult2 | PromiseLike<TResult2>) | null
    ): PromiseLike<TResult1 | TResult2> {
        return this._promise.then(onfulfilled, onrejected);
    }
    ...
    /** Customizes displayed URLs via callback */
    withUrlsCallback(callback: (obj: ResourceUrlsCallbackContext) => Promise<void>): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._promise.then(obj => obj.withUrlsCallback(callback)));
    }

    /** Customizes displayed URLs via async callback */
    withUrlsCallbackAsync(callback: (arg: ResourceUrlsCallbackContext) => Promise<void>): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._promise.then(obj => obj.withUrlsCallbackAsync(callback)));
    }

    /** Adds or modifies displayed URLs */
    withUrl(url: string, options?: WithUrlOptions): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._promise.then(obj => obj.withUrl(url, options)));
    }

    /** Adds a URL using a reference expression */
    withUrlExpression(url: ReferenceExpression, options?: WithUrlExpressionOptions): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._promise.then(obj => obj.withUrlExpression(url, options)));
    }

    /** Customizes the URL for a specific endpoint via callback */
    withUrlForEndpoint(endpointName: string, callback: (obj: ResourceUrlAnnotation) => Promise<void>): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._promise.then(obj => obj.withUrlForEndpoint(endpointName, callback)));
    }

    /** Prevents resource from starting automatically */
    withExplicitStart(): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._promise.then(obj => obj.withExplicitStart()));
    }

    /** Adds a health check by key */
    withHealthCheck(key: string): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._promise.then(obj => obj.withHealthCheck(key)));
    }

    /** Adds a resource command */
    withCommand(name: string, displayName: string, executeCommand: (arg: ExecuteCommandContext) => Promise<ExecuteCommandResult>, options?: WithCommandOptions): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._promise.then(obj => obj.withCommand(name, displayName, executeCommand, options)));
    }
    ...
    /** Adds a Bicep parameter without a value */
    withParameter(name: string): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._promise.then(obj => obj.withParameter(name)));
    }

    /** Adds a Bicep parameter with a string value */
    withParameterStringValue(name: string, value: string): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._promise.then(obj => obj.withParameterStringValue(name, value)));
    }

    /** Adds a Bicep parameter with a string list value */
    withParameterStringValues(name: string, value: string[]): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._promise.then(obj => obj.withParameterStringValues(name, value)));
    }

    /** Adds a Bicep parameter from a parameter resource builder */
    withParameterFromParameter(name: string, value: ParameterResource): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._promise.then(obj => obj.withParameterFromParameter(name, value)));
    }

    /** Adds a Bicep parameter from a connection string resource builder */
    withParameterFromConnectionString(name: string, value: ResourceBuilderBase): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._promise.then(obj => obj.withParameterFromConnectionString(name, value)));
    }

    /** Adds a Bicep parameter from another Bicep output reference */
    withParameterFromOutput(name: string, value: BicepOutputReference): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._promise.then(obj => obj.withParameterFromOutput(name, value)));
    }

    /** Adds a Bicep parameter from a reference expression */
    withParameterFromReferenceExpression(name: string, value: ReferenceExpression): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._promise.then(obj => obj.withParameterFromReferenceExpression(name, value)));
    }

    /** Adds a Bicep parameter from an endpoint reference */
    withParameterFromEndpoint(name: string, value: EndpointReference): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._promise.then(obj => obj.withParameterFromEndpoint(name, value)));
    }

    /** Configures the Azure provisioning infrastructure callback */
    configureInfrastructure(configure: (obj: AzureResourceInfrastructure) => Promise<void>): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._promise.then(obj => obj.configureInfrastructure(configure)));
    }

    /** Publishes an Azure resource to the manifest as a connection string */
    publishAsConnectionString(): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._promise.then(obj => obj.publishAsConnectionString()));
    }
    ...
    /** Clears the default Azure role assignments from a resource */
    clearDefaultRoleAssignments(): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._promise.then(obj => obj.clearDefaultRoleAssignments()));
    }
    ...
    /** Marks an Azure resource as existing in run mode by using parameter resources */
    runAsExistingFromParameters(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._promise.then(obj => obj.runAsExistingFromParameters(nameParameter, resourceGroupParameter)));
    }

    /** Marks an Azure resource as existing in run mode */
    runAsExisting(name: string, resourceGroup: string): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._promise.then(obj => obj.runAsExisting(name, resourceGroup)));
    }

    /** Marks an Azure resource as existing in publish mode by using parameter resources */
    publishAsExistingFromParameters(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._promise.then(obj => obj.publishAsExistingFromParameters(nameParameter, resourceGroupParameter)));
    }

    /** Marks an Azure resource as existing in publish mode */
    publishAsExisting(name: string, resourceGroup: string): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._promise.then(obj => obj.publishAsExisting(name, resourceGroup)));
    }

    /** Marks an Azure resource as existing in both run and publish modes */
    asExisting(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._promise.then(obj => obj.asExisting(nameParameter, resourceGroupParameter)));
    }

    /** Configures the Application Insights resource to use a Log Analytics Workspace */
    withLogAnalyticsWorkspace(logAnalyticsWorkspace: AzureLogAnalyticsWorkspaceResource): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._promise.then(obj => obj.withLogAnalyticsWorkspace(logAnalyticsWorkspace)));
    }

    /** Configures a compute environment resource to use an Azure Container Registry. */
    withAzureContainerRegistry(registryBuilder: AzureContainerRegistryResource): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._promise.then(obj => obj.withAzureContainerRegistry(registryBuilder)));
    }
...
export class AzureAppServiceEnvironmentResource extends ResourceBuilderBase<AzureAppServiceEnvironmentResourceHandle> {
    constructor(handle: AzureAppServiceEnvironmentResourceHandle, client: AspireClientRpc) {
        super(handle, client);
    }

    /** @internal */
    private async _withUrlsCallbackInternal(callback: (obj: ResourceUrlsCallbackContext) => Promise<void>): Promise<AzureAppServiceEnvironmentResource> {
        const callbackId = registerCallback(async (objData: unknown) => {
            const objHandle = wrapIfHandle(objData) as ResourceUrlsCallbackContextHandle;
            const obj = new ResourceUrlsCallbackContext(objHandle, this._client);
            await callback(obj);
    ...
    /** Customizes displayed URLs via callback */
    withUrlsCallback(callback: (obj: ResourceUrlsCallbackContext) => Promise<void>): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._withUrlsCallbackInternal(callback));
    }

    /** @internal */
    private async _withUrlsCallbackAsyncInternal(callback: (arg: ResourceUrlsCallbackContext) => Promise<void>): Promise<AzureAppServiceEnvironmentResource> {
        const callbackId = registerCallback(async (argData: unknown) => {
            const argHandle = wrapIfHandle(argData) as ResourceUrlsCallbackContextHandle;
            const arg = new ResourceUrlsCallbackContext(argHandle, this._client);
            await callback(arg);
    ...
    /** Customizes displayed URLs via async callback */
    withUrlsCallbackAsync(callback: (arg: ResourceUrlsCallbackContext) => Promise<void>): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._withUrlsCallbackAsyncInternal(callback));
    }

    /** @internal */
    private async _withUrlInternal(url: string, displayText?: string): Promise<AzureAppServiceEnvironmentResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, url };
        if (displayText !== undefined) rpcArgs.displayText = displayText;
        const result = await this._client.invokeCapability<AzureAppServiceEnvironmentResourceHandle>(
            'Aspire.Hosting/withUrl',
    ...
    /** Adds or modifies displayed URLs */
    withUrl(url: string, options?: WithUrlOptions): AzureAppServiceEnvironmentResourcePromise {
        const displayText = options?.displayText;
        return new AzureAppServiceEnvironmentResourcePromise(this._withUrlInternal(url, displayText));
    }

    /** @internal */
    private async _withUrlExpressionInternal(url: ReferenceExpression, displayText?: string): Promise<AzureAppServiceEnvironmentResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, url };
        if (displayText !== undefined) rpcArgs.displayText = displayText;
        const result = await this._client.invokeCapability<AzureAppServiceEnvironmentResourceHandle>(
            'Aspire.Hosting/withUrlExpression',
    ...
    /** Adds a URL using a reference expression */
    withUrlExpression(url: ReferenceExpression, options?: WithUrlExpressionOptions): AzureAppServiceEnvironmentResourcePromise {
        const displayText = options?.displayText;
        return new AzureAppServiceEnvironmentResourcePromise(this._withUrlExpressionInternal(url, displayText));
    }

    /** @internal */
    private async _withUrlForEndpointInternal(endpointName: string, callback: (obj: ResourceUrlAnnotation) => Promise<void>): Promise<AzureAppServiceEnvironmentResource> {
        const callbackId = registerCallback(async (objData: unknown) => {
            const obj = wrapIfHandle(objData) as ResourceUrlAnnotation;
            await callback(obj);
        });
    ...
    /** Customizes the URL for a specific endpoint via callback */
    withUrlForEndpoint(endpointName: string, callback: (obj: ResourceUrlAnnotation) => Promise<void>): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._withUrlForEndpointInternal(endpointName, callback));
    }

    /** @internal */
    private async _withExplicitStartInternal(): Promise<AzureAppServiceEnvironmentResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<AzureAppServiceEnvironmentResourceHandle>(
            'Aspire.Hosting/withExplicitStart',
            rpcArgs
    ...
    /** Prevents resource from starting automatically */
    withExplicitStart(): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._withExplicitStartInternal());
    }

    /** @internal */
    private async _withHealthCheckInternal(key: string): Promise<AzureAppServiceEnvironmentResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, key };
        const result = await this._client.invokeCapability<AzureAppServiceEnvironmentResourceHandle>(
            'Aspire.Hosting/withHealthCheck',
            rpcArgs
    ...
    /** Adds a health check by key */
    withHealthCheck(key: string): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._withHealthCheckInternal(key));
    }

    /** @internal */
    private async _withCommandInternal(name: string, displayName: string, executeCommand: (arg: ExecuteCommandContext) => Promise<ExecuteCommandResult>, commandOptions?: CommandOptions): Promise<AzureAppServiceEnvironmentResource> {
        const executeCommandId = registerCallback(async (argData: unknown) => {
            const argHandle = wrapIfHandle(argData) as ExecuteCommandContextHandle;
            const arg = new ExecuteCommandContext(argHandle, this._client);
            return await executeCommand(arg);
    ...
    /** Adds a resource command */
    withCommand(name: string, displayName: string, executeCommand: (arg: ExecuteCommandContext) => Promise<ExecuteCommandResult>, options?: WithCommandOptions): AzureAppServiceEnvironmentResourcePromise {
        const commandOptions = options?.commandOptions;
        return new AzureAppServiceEnvironmentResourcePromise(this._withCommandInternal(name, displayName, executeCommand, commandOptions));
    }

    /** @internal */
    private async _withParentRelationshipInternal(parent: ResourceBuilderBase): Promise<AzureAppServiceEnvironmentResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, parent };
        const result = await this._client.invokeCapability<AzureAppServiceEnvironmentResourceHandle>(
            'Aspire.Hosting/withParentRelationship',
            rpcArgs
    ...
    /** Sets the parent relationship */
    withParentRelationship(parent: ResourceBuilderBase): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._withParentRelationshipInternal(parent));
    }
    ...
    /** @internal */
    private async _withDashboardInternal(enable?: boolean): Promise<AzureAppServiceEnvironmentResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        if (enable !== undefined) rpcArgs.enable = enable;
        const result = await this._client.invokeCapability<AzureAppServiceEnvironmentResourceHandle>(
            'Aspire.Hosting.Azure.AppService/withDashboard',
            rpcArgs
        );
        return new AzureAppServiceEnvironmentResource(result, this._client);
    }
    ...
    withDashboard(options?: WithDashboardOptions): AzureAppServiceEnvironmentResourcePromise {
        const enable = options?.enable;
        return new AzureAppServiceEnvironmentResourcePromise(this._withDashboardInternal(enable));
    }

    /** @internal */
    private async _withAzureApplicationInsightsInternal(): Promise<AzureAppServiceEnvironmentResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<AzureAppServiceEnvironmentResourceHandle>(
            'Aspire.Hosting.Azure.AppService/withAzureApplicationInsights',
            rpcArgs
        );
        return new AzureAppServiceEnvironmentResource(result, this._client);
    }
    ...
    withAzureApplicationInsights(): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._withAzureApplicationInsightsInternal());
    }

    /** @internal */
    private async _withAzureApplicationInsightsLocationInternal(applicationInsightsLocation: string): Promise<AzureAppServiceEnvironmentResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, applicationInsightsLocation };
        const result = await this._client.invokeCapability<AzureAppServiceEnvironmentResourceHandle>(
            'Aspire.Hosting.Azure.AppService/withAzureApplicationInsightsLocation',
            rpcArgs
        );
        return new AzureAppServiceEnvironmentResource(result, this._client);
    }
    ...
    withAzureApplicationInsightsLocation(applicationInsightsLocation: string): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._withAzureApplicationInsightsLocationInternal(applicationInsightsLocation));
    }

    /** @internal */
    private async _withAzureApplicationInsightsLocationParameterInternal(applicationInsightsLocation: ParameterResource): Promise<AzureAppServiceEnvironmentResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, applicationInsightsLocation };
        const result = await this._client.invokeCapability<AzureAppServiceEnvironmentResourceHandle>(
            'Aspire.Hosting.Azure.AppService/withAzureApplicationInsightsLocationParameter',
            rpcArgs
        );
        return new AzureAppServiceEnvironmentResource(result, this._client);
    }
    ...
    withAzureApplicationInsightsLocationParameter(applicationInsightsLocation: ParameterResource): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._withAzureApplicationInsightsLocationParameterInternal(applicationInsightsLocation));
    }

    /** @internal */
    private async _withAzureApplicationInsightsResourceInternal(applicationInsightsBuilder: AzureApplicationInsightsResource): Promise<AzureAppServiceEnvironmentResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, applicationInsightsBuilder };
        const result = await this._client.invokeCapability<AzureAppServiceEnvironmentResourceHandle>(
            'Aspire.Hosting.Azure.AppService/withAzureApplicationInsightsResource',
            rpcArgs
        );
        return new AzureAppServiceEnvironmentResource(result, this._client);
    }
    ...
    withAzureApplicationInsightsResource(applicationInsightsBuilder: AzureApplicationInsightsResource): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._withAzureApplicationInsightsResourceInternal(applicationInsightsBuilder));
    }

    /** @internal */
    private async _withDeploymentSlotParameterInternal(deploymentSlot: ParameterResource): Promise<AzureAppServiceEnvironmentResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, deploymentSlot };
        const result = await this._client.invokeCapability<AzureAppServiceEnvironmentResourceHandle>(
            'Aspire.Hosting.Azure.AppService/withDeploymentSlotParameter',
            rpcArgs
        );
        return new AzureAppServiceEnvironmentResource(result, this._client);
    }
    ...
    withDeploymentSlotParameter(deploymentSlot: ParameterResource): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._withDeploymentSlotParameterInternal(deploymentSlot));
    }

    /** @internal */
    private async _withDeploymentSlotInternal(deploymentSlot: string): Promise<AzureAppServiceEnvironmentResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, deploymentSlot };
        const result = await this._client.invokeCapability<AzureAppServiceEnvironmentResourceHandle>(
            'Aspire.Hosting.Azure.AppService/withDeploymentSlot',
            rpcArgs
        );
        return new AzureAppServiceEnvironmentResource(result, this._client);
    }
    ...
    withDeploymentSlot(deploymentSlot: string): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._withDeploymentSlotInternal(deploymentSlot));
    }
    ...
    /** @internal */
    private async _withParameterInternal(name: string): Promise<AzureAppServiceEnvironmentResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name };
        const result = await this._client.invokeCapability<AzureAppServiceEnvironmentResourceHandle>(
            'Aspire.Hosting.Azure/withParameter',
            rpcArgs
    ...
    /** Adds a Bicep parameter without a value */
    withParameter(name: string): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._withParameterInternal(name));
    }

    /** @internal */
    private async _withParameterStringValueInternal(name: string, value: string): Promise<AzureAppServiceEnvironmentResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, value };
        const result = await this._client.invokeCapability<AzureAppServiceEnvironmentResourceHandle>(
            'Aspire.Hosting.Azure/withParameterStringValue',
            rpcArgs
    ...
    /** Adds a Bicep parameter with a string value */
    withParameterStringValue(name: string, value: string): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._withParameterStringValueInternal(name, value));
    }

    /** @internal */
    private async _withParameterStringValuesInternal(name: string, value: string[]): Promise<AzureAppServiceEnvironmentResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, value };
        const result = await this._client.invokeCapability<AzureAppServiceEnvironmentResourceHandle>(
            'Aspire.Hosting.Azure/withParameterStringValues',
            rpcArgs
    ...
    /** Adds a Bicep parameter with a string list value */
    withParameterStringValues(name: string, value: string[]): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._withParameterStringValuesInternal(name, value));
    }

    /** @internal */
    private async _withParameterFromParameterInternal(name: string, value: ParameterResource): Promise<AzureAppServiceEnvironmentResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, value };
        const result = await this._client.invokeCapability<AzureAppServiceEnvironmentResourceHandle>(
            'Aspire.Hosting.Azure/withParameterFromParameter',
            rpcArgs
    ...
    /** Adds a Bicep parameter from a parameter resource builder */
    withParameterFromParameter(name: string, value: ParameterResource): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._withParameterFromParameterInternal(name, value));
    }

    /** @internal */
    private async _withParameterFromConnectionStringInternal(name: string, value: ResourceBuilderBase): Promise<AzureAppServiceEnvironmentResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, value };
        const result = await this._client.invokeCapability<AzureAppServiceEnvironmentResourceHandle>(
            'Aspire.Hosting.Azure/withParameterFromConnectionString',
            rpcArgs
    ...
    /** Adds a Bicep parameter from a connection string resource builder */
    withParameterFromConnectionString(name: string, value: ResourceBuilderBase): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._withParameterFromConnectionStringInternal(name, value));
    }

    /** @internal */
    private async _withParameterFromOutputInternal(name: string, value: BicepOutputReference): Promise<AzureAppServiceEnvironmentResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, value };
        const result = await this._client.invokeCapability<AzureAppServiceEnvironmentResourceHandle>(
            'Aspire.Hosting.Azure/withParameterFromOutput',
            rpcArgs
    ...
    /** Adds a Bicep parameter from another Bicep output reference */
    withParameterFromOutput(name: string, value: BicepOutputReference): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._withParameterFromOutputInternal(name, value));
    }

    /** @internal */
    private async _withParameterFromReferenceExpressionInternal(name: string, value: ReferenceExpression): Promise<AzureAppServiceEnvironmentResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, value };
        const result = await this._client.invokeCapability<AzureAppServiceEnvironmentResourceHandle>(
            'Aspire.Hosting.Azure/withParameterFromReferenceExpression',
            rpcArgs
    ...
    /** Adds a Bicep parameter from a reference expression */
    withParameterFromReferenceExpression(name: string, value: ReferenceExpression): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._withParameterFromReferenceExpressionInternal(name, value));
    }

    /** @internal */
    private async _withParameterFromEndpointInternal(name: string, value: EndpointReference): Promise<AzureAppServiceEnvironmentResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, value };
        const result = await this._client.invokeCapability<AzureAppServiceEnvironmentResourceHandle>(
            'Aspire.Hosting.Azure/withParameterFromEndpoint',
            rpcArgs
    ...
    /** Adds a Bicep parameter from an endpoint reference */
    withParameterFromEndpoint(name: string, value: EndpointReference): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._withParameterFromEndpointInternal(name, value));
    }

    /** @internal */
    private async _configureInfrastructureInternal(configure: (obj: AzureResourceInfrastructure) => Promise<void>): Promise<AzureAppServiceEnvironmentResource> {
        const configureId = registerCallback(async (objData: unknown) => {
            const objHandle = wrapIfHandle(objData) as AzureResourceInfrastructureHandle;
            const obj = new AzureResourceInfrastructure(objHandle, this._client);
            await configure(obj);
    ...
    /** Configures the Azure provisioning infrastructure callback */
    configureInfrastructure(configure: (obj: AzureResourceInfrastructure) => Promise<void>): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._configureInfrastructureInternal(configure));
    }

    /** @internal */
    private async _publishAsConnectionStringInternal(): Promise<AzureAppServiceEnvironmentResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<AzureAppServiceEnvironmentResourceHandle>(
            'Aspire.Hosting.Azure/publishAsConnectionString',
            rpcArgs
    ...
    /** Publishes an Azure resource to the manifest as a connection string */
    publishAsConnectionString(): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._publishAsConnectionStringInternal());
    }
    ...
    /** @internal */
    private async _clearDefaultRoleAssignmentsInternal(): Promise<AzureAppServiceEnvironmentResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<AzureAppServiceEnvironmentResourceHandle>(
            'Aspire.Hosting.Azure/clearDefaultRoleAssignments',
            rpcArgs
    ...
    /** Clears the default Azure role assignments from a resource */
    clearDefaultRoleAssignments(): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._clearDefaultRoleAssignmentsInternal());
    }
    ...
    /** @internal */
    private async _runAsExistingFromParametersInternal(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): Promise<AzureAppServiceEnvironmentResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, nameParameter, resourceGroupParameter };
        const result = await this._client.invokeCapability<AzureAppServiceEnvironmentResourceHandle>(
            'Aspire.Hosting.Azure/runAsExistingFromParameters',
            rpcArgs
    ...
    /** Marks an Azure resource as existing in run mode by using parameter resources */
    runAsExistingFromParameters(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._runAsExistingFromParametersInternal(nameParameter, resourceGroupParameter));
    }

    /** @internal */
    private async _runAsExistingInternal(name: string, resourceGroup: string): Promise<AzureAppServiceEnvironmentResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, resourceGroup };
        const result = await this._client.invokeCapability<AzureAppServiceEnvironmentResourceHandle>(
            'Aspire.Hosting.Azure/runAsExisting',
            rpcArgs
    ...
    /** Marks an Azure resource as existing in run mode */
    runAsExisting(name: string, resourceGroup: string): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._runAsExistingInternal(name, resourceGroup));
    }

    /** @internal */
    private async _publishAsExistingFromParametersInternal(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): Promise<AzureAppServiceEnvironmentResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, nameParameter, resourceGroupParameter };
        const result = await this._client.invokeCapability<AzureAppServiceEnvironmentResourceHandle>(
            'Aspire.Hosting.Azure/publishAsExistingFromParameters',
            rpcArgs
    ...
    /** Marks an Azure resource as existing in publish mode by using parameter resources */
    publishAsExistingFromParameters(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._publishAsExistingFromParametersInternal(nameParameter, resourceGroupParameter));
    }

    /** @internal */
    private async _publishAsExistingInternal(name: string, resourceGroup: string): Promise<AzureAppServiceEnvironmentResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, resourceGroup };
        const result = await this._client.invokeCapability<AzureAppServiceEnvironmentResourceHandle>(
            'Aspire.Hosting.Azure/publishAsExisting',
            rpcArgs
    ...
    /** Marks an Azure resource as existing in publish mode */
    publishAsExisting(name: string, resourceGroup: string): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._publishAsExistingInternal(name, resourceGroup));
    }

    /** @internal */
    private async _asExistingInternal(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): Promise<AzureAppServiceEnvironmentResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, nameParameter, resourceGroupParameter };
        const result = await this._client.invokeCapability<AzureAppServiceEnvironmentResourceHandle>(
            'Aspire.Hosting.Azure/asExisting',
            rpcArgs
    ...
    /** Marks an Azure resource as existing in both run and publish modes */
    asExisting(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._asExistingInternal(nameParameter, resourceGroupParameter));
    }

    /** @internal */
    private async _withAzureContainerRegistryInternal(registryBuilder: AzureContainerRegistryResource): Promise<AzureAppServiceEnvironmentResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, registryBuilder };
        const result = await this._client.invokeCapability<AzureAppServiceEnvironmentResourceHandle>(
            'Aspire.Hosting.Azure.ContainerRegistry/withAzureContainerRegistry',
            rpcArgs
    ...
    /** Configures a compute environment resource to use an Azure Container Registry. */
    withAzureContainerRegistry(registryBuilder: AzureContainerRegistryResource): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._withAzureContainerRegistryInternal(registryBuilder));
    }
...
/**
 * Thenable wrapper for AzureAppServiceEnvironmentResource that enables fluent chaining.
 * @example
 * await builder.addSomething().withX().withY();
 */
export class AzureAppServiceEnvironmentResourcePromise implements PromiseLike<AzureAppServiceEnvironmentResource> {
    constructor(private _promise: Promise<AzureAppServiceEnvironmentResource>) {}

    then<TResult1 = AzureAppServiceEnvironmentResource, TResult2 = never>(
        onfulfilled?: ((value: AzureAppServiceEnvironmentResource) => TResult1 | PromiseLike<TResult1>) | null,
        onrejected?: ((reason: unknown) => TResult2 | PromiseLike<TResult2>) | null
    ): PromiseLike<TResult1 | TResult2> {
        return this._promise.then(onfulfilled, onrejected);
    }
    ...
    /** Customizes displayed URLs via callback */
    withUrlsCallback(callback: (obj: ResourceUrlsCallbackContext) => Promise<void>): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._promise.then(obj => obj.withUrlsCallback(callback)));
    }

    /** Customizes displayed URLs via async callback */
    withUrlsCallbackAsync(callback: (arg: ResourceUrlsCallbackContext) => Promise<void>): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._promise.then(obj => obj.withUrlsCallbackAsync(callback)));
    }

    /** Adds or modifies displayed URLs */
    withUrl(url: string, options?: WithUrlOptions): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._promise.then(obj => obj.withUrl(url, options)));
    }

    /** Adds a URL using a reference expression */
    withUrlExpression(url: ReferenceExpression, options?: WithUrlExpressionOptions): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._promise.then(obj => obj.withUrlExpression(url, options)));
    }

    /** Customizes the URL for a specific endpoint via callback */
    withUrlForEndpoint(endpointName: string, callback: (obj: ResourceUrlAnnotation) => Promise<void>): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._promise.then(obj => obj.withUrlForEndpoint(endpointName, callback)));
    }

    /** Prevents resource from starting automatically */
    withExplicitStart(): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._promise.then(obj => obj.withExplicitStart()));
    }

    /** Adds a health check by key */
    withHealthCheck(key: string): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._promise.then(obj => obj.withHealthCheck(key)));
    }

    /** Adds a resource command */
    withCommand(name: string, displayName: string, executeCommand: (arg: ExecuteCommandContext) => Promise<ExecuteCommandResult>, options?: WithCommandOptions): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._promise.then(obj => obj.withCommand(name, displayName, executeCommand, options)));
    }

    /** Sets the parent relationship */
    withParentRelationship(parent: ResourceBuilderBase): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._promise.then(obj => obj.withParentRelationship(parent)));
    }
    ...
    /** Configures whether the Aspire dashboard is included in the Azure App Service environment */
    withDashboard(options?: WithDashboardOptions): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._promise.then(obj => obj.withDashboard(options)));
    }

    /** Enables Azure Application Insights for the Azure App Service environment */
    withAzureApplicationInsights(): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._promise.then(obj => obj.withAzureApplicationInsights()));
    }

    /** Enables Azure Application Insights for the Azure App Service environment with a specific location */
    withAzureApplicationInsightsLocation(applicationInsightsLocation: string): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._promise.then(obj => obj.withAzureApplicationInsightsLocation(applicationInsightsLocation)));
    }

    /** Enables Azure Application Insights for the Azure App Service environment using a location parameter */
    withAzureApplicationInsightsLocationParameter(applicationInsightsLocation: ParameterResource): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._promise.then(obj => obj.withAzureApplicationInsightsLocationParameter(applicationInsightsLocation)));
    }

    /** Enables Azure Application Insights for the Azure App Service environment using an existing Application Insights resource */
    withAzureApplicationInsightsResource(applicationInsightsBuilder: AzureApplicationInsightsResource): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._promise.then(obj => obj.withAzureApplicationInsightsResource(applicationInsightsBuilder)));
    }

    /** Configures the deployment slot for all Azure App Services in the environment using a parameter */
    withDeploymentSlotParameter(deploymentSlot: ParameterResource): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._promise.then(obj => obj.withDeploymentSlotParameter(deploymentSlot)));
    }

    /** Configures the deployment slot for all Azure App Services in the environment */
    withDeploymentSlot(deploymentSlot: string): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._promise.then(obj => obj.withDeploymentSlot(deploymentSlot)));
    }
    ...
    /** Adds a Bicep parameter without a value */
    withParameter(name: string): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._promise.then(obj => obj.withParameter(name)));
    }

    /** Adds a Bicep parameter with a string value */
    withParameterStringValue(name: string, value: string): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._promise.then(obj => obj.withParameterStringValue(name, value)));
    }

    /** Adds a Bicep parameter with a string list value */
    withParameterStringValues(name: string, value: string[]): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._promise.then(obj => obj.withParameterStringValues(name, value)));
    }

    /** Adds a Bicep parameter from a parameter resource builder */
    withParameterFromParameter(name: string, value: ParameterResource): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._promise.then(obj => obj.withParameterFromParameter(name, value)));
    }

    /** Adds a Bicep parameter from a connection string resource builder */
    withParameterFromConnectionString(name: string, value: ResourceBuilderBase): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._promise.then(obj => obj.withParameterFromConnectionString(name, value)));
    }

    /** Adds a Bicep parameter from another Bicep output reference */
    withParameterFromOutput(name: string, value: BicepOutputReference): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._promise.then(obj => obj.withParameterFromOutput(name, value)));
    }

    /** Adds a Bicep parameter from a reference expression */
    withParameterFromReferenceExpression(name: string, value: ReferenceExpression): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._promise.then(obj => obj.withParameterFromReferenceExpression(name, value)));
    }

    /** Adds a Bicep parameter from an endpoint reference */
    withParameterFromEndpoint(name: string, value: EndpointReference): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._promise.then(obj => obj.withParameterFromEndpoint(name, value)));
    }

    /** Configures the Azure provisioning infrastructure callback */
    configureInfrastructure(configure: (obj: AzureResourceInfrastructure) => Promise<void>): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._promise.then(obj => obj.configureInfrastructure(configure)));
    }

    /** Publishes an Azure resource to the manifest as a connection string */
    publishAsConnectionString(): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._promise.then(obj => obj.publishAsConnectionString()));
    }
    ...
    /** Clears the default Azure role assignments from a resource */
    clearDefaultRoleAssignments(): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._promise.then(obj => obj.clearDefaultRoleAssignments()));
    }
    ...
    /** Marks an Azure resource as existing in run mode by using parameter resources */
    runAsExistingFromParameters(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._promise.then(obj => obj.runAsExistingFromParameters(nameParameter, resourceGroupParameter)));
    }

    /** Marks an Azure resource as existing in run mode */
    runAsExisting(name: string, resourceGroup: string): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._promise.then(obj => obj.runAsExisting(name, resourceGroup)));
    }

    /** Marks an Azure resource as existing in publish mode by using parameter resources */
    publishAsExistingFromParameters(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._promise.then(obj => obj.publishAsExistingFromParameters(nameParameter, resourceGroupParameter)));
    }

    /** Marks an Azure resource as existing in publish mode */
    publishAsExisting(name: string, resourceGroup: string): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._promise.then(obj => obj.publishAsExisting(name, resourceGroup)));
    }

    /** Marks an Azure resource as existing in both run and publish modes */
    asExisting(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._promise.then(obj => obj.asExisting(nameParameter, resourceGroupParameter)));
    }

    /** Configures a compute environment resource to use an Azure Container Registry. */
    withAzureContainerRegistry(registryBuilder: AzureContainerRegistryResource): AzureAppServiceEnvironmentResourcePromise {
        return new AzureAppServiceEnvironmentResourcePromise(this._promise.then(obj => obj.withAzureContainerRegistry(registryBuilder)));
    }
...
export class AzureContainerRegistryResource extends ResourceBuilderBase<AzureContainerRegistryResourceHandle> {
    ...
    /** @internal */
    private async _runAsExistingFromParametersInternal(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): Promise<AzureContainerRegistryResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, nameParameter, resourceGroupParameter };
        const result = await this._client.invokeCapability<AzureContainerRegistryResourceHandle>(
            'Aspire.Hosting.Azure/runAsExistingFromParameters',
            rpcArgs
    ...
    /** Marks an Azure resource as existing in run mode by using parameter resources */
    runAsExistingFromParameters(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): AzureContainerRegistryResourcePromise {
        return new AzureContainerRegistryResourcePromise(this._runAsExistingFromParametersInternal(nameParameter, resourceGroupParameter));
    }

    /** @internal */
    private async _runAsExistingInternal(name: string, resourceGroup: string): Promise<AzureContainerRegistryResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, resourceGroup };
        const result = await this._client.invokeCapability<AzureContainerRegistryResourceHandle>(
            'Aspire.Hosting.Azure/runAsExisting',
            rpcArgs
    ...
    /** Marks an Azure resource as existing in run mode */
    runAsExisting(name: string, resourceGroup: string): AzureContainerRegistryResourcePromise {
        return new AzureContainerRegistryResourcePromise(this._runAsExistingInternal(name, resourceGroup));
    }

    /** @internal */
    private async _publishAsExistingFromParametersInternal(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): Promise<AzureContainerRegistryResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, nameParameter, resourceGroupParameter };
        const result = await this._client.invokeCapability<AzureContainerRegistryResourceHandle>(
            'Aspire.Hosting.Azure/publishAsExistingFromParameters',
            rpcArgs
    ...
    /** Marks an Azure resource as existing in publish mode by using parameter resources */
    publishAsExistingFromParameters(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): AzureContainerRegistryResourcePromise {
        return new AzureContainerRegistryResourcePromise(this._publishAsExistingFromParametersInternal(nameParameter, resourceGroupParameter));
    }

    /** @internal */
    private async _publishAsExistingInternal(name: string, resourceGroup: string): Promise<AzureContainerRegistryResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, resourceGroup };
        const result = await this._client.invokeCapability<AzureContainerRegistryResourceHandle>(
            'Aspire.Hosting.Azure/publishAsExisting',
            rpcArgs
    ...
    /** Marks an Azure resource as existing in publish mode */
    publishAsExisting(name: string, resourceGroup: string): AzureContainerRegistryResourcePromise {
        return new AzureContainerRegistryResourcePromise(this._publishAsExistingInternal(name, resourceGroup));
    }

    /** @internal */
    private async _asExistingInternal(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): Promise<AzureContainerRegistryResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, nameParameter, resourceGroupParameter };
        const result = await this._client.invokeCapability<AzureContainerRegistryResourceHandle>(
            'Aspire.Hosting.Azure/asExisting',
            rpcArgs
    ...
    /** Marks an Azure resource as existing in both run and publish modes */
    asExisting(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): AzureContainerRegistryResourcePromise {
        return new AzureContainerRegistryResourcePromise(this._asExistingInternal(nameParameter, resourceGroupParameter));
    }
...
export class AzureContainerRegistryResourcePromise implements PromiseLike<AzureContainerRegistryResource> {
    ...
    /** Marks an Azure resource as existing in run mode by using parameter resources */
    runAsExistingFromParameters(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): AzureContainerRegistryResourcePromise {
        return new AzureContainerRegistryResourcePromise(this._promise.then(obj => obj.runAsExistingFromParameters(nameParameter, resourceGroupParameter)));
    }

    /** Marks an Azure resource as existing in run mode */
    runAsExisting(name: string, resourceGroup: string): AzureContainerRegistryResourcePromise {
        return new AzureContainerRegistryResourcePromise(this._promise.then(obj => obj.runAsExisting(name, resourceGroup)));
    }

    /** Marks an Azure resource as existing in publish mode by using parameter resources */
    publishAsExistingFromParameters(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): AzureContainerRegistryResourcePromise {
        return new AzureContainerRegistryResourcePromise(this._promise.then(obj => obj.publishAsExistingFromParameters(nameParameter, resourceGroupParameter)));
    }

    /** Marks an Azure resource as existing in publish mode */
    publishAsExisting(name: string, resourceGroup: string): AzureContainerRegistryResourcePromise {
        return new AzureContainerRegistryResourcePromise(this._promise.then(obj => obj.publishAsExisting(name, resourceGroup)));
    }

    /** Marks an Azure resource as existing in both run and publish modes */
    asExisting(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): AzureContainerRegistryResourcePromise {
        return new AzureContainerRegistryResourcePromise(this._promise.then(obj => obj.asExisting(nameParameter, resourceGroupParameter)));
    }
...
export class AzureLogAnalyticsWorkspaceResource extends ResourceBuilderBase<AzureLogAnalyticsWorkspaceResourceHandle> {
    ...
    /** @internal */
    private async _runAsExistingFromParametersInternal(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): Promise<AzureLogAnalyticsWorkspaceResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, nameParameter, resourceGroupParameter };
        const result = await this._client.invokeCapability<AzureLogAnalyticsWorkspaceResourceHandle>(
            'Aspire.Hosting.Azure/runAsExistingFromParameters',
            rpcArgs
    ...
    /** Marks an Azure resource as existing in run mode by using parameter resources */
    runAsExistingFromParameters(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): AzureLogAnalyticsWorkspaceResourcePromise {
        return new AzureLogAnalyticsWorkspaceResourcePromise(this._runAsExistingFromParametersInternal(nameParameter, resourceGroupParameter));
    }

    /** @internal */
    private async _runAsExistingInternal(name: string, resourceGroup: string): Promise<AzureLogAnalyticsWorkspaceResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, resourceGroup };
        const result = await this._client.invokeCapability<AzureLogAnalyticsWorkspaceResourceHandle>(
            'Aspire.Hosting.Azure/runAsExisting',
            rpcArgs
    ...
    /** Marks an Azure resource as existing in run mode */
    runAsExisting(name: string, resourceGroup: string): AzureLogAnalyticsWorkspaceResourcePromise {
        return new AzureLogAnalyticsWorkspaceResourcePromise(this._runAsExistingInternal(name, resourceGroup));
    }

    /** @internal */
    private async _publishAsExistingFromParametersInternal(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): Promise<AzureLogAnalyticsWorkspaceResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, nameParameter, resourceGroupParameter };
        const result = await this._client.invokeCapability<AzureLogAnalyticsWorkspaceResourceHandle>(
            'Aspire.Hosting.Azure/publishAsExistingFromParameters',
            rpcArgs
    ...
    /** Marks an Azure resource as existing in publish mode by using parameter resources */
    publishAsExistingFromParameters(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): AzureLogAnalyticsWorkspaceResourcePromise {
        return new AzureLogAnalyticsWorkspaceResourcePromise(this._publishAsExistingFromParametersInternal(nameParameter, resourceGroupParameter));
    }

    /** @internal */
    private async _publishAsExistingInternal(name: string, resourceGroup: string): Promise<AzureLogAnalyticsWorkspaceResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, resourceGroup };
        const result = await this._client.invokeCapability<AzureLogAnalyticsWorkspaceResourceHandle>(
            'Aspire.Hosting.Azure/publishAsExisting',
            rpcArgs
    ...
    /** Marks an Azure resource as existing in publish mode */
    publishAsExisting(name: string, resourceGroup: string): AzureLogAnalyticsWorkspaceResourcePromise {
        return new AzureLogAnalyticsWorkspaceResourcePromise(this._publishAsExistingInternal(name, resourceGroup));
    }

    /** @internal */
    private async _asExistingInternal(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): Promise<AzureLogAnalyticsWorkspaceResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, nameParameter, resourceGroupParameter };
        const result = await this._client.invokeCapability<AzureLogAnalyticsWorkspaceResourceHandle>(
            'Aspire.Hosting.Azure/asExisting',
            rpcArgs
    ...
    /** Marks an Azure resource as existing in both run and publish modes */
    asExisting(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): AzureLogAnalyticsWorkspaceResourcePromise {
        return new AzureLogAnalyticsWorkspaceResourcePromise(this._asExistingInternal(nameParameter, resourceGroupParameter));
    }
...
export class AzureLogAnalyticsWorkspaceResourcePromise implements PromiseLike<AzureLogAnalyticsWorkspaceResource> {
    ...
    /** Marks an Azure resource as existing in run mode by using parameter resources */
    runAsExistingFromParameters(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): AzureLogAnalyticsWorkspaceResourcePromise {
        return new AzureLogAnalyticsWorkspaceResourcePromise(this._promise.then(obj => obj.runAsExistingFromParameters(nameParameter, resourceGroupParameter)));
    }

    /** Marks an Azure resource as existing in run mode */
    runAsExisting(name: string, resourceGroup: string): AzureLogAnalyticsWorkspaceResourcePromise {
        return new AzureLogAnalyticsWorkspaceResourcePromise(this._promise.then(obj => obj.runAsExisting(name, resourceGroup)));
    }

    /** Marks an Azure resource as existing in publish mode by using parameter resources */
    publishAsExistingFromParameters(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): AzureLogAnalyticsWorkspaceResourcePromise {
        return new AzureLogAnalyticsWorkspaceResourcePromise(this._promise.then(obj => obj.publishAsExistingFromParameters(nameParameter, resourceGroupParameter)));
    }

    /** Marks an Azure resource as existing in publish mode */
    publishAsExisting(name: string, resourceGroup: string): AzureLogAnalyticsWorkspaceResourcePromise {
        return new AzureLogAnalyticsWorkspaceResourcePromise(this._promise.then(obj => obj.publishAsExisting(name, resourceGroup)));
    }

    /** Marks an Azure resource as existing in both run and publish modes */
    asExisting(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): AzureLogAnalyticsWorkspaceResourcePromise {
        return new AzureLogAnalyticsWorkspaceResourcePromise(this._promise.then(obj => obj.asExisting(nameParameter, resourceGroupParameter)));
    }
...
export class ContainerResource extends ResourceBuilderBase<ContainerResourceHandle> {
    ...
    /** @internal */
    private async _publishAsAzureAppServiceWebsiteInternal(configure?: (arg1: AzureResourceInfrastructure, arg2: WebSiteHandle) => Promise<void>, configureSlot?: (arg1: AzureResourceInfrastructure, arg2: WebSiteSlotHandle) => Promise<void>): Promise<ContainerResource> {
        const configureId = configure ? registerCallback(async (argsData: unknown) => {
            ...
            const arg2 = wrapIfHandle(args.p1) as WebSiteHandle;
            await configure(arg1, arg2);
        }) : undefined;
        const configureSlotId = configureSlot ? registerCallback(async (argsData: unknown) => {
            const args = argsData as { p0: unknown, p1: unknown };
            const arg1Handle = wrapIfHandle(args.p0) as AzureResourceInfrastructureHandle;
            const arg1 = new AzureResourceInfrastructure(arg1Handle, this._client);
            const arg2 = wrapIfHandle(args.p1) as WebSiteSlotHandle;
            await configureSlot(arg1, arg2);
        }) : undefined;
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        if (configure !== undefined) rpcArgs.configure = configureId;
        if (configureSlot !== undefined) rpcArgs.configureSlot = configureSlotId;
        const result = await this._client.invokeCapability<ContainerResourceHandle>(
            'Aspire.Hosting.Azure.AppService/publishAsAzureAppServiceWebsite',
            rpcArgs
        );
        return new ContainerResource(result, this._client);
    }
    ...
    publishAsAzureAppServiceWebsite(options?: PublishAsAzureAppServiceWebsiteOptions): ContainerResourcePromise {
        const configure = options?.configure;
        const configureSlot = options?.configureSlot;
        return new ContainerResourcePromise(this._publishAsAzureAppServiceWebsiteInternal(configure, configureSlot));
    }

    /** @internal */
    private async _skipEnvironmentVariableNameChecksInternal(): Promise<ContainerResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<ContainerResourceHandle>(
            'Aspire.Hosting.Azure.AppService/skipEnvironmentVariableNameChecks',
            rpcArgs
        );
        return new ContainerResource(result, this._client);
    }
    ...
    skipEnvironmentVariableNameChecks(): ContainerResourcePromise {
        return new ContainerResourcePromise(this._skipEnvironmentVariableNameChecksInternal());
    }
...
export class ContainerResourcePromise implements PromiseLike<ContainerResource> {
    ...
    /** Publishes the compute resource as an Azure App Service website or deployment slot */
    publishAsAzureAppServiceWebsite(options?: PublishAsAzureAppServiceWebsiteOptions): ContainerResourcePromise {
        return new ContainerResourcePromise(this._promise.then(obj => obj.publishAsAzureAppServiceWebsite(options)));
    }

    /** Skips Azure App Service environment variable name validation for the compute resource */
    skipEnvironmentVariableNameChecks(): ContainerResourcePromise {
        return new ContainerResourcePromise(this._promise.then(obj => obj.skipEnvironmentVariableNameChecks()));
    }
...
export class ExecutableResource extends ResourceBuilderBase<ExecutableResourceHandle> {
    ...
    /** @internal */
    private async _publishAsAzureAppServiceWebsiteInternal(configure?: (arg1: AzureResourceInfrastructure, arg2: WebSiteHandle) => Promise<void>, configureSlot?: (arg1: AzureResourceInfrastructure, arg2: WebSiteSlotHandle) => Promise<void>): Promise<ExecutableResource> {
        const configureId = configure ? registerCallback(async (argsData: unknown) => {
            const args = argsData as { p0: unknown, p1: unknown };
            const arg1Handle = wrapIfHandle(args.p0) as AzureResourceInfrastructureHandle;
            const arg1 = new AzureResourceInfrastructure(arg1Handle, this._client);
    ...
    /** Publishes the compute resource as an Azure App Service website or deployment slot */
    publishAsAzureAppServiceWebsite(options?: PublishAsAzureAppServiceWebsiteOptions): ExecutableResourcePromise {
        const configure = options?.configure;
        const configureSlot = options?.configureSlot;
        return new ExecutableResourcePromise(this._publishAsAzureAppServiceWebsiteInternal(configure, configureSlot));
    }

    /** @internal */
    private async _skipEnvironmentVariableNameChecksInternal(): Promise<ExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<ExecutableResourceHandle>(
            'Aspire.Hosting.Azure.AppService/skipEnvironmentVariableNameChecks',
            rpcArgs
    ...
    /** Skips Azure App Service environment variable name validation for the compute resource */
    skipEnvironmentVariableNameChecks(): ExecutableResourcePromise {
        return new ExecutableResourcePromise(this._skipEnvironmentVariableNameChecksInternal());
    }
...
export class ExecutableResourcePromise implements PromiseLike<ExecutableResource> {
    ...
    /** Publishes the compute resource as an Azure App Service website or deployment slot */
    publishAsAzureAppServiceWebsite(options?: PublishAsAzureAppServiceWebsiteOptions): ExecutableResourcePromise {
        return new ExecutableResourcePromise(this._promise.then(obj => obj.publishAsAzureAppServiceWebsite(options)));
    }

    /** Skips Azure App Service environment variable name validation for the compute resource */
    skipEnvironmentVariableNameChecks(): ExecutableResourcePromise {
        return new ExecutableResourcePromise(this._promise.then(obj => obj.skipEnvironmentVariableNameChecks()));
    }
...
export class ProjectResource extends ResourceBuilderBase<ProjectResourceHandle> {
    ...
    /** @internal */
    private async _publishAsAzureAppServiceWebsiteInternal(configure?: (arg1: AzureResourceInfrastructure, arg2: WebSiteHandle) => Promise<void>, configureSlot?: (arg1: AzureResourceInfrastructure, arg2: WebSiteSlotHandle) => Promise<void>): Promise<ProjectResource> {
        const configureId = configure ? registerCallback(async (argsData: unknown) => {
            const args = argsData as { p0: unknown, p1: unknown };
            const arg1Handle = wrapIfHandle(args.p0) as AzureResourceInfrastructureHandle;
            const arg1 = new AzureResourceInfrastructure(arg1Handle, this._client);
    ...
    /** Publishes the compute resource as an Azure App Service website or deployment slot */
    publishAsAzureAppServiceWebsite(options?: PublishAsAzureAppServiceWebsiteOptions): ProjectResourcePromise {
        const configure = options?.configure;
        const configureSlot = options?.configureSlot;
        return new ProjectResourcePromise(this._publishAsAzureAppServiceWebsiteInternal(configure, configureSlot));
    }

    /** @internal */
    private async _skipEnvironmentVariableNameChecksInternal(): Promise<ProjectResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<ProjectResourceHandle>(
            'Aspire.Hosting.Azure.AppService/skipEnvironmentVariableNameChecks',
            rpcArgs
    ...
    /** Skips Azure App Service environment variable name validation for the compute resource */
    skipEnvironmentVariableNameChecks(): ProjectResourcePromise {
        return new ProjectResourcePromise(this._skipEnvironmentVariableNameChecksInternal());
    }
...
export class ProjectResourcePromise implements PromiseLike<ProjectResource> {
    ...
    /** Publishes the compute resource as an Azure App Service website or deployment slot */
    publishAsAzureAppServiceWebsite(options?: PublishAsAzureAppServiceWebsiteOptions): ProjectResourcePromise {
        return new ProjectResourcePromise(this._promise.then(obj => obj.publishAsAzureAppServiceWebsite(options)));
    }

    /** Skips Azure App Service environment variable name validation for the compute resource */
    skipEnvironmentVariableNameChecks(): ProjectResourcePromise {
        return new ProjectResourcePromise(this._promise.then(obj => obj.skipEnvironmentVariableNameChecks()));
    }
...
export class ComputeResource extends ResourceBuilderBase<IComputeResourceHandle> {
    ...
    /** @internal */
    private async _publishAsAzureAppServiceWebsiteInternal(configure?: (arg1: AzureResourceInfrastructure, arg2: WebSiteHandle) => Promise<void>, configureSlot?: (arg1: AzureResourceInfrastructure, arg2: WebSiteSlotHandle) => Promise<void>): Promise<ComputeResource> {
        const configureId = configure ? registerCallback(async (argsData: unknown) => {
            const args = argsData as { p0: unknown, p1: unknown };
            const arg1Handle = wrapIfHandle(args.p0) as AzureResourceInfrastructureHandle;
            const arg1 = new AzureResourceInfrastructure(arg1Handle, this._client);
    ...
    /** Publishes the compute resource as an Azure App Service website or deployment slot */
    publishAsAzureAppServiceWebsite(options?: PublishAsAzureAppServiceWebsiteOptions): ComputeResourcePromise {
        const configure = options?.configure;
        const configureSlot = options?.configureSlot;
        return new ComputeResourcePromise(this._publishAsAzureAppServiceWebsiteInternal(configure, configureSlot));
    }

    /** @internal */
    private async _skipEnvironmentVariableNameChecksInternal(): Promise<ComputeResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<IComputeResourceHandle>(
            'Aspire.Hosting.Azure.AppService/skipEnvironmentVariableNameChecks',
            rpcArgs
    ...
    /** Skips Azure App Service environment variable name validation for the compute resource */
    skipEnvironmentVariableNameChecks(): ComputeResourcePromise {
        return new ComputeResourcePromise(this._skipEnvironmentVariableNameChecksInternal());
    }
...
export class ComputeResourcePromise implements PromiseLike<ComputeResource> {
    ...
    /** Publishes the compute resource as an Azure App Service website or deployment slot */
    publishAsAzureAppServiceWebsite(options?: PublishAsAzureAppServiceWebsiteOptions): ComputeResourcePromise {
        return new ComputeResourcePromise(this._promise.then(obj => obj.publishAsAzureAppServiceWebsite(options)));
    }

    /** Skips Azure App Service environment variable name validation for the compute resource */
    skipEnvironmentVariableNameChecks(): ComputeResourcePromise {
        return new ComputeResourcePromise(this._promise.then(obj => obj.skipEnvironmentVariableNameChecks()));
    }
...
registerHandleWrapper('Aspire.Hosting.Azure.ApplicationInsights/Aspire.Hosting.Azure.AzureApplicationInsightsResource', (handle, client) => new AzureApplicationInsightsResource(handle as AzureApplicationInsightsResourceHandle, client));
registerHandleWrapper('Aspire.Hosting.Azure.AppService/Aspire.Hosting.Azure.AzureAppServiceEnvironmentResource', (handle, client) => new AzureAppServiceEnvironmentResource(handle as AzureAppServiceEnvironmentResourceHandle, client));
