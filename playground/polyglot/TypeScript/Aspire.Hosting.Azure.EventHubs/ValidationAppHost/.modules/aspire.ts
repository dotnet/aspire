...
/** Handle to AzureEventHubConsumerGroupResource */
type AzureEventHubConsumerGroupResourceHandle = Handle<'Aspire.Hosting.Azure.EventHubs/Aspire.Hosting.Azure.AzureEventHubConsumerGroupResource'>;

/** Handle to AzureEventHubResource */
type AzureEventHubResourceHandle = Handle<'Aspire.Hosting.Azure.EventHubs/Aspire.Hosting.Azure.AzureEventHubResource'>;

/** Handle to AzureEventHubsEmulatorResource */
type AzureEventHubsEmulatorResourceHandle = Handle<'Aspire.Hosting.Azure.EventHubs/Aspire.Hosting.Azure.AzureEventHubsEmulatorResource'>;

/** Handle to AzureEventHubsResource */
type AzureEventHubsResourceHandle = Handle<'Aspire.Hosting.Azure.EventHubs/Aspire.Hosting.Azure.AzureEventHubsResource'>;
...
/** Enum type for AzureEventHubsRole */
export enum AzureEventHubsRole {
    AzureEventHubsDataOwner = "AzureEventHubsDataOwner",
    AzureEventHubsDataReceiver = "AzureEventHubsDataReceiver",
    AzureEventHubsDataSender = "AzureEventHubsDataSender",
}
...
export interface AddConsumerGroupOptions {
    groupName?: string;
}
...
export interface RunAsEmulator1Options {
...
export class AzureBlobStorageContainerResource extends ResourceBuilderBase<AzureBlobStorageContainerResourceHandle> {
    ...
    /** @internal */
    private async _withEventHubsRoleAssignmentsInternal(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): Promise<AzureBlobStorageContainerResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, target, roles };
        const result = await this._client.invokeCapability<AzureBlobStorageContainerResourceHandle>(
            'Aspire.Hosting.Azure.EventHubs/withEventHubsRoleAssignments',
            rpcArgs
    ...
    /** Assigns Event Hubs roles to a resource */
    withEventHubsRoleAssignments(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): AzureBlobStorageContainerResourcePromise {
        return new AzureBlobStorageContainerResourcePromise(this._withEventHubsRoleAssignmentsInternal(target, roles));
    }
...
export class AzureBlobStorageContainerResourcePromise implements PromiseLike<AzureBlobStorageContainerResource> {
    ...
    /** Assigns Event Hubs roles to a resource */
    withEventHubsRoleAssignments(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): AzureBlobStorageContainerResourcePromise {
        return new AzureBlobStorageContainerResourcePromise(this._promise.then(obj => obj.withEventHubsRoleAssignments(target, roles)));
    }
...
export class AzureBlobStorageResource extends ResourceBuilderBase<AzureBlobStorageResourceHandle> {
    ...
    /** @internal */
    private async _withEventHubsRoleAssignmentsInternal(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): Promise<AzureBlobStorageResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, target, roles };
        const result = await this._client.invokeCapability<AzureBlobStorageResourceHandle>(
            'Aspire.Hosting.Azure.EventHubs/withEventHubsRoleAssignments',
            rpcArgs
    ...
    /** Assigns Event Hubs roles to a resource */
    withEventHubsRoleAssignments(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): AzureBlobStorageResourcePromise {
        return new AzureBlobStorageResourcePromise(this._withEventHubsRoleAssignmentsInternal(target, roles));
    }
...
export class AzureBlobStorageResourcePromise implements PromiseLike<AzureBlobStorageResource> {
    ...
    /** Assigns Event Hubs roles to a resource */
    withEventHubsRoleAssignments(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): AzureBlobStorageResourcePromise {
        return new AzureBlobStorageResourcePromise(this._promise.then(obj => obj.withEventHubsRoleAssignments(target, roles)));
    }
...
export class AzureDataLakeStorageFileSystemResource extends ResourceBuilderBase<AzureDataLakeStorageFileSystemResourceHandle> {
    ...
    /** @internal */
    private async _withEventHubsRoleAssignmentsInternal(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): Promise<AzureDataLakeStorageFileSystemResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, target, roles };
        const result = await this._client.invokeCapability<AzureDataLakeStorageFileSystemResourceHandle>(
            'Aspire.Hosting.Azure.EventHubs/withEventHubsRoleAssignments',
            rpcArgs
    ...
    /** Assigns Event Hubs roles to a resource */
    withEventHubsRoleAssignments(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): AzureDataLakeStorageFileSystemResourcePromise {
        return new AzureDataLakeStorageFileSystemResourcePromise(this._withEventHubsRoleAssignmentsInternal(target, roles));
    }
...
export class AzureDataLakeStorageFileSystemResourcePromise implements PromiseLike<AzureDataLakeStorageFileSystemResource> {
    ...
    /** Assigns Event Hubs roles to a resource */
    withEventHubsRoleAssignments(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): AzureDataLakeStorageFileSystemResourcePromise {
        return new AzureDataLakeStorageFileSystemResourcePromise(this._promise.then(obj => obj.withEventHubsRoleAssignments(target, roles)));
    }
...
export class AzureDataLakeStorageResource extends ResourceBuilderBase<AzureDataLakeStorageResourceHandle> {
    ...
    /** @internal */
    private async _withEventHubsRoleAssignmentsInternal(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): Promise<AzureDataLakeStorageResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, target, roles };
        const result = await this._client.invokeCapability<AzureDataLakeStorageResourceHandle>(
            'Aspire.Hosting.Azure.EventHubs/withEventHubsRoleAssignments',
            rpcArgs
    ...
    /** Assigns Event Hubs roles to a resource */
    withEventHubsRoleAssignments(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): AzureDataLakeStorageResourcePromise {
        return new AzureDataLakeStorageResourcePromise(this._withEventHubsRoleAssignmentsInternal(target, roles));
    }
...
export class AzureDataLakeStorageResourcePromise implements PromiseLike<AzureDataLakeStorageResource> {
    ...
    /** Assigns Event Hubs roles to a resource */
    withEventHubsRoleAssignments(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): AzureDataLakeStorageResourcePromise {
        return new AzureDataLakeStorageResourcePromise(this._promise.then(obj => obj.withEventHubsRoleAssignments(target, roles)));
    }
...
export class AzureEventHubConsumerGroupResource extends ResourceBuilderBase<AzureEventHubConsumerGroupResourceHandle> {
    constructor(handle: AzureEventHubConsumerGroupResourceHandle, client: AspireClientRpc) {
        super(handle, client);
    }

    /** @internal */
    private async _withUrlsCallbackInternal(callback: (obj: ResourceUrlsCallbackContext) => Promise<void>): Promise<AzureEventHubConsumerGroupResource> {
        const callbackId = registerCallback(async (objData: unknown) => {
            const objHandle = wrapIfHandle(objData) as ResourceUrlsCallbackContextHandle;
            const obj = new ResourceUrlsCallbackContext(objHandle, this._client);
            await callback(obj);
        ...
        const rpcArgs: Record<string, unknown> = { builder: this._handle, callback: callbackId };
        const result = await this._client.invokeCapability<AzureEventHubConsumerGroupResourceHandle>(
            'Aspire.Hosting/withUrlsCallback',
            rpcArgs
        );
        return new AzureEventHubConsumerGroupResource(result, this._client);
    }

    /** Customizes displayed URLs via callback */
    withUrlsCallback(callback: (obj: ResourceUrlsCallbackContext) => Promise<void>): AzureEventHubConsumerGroupResourcePromise {
        return new AzureEventHubConsumerGroupResourcePromise(this._withUrlsCallbackInternal(callback));
    }

    /** @internal */
    private async _withUrlsCallbackAsyncInternal(callback: (arg: ResourceUrlsCallbackContext) => Promise<void>): Promise<AzureEventHubConsumerGroupResource> {
        const callbackId = registerCallback(async (argData: unknown) => {
            const argHandle = wrapIfHandle(argData) as ResourceUrlsCallbackContextHandle;
            const arg = new ResourceUrlsCallbackContext(argHandle, this._client);
            await callback(arg);
    ...
    /** Customizes displayed URLs via async callback */
    withUrlsCallbackAsync(callback: (arg: ResourceUrlsCallbackContext) => Promise<void>): AzureEventHubConsumerGroupResourcePromise {
        return new AzureEventHubConsumerGroupResourcePromise(this._withUrlsCallbackAsyncInternal(callback));
    }

    /** @internal */
    private async _withUrlInternal(url: string, displayText?: string): Promise<AzureEventHubConsumerGroupResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, url };
        if (displayText !== undefined) rpcArgs.displayText = displayText;
        const result = await this._client.invokeCapability<AzureEventHubConsumerGroupResourceHandle>(
            'Aspire.Hosting/withUrl',
    ...
    /** Adds or modifies displayed URLs */
    withUrl(url: string, options?: WithUrlOptions): AzureEventHubConsumerGroupResourcePromise {
        const displayText = options?.displayText;
        return new AzureEventHubConsumerGroupResourcePromise(this._withUrlInternal(url, displayText));
    }

    /** @internal */
    private async _withUrlExpressionInternal(url: ReferenceExpression, displayText?: string): Promise<AzureEventHubConsumerGroupResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, url };
        if (displayText !== undefined) rpcArgs.displayText = displayText;
        const result = await this._client.invokeCapability<AzureEventHubConsumerGroupResourceHandle>(
            'Aspire.Hosting/withUrlExpression',
    ...
    /** Adds a URL using a reference expression */
    withUrlExpression(url: ReferenceExpression, options?: WithUrlExpressionOptions): AzureEventHubConsumerGroupResourcePromise {
        const displayText = options?.displayText;
        return new AzureEventHubConsumerGroupResourcePromise(this._withUrlExpressionInternal(url, displayText));
    }

    /** @internal */
    private async _withUrlForEndpointInternal(endpointName: string, callback: (obj: ResourceUrlAnnotation) => Promise<void>): Promise<AzureEventHubConsumerGroupResource> {
        const callbackId = registerCallback(async (objData: unknown) => {
            const obj = wrapIfHandle(objData) as ResourceUrlAnnotation;
            await callback(obj);
        });
    ...
    /** Customizes the URL for a specific endpoint via callback */
    withUrlForEndpoint(endpointName: string, callback: (obj: ResourceUrlAnnotation) => Promise<void>): AzureEventHubConsumerGroupResourcePromise {
        return new AzureEventHubConsumerGroupResourcePromise(this._withUrlForEndpointInternal(endpointName, callback));
    }

    /** @internal */
    private async _withExplicitStartInternal(): Promise<AzureEventHubConsumerGroupResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<AzureEventHubConsumerGroupResourceHandle>(
            'Aspire.Hosting/withExplicitStart',
            rpcArgs
    ...
    /** Prevents resource from starting automatically */
    withExplicitStart(): AzureEventHubConsumerGroupResourcePromise {
        return new AzureEventHubConsumerGroupResourcePromise(this._withExplicitStartInternal());
    }

    /** @internal */
    private async _withHealthCheckInternal(key: string): Promise<AzureEventHubConsumerGroupResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, key };
        const result = await this._client.invokeCapability<AzureEventHubConsumerGroupResourceHandle>(
            'Aspire.Hosting/withHealthCheck',
            rpcArgs
    ...
    /** Adds a health check by key */
    withHealthCheck(key: string): AzureEventHubConsumerGroupResourcePromise {
        return new AzureEventHubConsumerGroupResourcePromise(this._withHealthCheckInternal(key));
    }

    /** @internal */
    private async _withCommandInternal(name: string, displayName: string, executeCommand: (arg: ExecuteCommandContext) => Promise<ExecuteCommandResult>, commandOptions?: CommandOptions): Promise<AzureEventHubConsumerGroupResource> {
        const executeCommandId = registerCallback(async (argData: unknown) => {
            const argHandle = wrapIfHandle(argData) as ExecuteCommandContextHandle;
            const arg = new ExecuteCommandContext(argHandle, this._client);
            return await executeCommand(arg);
    ...
    /** Adds a resource command */
    withCommand(name: string, displayName: string, executeCommand: (arg: ExecuteCommandContext) => Promise<ExecuteCommandResult>, options?: WithCommandOptions): AzureEventHubConsumerGroupResourcePromise {
        const commandOptions = options?.commandOptions;
        return new AzureEventHubConsumerGroupResourcePromise(this._withCommandInternal(name, displayName, executeCommand, commandOptions));
    }

    /** @internal */
    private async _withParentRelationshipInternal(parent: ResourceBuilderBase): Promise<AzureEventHubConsumerGroupResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, parent };
        const result = await this._client.invokeCapability<AzureEventHubConsumerGroupResourceHandle>(
            'Aspire.Hosting/withParentRelationship',
            rpcArgs
    ...
    /** Sets the parent relationship */
    withParentRelationship(parent: ResourceBuilderBase): AzureEventHubConsumerGroupResourcePromise {
        return new AzureEventHubConsumerGroupResourcePromise(this._withParentRelationshipInternal(parent));
    }
    ...
    /** @internal */
    private async _withEventHubsRoleAssignmentsInternal(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): Promise<AzureEventHubConsumerGroupResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, target, roles };
        const result = await this._client.invokeCapability<AzureEventHubConsumerGroupResourceHandle>(
            'Aspire.Hosting.Azure.EventHubs/withEventHubsRoleAssignments',
            rpcArgs
    ...
    /** Assigns Event Hubs roles to a resource */
    withEventHubsRoleAssignments(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): AzureEventHubConsumerGroupResourcePromise {
        return new AzureEventHubConsumerGroupResourcePromise(this._withEventHubsRoleAssignmentsInternal(target, roles));
    }

    /** @internal */
    private async _withStorageRoleAssignmentsInternal(target: AzureStorageResource, roles: AzureStorageRole[]): Promise<AzureEventHubConsumerGroupResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, target, roles };
        const result = await this._client.invokeCapability<AzureEventHubConsumerGroupResourceHandle>(
            'Aspire.Hosting.Azure.Storage/withStorageRoleAssignments',
            rpcArgs
    ...
    /** Assigns Azure Storage roles to a resource */
    withStorageRoleAssignments(target: AzureStorageResource, roles: AzureStorageRole[]): AzureEventHubConsumerGroupResourcePromise {
        return new AzureEventHubConsumerGroupResourcePromise(this._withStorageRoleAssignmentsInternal(target, roles));
    }

}

/**
 * Thenable wrapper for AzureEventHubConsumerGroupResource that enables fluent chaining.
 * @example
 * await builder.addSomething().withX().withY();
 */
export class AzureEventHubConsumerGroupResourcePromise implements PromiseLike<AzureEventHubConsumerGroupResource> {
    constructor(private _promise: Promise<AzureEventHubConsumerGroupResource>) {}

    then<TResult1 = AzureEventHubConsumerGroupResource, TResult2 = never>(
        onfulfilled?: ((value: AzureEventHubConsumerGroupResource) => TResult1 | PromiseLike<TResult1>) | null,
        onrejected?: ((reason: unknown) => TResult2 | PromiseLike<TResult2>) | null
    ): PromiseLike<TResult1 | TResult2> {
        return this._promise.then(onfulfilled, onrejected);
    }
    ...
    /** Customizes displayed URLs via callback */
    withUrlsCallback(callback: (obj: ResourceUrlsCallbackContext) => Promise<void>): AzureEventHubConsumerGroupResourcePromise {
        return new AzureEventHubConsumerGroupResourcePromise(this._promise.then(obj => obj.withUrlsCallback(callback)));
    }

    /** Customizes displayed URLs via async callback */
    withUrlsCallbackAsync(callback: (arg: ResourceUrlsCallbackContext) => Promise<void>): AzureEventHubConsumerGroupResourcePromise {
        return new AzureEventHubConsumerGroupResourcePromise(this._promise.then(obj => obj.withUrlsCallbackAsync(callback)));
    }

    /** Adds or modifies displayed URLs */
    withUrl(url: string, options?: WithUrlOptions): AzureEventHubConsumerGroupResourcePromise {
        return new AzureEventHubConsumerGroupResourcePromise(this._promise.then(obj => obj.withUrl(url, options)));
    }

    /** Adds a URL using a reference expression */
    withUrlExpression(url: ReferenceExpression, options?: WithUrlExpressionOptions): AzureEventHubConsumerGroupResourcePromise {
        return new AzureEventHubConsumerGroupResourcePromise(this._promise.then(obj => obj.withUrlExpression(url, options)));
    }

    /** Customizes the URL for a specific endpoint via callback */
    withUrlForEndpoint(endpointName: string, callback: (obj: ResourceUrlAnnotation) => Promise<void>): AzureEventHubConsumerGroupResourcePromise {
        return new AzureEventHubConsumerGroupResourcePromise(this._promise.then(obj => obj.withUrlForEndpoint(endpointName, callback)));
    }

    /** Prevents resource from starting automatically */
    withExplicitStart(): AzureEventHubConsumerGroupResourcePromise {
        return new AzureEventHubConsumerGroupResourcePromise(this._promise.then(obj => obj.withExplicitStart()));
    }

    /** Adds a health check by key */
    withHealthCheck(key: string): AzureEventHubConsumerGroupResourcePromise {
        return new AzureEventHubConsumerGroupResourcePromise(this._promise.then(obj => obj.withHealthCheck(key)));
    }

    /** Adds a resource command */
    withCommand(name: string, displayName: string, executeCommand: (arg: ExecuteCommandContext) => Promise<ExecuteCommandResult>, options?: WithCommandOptions): AzureEventHubConsumerGroupResourcePromise {
        return new AzureEventHubConsumerGroupResourcePromise(this._promise.then(obj => obj.withCommand(name, displayName, executeCommand, options)));
    }

    /** Sets the parent relationship */
    withParentRelationship(parent: ResourceBuilderBase): AzureEventHubConsumerGroupResourcePromise {
        return new AzureEventHubConsumerGroupResourcePromise(this._promise.then(obj => obj.withParentRelationship(parent)));
    }
    ...
    /** Assigns Event Hubs roles to a resource */
    withEventHubsRoleAssignments(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): AzureEventHubConsumerGroupResourcePromise {
        return new AzureEventHubConsumerGroupResourcePromise(this._promise.then(obj => obj.withEventHubsRoleAssignments(target, roles)));
    }

    /** Assigns Azure Storage roles to a resource */
    withStorageRoleAssignments(target: AzureStorageResource, roles: AzureStorageRole[]): AzureEventHubConsumerGroupResourcePromise {
        return new AzureEventHubConsumerGroupResourcePromise(this._promise.then(obj => obj.withStorageRoleAssignments(target, roles)));
    }
...
export class AzureEventHubResource extends ResourceBuilderBase<AzureEventHubResourceHandle> {
    constructor(handle: AzureEventHubResourceHandle, client: AspireClientRpc) {
        super(handle, client);
    }
    ...
    hubName = {
        get: async (): Promise<string> => {
            return await this._client.invokeCapability<string>(
                'Aspire.Hosting.Azure/AzureEventHubResource.hubName',
                { context: this._handle }
            );
        },
        set: async (value: string): Promise<void> => {
            await this._client.invokeCapability<void>(
                'Aspire.Hosting.Azure/AzureEventHubResource.setHubName',
                { context: this._handle, value }
            );
        }
    };
    ...
    partitionCount = {
        get: async (): Promise<number> => {
            return await this._client.invokeCapability<number>(
                'Aspire.Hosting.Azure/AzureEventHubResource.partitionCount',
                { context: this._handle }
            );
        },
        set: async (value: number): Promise<void> => {
            await this._client.invokeCapability<void>(
                'Aspire.Hosting.Azure/AzureEventHubResource.setPartitionCount',
                { context: this._handle, value }
            );
        }
    };
    ...
    name = {
        get: async (): Promise<string> => {
            return await this._client.invokeCapability<string>(
                'Aspire.Hosting.Azure/AzureEventHubResource.name',
                { context: this._handle }
            );
        },
    };
    ...
    /** @internal */
    private async _withUrlsCallbackInternal(callback: (obj: ResourceUrlsCallbackContext) => Promise<void>): Promise<AzureEventHubResource> {
        const callbackId = registerCallback(async (objData: unknown) => {
            const objHandle = wrapIfHandle(objData) as ResourceUrlsCallbackContextHandle;
            const obj = new ResourceUrlsCallbackContext(objHandle, this._client);
            await callback(obj);
    ...
    /** Customizes displayed URLs via callback */
    withUrlsCallback(callback: (obj: ResourceUrlsCallbackContext) => Promise<void>): AzureEventHubResourcePromise {
        return new AzureEventHubResourcePromise(this._withUrlsCallbackInternal(callback));
    }

    /** @internal */
    private async _withUrlsCallbackAsyncInternal(callback: (arg: ResourceUrlsCallbackContext) => Promise<void>): Promise<AzureEventHubResource> {
        const callbackId = registerCallback(async (argData: unknown) => {
            const argHandle = wrapIfHandle(argData) as ResourceUrlsCallbackContextHandle;
            const arg = new ResourceUrlsCallbackContext(argHandle, this._client);
            await callback(arg);
    ...
    /** Customizes displayed URLs via async callback */
    withUrlsCallbackAsync(callback: (arg: ResourceUrlsCallbackContext) => Promise<void>): AzureEventHubResourcePromise {
        return new AzureEventHubResourcePromise(this._withUrlsCallbackAsyncInternal(callback));
    }

    /** @internal */
    private async _withUrlInternal(url: string, displayText?: string): Promise<AzureEventHubResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, url };
        if (displayText !== undefined) rpcArgs.displayText = displayText;
        const result = await this._client.invokeCapability<AzureEventHubResourceHandle>(
            'Aspire.Hosting/withUrl',
    ...
    /** Adds or modifies displayed URLs */
    withUrl(url: string, options?: WithUrlOptions): AzureEventHubResourcePromise {
        const displayText = options?.displayText;
        return new AzureEventHubResourcePromise(this._withUrlInternal(url, displayText));
    }

    /** @internal */
    private async _withUrlExpressionInternal(url: ReferenceExpression, displayText?: string): Promise<AzureEventHubResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, url };
        if (displayText !== undefined) rpcArgs.displayText = displayText;
        const result = await this._client.invokeCapability<AzureEventHubResourceHandle>(
            'Aspire.Hosting/withUrlExpression',
    ...
    /** Adds a URL using a reference expression */
    withUrlExpression(url: ReferenceExpression, options?: WithUrlExpressionOptions): AzureEventHubResourcePromise {
        const displayText = options?.displayText;
        return new AzureEventHubResourcePromise(this._withUrlExpressionInternal(url, displayText));
    }

    /** @internal */
    private async _withUrlForEndpointInternal(endpointName: string, callback: (obj: ResourceUrlAnnotation) => Promise<void>): Promise<AzureEventHubResource> {
        const callbackId = registerCallback(async (objData: unknown) => {
            const obj = wrapIfHandle(objData) as ResourceUrlAnnotation;
            await callback(obj);
        });
    ...
    /** Customizes the URL for a specific endpoint via callback */
    withUrlForEndpoint(endpointName: string, callback: (obj: ResourceUrlAnnotation) => Promise<void>): AzureEventHubResourcePromise {
        return new AzureEventHubResourcePromise(this._withUrlForEndpointInternal(endpointName, callback));
    }

    /** @internal */
    private async _withExplicitStartInternal(): Promise<AzureEventHubResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<AzureEventHubResourceHandle>(
            'Aspire.Hosting/withExplicitStart',
            rpcArgs
    ...
    /** Prevents resource from starting automatically */
    withExplicitStart(): AzureEventHubResourcePromise {
        return new AzureEventHubResourcePromise(this._withExplicitStartInternal());
    }

    /** @internal */
    private async _withHealthCheckInternal(key: string): Promise<AzureEventHubResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, key };
        const result = await this._client.invokeCapability<AzureEventHubResourceHandle>(
            'Aspire.Hosting/withHealthCheck',
            rpcArgs
    ...
    /** Adds a health check by key */
    withHealthCheck(key: string): AzureEventHubResourcePromise {
        return new AzureEventHubResourcePromise(this._withHealthCheckInternal(key));
    }

    /** @internal */
    private async _withCommandInternal(name: string, displayName: string, executeCommand: (arg: ExecuteCommandContext) => Promise<ExecuteCommandResult>, commandOptions?: CommandOptions): Promise<AzureEventHubResource> {
        const executeCommandId = registerCallback(async (argData: unknown) => {
            const argHandle = wrapIfHandle(argData) as ExecuteCommandContextHandle;
            const arg = new ExecuteCommandContext(argHandle, this._client);
            return await executeCommand(arg);
    ...
    /** Adds a resource command */
    withCommand(name: string, displayName: string, executeCommand: (arg: ExecuteCommandContext) => Promise<ExecuteCommandResult>, options?: WithCommandOptions): AzureEventHubResourcePromise {
        const commandOptions = options?.commandOptions;
        return new AzureEventHubResourcePromise(this._withCommandInternal(name, displayName, executeCommand, commandOptions));
    }

    /** @internal */
    private async _withParentRelationshipInternal(parent: ResourceBuilderBase): Promise<AzureEventHubResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, parent };
        const result = await this._client.invokeCapability<AzureEventHubResourceHandle>(
            'Aspire.Hosting/withParentRelationship',
            rpcArgs
    ...
    /** Sets the parent relationship */
    withParentRelationship(parent: ResourceBuilderBase): AzureEventHubResourcePromise {
        return new AzureEventHubResourcePromise(this._withParentRelationshipInternal(parent));
    }
    ...
    /** @internal */
    private async _withPropertiesInternal(configure: (obj: AzureEventHubResource) => Promise<void>): Promise<AzureEventHubResource> {
        const configureId = registerCallback(async (objData: unknown) => {
            const objHandle = wrapIfHandle(objData) as AzureEventHubResourceHandle;
            const obj = new AzureEventHubResource(objHandle, this._client);
            await configure(obj);
        });
        const rpcArgs: Record<string, unknown> = { builder: this._handle, configure: configureId };
        const result = await this._client.invokeCapability<AzureEventHubResourceHandle>(
            'Aspire.Hosting.Azure.EventHubs/withProperties',
            rpcArgs
        );
        return new AzureEventHubResource(result, this._client);
    }
    ...
    withProperties(configure: (obj: AzureEventHubResource) => Promise<void>): AzureEventHubResourcePromise {
        return new AzureEventHubResourcePromise(this._withPropertiesInternal(configure));
    }

    /** @internal */
    private async _addConsumerGroupInternal(name: string, groupName?: string): Promise<AzureEventHubConsumerGroupResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name };
        if (groupName !== undefined) rpcArgs.groupName = groupName;
        const result = await this._client.invokeCapability<AzureEventHubConsumerGroupResourceHandle>(
            'Aspire.Hosting.Azure.EventHubs/addConsumerGroup',
            rpcArgs
        );
        return new AzureEventHubConsumerGroupResource(result, this._client);
    }
    ...
    addConsumerGroup(name: string, options?: AddConsumerGroupOptions): AzureEventHubConsumerGroupResourcePromise {
        const groupName = options?.groupName;
        return new AzureEventHubConsumerGroupResourcePromise(this._addConsumerGroupInternal(name, groupName));
    }

    /** @internal */
    private async _withEventHubsRoleAssignmentsInternal(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): Promise<AzureEventHubResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, target, roles };
        const result = await this._client.invokeCapability<AzureEventHubResourceHandle>(
            'Aspire.Hosting.Azure.EventHubs/withEventHubsRoleAssignments',
            rpcArgs
    ...
    /** Assigns Event Hubs roles to a resource */
    withEventHubsRoleAssignments(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): AzureEventHubResourcePromise {
        return new AzureEventHubResourcePromise(this._withEventHubsRoleAssignmentsInternal(target, roles));
    }

    /** @internal */
    private async _withStorageRoleAssignmentsInternal(target: AzureStorageResource, roles: AzureStorageRole[]): Promise<AzureEventHubResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, target, roles };
        const result = await this._client.invokeCapability<AzureEventHubResourceHandle>(
            'Aspire.Hosting.Azure.Storage/withStorageRoleAssignments',
            rpcArgs
    ...
    /** Assigns Azure Storage roles to a resource */
    withStorageRoleAssignments(target: AzureStorageResource, roles: AzureStorageRole[]): AzureEventHubResourcePromise {
        return new AzureEventHubResourcePromise(this._withStorageRoleAssignmentsInternal(target, roles));
    }

}

/**
 * Thenable wrapper for AzureEventHubResource that enables fluent chaining.
 * @example
 * await builder.addSomething().withX().withY();
 */
export class AzureEventHubResourcePromise implements PromiseLike<AzureEventHubResource> {
    constructor(private _promise: Promise<AzureEventHubResource>) {}

    then<TResult1 = AzureEventHubResource, TResult2 = never>(
        onfulfilled?: ((value: AzureEventHubResource) => TResult1 | PromiseLike<TResult1>) | null,
        onrejected?: ((reason: unknown) => TResult2 | PromiseLike<TResult2>) | null
    ): PromiseLike<TResult1 | TResult2> {
        return this._promise.then(onfulfilled, onrejected);
    }
    ...
    /** Customizes displayed URLs via callback */
    withUrlsCallback(callback: (obj: ResourceUrlsCallbackContext) => Promise<void>): AzureEventHubResourcePromise {
        return new AzureEventHubResourcePromise(this._promise.then(obj => obj.withUrlsCallback(callback)));
    }

    /** Customizes displayed URLs via async callback */
    withUrlsCallbackAsync(callback: (arg: ResourceUrlsCallbackContext) => Promise<void>): AzureEventHubResourcePromise {
        return new AzureEventHubResourcePromise(this._promise.then(obj => obj.withUrlsCallbackAsync(callback)));
    }

    /** Adds or modifies displayed URLs */
    withUrl(url: string, options?: WithUrlOptions): AzureEventHubResourcePromise {
        return new AzureEventHubResourcePromise(this._promise.then(obj => obj.withUrl(url, options)));
    }

    /** Adds a URL using a reference expression */
    withUrlExpression(url: ReferenceExpression, options?: WithUrlExpressionOptions): AzureEventHubResourcePromise {
        return new AzureEventHubResourcePromise(this._promise.then(obj => obj.withUrlExpression(url, options)));
    }

    /** Customizes the URL for a specific endpoint via callback */
    withUrlForEndpoint(endpointName: string, callback: (obj: ResourceUrlAnnotation) => Promise<void>): AzureEventHubResourcePromise {
        return new AzureEventHubResourcePromise(this._promise.then(obj => obj.withUrlForEndpoint(endpointName, callback)));
    }

    /** Prevents resource from starting automatically */
    withExplicitStart(): AzureEventHubResourcePromise {
        return new AzureEventHubResourcePromise(this._promise.then(obj => obj.withExplicitStart()));
    }

    /** Adds a health check by key */
    withHealthCheck(key: string): AzureEventHubResourcePromise {
        return new AzureEventHubResourcePromise(this._promise.then(obj => obj.withHealthCheck(key)));
    }

    /** Adds a resource command */
    withCommand(name: string, displayName: string, executeCommand: (arg: ExecuteCommandContext) => Promise<ExecuteCommandResult>, options?: WithCommandOptions): AzureEventHubResourcePromise {
        return new AzureEventHubResourcePromise(this._promise.then(obj => obj.withCommand(name, displayName, executeCommand, options)));
    }

    /** Sets the parent relationship */
    withParentRelationship(parent: ResourceBuilderBase): AzureEventHubResourcePromise {
        return new AzureEventHubResourcePromise(this._promise.then(obj => obj.withParentRelationship(parent)));
    }
    ...
    /** Configures properties of an Azure Event Hub */
    withProperties(configure: (obj: AzureEventHubResource) => Promise<void>): AzureEventHubResourcePromise {
        return new AzureEventHubResourcePromise(this._promise.then(obj => obj.withProperties(configure)));
    }

    /** Adds an Azure Event Hub consumer group resource */
    addConsumerGroup(name: string, options?: AddConsumerGroupOptions): AzureEventHubConsumerGroupResourcePromise {
        return new AzureEventHubConsumerGroupResourcePromise(this._promise.then(obj => obj.addConsumerGroup(name, options)));
    }

    /** Assigns Event Hubs roles to a resource */
    withEventHubsRoleAssignments(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): AzureEventHubResourcePromise {
        return new AzureEventHubResourcePromise(this._promise.then(obj => obj.withEventHubsRoleAssignments(target, roles)));
    }

    /** Assigns Azure Storage roles to a resource */
    withStorageRoleAssignments(target: AzureStorageResource, roles: AzureStorageRole[]): AzureEventHubResourcePromise {
        return new AzureEventHubResourcePromise(this._promise.then(obj => obj.withStorageRoleAssignments(target, roles)));
    }
...
export class AzureEventHubsEmulatorResource extends ResourceBuilderBase<AzureEventHubsEmulatorResourceHandle> {
    constructor(handle: AzureEventHubsEmulatorResourceHandle, client: AspireClientRpc) {
        super(handle, client);
    }

    /** @internal */
    private async _withBindMountInternal(source: string, target: string, isReadOnly?: boolean): Promise<AzureEventHubsEmulatorResource> {
    ...
    /** Adds a bind mount */
    withBindMount(source: string, target: string, options?: WithBindMountOptions): AzureEventHubsEmulatorResourcePromise {
        const isReadOnly = options?.isReadOnly;
        return new AzureEventHubsEmulatorResourcePromise(this._withBindMountInternal(source, target, isReadOnly));
    }

    /** @internal */
    private async _withEntrypointInternal(entrypoint: string): Promise<AzureEventHubsEmulatorResource> {
    ...
    withEntrypoint(entrypoint: string): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._withEntrypointInternal(entrypoint));
    }

    /** @internal */
    private async _withImageTagInternal(tag: string): Promise<AzureEventHubsEmulatorResource> {
    ...
    withImageTag(tag: string): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._withImageTagInternal(tag));
    }

    /** @internal */
    private async _withImageRegistryInternal(registry: string): Promise<AzureEventHubsEmulatorResource> {
    ...
    withImageRegistry(registry: string): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._withImageRegistryInternal(registry));
    }

    /** @internal */
    private async _withImageInternal(image: string, tag?: string): Promise<AzureEventHubsEmulatorResource> {
    ...
    withImage(image: string, options?: WithImageOptions): AzureEventHubsEmulatorResourcePromise {
        const tag = options?.tag;
        return new AzureEventHubsEmulatorResourcePromise(this._withImageInternal(image, tag));
    }

    /** @internal */
    private async _withContainerRuntimeArgsInternal(args: string[]): Promise<AzureEventHubsEmulatorResource> {
    ...
    withContainerRuntimeArgs(args: string[]): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._withContainerRuntimeArgsInternal(args));
    }

    /** @internal */
    private async _withLifetimeInternal(lifetime: ContainerLifetime): Promise<AzureEventHubsEmulatorResource> {
    ...
    withLifetime(lifetime: ContainerLifetime): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._withLifetimeInternal(lifetime));
    }

    /** @internal */
    private async _withImagePullPolicyInternal(pullPolicy: ImagePullPolicy): Promise<AzureEventHubsEmulatorResource> {
    ...
    withImagePullPolicy(pullPolicy: ImagePullPolicy): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._withImagePullPolicyInternal(pullPolicy));
    }

    /** @internal */
    private async _withContainerNameInternal(name: string): Promise<AzureEventHubsEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name };
        const result = await this._client.invokeCapability<AzureEventHubsEmulatorResourceHandle>(
    ...
    withContainerName(name: string): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._withContainerNameInternal(name));
    }

    /** @internal */
    private async _withEnvironmentInternal(name: string, value: string): Promise<AzureEventHubsEmulatorResource> {
    ...
    withEnvironment(name: string, value: string): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._withEnvironmentInternal(name, value));
    }

    /** @internal */
    private async _withEnvironmentExpressionInternal(name: string, value: ReferenceExpression): Promise<AzureEventHubsEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, value };
        const result = await this._client.invokeCapability<AzureEventHubsEmulatorResourceHandle>(
    ...
    withEnvironmentExpression(name: string, value: ReferenceExpression): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._withEnvironmentExpressionInternal(name, value));
    }

    /** @internal */
    private async _withEnvironmentCallbackInternal(callback: (obj: EnvironmentCallbackContext) => Promise<void>): Promise<AzureEventHubsEmulatorResource> {
        const callbackId = registerCallback(async (objData: unknown) => {
    ...
    withEnvironmentCallback(callback: (obj: EnvironmentCallbackContext) => Promise<void>): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._withEnvironmentCallbackInternal(callback));
    }

    /** @internal */
    private async _withEnvironmentCallbackAsyncInternal(callback: (arg: EnvironmentCallbackContext) => Promise<void>): Promise<AzureEventHubsEmulatorResource> {
        const callbackId = registerCallback(async (argData: unknown) => {
    ...
    withEnvironmentCallbackAsync(callback: (arg: EnvironmentCallbackContext) => Promise<void>): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._withEnvironmentCallbackAsyncInternal(callback));
    }

    /** @internal */
    private async _withArgsInternal(args: string[]): Promise<AzureEventHubsEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, args };
        const result = await this._client.invokeCapability<AzureEventHubsEmulatorResourceHandle>(
    ...
    /** Adds arguments */
    withArgs(args: string[]): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._withArgsInternal(args));
    }

    /** @internal */
    private async _withArgsCallbackInternal(callback: (obj: CommandLineArgsCallbackContext) => Promise<void>): Promise<AzureEventHubsEmulatorResource> {
        const callbackId = registerCallback(async (objData: unknown) => {
    ...
    withArgsCallback(callback: (obj: CommandLineArgsCallbackContext) => Promise<void>): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._withArgsCallbackInternal(callback));
    }

    /** @internal */
    private async _withArgsCallbackAsyncInternal(callback: (arg: CommandLineArgsCallbackContext) => Promise<void>): Promise<AzureEventHubsEmulatorResource> {
        const callbackId = registerCallback(async (argData: unknown) => {
    ...
    withArgsCallbackAsync(callback: (arg: CommandLineArgsCallbackContext) => Promise<void>): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._withArgsCallbackAsyncInternal(callback));
    }

    /** @internal */
    private async _withReferenceInternal(source: ResourceBuilderBase, connectionName?: string, optional?: boolean): Promise<AzureEventHubsEmulatorResource> {
    ...
    withReference(source: ResourceBuilderBase, options?: WithReferenceOptions): AzureEventHubsEmulatorResourcePromise {
        const connectionName = options?.connectionName;
        const optional = options?.optional;
        return new AzureEventHubsEmulatorResourcePromise(this._withReferenceInternal(source, connectionName, optional));
    }

    /** @internal */
    private async _withServiceReferenceInternal(source: ResourceBuilderBase): Promise<AzureEventHubsEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, source };
        const result = await this._client.invokeCapability<AzureEventHubsEmulatorResourceHandle>(
    ...
    withServiceReference(source: ResourceBuilderBase): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._withServiceReferenceInternal(source));
    }

    /** @internal */
    private async _withEndpointInternal(port?: number, targetPort?: number, scheme?: string, name?: string, env?: string, isProxied?: boolean, isExternal?: boolean, protocol?: ProtocolType): Promise<AzureEventHubsEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
    ...
    withEndpoint(options?: WithEndpointOptions): AzureEventHubsEmulatorResourcePromise {
        ...
        return new AzureEventHubsEmulatorResourcePromise(this._withEndpointInternal(port, targetPort, scheme, name, env, isProxied, isExternal, protocol));
    }

    /** @internal */
    private async _withHttpEndpointInternal(port?: number, targetPort?: number, name?: string, env?: string, isProxied?: boolean): Promise<AzureEventHubsEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        if (port !== undefined) rpcArgs.port = port;
        if (targetPort !== undefined) rpcArgs.targetPort = targetPort;
        if (name !== undefined) rpcArgs.name = name;
    ...
    withHttpEndpoint(options?: WithHttpEndpointOptions): AzureEventHubsEmulatorResourcePromise {
        const port = options?.port;
        const targetPort = options?.targetPort;
        const name = options?.name;
        const env = options?.env;
        const isProxied = options?.isProxied;
        return new AzureEventHubsEmulatorResourcePromise(this._withHttpEndpointInternal(port, targetPort, name, env, isProxied));
    }

    /** @internal */
    private async _withHttpsEndpointInternal(port?: number, targetPort?: number, name?: string, env?: string, isProxied?: boolean): Promise<AzureEventHubsEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        if (port !== undefined) rpcArgs.port = port;
        if (targetPort !== undefined) rpcArgs.targetPort = targetPort;
        if (name !== undefined) rpcArgs.name = name;
    ...
    withHttpsEndpoint(options?: WithHttpsEndpointOptions): AzureEventHubsEmulatorResourcePromise {
        const port = options?.port;
        const targetPort = options?.targetPort;
        const name = options?.name;
        const env = options?.env;
        const isProxied = options?.isProxied;
        return new AzureEventHubsEmulatorResourcePromise(this._withHttpsEndpointInternal(port, targetPort, name, env, isProxied));
    }

    /** @internal */
    private async _withExternalHttpEndpointsInternal(): Promise<AzureEventHubsEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<AzureEventHubsEmulatorResourceHandle>(
    ...
    withExternalHttpEndpoints(): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._withExternalHttpEndpointsInternal());
    }
    ...
    /** @internal */
    private async _asHttp2ServiceInternal(): Promise<AzureEventHubsEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<AzureEventHubsEmulatorResourceHandle>(
    ...
    asHttp2Service(): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._asHttp2ServiceInternal());
    }

    /** @internal */
    private async _withUrlsCallbackInternal(callback: (obj: ResourceUrlsCallbackContext) => Promise<void>): Promise<AzureEventHubsEmulatorResource> {
        const callbackId = registerCallback(async (objData: unknown) => {
            const objHandle = wrapIfHandle(objData) as ResourceUrlsCallbackContextHandle;
            const obj = new ResourceUrlsCallbackContext(objHandle, this._client);
            await callback(obj);
    ...
    /** Customizes displayed URLs via callback */
    withUrlsCallback(callback: (obj: ResourceUrlsCallbackContext) => Promise<void>): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._withUrlsCallbackInternal(callback));
    }

    /** @internal */
    private async _withUrlsCallbackAsyncInternal(callback: (arg: ResourceUrlsCallbackContext) => Promise<void>): Promise<AzureEventHubsEmulatorResource> {
        const callbackId = registerCallback(async (argData: unknown) => {
            const argHandle = wrapIfHandle(argData) as ResourceUrlsCallbackContextHandle;
            const arg = new ResourceUrlsCallbackContext(argHandle, this._client);
            await callback(arg);
    ...
    /** Customizes displayed URLs via async callback */
    withUrlsCallbackAsync(callback: (arg: ResourceUrlsCallbackContext) => Promise<void>): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._withUrlsCallbackAsyncInternal(callback));
    }

    /** @internal */
    private async _withUrlInternal(url: string, displayText?: string): Promise<AzureEventHubsEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, url };
        if (displayText !== undefined) rpcArgs.displayText = displayText;
        const result = await this._client.invokeCapability<AzureEventHubsEmulatorResourceHandle>(
            'Aspire.Hosting/withUrl',
    ...
    /** Adds or modifies displayed URLs */
    withUrl(url: string, options?: WithUrlOptions): AzureEventHubsEmulatorResourcePromise {
        const displayText = options?.displayText;
        return new AzureEventHubsEmulatorResourcePromise(this._withUrlInternal(url, displayText));
    }

    /** @internal */
    private async _withUrlExpressionInternal(url: ReferenceExpression, displayText?: string): Promise<AzureEventHubsEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, url };
        if (displayText !== undefined) rpcArgs.displayText = displayText;
        const result = await this._client.invokeCapability<AzureEventHubsEmulatorResourceHandle>(
            'Aspire.Hosting/withUrlExpression',
    ...
    /** Adds a URL using a reference expression */
    withUrlExpression(url: ReferenceExpression, options?: WithUrlExpressionOptions): AzureEventHubsEmulatorResourcePromise {
        const displayText = options?.displayText;
        return new AzureEventHubsEmulatorResourcePromise(this._withUrlExpressionInternal(url, displayText));
    }

    /** @internal */
    private async _withUrlForEndpointInternal(endpointName: string, callback: (obj: ResourceUrlAnnotation) => Promise<void>): Promise<AzureEventHubsEmulatorResource> {
        const callbackId = registerCallback(async (objData: unknown) => {
            const obj = wrapIfHandle(objData) as ResourceUrlAnnotation;
            await callback(obj);
        });
    ...
    /** Customizes the URL for a specific endpoint via callback */
    withUrlForEndpoint(endpointName: string, callback: (obj: ResourceUrlAnnotation) => Promise<void>): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._withUrlForEndpointInternal(endpointName, callback));
    }

    /** @internal */
    private async _withUrlForEndpointFactoryInternal(endpointName: string, callback: (arg: EndpointReference) => Promise<ResourceUrlAnnotation>): Promise<AzureEventHubsEmulatorResource> {
        const callbackId = registerCallback(async (argData: unknown) => {
    ...
    withUrlForEndpointFactory(endpointName: string, callback: (arg: EndpointReference) => Promise<ResourceUrlAnnotation>): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._withUrlForEndpointFactoryInternal(endpointName, callback));
    }

    /** @internal */
    private async _waitForInternal(dependency: ResourceBuilderBase): Promise<AzureEventHubsEmulatorResource> {
    ...
    waitFor(dependency: ResourceBuilderBase): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._waitForInternal(dependency));
    }

    /** @internal */
    private async _withExplicitStartInternal(): Promise<AzureEventHubsEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<AzureEventHubsEmulatorResourceHandle>(
            'Aspire.Hosting/withExplicitStart',
            rpcArgs
    ...
    /** Prevents resource from starting automatically */
    withExplicitStart(): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._withExplicitStartInternal());
    }

    /** @internal */
    private async _waitForCompletionInternal(dependency: ResourceBuilderBase, exitCode?: number): Promise<AzureEventHubsEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, dependency };
    ...
    waitForCompletion(dependency: ResourceBuilderBase, options?: WaitForCompletionOptions): AzureEventHubsEmulatorResourcePromise {
        const exitCode = options?.exitCode;
        return new AzureEventHubsEmulatorResourcePromise(this._waitForCompletionInternal(dependency, exitCode));
    }

    /** @internal */
    private async _withHealthCheckInternal(key: string): Promise<AzureEventHubsEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, key };
        const result = await this._client.invokeCapability<AzureEventHubsEmulatorResourceHandle>(
            'Aspire.Hosting/withHealthCheck',
            rpcArgs
    ...
    /** Adds a health check by key */
    withHealthCheck(key: string): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._withHealthCheckInternal(key));
    }

    /** @internal */
    private async _withHttpHealthCheckInternal(path?: string, statusCode?: number, endpointName?: string): Promise<AzureEventHubsEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
    ...
    withHttpHealthCheck(options?: WithHttpHealthCheckOptions): AzureEventHubsEmulatorResourcePromise {
        const path = options?.path;
        const statusCode = options?.statusCode;
        const endpointName = options?.endpointName;
        return new AzureEventHubsEmulatorResourcePromise(this._withHttpHealthCheckInternal(path, statusCode, endpointName));
    }

    /** @internal */
    private async _withCommandInternal(name: string, displayName: string, executeCommand: (arg: ExecuteCommandContext) => Promise<ExecuteCommandResult>, commandOptions?: CommandOptions): Promise<AzureEventHubsEmulatorResource> {
        const executeCommandId = registerCallback(async (argData: unknown) => {
            const argHandle = wrapIfHandle(argData) as ExecuteCommandContextHandle;
            const arg = new ExecuteCommandContext(argHandle, this._client);
            return await executeCommand(arg);
    ...
    /** Adds a resource command */
    withCommand(name: string, displayName: string, executeCommand: (arg: ExecuteCommandContext) => Promise<ExecuteCommandResult>, options?: WithCommandOptions): AzureEventHubsEmulatorResourcePromise {
        const commandOptions = options?.commandOptions;
        return new AzureEventHubsEmulatorResourcePromise(this._withCommandInternal(name, displayName, executeCommand, commandOptions));
    }

    /** @internal */
    private async _withParentRelationshipInternal(parent: ResourceBuilderBase): Promise<AzureEventHubsEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, parent };
        const result = await this._client.invokeCapability<AzureEventHubsEmulatorResourceHandle>(
            'Aspire.Hosting/withParentRelationship',
            rpcArgs
    ...
    /** Sets the parent relationship */
    withParentRelationship(parent: ResourceBuilderBase): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._withParentRelationshipInternal(parent));
    }

    /** @internal */
    private async _withVolumeInternal(target: string, name?: string, isReadOnly?: boolean): Promise<AzureEventHubsEmulatorResource> {
    ...
    /** Adds a volume */
    withVolume(target: string, options?: WithVolumeOptions): AzureEventHubsEmulatorResourcePromise {
        const name = options?.name;
        const isReadOnly = options?.isReadOnly;
        return new AzureEventHubsEmulatorResourcePromise(this._withVolumeInternal(target, name, isReadOnly));
    }
    ...
    private async _withHostPortInternal(port?: number): Promise<AzureEventHubsEmulatorResource> {
        ...
        if (port !== undefined) rpcArgs.port = port;
        const result = await this._client.invokeCapability<AzureEventHubsEmulatorResourceHandle>(
            'Aspire.Hosting.Azure.EventHubs/withHostPort',
            rpcArgs
        );
        return new AzureEventHubsEmulatorResource(result, this._client);
    }
    ...
    withHostPort(options?: WithHostPortOptions): AzureEventHubsEmulatorResourcePromise {
        const port = options?.port;
        return new AzureEventHubsEmulatorResourcePromise(this._withHostPortInternal(port));
    }

    /** @internal */
    private async _withConfigurationFileInternal(path: string): Promise<AzureEventHubsEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, path };
        const result = await this._client.invokeCapability<AzureEventHubsEmulatorResourceHandle>(
            'Aspire.Hosting.Azure.EventHubs/withConfigurationFile',
            rpcArgs
        );
        return new AzureEventHubsEmulatorResource(result, this._client);
    }
    ...
    withConfigurationFile(path: string): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._withConfigurationFileInternal(path));
    }

    /** @internal */
    private async _withEventHubsRoleAssignmentsInternal(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): Promise<AzureEventHubsEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, target, roles };
        const result = await this._client.invokeCapability<AzureEventHubsEmulatorResourceHandle>(
            'Aspire.Hosting.Azure.EventHubs/withEventHubsRoleAssignments',
            rpcArgs
    ...
    /** @internal */
    private async _withStorageRoleAssignmentsInternal(target: AzureStorageResource, roles: AzureStorageRole[]): Promise<AzureEventHubsEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, target, roles };
        const result = await this._client.invokeCapability<AzureEventHubsEmulatorResourceHandle>(
            'Aspire.Hosting.Azure.Storage/withStorageRoleAssignments',
            rpcArgs
    ...
    /** Assigns Azure Storage roles to a resource */
    withStorageRoleAssignments(target: AzureStorageResource, roles: AzureStorageRole[]): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._withStorageRoleAssignmentsInternal(target, roles));
    }

}

/**
 * Thenable wrapper for AzureEventHubsEmulatorResource that enables fluent chaining.
 * @example
 * await builder.addSomething().withX().withY();
 */
export class AzureEventHubsEmulatorResourcePromise implements PromiseLike<AzureEventHubsEmulatorResource> {
    constructor(private _promise: Promise<AzureEventHubsEmulatorResource>) {}

    then<TResult1 = AzureEventHubsEmulatorResource, TResult2 = never>(
        onfulfilled?: ((value: AzureEventHubsEmulatorResource) => TResult1 | PromiseLike<TResult1>) | null,
        onrejected?: ((reason: unknown) => TResult2 | PromiseLike<TResult2>) | null
    ): PromiseLike<TResult1 | TResult2> {
        return this._promise.then(onfulfilled, onrejected);
    }
    ...
    /** Adds a bind mount */
    withBindMount(source: string, target: string, options?: WithBindMountOptions): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._promise.then(obj => obj.withBindMount(source, target, options)));
    }

    /** Sets the container entrypoint */
    withEntrypoint(entrypoint: string): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._promise.then(obj => obj.withEntrypoint(entrypoint)));
    }

    /** Sets the container image tag */
    withImageTag(tag: string): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._promise.then(obj => obj.withImageTag(tag)));
    }

    /** Sets the container image registry */
    withImageRegistry(registry: string): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._promise.then(obj => obj.withImageRegistry(registry)));
    }

    /** Sets the container image */
    withImage(image: string, options?: WithImageOptions): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._promise.then(obj => obj.withImage(image, options)));
    }

    /** Adds runtime arguments for the container */
    withContainerRuntimeArgs(args: string[]): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._promise.then(obj => obj.withContainerRuntimeArgs(args)));
    }

    /** Sets the lifetime behavior of the container resource */
    withLifetime(lifetime: ContainerLifetime): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._promise.then(obj => obj.withLifetime(lifetime)));
    }

    /** Sets the container image pull policy */
    withImagePullPolicy(pullPolicy: ImagePullPolicy): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._promise.then(obj => obj.withImagePullPolicy(pullPolicy)));
    }

    /** Sets the container name */
    withContainerName(name: string): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._promise.then(obj => obj.withContainerName(name)));
    }

    /** Sets an environment variable */
    withEnvironment(name: string, value: string): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._promise.then(obj => obj.withEnvironment(name, value)));
    }

    /** Adds an environment variable with a reference expression */
    withEnvironmentExpression(name: string, value: ReferenceExpression): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._promise.then(obj => obj.withEnvironmentExpression(name, value)));
    }

    /** Sets environment variables via callback */
    withEnvironmentCallback(callback: (obj: EnvironmentCallbackContext) => Promise<void>): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._promise.then(obj => obj.withEnvironmentCallback(callback)));
    }

    /** Sets environment variables via async callback */
    withEnvironmentCallbackAsync(callback: (arg: EnvironmentCallbackContext) => Promise<void>): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._promise.then(obj => obj.withEnvironmentCallbackAsync(callback)));
    }

    /** Adds arguments */
    withArgs(args: string[]): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._promise.then(obj => obj.withArgs(args)));
    }

    /** Sets command-line arguments via callback */
    withArgsCallback(callback: (obj: CommandLineArgsCallbackContext) => Promise<void>): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._promise.then(obj => obj.withArgsCallback(callback)));
    }

    /** Sets command-line arguments via async callback */
    withArgsCallbackAsync(callback: (arg: CommandLineArgsCallbackContext) => Promise<void>): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._promise.then(obj => obj.withArgsCallbackAsync(callback)));
    }

    /** Adds a reference to another resource */
    withReference(source: ResourceBuilderBase, options?: WithReferenceOptions): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._promise.then(obj => obj.withReference(source, options)));
    }

    /** Adds a service discovery reference to another resource */
    withServiceReference(source: ResourceBuilderBase): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._promise.then(obj => obj.withServiceReference(source)));
    }

    /** Adds a network endpoint */
    withEndpoint(options?: WithEndpointOptions): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._promise.then(obj => obj.withEndpoint(options)));
    }

    /** Adds an HTTP endpoint */
    withHttpEndpoint(options?: WithHttpEndpointOptions): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._promise.then(obj => obj.withHttpEndpoint(options)));
    }

    /** Adds an HTTPS endpoint */
    withHttpsEndpoint(options?: WithHttpsEndpointOptions): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._promise.then(obj => obj.withHttpsEndpoint(options)));
    }

    /** Makes HTTP endpoints externally accessible */
    withExternalHttpEndpoints(): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._promise.then(obj => obj.withExternalHttpEndpoints()));
    }
    ...
    /** Configures resource for HTTP/2 */
    asHttp2Service(): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._promise.then(obj => obj.asHttp2Service()));
    }

    /** Customizes displayed URLs via callback */
    withUrlsCallback(callback: (obj: ResourceUrlsCallbackContext) => Promise<void>): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._promise.then(obj => obj.withUrlsCallback(callback)));
    }

    /** Customizes displayed URLs via async callback */
    withUrlsCallbackAsync(callback: (arg: ResourceUrlsCallbackContext) => Promise<void>): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._promise.then(obj => obj.withUrlsCallbackAsync(callback)));
    }

    /** Adds or modifies displayed URLs */
    withUrl(url: string, options?: WithUrlOptions): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._promise.then(obj => obj.withUrl(url, options)));
    }

    /** Adds a URL using a reference expression */
    withUrlExpression(url: ReferenceExpression, options?: WithUrlExpressionOptions): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._promise.then(obj => obj.withUrlExpression(url, options)));
    }

    /** Customizes the URL for a specific endpoint via callback */
    withUrlForEndpoint(endpointName: string, callback: (obj: ResourceUrlAnnotation) => Promise<void>): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._promise.then(obj => obj.withUrlForEndpoint(endpointName, callback)));
    }

    /** Adds a URL for a specific endpoint via factory callback */
    withUrlForEndpointFactory(endpointName: string, callback: (arg: EndpointReference) => Promise<ResourceUrlAnnotation>): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._promise.then(obj => obj.withUrlForEndpointFactory(endpointName, callback)));
    }

    /** Waits for another resource to be ready */
    waitFor(dependency: ResourceBuilderBase): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._promise.then(obj => obj.waitFor(dependency)));
    }

    /** Prevents resource from starting automatically */
    withExplicitStart(): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._promise.then(obj => obj.withExplicitStart()));
    }

    /** Waits for resource completion */
    waitForCompletion(dependency: ResourceBuilderBase, options?: WaitForCompletionOptions): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._promise.then(obj => obj.waitForCompletion(dependency, options)));
    }

    /** Adds a health check by key */
    withHealthCheck(key: string): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._promise.then(obj => obj.withHealthCheck(key)));
    }

    /** Adds an HTTP health check */
    withHttpHealthCheck(options?: WithHttpHealthCheckOptions): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._promise.then(obj => obj.withHttpHealthCheck(options)));
    }

    /** Adds a resource command */
    withCommand(name: string, displayName: string, executeCommand: (arg: ExecuteCommandContext) => Promise<ExecuteCommandResult>, options?: WithCommandOptions): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._promise.then(obj => obj.withCommand(name, displayName, executeCommand, options)));
    }

    /** Sets the parent relationship */
    withParentRelationship(parent: ResourceBuilderBase): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._promise.then(obj => obj.withParentRelationship(parent)));
    }

    /** Adds a volume */
    withVolume(target: string, options?: WithVolumeOptions): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._promise.then(obj => obj.withVolume(target, options)));
    }
    ...
    /** Sets an environment variable from an Azure Key Vault secret reference */
    withEnvironmentFromKeyVaultSecret(name: string, secretReference: ResourceBuilderBase): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._promise.then(obj => obj.withEnvironmentFromKeyVaultSecret(name, secretReference)));
    }
...
export class AzureEventHubsResource extends ResourceBuilderBase<AzureEventHubsResourceHandle> {
    constructor(handle: AzureEventHubsResourceHandle, client: AspireClientRpc) {
        super(handle, client);
    }

    /** @internal */
    private async _withEndpointInternal(port?: number, targetPort?: number, scheme?: string, name?: string, env?: string, isProxied?: boolean, isExternal?: boolean, protocol?: ProtocolType): Promise<AzureEventHubsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        if (port !== undefined) rpcArgs.port = port;
        if (targetPort !== undefined) rpcArgs.targetPort = targetPort;
        if (scheme !== undefined) rpcArgs.scheme = scheme;
    ...
    /** Adds a network endpoint */
    withEndpoint(options?: WithEndpointOptions): AzureEventHubsResourcePromise {
        const port = options?.port;
        const targetPort = options?.targetPort;
        const scheme = options?.scheme;
        const name = options?.name;
        ...
        const isExternal = options?.isExternal;
        const protocol = options?.protocol;
        return new AzureEventHubsResourcePromise(this._withEndpointInternal(port, targetPort, scheme, name, env, isProxied, isExternal, protocol));
    }

    /** @internal */
    private async _withHttpEndpointInternal(port?: number, targetPort?: number, name?: string, env?: string, isProxied?: boolean): Promise<AzureEventHubsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        if (port !== undefined) rpcArgs.port = port;
        if (targetPort !== undefined) rpcArgs.targetPort = targetPort;
        if (name !== undefined) rpcArgs.name = name;
    ...
    /** Adds an HTTP endpoint */
    withHttpEndpoint(options?: WithHttpEndpointOptions): AzureEventHubsResourcePromise {
        const port = options?.port;
        const targetPort = options?.targetPort;
        const name = options?.name;
        const env = options?.env;
        const isProxied = options?.isProxied;
        return new AzureEventHubsResourcePromise(this._withHttpEndpointInternal(port, targetPort, name, env, isProxied));
    }

    /** @internal */
    private async _withHttpsEndpointInternal(port?: number, targetPort?: number, name?: string, env?: string, isProxied?: boolean): Promise<AzureEventHubsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        if (port !== undefined) rpcArgs.port = port;
        if (targetPort !== undefined) rpcArgs.targetPort = targetPort;
        if (name !== undefined) rpcArgs.name = name;
    ...
    /** Adds an HTTPS endpoint */
    withHttpsEndpoint(options?: WithHttpsEndpointOptions): AzureEventHubsResourcePromise {
        const port = options?.port;
        const targetPort = options?.targetPort;
        const name = options?.name;
        const env = options?.env;
        const isProxied = options?.isProxied;
        return new AzureEventHubsResourcePromise(this._withHttpsEndpointInternal(port, targetPort, name, env, isProxied));
    }

    /** @internal */
    private async _withExternalHttpEndpointsInternal(): Promise<AzureEventHubsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<AzureEventHubsResourceHandle>(
            'Aspire.Hosting/withExternalHttpEndpoints',
            rpcArgs
    ...
    /** Makes HTTP endpoints externally accessible */
    withExternalHttpEndpoints(): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._withExternalHttpEndpointsInternal());
    }
    ...
    /** @internal */
    private async _asHttp2ServiceInternal(): Promise<AzureEventHubsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<AzureEventHubsResourceHandle>(
            'Aspire.Hosting/asHttp2Service',
            rpcArgs
    ...
    /** Configures resource for HTTP/2 */
    asHttp2Service(): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._asHttp2ServiceInternal());
    }

    /** @internal */
    private async _withUrlsCallbackInternal(callback: (obj: ResourceUrlsCallbackContext) => Promise<void>): Promise<AzureEventHubsResource> {
        const callbackId = registerCallback(async (objData: unknown) => {
            const objHandle = wrapIfHandle(objData) as ResourceUrlsCallbackContextHandle;
            const obj = new ResourceUrlsCallbackContext(objHandle, this._client);
            await callback(obj);
    ...
    /** Customizes displayed URLs via callback */
    withUrlsCallback(callback: (obj: ResourceUrlsCallbackContext) => Promise<void>): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._withUrlsCallbackInternal(callback));
    }

    /** @internal */
    private async _withUrlsCallbackAsyncInternal(callback: (arg: ResourceUrlsCallbackContext) => Promise<void>): Promise<AzureEventHubsResource> {
        const callbackId = registerCallback(async (argData: unknown) => {
            const argHandle = wrapIfHandle(argData) as ResourceUrlsCallbackContextHandle;
            const arg = new ResourceUrlsCallbackContext(argHandle, this._client);
            await callback(arg);
    ...
    /** Customizes displayed URLs via async callback */
    withUrlsCallbackAsync(callback: (arg: ResourceUrlsCallbackContext) => Promise<void>): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._withUrlsCallbackAsyncInternal(callback));
    }

    /** @internal */
    private async _withUrlInternal(url: string, displayText?: string): Promise<AzureEventHubsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, url };
        if (displayText !== undefined) rpcArgs.displayText = displayText;
        const result = await this._client.invokeCapability<AzureEventHubsResourceHandle>(
            'Aspire.Hosting/withUrl',
    ...
    /** Adds or modifies displayed URLs */
    withUrl(url: string, options?: WithUrlOptions): AzureEventHubsResourcePromise {
        const displayText = options?.displayText;
        return new AzureEventHubsResourcePromise(this._withUrlInternal(url, displayText));
    }

    /** @internal */
    private async _withUrlExpressionInternal(url: ReferenceExpression, displayText?: string): Promise<AzureEventHubsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, url };
        if (displayText !== undefined) rpcArgs.displayText = displayText;
        const result = await this._client.invokeCapability<AzureEventHubsResourceHandle>(
            'Aspire.Hosting/withUrlExpression',
    ...
    /** Adds a URL using a reference expression */
    withUrlExpression(url: ReferenceExpression, options?: WithUrlExpressionOptions): AzureEventHubsResourcePromise {
        const displayText = options?.displayText;
        return new AzureEventHubsResourcePromise(this._withUrlExpressionInternal(url, displayText));
    }

    /** @internal */
    private async _withUrlForEndpointInternal(endpointName: string, callback: (obj: ResourceUrlAnnotation) => Promise<void>): Promise<AzureEventHubsResource> {
        const callbackId = registerCallback(async (objData: unknown) => {
            const obj = wrapIfHandle(objData) as ResourceUrlAnnotation;
            await callback(obj);
        });
    ...
    /** Customizes the URL for a specific endpoint via callback */
    withUrlForEndpoint(endpointName: string, callback: (obj: ResourceUrlAnnotation) => Promise<void>): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._withUrlForEndpointInternal(endpointName, callback));
    }

    /** @internal */
    private async _withUrlForEndpointFactoryInternal(endpointName: string, callback: (arg: EndpointReference) => Promise<ResourceUrlAnnotation>): Promise<AzureEventHubsResource> {
        const callbackId = registerCallback(async (argData: unknown) => {
            const argHandle = wrapIfHandle(argData) as EndpointReferenceHandle;
            const arg = new EndpointReference(argHandle, this._client);
            return await callback(arg);
    ...
    /** Adds a URL for a specific endpoint via factory callback */
    withUrlForEndpointFactory(endpointName: string, callback: (arg: EndpointReference) => Promise<ResourceUrlAnnotation>): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._withUrlForEndpointFactoryInternal(endpointName, callback));
    }

    /** @internal */
    private async _withExplicitStartInternal(): Promise<AzureEventHubsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<AzureEventHubsResourceHandle>(
            'Aspire.Hosting/withExplicitStart',
            rpcArgs
    ...
    /** Prevents resource from starting automatically */
    withExplicitStart(): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._withExplicitStartInternal());
    }

    /** @internal */
    private async _withHealthCheckInternal(key: string): Promise<AzureEventHubsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, key };
        const result = await this._client.invokeCapability<AzureEventHubsResourceHandle>(
            'Aspire.Hosting/withHealthCheck',
            rpcArgs
    ...
    /** Adds a health check by key */
    withHealthCheck(key: string): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._withHealthCheckInternal(key));
    }

    /** @internal */
    private async _withHttpHealthCheckInternal(path?: string, statusCode?: number, endpointName?: string): Promise<AzureEventHubsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        if (path !== undefined) rpcArgs.path = path;
        if (statusCode !== undefined) rpcArgs.statusCode = statusCode;
        if (endpointName !== undefined) rpcArgs.endpointName = endpointName;
    ...
    /** Adds an HTTP health check */
    withHttpHealthCheck(options?: WithHttpHealthCheckOptions): AzureEventHubsResourcePromise {
        const path = options?.path;
        const statusCode = options?.statusCode;
        const endpointName = options?.endpointName;
        return new AzureEventHubsResourcePromise(this._withHttpHealthCheckInternal(path, statusCode, endpointName));
    }

    /** @internal */
    private async _withCommandInternal(name: string, displayName: string, executeCommand: (arg: ExecuteCommandContext) => Promise<ExecuteCommandResult>, commandOptions?: CommandOptions): Promise<AzureEventHubsResource> {
        const executeCommandId = registerCallback(async (argData: unknown) => {
            const argHandle = wrapIfHandle(argData) as ExecuteCommandContextHandle;
            const arg = new ExecuteCommandContext(argHandle, this._client);
            return await executeCommand(arg);
    ...
    /** Adds a resource command */
    withCommand(name: string, displayName: string, executeCommand: (arg: ExecuteCommandContext) => Promise<ExecuteCommandResult>, options?: WithCommandOptions): AzureEventHubsResourcePromise {
        const commandOptions = options?.commandOptions;
        return new AzureEventHubsResourcePromise(this._withCommandInternal(name, displayName, executeCommand, commandOptions));
    }

    /** @internal */
    private async _withParentRelationshipInternal(parent: ResourceBuilderBase): Promise<AzureEventHubsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, parent };
        const result = await this._client.invokeCapability<AzureEventHubsResourceHandle>(
            'Aspire.Hosting/withParentRelationship',
            rpcArgs
    ...
    /** Sets the parent relationship */
    withParentRelationship(parent: ResourceBuilderBase): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._withParentRelationshipInternal(parent));
    }
    ...
    /** @internal */
    private async _withParameterInternal(name: string): Promise<AzureEventHubsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name };
        const result = await this._client.invokeCapability<AzureEventHubsResourceHandle>(
    ...
    withParameter(name: string): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._withParameterInternal(name));
    }

    /** @internal */
    private async _withParameterStringValueInternal(name: string, value: string): Promise<AzureEventHubsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, value };
        const result = await this._client.invokeCapability<AzureEventHubsResourceHandle>(
    ...
    withParameterStringValue(name: string, value: string): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._withParameterStringValueInternal(name, value));
    }

    /** @internal */
    private async _withParameterStringValuesInternal(name: string, value: string[]): Promise<AzureEventHubsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, value };
        const result = await this._client.invokeCapability<AzureEventHubsResourceHandle>(
    ...
    withParameterStringValues(name: string, value: string[]): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._withParameterStringValuesInternal(name, value));
    }

    /** @internal */
    private async _withParameterFromParameterInternal(name: string, value: ParameterResource): Promise<AzureEventHubsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, value };
        const result = await this._client.invokeCapability<AzureEventHubsResourceHandle>(
    ...
    withParameterFromParameter(name: string, value: ParameterResource): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._withParameterFromParameterInternal(name, value));
    }

    /** @internal */
    private async _withParameterFromConnectionStringInternal(name: string, value: ResourceBuilderBase): Promise<AzureEventHubsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, value };
        const result = await this._client.invokeCapability<AzureEventHubsResourceHandle>(
    ...
    withParameterFromConnectionString(name: string, value: ResourceBuilderBase): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._withParameterFromConnectionStringInternal(name, value));
    }

    /** @internal */
    private async _withParameterFromOutputInternal(name: string, value: BicepOutputReference): Promise<AzureEventHubsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, value };
        const result = await this._client.invokeCapability<AzureEventHubsResourceHandle>(
    ...
    withParameterFromOutput(name: string, value: BicepOutputReference): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._withParameterFromOutputInternal(name, value));
    }

    /** @internal */
    private async _withParameterFromReferenceExpressionInternal(name: string, value: ReferenceExpression): Promise<AzureEventHubsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, value };
        const result = await this._client.invokeCapability<AzureEventHubsResourceHandle>(
    ...
    withParameterFromReferenceExpression(name: string, value: ReferenceExpression): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._withParameterFromReferenceExpressionInternal(name, value));
    }

    /** @internal */
    private async _withParameterFromEndpointInternal(name: string, value: EndpointReference): Promise<AzureEventHubsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, value };
        const result = await this._client.invokeCapability<AzureEventHubsResourceHandle>(
    ...
    withParameterFromEndpoint(name: string, value: EndpointReference): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._withParameterFromEndpointInternal(name, value));
    }

    /** @internal */
    private async _configureInfrastructureInternal(configure: (obj: AzureResourceInfrastructure) => Promise<void>): Promise<AzureEventHubsResource> {
        const configureId = registerCallback(async (objData: unknown) => {
            const objHandle = wrapIfHandle(objData) as AzureResourceInfrastructureHandle;
            const obj = new AzureResourceInfrastructure(objHandle, this._client);
            await configure(obj);
    ...
    configureInfrastructure(configure: (obj: AzureResourceInfrastructure) => Promise<void>): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._configureInfrastructureInternal(configure));
    }

    /** @internal */
    private async _publishAsConnectionStringInternal(): Promise<AzureEventHubsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<AzureEventHubsResourceHandle>(
            'Aspire.Hosting.Azure/publishAsConnectionString',
            rpcArgs
    ...
    /** Publishes an Azure resource to the manifest as a connection string */
    publishAsConnectionString(): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._publishAsConnectionStringInternal());
    }
    ...
    /** @internal */
    private async _clearDefaultRoleAssignmentsInternal(): Promise<AzureEventHubsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<AzureEventHubsResourceHandle>(
            'Aspire.Hosting.Azure/clearDefaultRoleAssignments',
            rpcArgs
    ...
    /** Clears the default Azure role assignments from a resource */
    clearDefaultRoleAssignments(): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._clearDefaultRoleAssignmentsInternal());
    }
    ...
    /** @internal */
    private async _runAsExistingFromParametersInternal(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): Promise<AzureEventHubsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, nameParameter, resourceGroupParameter };
        const result = await this._client.invokeCapability<AzureEventHubsResourceHandle>(
            'Aspire.Hosting.Azure/runAsExistingFromParameters',
            rpcArgs
    ...
    /** Marks an Azure resource as existing in run mode by using parameter resources */
    runAsExistingFromParameters(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._runAsExistingFromParametersInternal(nameParameter, resourceGroupParameter));
    }

    /** @internal */
    private async _runAsExistingInternal(name: string, resourceGroup: string): Promise<AzureEventHubsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, resourceGroup };
        const result = await this._client.invokeCapability<AzureEventHubsResourceHandle>(
            'Aspire.Hosting.Azure/runAsExisting',
            rpcArgs
    ...
    /** Marks an Azure resource as existing in run mode */
    runAsExisting(name: string, resourceGroup: string): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._runAsExistingInternal(name, resourceGroup));
    }

    /** @internal */
    private async _publishAsExistingFromParametersInternal(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): Promise<AzureEventHubsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, nameParameter, resourceGroupParameter };
        const result = await this._client.invokeCapability<AzureEventHubsResourceHandle>(
            'Aspire.Hosting.Azure/publishAsExistingFromParameters',
            rpcArgs
    ...
    /** Marks an Azure resource as existing in publish mode by using parameter resources */
    publishAsExistingFromParameters(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._publishAsExistingFromParametersInternal(nameParameter, resourceGroupParameter));
    }

    /** @internal */
    private async _publishAsExistingInternal(name: string, resourceGroup: string): Promise<AzureEventHubsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, resourceGroup };
        const result = await this._client.invokeCapability<AzureEventHubsResourceHandle>(
            'Aspire.Hosting.Azure/publishAsExisting',
            rpcArgs
    ...
    /** Marks an Azure resource as existing in publish mode */
    publishAsExisting(name: string, resourceGroup: string): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._publishAsExistingInternal(name, resourceGroup));
    }

    /** @internal */
    private async _asExistingInternal(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): Promise<AzureEventHubsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, nameParameter, resourceGroupParameter };
        const result = await this._client.invokeCapability<AzureEventHubsResourceHandle>(
            'Aspire.Hosting.Azure/asExisting',
            rpcArgs
    ...
    /** @internal */
    private async _withStorageRoleAssignmentsInternal(target: AzureStorageResource, roles: AzureStorageRole[]): Promise<AzureEventHubsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, target, roles };
        const result = await this._client.invokeCapability<AzureEventHubsResourceHandle>(
            'Aspire.Hosting.Azure.Storage/withStorageRoleAssignments',
            rpcArgs
    ...
    /** Assigns Azure Storage roles to a resource */
    withStorageRoleAssignments(target: AzureStorageResource, roles: AzureStorageRole[]): AzureEventHubsResourcePromise {
...
/**
 * Thenable wrapper for AzureEventHubsResource that enables fluent chaining.
 * @example
 * await builder.addSomething().withX().withY();
 */
export class AzureEventHubsResourcePromise implements PromiseLike<AzureEventHubsResource> {
    constructor(private _promise: Promise<AzureEventHubsResource>) {}

    then<TResult1 = AzureEventHubsResource, TResult2 = never>(
        onfulfilled?: ((value: AzureEventHubsResource) => TResult1 | PromiseLike<TResult1>) | null,
        onrejected?: ((reason: unknown) => TResult2 | PromiseLike<TResult2>) | null
    ): PromiseLike<TResult1 | TResult2> {
        return this._promise.then(onfulfilled, onrejected);
    }
    ...
    /** Adds a network endpoint */
    withEndpoint(options?: WithEndpointOptions): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._promise.then(obj => obj.withEndpoint(options)));
    }

    /** Adds an HTTP endpoint */
    withHttpEndpoint(options?: WithHttpEndpointOptions): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._promise.then(obj => obj.withHttpEndpoint(options)));
    }

    /** Adds an HTTPS endpoint */
    withHttpsEndpoint(options?: WithHttpsEndpointOptions): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._promise.then(obj => obj.withHttpsEndpoint(options)));
    }

    /** Makes HTTP endpoints externally accessible */
    withExternalHttpEndpoints(): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._promise.then(obj => obj.withExternalHttpEndpoints()));
    }
    ...
    /** Configures resource for HTTP/2 */
    asHttp2Service(): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._promise.then(obj => obj.asHttp2Service()));
    }

    /** Customizes displayed URLs via callback */
    withUrlsCallback(callback: (obj: ResourceUrlsCallbackContext) => Promise<void>): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._promise.then(obj => obj.withUrlsCallback(callback)));
    }

    /** Customizes displayed URLs via async callback */
    withUrlsCallbackAsync(callback: (arg: ResourceUrlsCallbackContext) => Promise<void>): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._promise.then(obj => obj.withUrlsCallbackAsync(callback)));
    }

    /** Adds or modifies displayed URLs */
    withUrl(url: string, options?: WithUrlOptions): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._promise.then(obj => obj.withUrl(url, options)));
    }

    /** Adds a URL using a reference expression */
    withUrlExpression(url: ReferenceExpression, options?: WithUrlExpressionOptions): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._promise.then(obj => obj.withUrlExpression(url, options)));
    }

    /** Customizes the URL for a specific endpoint via callback */
    withUrlForEndpoint(endpointName: string, callback: (obj: ResourceUrlAnnotation) => Promise<void>): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._promise.then(obj => obj.withUrlForEndpoint(endpointName, callback)));
    }

    /** Adds a URL for a specific endpoint via factory callback */
    withUrlForEndpointFactory(endpointName: string, callback: (arg: EndpointReference) => Promise<ResourceUrlAnnotation>): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._promise.then(obj => obj.withUrlForEndpointFactory(endpointName, callback)));
    }

    /** Prevents resource from starting automatically */
    withExplicitStart(): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._promise.then(obj => obj.withExplicitStart()));
    }

    /** Adds a health check by key */
    withHealthCheck(key: string): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._promise.then(obj => obj.withHealthCheck(key)));
    }

    /** Adds an HTTP health check */
    withHttpHealthCheck(options?: WithHttpHealthCheckOptions): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._promise.then(obj => obj.withHttpHealthCheck(options)));
    }

    /** Adds a resource command */
    withCommand(name: string, displayName: string, executeCommand: (arg: ExecuteCommandContext) => Promise<ExecuteCommandResult>, options?: WithCommandOptions): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._promise.then(obj => obj.withCommand(name, displayName, executeCommand, options)));
    }

    /** Sets the parent relationship */
    withParentRelationship(parent: ResourceBuilderBase): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._promise.then(obj => obj.withParentRelationship(parent)));
    }
    ...
    /** Adds a Bicep parameter without a value */
    withParameter(name: string): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._promise.then(obj => obj.withParameter(name)));
    }

    /** Adds a Bicep parameter with a string value */
    withParameterStringValue(name: string, value: string): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._promise.then(obj => obj.withParameterStringValue(name, value)));
    }

    /** Adds a Bicep parameter with a string list value */
    withParameterStringValues(name: string, value: string[]): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._promise.then(obj => obj.withParameterStringValues(name, value)));
    }

    /** Adds a Bicep parameter from a parameter resource builder */
    withParameterFromParameter(name: string, value: ParameterResource): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._promise.then(obj => obj.withParameterFromParameter(name, value)));
    }

    /** Adds a Bicep parameter from a connection string resource builder */
    withParameterFromConnectionString(name: string, value: ResourceBuilderBase): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._promise.then(obj => obj.withParameterFromConnectionString(name, value)));
    }

    /** Adds a Bicep parameter from another Bicep output reference */
    withParameterFromOutput(name: string, value: BicepOutputReference): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._promise.then(obj => obj.withParameterFromOutput(name, value)));
    }

    /** Adds a Bicep parameter from a reference expression */
    withParameterFromReferenceExpression(name: string, value: ReferenceExpression): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._promise.then(obj => obj.withParameterFromReferenceExpression(name, value)));
    }

    /** Adds a Bicep parameter from an endpoint reference */
    withParameterFromEndpoint(name: string, value: EndpointReference): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._promise.then(obj => obj.withParameterFromEndpoint(name, value)));
    }

    /** Configures the Azure provisioning infrastructure callback */
    configureInfrastructure(configure: (obj: AzureResourceInfrastructure) => Promise<void>): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._promise.then(obj => obj.configureInfrastructure(configure)));
    }

    /** Publishes an Azure resource to the manifest as a connection string */
    publishAsConnectionString(): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._promise.then(obj => obj.publishAsConnectionString()));
    }
    ...
    /** Clears the default Azure role assignments from a resource */
    clearDefaultRoleAssignments(): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._promise.then(obj => obj.clearDefaultRoleAssignments()));
    }
    ...
    /** Marks an Azure resource as existing in run mode by using parameter resources */
    runAsExistingFromParameters(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._promise.then(obj => obj.runAsExistingFromParameters(nameParameter, resourceGroupParameter)));
    }

    /** Marks an Azure resource as existing in run mode */
    runAsExisting(name: string, resourceGroup: string): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._promise.then(obj => obj.runAsExisting(name, resourceGroup)));
    }

    /** Marks an Azure resource as existing in publish mode by using parameter resources */
    publishAsExistingFromParameters(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._promise.then(obj => obj.publishAsExistingFromParameters(nameParameter, resourceGroupParameter)));
    }

    /** Marks an Azure resource as existing in publish mode */
    publishAsExisting(name: string, resourceGroup: string): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._promise.then(obj => obj.publishAsExisting(name, resourceGroup)));
    }
...
export class AzureQueueStorageQueueResource extends ResourceBuilderBase<AzureQueueStorageQueueResourceHandle> {
    ...
    /** @internal */
    private async _withEventHubsRoleAssignmentsInternal(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): Promise<AzureQueueStorageQueueResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, target, roles };
        const result = await this._client.invokeCapability<AzureQueueStorageQueueResourceHandle>(
            'Aspire.Hosting.Azure.EventHubs/withEventHubsRoleAssignments',
            rpcArgs
    ...
    /** Assigns Event Hubs roles to a resource */
    withEventHubsRoleAssignments(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): AzureQueueStorageQueueResourcePromise {
        return new AzureQueueStorageQueueResourcePromise(this._withEventHubsRoleAssignmentsInternal(target, roles));
    }
...
export class AzureQueueStorageQueueResourcePromise implements PromiseLike<AzureQueueStorageQueueResource> {
    ...
    /** Assigns Event Hubs roles to a resource */
    withEventHubsRoleAssignments(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): AzureQueueStorageQueueResourcePromise {
        return new AzureQueueStorageQueueResourcePromise(this._promise.then(obj => obj.withEventHubsRoleAssignments(target, roles)));
    }
...
export class AzureQueueStorageResource extends ResourceBuilderBase<AzureQueueStorageResourceHandle> {
    ...
    /** @internal */
    private async _withEventHubsRoleAssignmentsInternal(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): Promise<AzureQueueStorageResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, target, roles };
        const result = await this._client.invokeCapability<AzureQueueStorageResourceHandle>(
            'Aspire.Hosting.Azure.EventHubs/withEventHubsRoleAssignments',
            rpcArgs
    ...
    /** Assigns Event Hubs roles to a resource */
    withEventHubsRoleAssignments(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): AzureQueueStorageResourcePromise {
        return new AzureQueueStorageResourcePromise(this._withEventHubsRoleAssignmentsInternal(target, roles));
    }
...
export class AzureQueueStorageResourcePromise implements PromiseLike<AzureQueueStorageResource> {
    ...
    /** Assigns Event Hubs roles to a resource */
    withEventHubsRoleAssignments(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): AzureQueueStorageResourcePromise {
        return new AzureQueueStorageResourcePromise(this._promise.then(obj => obj.withEventHubsRoleAssignments(target, roles)));
    }
...
export class AzureTableStorageResource extends ResourceBuilderBase<AzureTableStorageResourceHandle> {
    ...
    /** @internal */
    private async _withEventHubsRoleAssignmentsInternal(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): Promise<AzureTableStorageResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, target, roles };
        const result = await this._client.invokeCapability<AzureTableStorageResourceHandle>(
            'Aspire.Hosting.Azure.EventHubs/withEventHubsRoleAssignments',
            rpcArgs
    ...
    /** Assigns Event Hubs roles to a resource */
    withEventHubsRoleAssignments(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): AzureTableStorageResourcePromise {
        return new AzureTableStorageResourcePromise(this._withEventHubsRoleAssignmentsInternal(target, roles));
    }
...
export class AzureTableStorageResourcePromise implements PromiseLike<AzureTableStorageResource> {
    ...
    /** Assigns Event Hubs roles to a resource */
    withEventHubsRoleAssignments(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): AzureTableStorageResourcePromise {
        return new AzureTableStorageResourcePromise(this._promise.then(obj => obj.withEventHubsRoleAssignments(target, roles)));
    }
...
export class ParameterResource extends ResourceBuilderBase<ParameterResourceHandle> {
    ...
    /** @internal */
    private async _withEventHubsRoleAssignmentsInternal(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): Promise<ParameterResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, target, roles };
        const result = await this._client.invokeCapability<ParameterResourceHandle>(
            'Aspire.Hosting.Azure.EventHubs/withEventHubsRoleAssignments',
            rpcArgs
    ...
    /** Assigns Event Hubs roles to a resource */
    withEventHubsRoleAssignments(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): ParameterResourcePromise {
        return new ParameterResourcePromise(this._withEventHubsRoleAssignmentsInternal(target, roles));
    }
...
export class ParameterResourcePromise implements PromiseLike<ParameterResource> {
    ...
    /** Assigns Event Hubs roles to a resource */
    withEventHubsRoleAssignments(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): ParameterResourcePromise {
        return new ParameterResourcePromise(this._promise.then(obj => obj.withEventHubsRoleAssignments(target, roles)));
    }
...
export class Resource extends ResourceBuilderBase<IResourceHandle> {
    ...
    /** @internal */
    private async _withEventHubsRoleAssignmentsInternal(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): Promise<Resource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, target, roles };
        const result = await this._client.invokeCapability<IResourceHandle>(
            'Aspire.Hosting.Azure.EventHubs/withEventHubsRoleAssignments',
            rpcArgs
    ...
    /** Assigns Event Hubs roles to a resource */
    withEventHubsRoleAssignments(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): ResourcePromise {
        return new ResourcePromise(this._withEventHubsRoleAssignmentsInternal(target, roles));
    }
...
export class ResourcePromise implements PromiseLike<Resource> {
    ...
    /** Assigns Event Hubs roles to a resource */
    withEventHubsRoleAssignments(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): ResourcePromise {
        return new ResourcePromise(this._promise.then(obj => obj.withEventHubsRoleAssignments(target, roles)));
    }
...
registerHandleWrapper('Aspire.Hosting.Azure.EventHubs/Aspire.Hosting.Azure.AzureEventHubConsumerGroupResource', (handle, client) => new AzureEventHubConsumerGroupResource(handle as AzureEventHubConsumerGroupResourceHandle, client));
registerHandleWrapper('Aspire.Hosting.Azure.EventHubs/Aspire.Hosting.Azure.AzureEventHubResource', (handle, client) => new AzureEventHubResource(handle as AzureEventHubResourceHandle, client));
registerHandleWrapper('Aspire.Hosting.Azure.EventHubs/Aspire.Hosting.Azure.AzureEventHubsEmulatorResource', (handle, client) => new AzureEventHubsEmulatorResource(handle as AzureEventHubsEmulatorResourceHandle, client));
registerHandleWrapper('Aspire.Hosting.Azure.EventHubs/Aspire.Hosting.Azure.AzureEventHubsResource', (handle, client) => new AzureEventHubsResource(handle as AzureEventHubsResourceHandle, client));
