...
export class AzureEventHubConsumerGroupResource extends ResourceBuilderBase<AzureEventHubConsumerGroupResourceHandle> {
    ...
    /** @internal */
    private async _withRoleAssignmentsInternal(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): Promise<AzureEventHubConsumerGroupResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, target, roles };
        const result = await this._client.invokeCapability<AzureEventHubConsumerGroupResourceHandle>(
            'Aspire.Hosting.Azure.EventHubs/withRoleAssignments',
            rpcArgs
        );
        return new AzureEventHubConsumerGroupResource(result, this._client);
    }
    ...
    withRoleAssignments(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): AzureEventHubConsumerGroupResourcePromise {
        return new AzureEventHubConsumerGroupResourcePromise(this._withRoleAssignmentsInternal(target, roles));
    }
...
export class AzureEventHubConsumerGroupResourcePromise implements PromiseLike<AzureEventHubConsumerGroupResource> {
    ...
    /** Assigns Event Hubs roles to a resource */
    withRoleAssignments(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): AzureEventHubConsumerGroupResourcePromise {
        return new AzureEventHubConsumerGroupResourcePromise(this._promise.then(obj => obj.withRoleAssignments(target, roles)));
    }
...
export class AzureEventHubResource extends ResourceBuilderBase<AzureEventHubResourceHandle> {
    ...
    /** @internal */
    private async _withRoleAssignmentsInternal(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): Promise<AzureEventHubResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, target, roles };
        const result = await this._client.invokeCapability<AzureEventHubResourceHandle>(
            'Aspire.Hosting.Azure.EventHubs/withRoleAssignments',
            rpcArgs
    ...
    /** Assigns Event Hubs roles to a resource */
    withRoleAssignments(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): AzureEventHubResourcePromise {
        return new AzureEventHubResourcePromise(this._withRoleAssignmentsInternal(target, roles));
    }
...
export class AzureEventHubResourcePromise implements PromiseLike<AzureEventHubResource> {
    ...
    /** Assigns Event Hubs roles to a resource */
    withRoleAssignments(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): AzureEventHubResourcePromise {
        return new AzureEventHubResourcePromise(this._promise.then(obj => obj.withRoleAssignments(target, roles)));
    }
...
export class AzureEventHubsEmulatorResource extends ResourceBuilderBase<AzureEventHubsEmulatorResourceHandle> {
    ...
    /** @internal */
    private async _withRoleAssignmentsInternal(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): Promise<AzureEventHubsEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, target, roles };
        const result = await this._client.invokeCapability<AzureEventHubsEmulatorResourceHandle>(
            'Aspire.Hosting.Azure.EventHubs/withRoleAssignments',
            rpcArgs
    ...
    /** Assigns Event Hubs roles to a resource */
    withRoleAssignments(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._withRoleAssignmentsInternal(target, roles));
    }
...
export class AzureEventHubsEmulatorResourcePromise implements PromiseLike<AzureEventHubsEmulatorResource> {
    ...
    /** Assigns Event Hubs roles to a resource */
    withRoleAssignments(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): AzureEventHubsEmulatorResourcePromise {
        return new AzureEventHubsEmulatorResourcePromise(this._promise.then(obj => obj.withRoleAssignments(target, roles)));
    }
...
export class AzureEventHubsResource extends ResourceBuilderBase<AzureEventHubsResourceHandle> {
    ...
    /** @internal */
    private async _withRoleAssignmentsInternal(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): Promise<AzureEventHubsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, target, roles };
        const result = await this._client.invokeCapability<AzureEventHubsResourceHandle>(
            'Aspire.Hosting.Azure.EventHubs/withRoleAssignments',
            rpcArgs
    ...
    /** Assigns Event Hubs roles to a resource */
    withRoleAssignments(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._withRoleAssignmentsInternal(target, roles));
    }
...
export class AzureEventHubsResourcePromise implements PromiseLike<AzureEventHubsResource> {
    ...
    /** Assigns Event Hubs roles to a resource */
    withRoleAssignments(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): AzureEventHubsResourcePromise {
        return new AzureEventHubsResourcePromise(this._promise.then(obj => obj.withRoleAssignments(target, roles)));
    }
...
export class ContainerResource extends ResourceBuilderBase<ContainerResourceHandle> {
    ...
    /** @internal */
    private async _withRoleAssignmentsInternal(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): Promise<ContainerResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, target, roles };
        const result = await this._client.invokeCapability<ContainerResourceHandle>(
            'Aspire.Hosting.Azure.EventHubs/withRoleAssignments',
            rpcArgs
    ...
    /** Assigns Event Hubs roles to a resource */
    withRoleAssignments(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): ContainerResourcePromise {
...
export class ExecutableResource extends ResourceBuilderBase<ExecutableResourceHandle> {
    ...
    /** @internal */
    private async _withRoleAssignmentsInternal(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): Promise<ExecutableResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, target, roles };
        const result = await this._client.invokeCapability<ExecutableResourceHandle>(
            'Aspire.Hosting.Azure.EventHubs/withRoleAssignments',
            rpcArgs
    ...
    /** Assigns Event Hubs roles to a resource */
    withRoleAssignments(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): ExecutableResourcePromise {
...
export class ParameterResource extends ResourceBuilderBase<ParameterResourceHandle> {
    ...
    /** @internal */
    private async _withRoleAssignmentsInternal(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): Promise<ParameterResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, target, roles };
        const result = await this._client.invokeCapability<ParameterResourceHandle>(
            'Aspire.Hosting.Azure.EventHubs/withRoleAssignments',
            rpcArgs
    ...
    /** Assigns Event Hubs roles to a resource */
    withRoleAssignments(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): ParameterResourcePromise {
...
export class ProjectResource extends ResourceBuilderBase<ProjectResourceHandle> {
    ...
    /** @internal */
    private async _withRoleAssignmentsInternal(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): Promise<ProjectResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, target, roles };
        const result = await this._client.invokeCapability<ProjectResourceHandle>(
            'Aspire.Hosting.Azure.EventHubs/withRoleAssignments',
            rpcArgs
    ...
    /** Assigns Event Hubs roles to a resource */
    withRoleAssignments(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): ProjectResourcePromise {
...
export class Resource extends ResourceBuilderBase<IResourceHandle> {
    ...
    /** @internal */
    private async _withRoleAssignmentsInternal(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): Promise<Resource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, target, roles };
        const result = await this._client.invokeCapability<IResourceHandle>(
            'Aspire.Hosting.Azure.EventHubs/withRoleAssignments',
            rpcArgs
    ...
    /** Assigns Event Hubs roles to a resource */
    withRoleAssignments(target: AzureEventHubsResource, roles: AzureEventHubsRole[]): ResourcePromise {
