...
export class DistributedApplicationBuilder {
    ...
    /** @internal */
    async _addAzureAppConfigurationInternal(name: string): Promise<AzureAppConfigurationResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name };
...
export class AzureAppConfigurationEmulatorResource extends ResourceBuilderBase<AzureAppConfigurationEmulatorResourceHandle> {
    constructor(handle: AzureAppConfigurationEmulatorResourceHandle, client: AspireClientRpc) {
        super(handle, client);
    }

    /** @internal */
    private async _withBindMountInternal(source: string, target: string, isReadOnly?: boolean): Promise<AzureAppConfigurationEmulatorResource> {
    ...
    /** @internal */
    private async _withEntrypointInternal(entrypoint: string): Promise<AzureAppConfigurationEmulatorResource> {
    ...
    /** @internal */
    private async _withImageTagInternal(tag: string): Promise<AzureAppConfigurationEmulatorResource> {
    ...
    /** @internal */
    private async _withImageRegistryInternal(registry: string): Promise<AzureAppConfigurationEmulatorResource> {
    ...
    /** @internal */
    private async _withImageInternal(image: string, tag?: string): Promise<AzureAppConfigurationEmulatorResource> {
    ...
    /** @internal */
    private async _withContainerRuntimeArgsInternal(args: string[]): Promise<AzureAppConfigurationEmulatorResource> {
    ...
    /** @internal */
    private async _withLifetimeInternal(lifetime: ContainerLifetime): Promise<AzureAppConfigurationEmulatorResource> {
    ...
    /** @internal */
    private async _withImagePullPolicyInternal(pullPolicy: ImagePullPolicy): Promise<AzureAppConfigurationEmulatorResource> {
    ...
    /** @internal */
    private async _withContainerNameInternal(name: string): Promise<AzureAppConfigurationEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name };
        const result = await this._client.invokeCapability<AzureAppConfigurationEmulatorResourceHandle>(
    ...
    /** @internal */
    private async _withEnvironmentInternal(name: string, value: string): Promise<AzureAppConfigurationEmulatorResource> {
    ...
    /** @internal */
    private async _withEnvironmentExpressionInternal(name: string, value: ReferenceExpression): Promise<AzureAppConfigurationEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, value };
        const result = await this._client.invokeCapability<AzureAppConfigurationEmulatorResourceHandle>(
    ...
    /** @internal */
    private async _withEnvironmentCallbackInternal(callback: (obj: EnvironmentCallbackContext) => Promise<void>): Promise<AzureAppConfigurationEmulatorResource> {
    ...
    withEnvironmentCallback(callback: (obj: EnvironmentCallbackContext) => Promise<void>): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._withEnvironmentCallbackInternal(callback));
    }

    /** @internal */
    private async _withEnvironmentCallbackAsyncInternal(callback: (arg: EnvironmentCallbackContext) => Promise<void>): Promise<AzureAppConfigurationEmulatorResource> {
    ...
    withEnvironmentCallbackAsync(callback: (arg: EnvironmentCallbackContext) => Promise<void>): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._withEnvironmentCallbackAsyncInternal(callback));
    }

    /** @internal */
    private async _withArgsInternal(args: string[]): Promise<AzureAppConfigurationEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, args };
        const result = await this._client.invokeCapability<AzureAppConfigurationEmulatorResourceHandle>(
    ...
    /** @internal */
    private async _withArgsCallbackInternal(callback: (obj: CommandLineArgsCallbackContext) => Promise<void>): Promise<AzureAppConfigurationEmulatorResource> {
        const callbackId = registerCallback(async (objData: unknown) => {
    ...
    withArgsCallback(callback: (obj: CommandLineArgsCallbackContext) => Promise<void>): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._withArgsCallbackInternal(callback));
    }

    /** @internal */
    private async _withArgsCallbackAsyncInternal(callback: (arg: CommandLineArgsCallbackContext) => Promise<void>): Promise<AzureAppConfigurationEmulatorResource> {
        const callbackId = registerCallback(async (argData: unknown) => {
    ...
    withArgsCallbackAsync(callback: (arg: CommandLineArgsCallbackContext) => Promise<void>): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._withArgsCallbackAsyncInternal(callback));
    }

    /** @internal */
    private async _withReferenceInternal(source: ResourceBuilderBase, connectionName?: string, optional?: boolean): Promise<AzureAppConfigurationEmulatorResource> {
    ...
    /** @internal */
    private async _withServiceReferenceInternal(source: ResourceBuilderBase): Promise<AzureAppConfigurationEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, source };
        const result = await this._client.invokeCapability<AzureAppConfigurationEmulatorResourceHandle>(
    ...
    /** @internal */
    private async _withEndpointInternal(port?: number, targetPort?: number, scheme?: string, name?: string, env?: string, isProxied?: boolean, isExternal?: boolean, protocol?: ProtocolType): Promise<AzureAppConfigurationEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
    ...
    /** @internal */
    private async _withHttpEndpointInternal(port?: number, targetPort?: number, name?: string, env?: string, isProxied?: boolean): Promise<AzureAppConfigurationEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        if (port !== undefined) rpcArgs.port = port;
        if (targetPort !== undefined) rpcArgs.targetPort = targetPort;
        if (name !== undefined) rpcArgs.name = name;
    ...
    /** @internal */
    private async _withHttpsEndpointInternal(port?: number, targetPort?: number, name?: string, env?: string, isProxied?: boolean): Promise<AzureAppConfigurationEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        if (port !== undefined) rpcArgs.port = port;
        if (targetPort !== undefined) rpcArgs.targetPort = targetPort;
        if (name !== undefined) rpcArgs.name = name;
    ...
    /** @internal */
    private async _withExternalHttpEndpointsInternal(): Promise<AzureAppConfigurationEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<AzureAppConfigurationEmulatorResourceHandle>(
    ...
    /** @internal */
    private async _asHttp2ServiceInternal(): Promise<AzureAppConfigurationEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<AzureAppConfigurationEmulatorResourceHandle>(
    ...
    /** @internal */
    private async _withUrlsCallbackInternal(callback: (obj: ResourceUrlsCallbackContext) => Promise<void>): Promise<AzureAppConfigurationEmulatorResource> {
        const callbackId = registerCallback(async (objData: unknown) => {
    ...
    withUrlsCallback(callback: (obj: ResourceUrlsCallbackContext) => Promise<void>): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._withUrlsCallbackInternal(callback));
    }

    /** @internal */
    private async _withUrlsCallbackAsyncInternal(callback: (arg: ResourceUrlsCallbackContext) => Promise<void>): Promise<AzureAppConfigurationEmulatorResource> {
        const callbackId = registerCallback(async (argData: unknown) => {
    ...
    withUrlsCallbackAsync(callback: (arg: ResourceUrlsCallbackContext) => Promise<void>): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._withUrlsCallbackAsyncInternal(callback));
    }

    /** @internal */
    private async _withUrlInternal(url: string, displayText?: string): Promise<AzureAppConfigurationEmulatorResource> {
    ...
    /** @internal */
    private async _withUrlExpressionInternal(url: ReferenceExpression, displayText?: string): Promise<AzureAppConfigurationEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, url };
        if (displayText !== undefined) rpcArgs.displayText = displayText;
        const result = await this._client.invokeCapability<AzureAppConfigurationEmulatorResourceHandle>(
    ...
    /** @internal */
    private async _withUrlForEndpointInternal(endpointName: string, callback: (obj: ResourceUrlAnnotation) => Promise<void>): Promise<AzureAppConfigurationEmulatorResource> {
        const callbackId = registerCallback(async (objData: unknown) => {
    ...
    withUrlForEndpoint(endpointName: string, callback: (obj: ResourceUrlAnnotation) => Promise<void>): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._withUrlForEndpointInternal(endpointName, callback));
    }

    /** @internal */
    private async _withUrlForEndpointFactoryInternal(endpointName: string, callback: (arg: EndpointReference) => Promise<ResourceUrlAnnotation>): Promise<AzureAppConfigurationEmulatorResource> {
        const callbackId = registerCallback(async (argData: unknown) => {
    ...
    withUrlForEndpointFactory(endpointName: string, callback: (arg: EndpointReference) => Promise<ResourceUrlAnnotation>): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._withUrlForEndpointFactoryInternal(endpointName, callback));
    }

    /** @internal */
    private async _waitForInternal(dependency: ResourceBuilderBase): Promise<AzureAppConfigurationEmulatorResource> {
    ...
    waitFor(dependency: ResourceBuilderBase): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._waitForInternal(dependency));
    }

    /** @internal */
    private async _withExplicitStartInternal(): Promise<AzureAppConfigurationEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<AzureAppConfigurationEmulatorResourceHandle>(
    ...
    withExplicitStart(): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._withExplicitStartInternal());
    }

    /** @internal */
    private async _waitForCompletionInternal(dependency: ResourceBuilderBase, exitCode?: number): Promise<AzureAppConfigurationEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, dependency };
    ...
    waitForCompletion(dependency: ResourceBuilderBase, options?: WaitForCompletionOptions): AzureAppConfigurationEmulatorResourcePromise {
        const exitCode = options?.exitCode;
        return new AzureAppConfigurationEmulatorResourcePromise(this._waitForCompletionInternal(dependency, exitCode));
    }

    /** @internal */
    private async _withHealthCheckInternal(key: string): Promise<AzureAppConfigurationEmulatorResource> {
    ...
    withHealthCheck(key: string): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._withHealthCheckInternal(key));
    }

    /** @internal */
    private async _withHttpHealthCheckInternal(path?: string, statusCode?: number, endpointName?: string): Promise<AzureAppConfigurationEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
    ...
    withHttpHealthCheck(options?: WithHttpHealthCheckOptions): AzureAppConfigurationEmulatorResourcePromise {
        const path = options?.path;
        const statusCode = options?.statusCode;
        const endpointName = options?.endpointName;
        return new AzureAppConfigurationEmulatorResourcePromise(this._withHttpHealthCheckInternal(path, statusCode, endpointName));
    }

    /** @internal */
    private async _withCommandInternal(name: string, displayName: string, executeCommand: (arg: ExecuteCommandContext) => Promise<ExecuteCommandResult>, commandOptions?: CommandOptions): Promise<AzureAppConfigurationEmulatorResource> {
    ...
    withCommand(name: string, displayName: string, executeCommand: (arg: ExecuteCommandContext) => Promise<ExecuteCommandResult>, options?: WithCommandOptions): AzureAppConfigurationEmulatorResourcePromise {
        const commandOptions = options?.commandOptions;
        return new AzureAppConfigurationEmulatorResourcePromise(this._withCommandInternal(name, displayName, executeCommand, commandOptions));
    }

    /** @internal */
    private async _withParentRelationshipInternal(parent: ResourceBuilderBase): Promise<AzureAppConfigurationEmulatorResource> {
    ...
    withParentRelationship(parent: ResourceBuilderBase): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._withParentRelationshipInternal(parent));
    }

    /** @internal */
    private async _withVolumeInternal(target: string, name?: string, isReadOnly?: boolean): Promise<AzureAppConfigurationEmulatorResource> {
    ...
    /** Adds a volume */
    withVolume(target: string, options?: WithVolumeOptions): AzureAppConfigurationEmulatorResourcePromise {
        const name = options?.name;
        const isReadOnly = options?.isReadOnly;
        return new AzureAppConfigurationEmulatorResourcePromise(this._withVolumeInternal(target, name, isReadOnly));
    }
    ...
    /** @internal */
    private async _withDataBindMountInternal(path?: string): Promise<AzureAppConfigurationEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        if (path !== undefined) rpcArgs.path = path;
        const result = await this._client.invokeCapability<AzureAppConfigurationEmulatorResourceHandle>(
            'Aspire.Hosting.Azure.AppConfiguration/withDataBindMount',
            rpcArgs
        );
        return new AzureAppConfigurationEmulatorResource(result, this._client);
    }
    ...
    withDataBindMount(options?: WithDataBindMountOptions): AzureAppConfigurationEmulatorResourcePromise {
        const path = options?.path;
        return new AzureAppConfigurationEmulatorResourcePromise(this._withDataBindMountInternal(path));
    }

    /** @internal */
    private async _withDataVolumeInternal(name?: string): Promise<AzureAppConfigurationEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        if (name !== undefined) rpcArgs.name = name;
        const result = await this._client.invokeCapability<AzureAppConfigurationEmulatorResourceHandle>(
            'Aspire.Hosting.Azure.AppConfiguration/withDataVolume',
            rpcArgs
        );
        return new AzureAppConfigurationEmulatorResource(result, this._client);
    }
    ...
    withDataVolume(options?: WithDataVolumeOptions): AzureAppConfigurationEmulatorResourcePromise {
        const name = options?.name;
        return new AzureAppConfigurationEmulatorResourcePromise(this._withDataVolumeInternal(name));
    }

    /** @internal */
    private async _withHostPortInternal(port?: number): Promise<AzureAppConfigurationEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        if (port !== undefined) rpcArgs.port = port;
        const result = await this._client.invokeCapability<AzureAppConfigurationEmulatorResourceHandle>(
            'Aspire.Hosting.Azure.AppConfiguration/withHostPort',
            rpcArgs
        );
        return new AzureAppConfigurationEmulatorResource(result, this._client);
    }
    ...
    withHostPort(options?: WithHostPortOptions): AzureAppConfigurationEmulatorResourcePromise {
        const port = options?.port;
        return new AzureAppConfigurationEmulatorResourcePromise(this._withHostPortInternal(port));
    }
    ...
    /** @internal */
    private async _withEnvironmentFromOutputInternal(name: string, bicepOutputReference: BicepOutputReference): Promise<AzureAppConfigurationEmulatorResource> {
    ...
    withEnvironmentFromOutput(name: string, bicepOutputReference: BicepOutputReference): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._withEnvironmentFromOutputInternal(name, bicepOutputReference));
    }

    /** @internal */
    private async _withEnvironmentFromKeyVaultSecretInternal(name: string, secretReference: ResourceBuilderBase): Promise<AzureAppConfigurationEmulatorResource> {
    ...
    withEnvironmentFromKeyVaultSecret(name: string, secretReference: ResourceBuilderBase): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._withEnvironmentFromKeyVaultSecretInternal(name, secretReference));
    }

    /** @internal */
    private async _withAzureUserAssignedIdentityInternal(identityResourceBuilder: AzureUserAssignedIdentityResource): Promise<AzureAppConfigurationEmulatorResource> {
    ...
    withAzureUserAssignedIdentity(identityResourceBuilder: AzureUserAssignedIdentityResource): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._withAzureUserAssignedIdentityInternal(identityResourceBuilder));
    }

}

/**
 * Thenable wrapper for AzureAppConfigurationEmulatorResource that enables fluent chaining.
 * @example
 * await builder.addSomething().withX().withY();
 */
export class AzureAppConfigurationEmulatorResourcePromise implements PromiseLike<AzureAppConfigurationEmulatorResource> {
    constructor(private _promise: Promise<AzureAppConfigurationEmulatorResource>) {}

    then<TResult1 = AzureAppConfigurationEmulatorResource, TResult2 = never>(
        onfulfilled?: ((value: AzureAppConfigurationEmulatorResource) => TResult1 | PromiseLike<TResult1>) | null,
        onrejected?: ((reason: unknown) => TResult2 | PromiseLike<TResult2>) | null
    ): PromiseLike<TResult1 | TResult2> {
        return this._promise.then(onfulfilled, onrejected);
    }
    ...
    /** Adds a bind mount */
    withBindMount(source: string, target: string, options?: WithBindMountOptions): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._promise.then(obj => obj.withBindMount(source, target, options)));
    }

    /** Sets the container entrypoint */
    withEntrypoint(entrypoint: string): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._promise.then(obj => obj.withEntrypoint(entrypoint)));
    }

    /** Sets the container image tag */
    withImageTag(tag: string): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._promise.then(obj => obj.withImageTag(tag)));
    }

    /** Sets the container image registry */
    withImageRegistry(registry: string): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._promise.then(obj => obj.withImageRegistry(registry)));
    }

    /** Sets the container image */
    withImage(image: string, options?: WithImageOptions): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._promise.then(obj => obj.withImage(image, options)));
    }

    /** Adds runtime arguments for the container */
    withContainerRuntimeArgs(args: string[]): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._promise.then(obj => obj.withContainerRuntimeArgs(args)));
    }

    /** Sets the lifetime behavior of the container resource */
    withLifetime(lifetime: ContainerLifetime): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._promise.then(obj => obj.withLifetime(lifetime)));
    }

    /** Sets the container image pull policy */
    withImagePullPolicy(pullPolicy: ImagePullPolicy): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._promise.then(obj => obj.withImagePullPolicy(pullPolicy)));
    }

    /** Sets the container name */
    withContainerName(name: string): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._promise.then(obj => obj.withContainerName(name)));
    }

    /** Sets an environment variable */
    withEnvironment(name: string, value: string): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._promise.then(obj => obj.withEnvironment(name, value)));
    }

    /** Adds an environment variable with a reference expression */
    withEnvironmentExpression(name: string, value: ReferenceExpression): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._promise.then(obj => obj.withEnvironmentExpression(name, value)));
    }

    /** Sets environment variables via callback */
    withEnvironmentCallback(callback: (obj: EnvironmentCallbackContext) => Promise<void>): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._promise.then(obj => obj.withEnvironmentCallback(callback)));
    }

    /** Sets environment variables via async callback */
    withEnvironmentCallbackAsync(callback: (arg: EnvironmentCallbackContext) => Promise<void>): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._promise.then(obj => obj.withEnvironmentCallbackAsync(callback)));
    }

    /** Adds arguments */
    withArgs(args: string[]): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._promise.then(obj => obj.withArgs(args)));
    }

    /** Sets command-line arguments via callback */
    withArgsCallback(callback: (obj: CommandLineArgsCallbackContext) => Promise<void>): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._promise.then(obj => obj.withArgsCallback(callback)));
    }

    /** Sets command-line arguments via async callback */
    withArgsCallbackAsync(callback: (arg: CommandLineArgsCallbackContext) => Promise<void>): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._promise.then(obj => obj.withArgsCallbackAsync(callback)));
    }

    /** Adds a reference to another resource */
    withReference(source: ResourceBuilderBase, options?: WithReferenceOptions): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._promise.then(obj => obj.withReference(source, options)));
    }

    /** Adds a service discovery reference to another resource */
    withServiceReference(source: ResourceBuilderBase): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._promise.then(obj => obj.withServiceReference(source)));
    }

    /** Adds a network endpoint */
    withEndpoint(options?: WithEndpointOptions): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._promise.then(obj => obj.withEndpoint(options)));
    }

    /** Adds an HTTP endpoint */
    withHttpEndpoint(options?: WithHttpEndpointOptions): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._promise.then(obj => obj.withHttpEndpoint(options)));
    }

    /** Adds an HTTPS endpoint */
    withHttpsEndpoint(options?: WithHttpsEndpointOptions): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._promise.then(obj => obj.withHttpsEndpoint(options)));
    }

    /** Makes HTTP endpoints externally accessible */
    withExternalHttpEndpoints(): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._promise.then(obj => obj.withExternalHttpEndpoints()));
    }
    ...
    /** Configures resource for HTTP/2 */
    asHttp2Service(): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._promise.then(obj => obj.asHttp2Service()));
    }

    /** Customizes displayed URLs via callback */
    withUrlsCallback(callback: (obj: ResourceUrlsCallbackContext) => Promise<void>): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._promise.then(obj => obj.withUrlsCallback(callback)));
    }

    /** Customizes displayed URLs via async callback */
    withUrlsCallbackAsync(callback: (arg: ResourceUrlsCallbackContext) => Promise<void>): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._promise.then(obj => obj.withUrlsCallbackAsync(callback)));
    }

    /** Adds or modifies displayed URLs */
    withUrl(url: string, options?: WithUrlOptions): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._promise.then(obj => obj.withUrl(url, options)));
    }

    /** Adds a URL using a reference expression */
    withUrlExpression(url: ReferenceExpression, options?: WithUrlExpressionOptions): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._promise.then(obj => obj.withUrlExpression(url, options)));
    }

    /** Customizes the URL for a specific endpoint via callback */
    withUrlForEndpoint(endpointName: string, callback: (obj: ResourceUrlAnnotation) => Promise<void>): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._promise.then(obj => obj.withUrlForEndpoint(endpointName, callback)));
    }

    /** Adds a URL for a specific endpoint via factory callback */
    withUrlForEndpointFactory(endpointName: string, callback: (arg: EndpointReference) => Promise<ResourceUrlAnnotation>): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._promise.then(obj => obj.withUrlForEndpointFactory(endpointName, callback)));
    }

    /** Waits for another resource to be ready */
    waitFor(dependency: ResourceBuilderBase): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._promise.then(obj => obj.waitFor(dependency)));
    }

    /** Prevents resource from starting automatically */
    withExplicitStart(): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._promise.then(obj => obj.withExplicitStart()));
    }

    /** Waits for resource completion */
    waitForCompletion(dependency: ResourceBuilderBase, options?: WaitForCompletionOptions): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._promise.then(obj => obj.waitForCompletion(dependency, options)));
    }

    /** Adds a health check by key */
    withHealthCheck(key: string): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._promise.then(obj => obj.withHealthCheck(key)));
    }

    /** Adds an HTTP health check */
    withHttpHealthCheck(options?: WithHttpHealthCheckOptions): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._promise.then(obj => obj.withHttpHealthCheck(options)));
    }

    /** Adds a resource command */
    withCommand(name: string, displayName: string, executeCommand: (arg: ExecuteCommandContext) => Promise<ExecuteCommandResult>, options?: WithCommandOptions): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._promise.then(obj => obj.withCommand(name, displayName, executeCommand, options)));
    }

    /** Sets the parent relationship */
    withParentRelationship(parent: ResourceBuilderBase): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._promise.then(obj => obj.withParentRelationship(parent)));
    }

    /** Adds a volume */
    withVolume(target: string, options?: WithVolumeOptions): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._promise.then(obj => obj.withVolume(target, options)));
    }
    ...
    /** Adds a data bind mount for the App Configuration emulator */
    withDataBindMount(options?: WithDataBindMountOptions): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._promise.then(obj => obj.withDataBindMount(options)));
    }

    /** Adds a data volume for the App Configuration emulator */
    withDataVolume(options?: WithDataVolumeOptions): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._promise.then(obj => obj.withDataVolume(options)));
    }

    /** Sets the host port for the App Configuration emulator */
    withHostPort(options?: WithHostPortOptions): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._promise.then(obj => obj.withHostPort(options)));
    }
    ...
    /** Sets an environment variable from a Bicep output reference */
    withEnvironmentFromOutput(name: string, bicepOutputReference: BicepOutputReference): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._promise.then(obj => obj.withEnvironmentFromOutput(name, bicepOutputReference)));
    }

    /** Sets an environment variable from an Azure Key Vault secret reference */
    withEnvironmentFromKeyVaultSecret(name: string, secretReference: ResourceBuilderBase): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._promise.then(obj => obj.withEnvironmentFromKeyVaultSecret(name, secretReference)));
    }

    /** Associates an Azure user-assigned identity with a compute resource */
    withAzureUserAssignedIdentity(identityResourceBuilder: AzureUserAssignedIdentityResource): AzureAppConfigurationEmulatorResourcePromise {
        return new AzureAppConfigurationEmulatorResourcePromise(this._promise.then(obj => obj.withAzureUserAssignedIdentity(identityResourceBuilder)));
    }
...
export class AzureAppConfigurationResource extends ResourceBuilderBase<AzureAppConfigurationResourceHandle> {
    constructor(handle: AzureAppConfigurationResourceHandle, client: AspireClientRpc) {
        super(handle, client);
    }

    /** @internal */
    private async _withEndpointInternal(port?: number, targetPort?: number, scheme?: string, name?: string, env?: string, isProxied?: boolean, isExternal?: boolean, protocol?: ProtocolType): Promise<AzureAppConfigurationResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        if (port !== undefined) rpcArgs.port = port;
        if (targetPort !== undefined) rpcArgs.targetPort = targetPort;
        if (scheme !== undefined) rpcArgs.scheme = scheme;
    ...
    /** Adds a network endpoint */
    withEndpoint(options?: WithEndpointOptions): AzureAppConfigurationResourcePromise {
        const port = options?.port;
        const targetPort = options?.targetPort;
        const scheme = options?.scheme;
        const name = options?.name;
        ...
        const isExternal = options?.isExternal;
        const protocol = options?.protocol;
        return new AzureAppConfigurationResourcePromise(this._withEndpointInternal(port, targetPort, scheme, name, env, isProxied, isExternal, protocol));
    }

    /** @internal */
    private async _withHttpEndpointInternal(port?: number, targetPort?: number, name?: string, env?: string, isProxied?: boolean): Promise<AzureAppConfigurationResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        if (port !== undefined) rpcArgs.port = port;
        if (targetPort !== undefined) rpcArgs.targetPort = targetPort;
        if (name !== undefined) rpcArgs.name = name;
    ...
    /** Adds an HTTP endpoint */
    withHttpEndpoint(options?: WithHttpEndpointOptions): AzureAppConfigurationResourcePromise {
        const port = options?.port;
        const targetPort = options?.targetPort;
        const name = options?.name;
        const env = options?.env;
        const isProxied = options?.isProxied;
        return new AzureAppConfigurationResourcePromise(this._withHttpEndpointInternal(port, targetPort, name, env, isProxied));
    }

    /** @internal */
    private async _withHttpsEndpointInternal(port?: number, targetPort?: number, name?: string, env?: string, isProxied?: boolean): Promise<AzureAppConfigurationResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        if (port !== undefined) rpcArgs.port = port;
        if (targetPort !== undefined) rpcArgs.targetPort = targetPort;
        if (name !== undefined) rpcArgs.name = name;
    ...
    /** Adds an HTTPS endpoint */
    withHttpsEndpoint(options?: WithHttpsEndpointOptions): AzureAppConfigurationResourcePromise {
        const port = options?.port;
        const targetPort = options?.targetPort;
        const name = options?.name;
        const env = options?.env;
        const isProxied = options?.isProxied;
        return new AzureAppConfigurationResourcePromise(this._withHttpsEndpointInternal(port, targetPort, name, env, isProxied));
    }

    /** @internal */
    private async _withExternalHttpEndpointsInternal(): Promise<AzureAppConfigurationResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<AzureAppConfigurationResourceHandle>(
            'Aspire.Hosting/withExternalHttpEndpoints',
            rpcArgs
    ...
    /** Makes HTTP endpoints externally accessible */
    withExternalHttpEndpoints(): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._withExternalHttpEndpointsInternal());
    }
    ...
    /** @internal */
    private async _asHttp2ServiceInternal(): Promise<AzureAppConfigurationResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<AzureAppConfigurationResourceHandle>(
            'Aspire.Hosting/asHttp2Service',
            rpcArgs
    ...
    /** Configures resource for HTTP/2 */
    asHttp2Service(): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._asHttp2ServiceInternal());
    }

    /** @internal */
    private async _withUrlsCallbackInternal(callback: (obj: ResourceUrlsCallbackContext) => Promise<void>): Promise<AzureAppConfigurationResource> {
        const callbackId = registerCallback(async (objData: unknown) => {
            const objHandle = wrapIfHandle(objData) as ResourceUrlsCallbackContextHandle;
            const obj = new ResourceUrlsCallbackContext(objHandle, this._client);
            await callback(obj);
    ...
    /** Customizes displayed URLs via callback */
    withUrlsCallback(callback: (obj: ResourceUrlsCallbackContext) => Promise<void>): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._withUrlsCallbackInternal(callback));
    }

    /** @internal */
    private async _withUrlsCallbackAsyncInternal(callback: (arg: ResourceUrlsCallbackContext) => Promise<void>): Promise<AzureAppConfigurationResource> {
        const callbackId = registerCallback(async (argData: unknown) => {
            const argHandle = wrapIfHandle(argData) as ResourceUrlsCallbackContextHandle;
            const arg = new ResourceUrlsCallbackContext(argHandle, this._client);
            await callback(arg);
    ...
    /** Customizes displayed URLs via async callback */
    withUrlsCallbackAsync(callback: (arg: ResourceUrlsCallbackContext) => Promise<void>): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._withUrlsCallbackAsyncInternal(callback));
    }

    /** @internal */
    private async _withUrlInternal(url: string, displayText?: string): Promise<AzureAppConfigurationResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, url };
        if (displayText !== undefined) rpcArgs.displayText = displayText;
        const result = await this._client.invokeCapability<AzureAppConfigurationResourceHandle>(
            'Aspire.Hosting/withUrl',
    ...
    /** Adds or modifies displayed URLs */
    withUrl(url: string, options?: WithUrlOptions): AzureAppConfigurationResourcePromise {
        const displayText = options?.displayText;
        return new AzureAppConfigurationResourcePromise(this._withUrlInternal(url, displayText));
    }

    /** @internal */
    private async _withUrlExpressionInternal(url: ReferenceExpression, displayText?: string): Promise<AzureAppConfigurationResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, url };
        if (displayText !== undefined) rpcArgs.displayText = displayText;
        const result = await this._client.invokeCapability<AzureAppConfigurationResourceHandle>(
            'Aspire.Hosting/withUrlExpression',
    ...
    /** Adds a URL using a reference expression */
    withUrlExpression(url: ReferenceExpression, options?: WithUrlExpressionOptions): AzureAppConfigurationResourcePromise {
        const displayText = options?.displayText;
        return new AzureAppConfigurationResourcePromise(this._withUrlExpressionInternal(url, displayText));
    }

    /** @internal */
    private async _withUrlForEndpointInternal(endpointName: string, callback: (obj: ResourceUrlAnnotation) => Promise<void>): Promise<AzureAppConfigurationResource> {
        const callbackId = registerCallback(async (objData: unknown) => {
            const obj = wrapIfHandle(objData) as ResourceUrlAnnotation;
            await callback(obj);
        });
    ...
    /** Customizes the URL for a specific endpoint via callback */
    withUrlForEndpoint(endpointName: string, callback: (obj: ResourceUrlAnnotation) => Promise<void>): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._withUrlForEndpointInternal(endpointName, callback));
    }

    /** @internal */
    private async _withUrlForEndpointFactoryInternal(endpointName: string, callback: (arg: EndpointReference) => Promise<ResourceUrlAnnotation>): Promise<AzureAppConfigurationResource> {
        const callbackId = registerCallback(async (argData: unknown) => {
            const argHandle = wrapIfHandle(argData) as EndpointReferenceHandle;
            const arg = new EndpointReference(argHandle, this._client);
            return await callback(arg);
    ...
    /** Adds a URL for a specific endpoint via factory callback */
    withUrlForEndpointFactory(endpointName: string, callback: (arg: EndpointReference) => Promise<ResourceUrlAnnotation>): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._withUrlForEndpointFactoryInternal(endpointName, callback));
    }

    /** @internal */
    private async _withExplicitStartInternal(): Promise<AzureAppConfigurationResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<AzureAppConfigurationResourceHandle>(
            'Aspire.Hosting/withExplicitStart',
            rpcArgs
    ...
    /** Prevents resource from starting automatically */
    withExplicitStart(): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._withExplicitStartInternal());
    }

    /** @internal */
    private async _withHealthCheckInternal(key: string): Promise<AzureAppConfigurationResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, key };
        const result = await this._client.invokeCapability<AzureAppConfigurationResourceHandle>(
            'Aspire.Hosting/withHealthCheck',
            rpcArgs
    ...
    /** Adds a health check by key */
    withHealthCheck(key: string): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._withHealthCheckInternal(key));
    }

    /** @internal */
    private async _withHttpHealthCheckInternal(path?: string, statusCode?: number, endpointName?: string): Promise<AzureAppConfigurationResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        if (path !== undefined) rpcArgs.path = path;
        if (statusCode !== undefined) rpcArgs.statusCode = statusCode;
        if (endpointName !== undefined) rpcArgs.endpointName = endpointName;
    ...
    /** Adds an HTTP health check */
    withHttpHealthCheck(options?: WithHttpHealthCheckOptions): AzureAppConfigurationResourcePromise {
        const path = options?.path;
        const statusCode = options?.statusCode;
        const endpointName = options?.endpointName;
        return new AzureAppConfigurationResourcePromise(this._withHttpHealthCheckInternal(path, statusCode, endpointName));
    }

    /** @internal */
    private async _withCommandInternal(name: string, displayName: string, executeCommand: (arg: ExecuteCommandContext) => Promise<ExecuteCommandResult>, commandOptions?: CommandOptions): Promise<AzureAppConfigurationResource> {
        const executeCommandId = registerCallback(async (argData: unknown) => {
            const argHandle = wrapIfHandle(argData) as ExecuteCommandContextHandle;
            const arg = new ExecuteCommandContext(argHandle, this._client);
            return await executeCommand(arg);
    ...
    /** Adds a resource command */
    withCommand(name: string, displayName: string, executeCommand: (arg: ExecuteCommandContext) => Promise<ExecuteCommandResult>, options?: WithCommandOptions): AzureAppConfigurationResourcePromise {
        const commandOptions = options?.commandOptions;
        return new AzureAppConfigurationResourcePromise(this._withCommandInternal(name, displayName, executeCommand, commandOptions));
    }

    /** @internal */
    private async _withParentRelationshipInternal(parent: ResourceBuilderBase): Promise<AzureAppConfigurationResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, parent };
        const result = await this._client.invokeCapability<AzureAppConfigurationResourceHandle>(
            'Aspire.Hosting/withParentRelationship',
            rpcArgs
    ...
    /** Sets the parent relationship */
    withParentRelationship(parent: ResourceBuilderBase): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._withParentRelationshipInternal(parent));
    }
    ...
    /** @internal */
    private async _runAsEmulatorInternal(configureEmulator?: (obj: AzureAppConfigurationEmulatorResource) => Promise<void>): Promise<AzureAppConfigurationResource> {
        const configureEmulatorId = configureEmulator ? registerCallback(async (objData: unknown) => {
            const objHandle = wrapIfHandle(objData) as AzureAppConfigurationEmulatorResourceHandle;
            const obj = new AzureAppConfigurationEmulatorResource(objHandle, this._client);
            await configureEmulator(obj);
        }) : undefined;
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        if (configureEmulator !== undefined) rpcArgs.configureEmulator = configureEmulatorId;
        const result = await this._client.invokeCapability<AzureAppConfigurationResourceHandle>(
            'Aspire.Hosting.Azure.AppConfiguration/runAsEmulator',
            rpcArgs
        );
        return new AzureAppConfigurationResource(result, this._client);
    }
    ...
    runAsEmulator(options?: RunAsEmulatorOptions): AzureAppConfigurationResourcePromise {
        const configureEmulator = options?.configureEmulator;
        return new AzureAppConfigurationResourcePromise(this._runAsEmulatorInternal(configureEmulator));
    }
    ...
    /** @internal */
    private async _withParameterInternal(name: string): Promise<AzureAppConfigurationResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name };
        const result = await this._client.invokeCapability<AzureAppConfigurationResourceHandle>(
    ...
    withParameter(name: string): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._withParameterInternal(name));
    }

    /** @internal */
    private async _withParameterStringValueInternal(name: string, value: string): Promise<AzureAppConfigurationResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, value };
        const result = await this._client.invokeCapability<AzureAppConfigurationResourceHandle>(
    ...
    withParameterStringValue(name: string, value: string): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._withParameterStringValueInternal(name, value));
    }

    /** @internal */
    private async _withParameterStringValuesInternal(name: string, value: string[]): Promise<AzureAppConfigurationResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, value };
        const result = await this._client.invokeCapability<AzureAppConfigurationResourceHandle>(
    ...
    withParameterStringValues(name: string, value: string[]): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._withParameterStringValuesInternal(name, value));
    }

    /** @internal */
    private async _withParameterFromParameterInternal(name: string, value: ParameterResource): Promise<AzureAppConfigurationResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, value };
        const result = await this._client.invokeCapability<AzureAppConfigurationResourceHandle>(
    ...
    withParameterFromParameter(name: string, value: ParameterResource): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._withParameterFromParameterInternal(name, value));
    }

    /** @internal */
    private async _withParameterFromConnectionStringInternal(name: string, value: ResourceBuilderBase): Promise<AzureAppConfigurationResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, value };
        const result = await this._client.invokeCapability<AzureAppConfigurationResourceHandle>(
    ...
    withParameterFromConnectionString(name: string, value: ResourceBuilderBase): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._withParameterFromConnectionStringInternal(name, value));
    }

    /** @internal */
    private async _withParameterFromOutputInternal(name: string, value: BicepOutputReference): Promise<AzureAppConfigurationResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, value };
        const result = await this._client.invokeCapability<AzureAppConfigurationResourceHandle>(
    ...
    withParameterFromOutput(name: string, value: BicepOutputReference): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._withParameterFromOutputInternal(name, value));
    }

    /** @internal */
    private async _withParameterFromReferenceExpressionInternal(name: string, value: ReferenceExpression): Promise<AzureAppConfigurationResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, value };
        const result = await this._client.invokeCapability<AzureAppConfigurationResourceHandle>(
    ...
    withParameterFromReferenceExpression(name: string, value: ReferenceExpression): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._withParameterFromReferenceExpressionInternal(name, value));
    }

    /** @internal */
    private async _withParameterFromEndpointInternal(name: string, value: EndpointReference): Promise<AzureAppConfigurationResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, value };
        const result = await this._client.invokeCapability<AzureAppConfigurationResourceHandle>(
    ...
    withParameterFromEndpoint(name: string, value: EndpointReference): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._withParameterFromEndpointInternal(name, value));
    }

    /** @internal */
    private async _configureInfrastructureInternal(configure: (obj: AzureResourceInfrastructure) => Promise<void>): Promise<AzureAppConfigurationResource> {
    ...
    configureInfrastructure(configure: (obj: AzureResourceInfrastructure) => Promise<void>): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._configureInfrastructureInternal(configure));
    }

    /** @internal */
    private async _publishAsConnectionStringInternal(): Promise<AzureAppConfigurationResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<AzureAppConfigurationResourceHandle>(
    ...
    publishAsConnectionString(): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._publishAsConnectionStringInternal());
    }
    ...
    /** @internal */
    private async _clearDefaultRoleAssignmentsInternal(): Promise<AzureAppConfigurationResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<AzureAppConfigurationResourceHandle>(
    ...
    clearDefaultRoleAssignments(): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._clearDefaultRoleAssignmentsInternal());
    }
    ...
    /** @internal */
    private async _runAsExistingFromParametersInternal(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): Promise<AzureAppConfigurationResource> {
    ...
    runAsExistingFromParameters(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._runAsExistingFromParametersInternal(nameParameter, resourceGroupParameter));
    }

    /** @internal */
    private async _runAsExistingInternal(name: string, resourceGroup: string): Promise<AzureAppConfigurationResource> {
    ...
    runAsExisting(name: string, resourceGroup: string): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._runAsExistingInternal(name, resourceGroup));
    }

    /** @internal */
    private async _publishAsExistingFromParametersInternal(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): Promise<AzureAppConfigurationResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, nameParameter, resourceGroupParameter };
        const result = await this._client.invokeCapability<AzureAppConfigurationResourceHandle>(
    ...
    publishAsExistingFromParameters(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._publishAsExistingFromParametersInternal(nameParameter, resourceGroupParameter));
    }

    /** @internal */
    private async _publishAsExistingInternal(name: string, resourceGroup: string): Promise<AzureAppConfigurationResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, resourceGroup };
        const result = await this._client.invokeCapability<AzureAppConfigurationResourceHandle>(
    ...
    publishAsExisting(name: string, resourceGroup: string): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._publishAsExistingInternal(name, resourceGroup));
    }

    /** @internal */
    private async _asExistingInternal(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): Promise<AzureAppConfigurationResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, nameParameter, resourceGroupParameter };
        const result = await this._client.invokeCapability<AzureAppConfigurationResourceHandle>(
    ...
    asExisting(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._asExistingInternal(nameParameter, resourceGroupParameter));
    }

}

/**
 * Thenable wrapper for AzureAppConfigurationResource that enables fluent chaining.
 * @example
 * await builder.addSomething().withX().withY();
 */
export class AzureAppConfigurationResourcePromise implements PromiseLike<AzureAppConfigurationResource> {
    constructor(private _promise: Promise<AzureAppConfigurationResource>) {}

    then<TResult1 = AzureAppConfigurationResource, TResult2 = never>(
        onfulfilled?: ((value: AzureAppConfigurationResource) => TResult1 | PromiseLike<TResult1>) | null,
        onrejected?: ((reason: unknown) => TResult2 | PromiseLike<TResult2>) | null
    ): PromiseLike<TResult1 | TResult2> {
        return this._promise.then(onfulfilled, onrejected);
    }
    ...
    /** Adds a network endpoint */
    withEndpoint(options?: WithEndpointOptions): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._promise.then(obj => obj.withEndpoint(options)));
    }

    /** Adds an HTTP endpoint */
    withHttpEndpoint(options?: WithHttpEndpointOptions): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._promise.then(obj => obj.withHttpEndpoint(options)));
    }

    /** Adds an HTTPS endpoint */
    withHttpsEndpoint(options?: WithHttpsEndpointOptions): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._promise.then(obj => obj.withHttpsEndpoint(options)));
    }

    /** Makes HTTP endpoints externally accessible */
    withExternalHttpEndpoints(): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._promise.then(obj => obj.withExternalHttpEndpoints()));
    }
    ...
    /** Configures resource for HTTP/2 */
    asHttp2Service(): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._promise.then(obj => obj.asHttp2Service()));
    }

    /** Customizes displayed URLs via callback */
    withUrlsCallback(callback: (obj: ResourceUrlsCallbackContext) => Promise<void>): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._promise.then(obj => obj.withUrlsCallback(callback)));
    }

    /** Customizes displayed URLs via async callback */
    withUrlsCallbackAsync(callback: (arg: ResourceUrlsCallbackContext) => Promise<void>): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._promise.then(obj => obj.withUrlsCallbackAsync(callback)));
    }

    /** Adds or modifies displayed URLs */
    withUrl(url: string, options?: WithUrlOptions): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._promise.then(obj => obj.withUrl(url, options)));
    }

    /** Adds a URL using a reference expression */
    withUrlExpression(url: ReferenceExpression, options?: WithUrlExpressionOptions): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._promise.then(obj => obj.withUrlExpression(url, options)));
    }

    /** Customizes the URL for a specific endpoint via callback */
    withUrlForEndpoint(endpointName: string, callback: (obj: ResourceUrlAnnotation) => Promise<void>): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._promise.then(obj => obj.withUrlForEndpoint(endpointName, callback)));
    }

    /** Adds a URL for a specific endpoint via factory callback */
    withUrlForEndpointFactory(endpointName: string, callback: (arg: EndpointReference) => Promise<ResourceUrlAnnotation>): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._promise.then(obj => obj.withUrlForEndpointFactory(endpointName, callback)));
    }

    /** Prevents resource from starting automatically */
    withExplicitStart(): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._promise.then(obj => obj.withExplicitStart()));
    }

    /** Adds a health check by key */
    withHealthCheck(key: string): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._promise.then(obj => obj.withHealthCheck(key)));
    }

    /** Adds an HTTP health check */
    withHttpHealthCheck(options?: WithHttpHealthCheckOptions): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._promise.then(obj => obj.withHttpHealthCheck(options)));
    }

    /** Adds a resource command */
    withCommand(name: string, displayName: string, executeCommand: (arg: ExecuteCommandContext) => Promise<ExecuteCommandResult>, options?: WithCommandOptions): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._promise.then(obj => obj.withCommand(name, displayName, executeCommand, options)));
    }

    /** Sets the parent relationship */
    withParentRelationship(parent: ResourceBuilderBase): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._promise.then(obj => obj.withParentRelationship(parent)));
    }
    ...
    /** Configures Azure App Configuration to run with the local emulator */
    runAsEmulator(options?: RunAsEmulatorOptions): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._promise.then(obj => obj.runAsEmulator(options)));
    }
    ...
    /** Adds a Bicep parameter without a value */
    withParameter(name: string): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._promise.then(obj => obj.withParameter(name)));
    }

    /** Adds a Bicep parameter with a string value */
    withParameterStringValue(name: string, value: string): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._promise.then(obj => obj.withParameterStringValue(name, value)));
    }

    /** Adds a Bicep parameter with a string list value */
    withParameterStringValues(name: string, value: string[]): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._promise.then(obj => obj.withParameterStringValues(name, value)));
    }

    /** Adds a Bicep parameter from a parameter resource builder */
    withParameterFromParameter(name: string, value: ParameterResource): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._promise.then(obj => obj.withParameterFromParameter(name, value)));
    }

    /** Adds a Bicep parameter from a connection string resource builder */
    withParameterFromConnectionString(name: string, value: ResourceBuilderBase): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._promise.then(obj => obj.withParameterFromConnectionString(name, value)));
    }

    /** Adds a Bicep parameter from another Bicep output reference */
    withParameterFromOutput(name: string, value: BicepOutputReference): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._promise.then(obj => obj.withParameterFromOutput(name, value)));
    }

    /** Adds a Bicep parameter from a reference expression */
    withParameterFromReferenceExpression(name: string, value: ReferenceExpression): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._promise.then(obj => obj.withParameterFromReferenceExpression(name, value)));
    }

    /** Adds a Bicep parameter from an endpoint reference */
    withParameterFromEndpoint(name: string, value: EndpointReference): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._promise.then(obj => obj.withParameterFromEndpoint(name, value)));
    }

    /** Configures the Azure provisioning infrastructure callback */
    configureInfrastructure(configure: (obj: AzureResourceInfrastructure) => Promise<void>): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._promise.then(obj => obj.configureInfrastructure(configure)));
    }

    /** Publishes an Azure resource to the manifest as a connection string */
    publishAsConnectionString(): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._promise.then(obj => obj.publishAsConnectionString()));
    }
    ...
    /** Clears the default Azure role assignments from a resource */
    clearDefaultRoleAssignments(): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._promise.then(obj => obj.clearDefaultRoleAssignments()));
    }
    ...
    /** Marks an Azure resource as existing in run mode by using parameter resources */
    runAsExistingFromParameters(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._promise.then(obj => obj.runAsExistingFromParameters(nameParameter, resourceGroupParameter)));
    }

    /** Marks an Azure resource as existing in run mode */
    runAsExisting(name: string, resourceGroup: string): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._promise.then(obj => obj.runAsExisting(name, resourceGroup)));
    }

    /** Marks an Azure resource as existing in publish mode by using parameter resources */
    publishAsExistingFromParameters(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._promise.then(obj => obj.publishAsExistingFromParameters(nameParameter, resourceGroupParameter)));
    }

    /** Marks an Azure resource as existing in publish mode */
    publishAsExisting(name: string, resourceGroup: string): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._promise.then(obj => obj.publishAsExisting(name, resourceGroup)));
    }

    /** Marks an Azure resource as existing in both run and publish modes */
    asExisting(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): AzureAppConfigurationResourcePromise {
        return new AzureAppConfigurationResourcePromise(this._promise.then(obj => obj.asExisting(nameParameter, resourceGroupParameter)));
    }
...
registerHandleWrapper('Aspire.Hosting.Azure.AppConfiguration/Aspire.Hosting.Azure.AzureAppConfigurationEmulatorResource', (handle, client) => new AzureAppConfigurationEmulatorResource(handle as AzureAppConfigurationEmulatorResourceHandle, client));
registerHandleWrapper('Aspire.Hosting.Azure.AppConfiguration/Aspire.Hosting.Azure.AzureAppConfigurationResource', (handle, client) => new AzureAppConfigurationResource(handle as AzureAppConfigurationResourceHandle, client));
