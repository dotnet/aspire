...
export class AzureApplicationInsightsResource extends ResourceBuilderBase<AzureApplicationInsightsResourceHandle> {
    ...
    /** @internal */
    private async _withContainerRegistryInternal(registry: ResourceBuilderBase): Promise<AzureApplicationInsightsResource> {
    ...
    withContainerRegistry(registry: ResourceBuilderBase): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._withContainerRegistryInternal(registry));
    }

    /** @internal */
    private async _withDockerfileBaseImageInternal(buildImage?: string, runtimeImage?: string): Promise<AzureApplicationInsightsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
    ...
    withDockerfileBaseImage(options?: WithDockerfileBaseImageOptions): AzureApplicationInsightsResourcePromise {
        const buildImage = options?.buildImage;
        const runtimeImage = options?.runtimeImage;
        return new AzureApplicationInsightsResourcePromise(this._withDockerfileBaseImageInternal(buildImage, runtimeImage));
    }

    /** @internal */
    private async _withRequiredCommandInternal(command: string, helpLink?: string): Promise<AzureApplicationInsightsResource> {
    ...
    withRequiredCommand(command: string, options?: WithRequiredCommandOptions): AzureApplicationInsightsResourcePromise {
        const helpLink = options?.helpLink;
        return new AzureApplicationInsightsResourcePromise(this._withRequiredCommandInternal(command, helpLink));
    }

    /** @internal */
    private async _withConnectionPropertyInternal(name: string, value: ReferenceExpression): Promise<AzureApplicationInsightsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, value };
        const result = await this._client.invokeCapability<AzureApplicationInsightsResourceHandle>(
    ...
    withConnectionProperty(name: string, value: ReferenceExpression): AzureApplicationInsightsResourcePromise {
    ...
    /** @internal */
    private async _excludeFromManifestInternal(): Promise<AzureApplicationInsightsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<AzureApplicationInsightsResourceHandle>(
    ...
    excludeFromManifest(): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._excludeFromManifestInternal());
    }
    ...
    /** @internal */
    private async _withChildRelationshipInternal(child: ResourceBuilderBase): Promise<AzureApplicationInsightsResource> {
    ...
    withChildRelationship(child: ResourceBuilderBase): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._withChildRelationshipInternal(child));
    }

    /** @internal */
    private async _withIconNameInternal(iconName: string, iconVariant?: IconVariant): Promise<AzureApplicationInsightsResource> {
    ...
    withIconName(iconName: string, options?: WithIconNameOptions): AzureApplicationInsightsResourcePromise {
        const iconVariant = options?.iconVariant;
        return new AzureApplicationInsightsResourcePromise(this._withIconNameInternal(iconName, iconVariant));
    }

    /** @internal */
    private async _excludeFromMcpInternal(): Promise<AzureApplicationInsightsResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<AzureApplicationInsightsResourceHandle>(
    ...
    excludeFromMcp(): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._excludeFromMcpInternal());
    }

    /** @internal */
    private async _withRemoteImageNameInternal(remoteImageName: string): Promise<AzureApplicationInsightsResource> {
    ...
    withRemoteImageName(remoteImageName: string): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._withRemoteImageNameInternal(remoteImageName));
    }

    /** @internal */
    private async _withRemoteImageTagInternal(remoteImageTag: string): Promise<AzureApplicationInsightsResource> {
    ...
    withRemoteImageTag(remoteImageTag: string): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._withRemoteImageTagInternal(remoteImageTag));
    }

    /** @internal */
    private async _withPipelineStepFactoryInternal(stepName: string, callback: (arg: PipelineStepContext) => Promise<void>, dependsOn?: string[], requiredBy?: string[], tags?: string[], description?: string): Promise<AzureApplicationInsightsResource> {
        const callbackId = registerCallback(async (argData: unknown) => {
    ...
    withPipelineStepFactory(stepName: string, callback: (arg: PipelineStepContext) => Promise<void>, options?: WithPipelineStepFactoryOptions): AzureApplicationInsightsResourcePromise {
        const dependsOn = options?.dependsOn;
        const requiredBy = options?.requiredBy;
        const tags = options?.tags;
        const description = options?.description;
        return new AzureApplicationInsightsResourcePromise(this._withPipelineStepFactoryInternal(stepName, callback, dependsOn, requiredBy, tags, description));
    }

    /** @internal */
    private async _withPipelineConfigurationAsyncInternal(callback: (arg: PipelineConfigurationContext) => Promise<void>): Promise<AzureApplicationInsightsResource> {
        const callbackId = registerCallback(async (argData: unknown) => {
    ...
    withPipelineConfigurationAsync(callback: (arg: PipelineConfigurationContext) => Promise<void>): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._withPipelineConfigurationAsyncInternal(callback));
    }

    /** @internal */
    private async _withPipelineConfigurationInternal(callback: (obj: PipelineConfigurationContext) => Promise<void>): Promise<AzureApplicationInsightsResource> {
        const callbackId = registerCallback(async (objData: unknown) => {
    ...
    withPipelineConfiguration(callback: (obj: PipelineConfigurationContext) => Promise<void>): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._withPipelineConfigurationInternal(callback));
    }
...
export class AzureApplicationInsightsResourcePromise implements PromiseLike<AzureApplicationInsightsResource> {
    ...
    /** Configures a resource to use a container registry */
    withContainerRegistry(registry: ResourceBuilderBase): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._promise.then(obj => obj.withContainerRegistry(registry)));
    }

    /** Sets the base image for a Dockerfile build */
    withDockerfileBaseImage(options?: WithDockerfileBaseImageOptions): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._promise.then(obj => obj.withDockerfileBaseImage(options)));
    }

    /** Adds a required command dependency */
    withRequiredCommand(command: string, options?: WithRequiredCommandOptions): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._promise.then(obj => obj.withRequiredCommand(command, options)));
    }
    ...
    /** Excludes the resource from the deployment manifest */
    excludeFromManifest(): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._promise.then(obj => obj.excludeFromManifest()));
    }
    ...
    /** Sets a child relationship */
    withChildRelationship(child: ResourceBuilderBase): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._promise.then(obj => obj.withChildRelationship(child)));
    }

    /** Sets the icon for the resource */
    withIconName(iconName: string, options?: WithIconNameOptions): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._promise.then(obj => obj.withIconName(iconName, options)));
    }

    /** Excludes the resource from MCP server exposure */
    excludeFromMcp(): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._promise.then(obj => obj.excludeFromMcp()));
    }

    /** Sets the remote image name for publishing */
    withRemoteImageName(remoteImageName: string): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._promise.then(obj => obj.withRemoteImageName(remoteImageName)));
    }

    /** Sets the remote image tag for publishing */
    withRemoteImageTag(remoteImageTag: string): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._promise.then(obj => obj.withRemoteImageTag(remoteImageTag)));
    }

    /** Adds a pipeline step to the resource */
    withPipelineStepFactory(stepName: string, callback: (arg: PipelineStepContext) => Promise<void>, options?: WithPipelineStepFactoryOptions): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._promise.then(obj => obj.withPipelineStepFactory(stepName, callback, options)));
    }

    /** Configures pipeline step dependencies via an async callback */
    withPipelineConfigurationAsync(callback: (arg: PipelineConfigurationContext) => Promise<void>): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._promise.then(obj => obj.withPipelineConfigurationAsync(callback)));
    }

    /** Configures pipeline step dependencies via a callback */
    withPipelineConfiguration(callback: (obj: PipelineConfigurationContext) => Promise<void>): AzureApplicationInsightsResourcePromise {
        return new AzureApplicationInsightsResourcePromise(this._promise.then(obj => obj.withPipelineConfiguration(callback)));
    }
...
export class AzureLogAnalyticsWorkspaceResource extends ResourceBuilderBase<AzureLogAnalyticsWorkspaceResourceHandle> {
    ...
    /** @internal */
    private async _withRemoteImageNameInternal(remoteImageName: string): Promise<AzureLogAnalyticsWorkspaceResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, remoteImageName };
        const result = await this._client.invokeCapability<AzureLogAnalyticsWorkspaceResourceHandle>(
            'Aspire.Hosting/withRemoteImageName',
            rpcArgs
    ...
    /** Sets the remote image name for publishing */
    withRemoteImageName(remoteImageName: string): AzureLogAnalyticsWorkspaceResourcePromise {
        return new AzureLogAnalyticsWorkspaceResourcePromise(this._withRemoteImageNameInternal(remoteImageName));
    }

    /** @internal */
    private async _withRemoteImageTagInternal(remoteImageTag: string): Promise<AzureLogAnalyticsWorkspaceResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, remoteImageTag };
        const result = await this._client.invokeCapability<AzureLogAnalyticsWorkspaceResourceHandle>(
            'Aspire.Hosting/withRemoteImageTag',
            rpcArgs
    ...
    /** Sets the remote image tag for publishing */
    withRemoteImageTag(remoteImageTag: string): AzureLogAnalyticsWorkspaceResourcePromise {
        return new AzureLogAnalyticsWorkspaceResourcePromise(this._withRemoteImageTagInternal(remoteImageTag));
    }
...
export class AzureLogAnalyticsWorkspaceResourcePromise implements PromiseLike<AzureLogAnalyticsWorkspaceResource> {
    ...
    /** Sets the remote image name for publishing */
    withRemoteImageName(remoteImageName: string): AzureLogAnalyticsWorkspaceResourcePromise {
        return new AzureLogAnalyticsWorkspaceResourcePromise(this._promise.then(obj => obj.withRemoteImageName(remoteImageName)));
    }

    /** Sets the remote image tag for publishing */
    withRemoteImageTag(remoteImageTag: string): AzureLogAnalyticsWorkspaceResourcePromise {
        return new AzureLogAnalyticsWorkspaceResourcePromise(this._promise.then(obj => obj.withRemoteImageTag(remoteImageTag)));
    }
