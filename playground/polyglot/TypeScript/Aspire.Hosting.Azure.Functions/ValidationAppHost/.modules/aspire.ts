...
export class AzureFunctionsProjectResource extends ResourceBuilderBase<AzureFunctionsProjectResourceHandle> {
    ...
    /** @internal */
    private async _publishWithContainerFilesInternal(source: ResourceBuilderBase, destinationPath: string): Promise<AzureFunctionsProjectResource> {
    ...
    publishWithContainerFiles(source: ResourceBuilderBase, destinationPath: string): AzureFunctionsProjectResourcePromise {
        return new AzureFunctionsProjectResourcePromise(this._publishWithContainerFilesInternal(source, destinationPath));
    }
    ...
    /** @internal */
    private async _withStorageRoleAssignmentsInternal(target: AzureStorageResource, roles: AzureStorageRole[]): Promise<AzureFunctionsProjectResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, target, roles };
        const result = await this._client.invokeCapability<AzureFunctionsProjectResourceHandle>(
            'Aspire.Hosting.Azure.Storage/withStorageRoleAssignments',
            rpcArgs
    ...
    /** Assigns Azure Storage roles to a resource */
    withStorageRoleAssignments(target: AzureStorageResource, roles: AzureStorageRole[]): AzureFunctionsProjectResourcePromise {
        return new AzureFunctionsProjectResourcePromise(this._withStorageRoleAssignmentsInternal(target, roles));
    }

    /** @internal */
    private async _withEnvironmentFromOutputInternal(name: string, bicepOutputReference: BicepOutputReference): Promise<AzureFunctionsProjectResource> {
    ...
    withEnvironmentFromOutput(name: string, bicepOutputReference: BicepOutputReference): AzureFunctionsProjectResourcePromise {
        return new AzureFunctionsProjectResourcePromise(this._withEnvironmentFromOutputInternal(name, bicepOutputReference));
    }

    /** @internal */
    private async _withEnvironmentFromKeyVaultSecretInternal(name: string, secretReference: ResourceBuilderBase): Promise<AzureFunctionsProjectResource> {
    ...
    withEnvironmentFromKeyVaultSecret(name: string, secretReference: ResourceBuilderBase): AzureFunctionsProjectResourcePromise {
        return new AzureFunctionsProjectResourcePromise(this._withEnvironmentFromKeyVaultSecretInternal(name, secretReference));
    }

    /** @internal */
    private async _withAzureUserAssignedIdentityInternal(identityResourceBuilder: AzureUserAssignedIdentityResource): Promise<AzureFunctionsProjectResource> {
    ...
    withAzureUserAssignedIdentity(identityResourceBuilder: AzureUserAssignedIdentityResource): AzureFunctionsProjectResourcePromise {
        return new AzureFunctionsProjectResourcePromise(this._withAzureUserAssignedIdentityInternal(identityResourceBuilder));
    }
...
export class AzureFunctionsProjectResourcePromise implements PromiseLike<AzureFunctionsProjectResource> {
    ...
    /** Configures the resource to copy container files from the specified source during publishing */
    publishWithContainerFiles(source: ResourceBuilderBase, destinationPath: string): AzureFunctionsProjectResourcePromise {
        return new AzureFunctionsProjectResourcePromise(this._promise.then(obj => obj.publishWithContainerFiles(source, destinationPath)));
    }
    ...
    /** Assigns Azure Storage roles to a resource */
    withStorageRoleAssignments(target: AzureStorageResource, roles: AzureStorageRole[]): AzureFunctionsProjectResourcePromise {
        return new AzureFunctionsProjectResourcePromise(this._promise.then(obj => obj.withStorageRoleAssignments(target, roles)));
    }

    /** Sets an environment variable from a Bicep output reference */
    withEnvironmentFromOutput(name: string, bicepOutputReference: BicepOutputReference): AzureFunctionsProjectResourcePromise {
        return new AzureFunctionsProjectResourcePromise(this._promise.then(obj => obj.withEnvironmentFromOutput(name, bicepOutputReference)));
    }

    /** Sets an environment variable from an Azure Key Vault secret reference */
    withEnvironmentFromKeyVaultSecret(name: string, secretReference: ResourceBuilderBase): AzureFunctionsProjectResourcePromise {
        return new AzureFunctionsProjectResourcePromise(this._promise.then(obj => obj.withEnvironmentFromKeyVaultSecret(name, secretReference)));
    }

    /** Associates an Azure user-assigned identity with a compute resource */
    withAzureUserAssignedIdentity(identityResourceBuilder: AzureUserAssignedIdentityResource): AzureFunctionsProjectResourcePromise {
        return new AzureFunctionsProjectResourcePromise(this._promise.then(obj => obj.withAzureUserAssignedIdentity(identityResourceBuilder)));
    }
