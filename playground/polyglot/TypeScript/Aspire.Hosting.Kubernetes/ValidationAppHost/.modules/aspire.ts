...
/** Handle to KubernetesEnvironmentResource */
type KubernetesEnvironmentResourceHandle = Handle<'Aspire.Hosting.Kubernetes/Aspire.Hosting.Kubernetes.KubernetesEnvironmentResource'>;

/** Handle to KubernetesResource */
type KubernetesResourceHandle = Handle<'Aspire.Hosting.Kubernetes/Aspire.Hosting.Kubernetes.KubernetesResource'>;
...
export class DistributedApplicationBuilder {
    ...
    /** @internal */
    async _addKubernetesEnvironmentInternal(name: string): Promise<KubernetesEnvironmentResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name };
        const result = await this._client.invokeCapability<KubernetesEnvironmentResourceHandle>(
            'Aspire.Hosting.Kubernetes/addKubernetesEnvironment',
            rpcArgs
        );
        return new KubernetesEnvironmentResource(result, this._client);
    }

    addKubernetesEnvironment(name: string): KubernetesEnvironmentResourcePromise {
        return new KubernetesEnvironmentResourcePromise(this._addKubernetesEnvironmentInternal(name));
    }
...
export class DistributedApplicationBuilderPromise implements PromiseLike<DistributedApplicationBuilder> {
    ...
    /** Adds a Kubernetes publishing environment */
    addKubernetesEnvironment(name: string): KubernetesEnvironmentResourcePromise {
        return new KubernetesEnvironmentResourcePromise(this._promise.then(obj => obj.addKubernetesEnvironment(name)));
    }
...
export class ContainerResource extends ResourceBuilderBase<ContainerResourceHandle> {
    ...
    /** @internal */
    private async _publishAsKubernetesServiceInternal(configure: (obj: KubernetesResource) => Promise<void>): Promise<ContainerResource> {
        const configureId = registerCallback(async (objData: unknown) => {
            const objHandle = wrapIfHandle(objData) as KubernetesResourceHandle;
            const obj = new KubernetesResource(objHandle, this._client);
            await configure(obj);
        });
        const rpcArgs: Record<string, unknown> = { builder: this._handle, configure: configureId };
        const result = await this._client.invokeCapability<ContainerResourceHandle>(
            'Aspire.Hosting.Kubernetes/publishAsKubernetesService',
            rpcArgs
        );
        return new ContainerResource(result, this._client);
    }
    ...
    publishAsKubernetesService(configure: (obj: KubernetesResource) => Promise<void>): ContainerResourcePromise {
        return new ContainerResourcePromise(this._publishAsKubernetesServiceInternal(configure));
    }
...
export class ContainerResourcePromise implements PromiseLike<ContainerResource> {
    ...
    /** Publishes the resource as a Kubernetes service */
    publishAsKubernetesService(configure: (obj: KubernetesResource) => Promise<void>): ContainerResourcePromise {
        return new ContainerResourcePromise(this._promise.then(obj => obj.publishAsKubernetesService(configure)));
    }
...
export class CSharpAppResource extends ResourceBuilderBase<CSharpAppResourceHandle> {
    ...
    /** @internal */
    private async _publishAsKubernetesServiceInternal(configure: (obj: KubernetesResource) => Promise<void>): Promise<CSharpAppResource> {
        const configureId = registerCallback(async (objData: unknown) => {
            const objHandle = wrapIfHandle(objData) as KubernetesResourceHandle;
            const obj = new KubernetesResource(objHandle, this._client);
            await configure(obj);
    ...
    /** Publishes the resource as a Kubernetes service */
    publishAsKubernetesService(configure: (obj: KubernetesResource) => Promise<void>): CSharpAppResourcePromise {
        return new CSharpAppResourcePromise(this._publishAsKubernetesServiceInternal(configure));
    }
...
export class CSharpAppResourcePromise implements PromiseLike<CSharpAppResource> {
    ...
    /** Publishes the resource as a Kubernetes service */
    publishAsKubernetesService(configure: (obj: KubernetesResource) => Promise<void>): CSharpAppResourcePromise {
        return new CSharpAppResourcePromise(this._promise.then(obj => obj.publishAsKubernetesService(configure)));
    }
...
export class DotnetToolResource extends ResourceBuilderBase<DotnetToolResourceHandle> {
    ...
    /** @internal */
    private async _publishAsKubernetesServiceInternal(configure: (obj: KubernetesResource) => Promise<void>): Promise<DotnetToolResource> {
        const configureId = registerCallback(async (objData: unknown) => {
            const objHandle = wrapIfHandle(objData) as KubernetesResourceHandle;
            const obj = new KubernetesResource(objHandle, this._client);
            await configure(obj);
    ...
    /** Publishes the resource as a Kubernetes service */
    publishAsKubernetesService(configure: (obj: KubernetesResource) => Promise<void>): DotnetToolResourcePromise {
        return new DotnetToolResourcePromise(this._publishAsKubernetesServiceInternal(configure));
    }
...
export class DotnetToolResourcePromise implements PromiseLike<DotnetToolResource> {
    ...
    /** Publishes the resource as a Kubernetes service */
    publishAsKubernetesService(configure: (obj: KubernetesResource) => Promise<void>): DotnetToolResourcePromise {
        return new DotnetToolResourcePromise(this._promise.then(obj => obj.publishAsKubernetesService(configure)));
    }
...
export class ExecutableResource extends ResourceBuilderBase<ExecutableResourceHandle> {
    ...
    /** @internal */
    private async _publishAsKubernetesServiceInternal(configure: (obj: KubernetesResource) => Promise<void>): Promise<ExecutableResource> {
        const configureId = registerCallback(async (objData: unknown) => {
            const objHandle = wrapIfHandle(objData) as KubernetesResourceHandle;
            const obj = new KubernetesResource(objHandle, this._client);
            await configure(obj);
    ...
    /** Publishes the resource as a Kubernetes service */
    publishAsKubernetesService(configure: (obj: KubernetesResource) => Promise<void>): ExecutableResourcePromise {
        return new ExecutableResourcePromise(this._publishAsKubernetesServiceInternal(configure));
    }
...
export class ExecutableResourcePromise implements PromiseLike<ExecutableResource> {
    ...
    /** Publishes the resource as a Kubernetes service */
    publishAsKubernetesService(configure: (obj: KubernetesResource) => Promise<void>): ExecutableResourcePromise {
        return new ExecutableResourcePromise(this._promise.then(obj => obj.publishAsKubernetesService(configure)));
    }
...
export class KubernetesEnvironmentResource extends ResourceBuilderBase<KubernetesEnvironmentResourceHandle> {
    constructor(handle: KubernetesEnvironmentResourceHandle, client: AspireClientRpc) {
        super(handle, client);
    }
    ...
    helmChartName = {
        get: async (): Promise<string> => {
            return await this._client.invokeCapability<string>(
                'Aspire.Hosting.Kubernetes/KubernetesEnvironmentResource.helmChartName',
                { context: this._handle }
            );
        },
        set: async (value: string): Promise<void> => {
            await this._client.invokeCapability<void>(
                'Aspire.Hosting.Kubernetes/KubernetesEnvironmentResource.setHelmChartName',
                { context: this._handle, value }
            );
        }
    };
    ...
    helmChartVersion = {
        get: async (): Promise<string> => {
            return await this._client.invokeCapability<string>(
                'Aspire.Hosting.Kubernetes/KubernetesEnvironmentResource.helmChartVersion',
                { context: this._handle }
            );
        },
        set: async (value: string): Promise<void> => {
            await this._client.invokeCapability<void>(
                'Aspire.Hosting.Kubernetes/KubernetesEnvironmentResource.setHelmChartVersion',
                { context: this._handle, value }
            );
        }
    };
    ...
    helmChartDescription = {
        get: async (): Promise<string> => {
            return await this._client.invokeCapability<string>(
                'Aspire.Hosting.Kubernetes/KubernetesEnvironmentResource.helmChartDescription',
                { context: this._handle }
            );
        },
        set: async (value: string): Promise<void> => {
            await this._client.invokeCapability<void>(
                'Aspire.Hosting.Kubernetes/KubernetesEnvironmentResource.setHelmChartDescription',
                { context: this._handle, value }
            );
        }
    };
    ...
    defaultStorageType = {
        get: async (): Promise<string> => {
            return await this._client.invokeCapability<string>(
                'Aspire.Hosting.Kubernetes/KubernetesEnvironmentResource.defaultStorageType',
                { context: this._handle }
            );
        },
        set: async (value: string): Promise<void> => {
            await this._client.invokeCapability<void>(
                'Aspire.Hosting.Kubernetes/KubernetesEnvironmentResource.setDefaultStorageType',
                { context: this._handle, value }
            );
        }
    };
    ...
    defaultStorageClassName = {
        get: async (): Promise<string> => {
            return await this._client.invokeCapability<string>(
                'Aspire.Hosting.Kubernetes/KubernetesEnvironmentResource.defaultStorageClassName',
                { context: this._handle }
            );
        },
        set: async (value: string): Promise<void> => {
            await this._client.invokeCapability<void>(
                'Aspire.Hosting.Kubernetes/KubernetesEnvironmentResource.setDefaultStorageClassName',
                { context: this._handle, value }
            );
        }
    };
    ...
    defaultStorageSize = {
        get: async (): Promise<string> => {
            return await this._client.invokeCapability<string>(
                'Aspire.Hosting.Kubernetes/KubernetesEnvironmentResource.defaultStorageSize',
                { context: this._handle }
            );
        },
        set: async (value: string): Promise<void> => {
            await this._client.invokeCapability<void>(
                'Aspire.Hosting.Kubernetes/KubernetesEnvironmentResource.setDefaultStorageSize',
                { context: this._handle, value }
            );
        }
    };
    ...
    defaultStorageReadWritePolicy = {
        get: async (): Promise<string> => {
            return await this._client.invokeCapability<string>(
                'Aspire.Hosting.Kubernetes/KubernetesEnvironmentResource.defaultStorageReadWritePolicy',
                { context: this._handle }
            );
        },
        set: async (value: string): Promise<void> => {
            await this._client.invokeCapability<void>(
                'Aspire.Hosting.Kubernetes/KubernetesEnvironmentResource.setDefaultStorageReadWritePolicy',
                { context: this._handle, value }
            );
        }
    };
    ...
    defaultImagePullPolicy = {
        get: async (): Promise<string> => {
            return await this._client.invokeCapability<string>(
                'Aspire.Hosting.Kubernetes/KubernetesEnvironmentResource.defaultImagePullPolicy',
                { context: this._handle }
            );
        },
        set: async (value: string): Promise<void> => {
            await this._client.invokeCapability<void>(
                'Aspire.Hosting.Kubernetes/KubernetesEnvironmentResource.setDefaultImagePullPolicy',
                { context: this._handle, value }
            );
        }
    };
    ...
    defaultServiceType = {
        get: async (): Promise<string> => {
            return await this._client.invokeCapability<string>(
                'Aspire.Hosting.Kubernetes/KubernetesEnvironmentResource.defaultServiceType',
                { context: this._handle }
            );
        },
        set: async (value: string): Promise<void> => {
            await this._client.invokeCapability<void>(
                'Aspire.Hosting.Kubernetes/KubernetesEnvironmentResource.setDefaultServiceType',
                { context: this._handle, value }
            );
        }
    };
    ...
    name = {
        get: async (): Promise<string> => {
            return await this._client.invokeCapability<string>(
                'Aspire.Hosting.Kubernetes/KubernetesEnvironmentResource.name',
                { context: this._handle }
            );
        },
    };
    ...
    /** @internal */
    private async _withContainerRegistryInternal(registry: ResourceBuilderBase): Promise<KubernetesEnvironmentResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, registry };
        const result = await this._client.invokeCapability<KubernetesEnvironmentResourceHandle>(
            'Aspire.Hosting/withContainerRegistry',
            rpcArgs
    ...
    /** Configures a resource to use a container registry */
    withContainerRegistry(registry: ResourceBuilderBase): KubernetesEnvironmentResourcePromise {
        return new KubernetesEnvironmentResourcePromise(this._withContainerRegistryInternal(registry));
    }

    /** @internal */
    private async _withDockerfileBaseImageInternal(buildImage?: string, runtimeImage?: string): Promise<KubernetesEnvironmentResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        if (buildImage !== undefined) rpcArgs.buildImage = buildImage;
        if (runtimeImage !== undefined) rpcArgs.runtimeImage = runtimeImage;
        const result = await this._client.invokeCapability<KubernetesEnvironmentResourceHandle>(
    ...
    /** Sets the base image for a Dockerfile build */
    withDockerfileBaseImage(options?: WithDockerfileBaseImageOptions): KubernetesEnvironmentResourcePromise {
        const buildImage = options?.buildImage;
        const runtimeImage = options?.runtimeImage;
        return new KubernetesEnvironmentResourcePromise(this._withDockerfileBaseImageInternal(buildImage, runtimeImage));
    }

    /** @internal */
    private async _withRequiredCommandInternal(command: string, helpLink?: string): Promise<KubernetesEnvironmentResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, command };
        if (helpLink !== undefined) rpcArgs.helpLink = helpLink;
        const result = await this._client.invokeCapability<KubernetesEnvironmentResourceHandle>(
            'Aspire.Hosting/withRequiredCommand',
    ...
    /** Adds a required command dependency */
    withRequiredCommand(command: string, options?: WithRequiredCommandOptions): KubernetesEnvironmentResourcePromise {
        const helpLink = options?.helpLink;
        return new KubernetesEnvironmentResourcePromise(this._withRequiredCommandInternal(command, helpLink));
    }

    /** @internal */
    private async _withUrlsCallbackInternal(callback: (obj: ResourceUrlsCallbackContext) => Promise<void>): Promise<KubernetesEnvironmentResource> {
        const callbackId = registerCallback(async (objData: unknown) => {
            const objHandle = wrapIfHandle(objData) as ResourceUrlsCallbackContextHandle;
            const obj = new ResourceUrlsCallbackContext(objHandle, this._client);
            await callback(obj);
    ...
    /** Customizes displayed URLs via callback */
    withUrlsCallback(callback: (obj: ResourceUrlsCallbackContext) => Promise<void>): KubernetesEnvironmentResourcePromise {
        return new KubernetesEnvironmentResourcePromise(this._withUrlsCallbackInternal(callback));
    }

    /** @internal */
    private async _withUrlsCallbackAsyncInternal(callback: (arg: ResourceUrlsCallbackContext) => Promise<void>): Promise<KubernetesEnvironmentResource> {
        const callbackId = registerCallback(async (argData: unknown) => {
            const argHandle = wrapIfHandle(argData) as ResourceUrlsCallbackContextHandle;
            const arg = new ResourceUrlsCallbackContext(argHandle, this._client);
            await callback(arg);
    ...
    /** Customizes displayed URLs via async callback */
    withUrlsCallbackAsync(callback: (arg: ResourceUrlsCallbackContext) => Promise<void>): KubernetesEnvironmentResourcePromise {
        return new KubernetesEnvironmentResourcePromise(this._withUrlsCallbackAsyncInternal(callback));
    }

    /** @internal */
    private async _withUrlInternal(url: string, displayText?: string): Promise<KubernetesEnvironmentResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, url };
        if (displayText !== undefined) rpcArgs.displayText = displayText;
        const result = await this._client.invokeCapability<KubernetesEnvironmentResourceHandle>(
            'Aspire.Hosting/withUrl',
    ...
    /** Adds or modifies displayed URLs */
    withUrl(url: string, options?: WithUrlOptions): KubernetesEnvironmentResourcePromise {
        const displayText = options?.displayText;
        return new KubernetesEnvironmentResourcePromise(this._withUrlInternal(url, displayText));
    }

    /** @internal */
    private async _withUrlExpressionInternal(url: ReferenceExpression, displayText?: string): Promise<KubernetesEnvironmentResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, url };
        if (displayText !== undefined) rpcArgs.displayText = displayText;
        const result = await this._client.invokeCapability<KubernetesEnvironmentResourceHandle>(
            'Aspire.Hosting/withUrlExpression',
    ...
    /** Adds a URL using a reference expression */
    withUrlExpression(url: ReferenceExpression, options?: WithUrlExpressionOptions): KubernetesEnvironmentResourcePromise {
        const displayText = options?.displayText;
        return new KubernetesEnvironmentResourcePromise(this._withUrlExpressionInternal(url, displayText));
    }

    /** @internal */
    private async _withUrlForEndpointInternal(endpointName: string, callback: (obj: ResourceUrlAnnotation) => Promise<void>): Promise<KubernetesEnvironmentResource> {
        const callbackId = registerCallback(async (objData: unknown) => {
            const obj = wrapIfHandle(objData) as ResourceUrlAnnotation;
            await callback(obj);
        });
    ...
    /** Customizes the URL for a specific endpoint via callback */
    withUrlForEndpoint(endpointName: string, callback: (obj: ResourceUrlAnnotation) => Promise<void>): KubernetesEnvironmentResourcePromise {
        return new KubernetesEnvironmentResourcePromise(this._withUrlForEndpointInternal(endpointName, callback));
    }

    /** @internal */
    private async _excludeFromManifestInternal(): Promise<KubernetesEnvironmentResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<KubernetesEnvironmentResourceHandle>(
            'Aspire.Hosting/excludeFromManifest',
            rpcArgs
    ...
    /** Excludes the resource from the deployment manifest */
    excludeFromManifest(): KubernetesEnvironmentResourcePromise {
        return new KubernetesEnvironmentResourcePromise(this._excludeFromManifestInternal());
    }

    /** @internal */
    private async _withExplicitStartInternal(): Promise<KubernetesEnvironmentResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<KubernetesEnvironmentResourceHandle>(
            'Aspire.Hosting/withExplicitStart',
            rpcArgs
    ...
    /** Prevents resource from starting automatically */
    withExplicitStart(): KubernetesEnvironmentResourcePromise {
        return new KubernetesEnvironmentResourcePromise(this._withExplicitStartInternal());
    }

    /** @internal */
    private async _withHealthCheckInternal(key: string): Promise<KubernetesEnvironmentResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, key };
        const result = await this._client.invokeCapability<KubernetesEnvironmentResourceHandle>(
            'Aspire.Hosting/withHealthCheck',
            rpcArgs
    ...
    /** Adds a health check by key */
    withHealthCheck(key: string): KubernetesEnvironmentResourcePromise {
        return new KubernetesEnvironmentResourcePromise(this._withHealthCheckInternal(key));
    }

    /** @internal */
    private async _withCommandInternal(name: string, displayName: string, executeCommand: (arg: ExecuteCommandContext) => Promise<ExecuteCommandResult>, commandOptions?: CommandOptions): Promise<KubernetesEnvironmentResource> {
        const executeCommandId = registerCallback(async (argData: unknown) => {
            const argHandle = wrapIfHandle(argData) as ExecuteCommandContextHandle;
            const arg = new ExecuteCommandContext(argHandle, this._client);
            return await executeCommand(arg);
    ...
    /** Adds a resource command */
    withCommand(name: string, displayName: string, executeCommand: (arg: ExecuteCommandContext) => Promise<ExecuteCommandResult>, options?: WithCommandOptions): KubernetesEnvironmentResourcePromise {
        const commandOptions = options?.commandOptions;
        return new KubernetesEnvironmentResourcePromise(this._withCommandInternal(name, displayName, executeCommand, commandOptions));
    }

    /** @internal */
    private async _withParentRelationshipInternal(parent: ResourceBuilderBase): Promise<KubernetesEnvironmentResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, parent };
        const result = await this._client.invokeCapability<KubernetesEnvironmentResourceHandle>(
            'Aspire.Hosting/withParentRelationship',
            rpcArgs
    ...
    /** Sets the parent relationship */
    withParentRelationship(parent: ResourceBuilderBase): KubernetesEnvironmentResourcePromise {
        return new KubernetesEnvironmentResourcePromise(this._withParentRelationshipInternal(parent));
    }

    /** @internal */
    private async _withChildRelationshipInternal(child: ResourceBuilderBase): Promise<KubernetesEnvironmentResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, child };
        const result = await this._client.invokeCapability<KubernetesEnvironmentResourceHandle>(
            'Aspire.Hosting/withChildRelationship',
            rpcArgs
    ...
    /** Sets a child relationship */
    withChildRelationship(child: ResourceBuilderBase): KubernetesEnvironmentResourcePromise {
        return new KubernetesEnvironmentResourcePromise(this._withChildRelationshipInternal(child));
    }

    /** @internal */
    private async _withIconNameInternal(iconName: string, iconVariant?: IconVariant): Promise<KubernetesEnvironmentResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, iconName };
        if (iconVariant !== undefined) rpcArgs.iconVariant = iconVariant;
        const result = await this._client.invokeCapability<KubernetesEnvironmentResourceHandle>(
            'Aspire.Hosting/withIconName',
    ...
    /** Sets the icon for the resource */
    withIconName(iconName: string, options?: WithIconNameOptions): KubernetesEnvironmentResourcePromise {
        const iconVariant = options?.iconVariant;
        return new KubernetesEnvironmentResourcePromise(this._withIconNameInternal(iconName, iconVariant));
    }

    /** @internal */
    private async _excludeFromMcpInternal(): Promise<KubernetesEnvironmentResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<KubernetesEnvironmentResourceHandle>(
            'Aspire.Hosting/excludeFromMcp',
            rpcArgs
    ...
    /** Excludes the resource from MCP server exposure */
    excludeFromMcp(): KubernetesEnvironmentResourcePromise {
        return new KubernetesEnvironmentResourcePromise(this._excludeFromMcpInternal());
    }

    /** @internal */
    private async _withRemoteImageNameInternal(remoteImageName: string): Promise<KubernetesEnvironmentResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, remoteImageName };
        const result = await this._client.invokeCapability<KubernetesEnvironmentResourceHandle>(
            'Aspire.Hosting/withRemoteImageName',
            rpcArgs
    ...
    /** Sets the remote image name for publishing */
    withRemoteImageName(remoteImageName: string): KubernetesEnvironmentResourcePromise {
        return new KubernetesEnvironmentResourcePromise(this._withRemoteImageNameInternal(remoteImageName));
    }

    /** @internal */
    private async _withRemoteImageTagInternal(remoteImageTag: string): Promise<KubernetesEnvironmentResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, remoteImageTag };
        const result = await this._client.invokeCapability<KubernetesEnvironmentResourceHandle>(
            'Aspire.Hosting/withRemoteImageTag',
            rpcArgs
    ...
    /** Sets the remote image tag for publishing */
    withRemoteImageTag(remoteImageTag: string): KubernetesEnvironmentResourcePromise {
        return new KubernetesEnvironmentResourcePromise(this._withRemoteImageTagInternal(remoteImageTag));
    }

    /** @internal */
    private async _withPipelineStepFactoryInternal(stepName: string, callback: (arg: PipelineStepContext) => Promise<void>, dependsOn?: string[], requiredBy?: string[], tags?: string[], description?: string): Promise<KubernetesEnvironmentResource> {
        const callbackId = registerCallback(async (argData: unknown) => {
            const argHandle = wrapIfHandle(argData) as PipelineStepContextHandle;
            const arg = new PipelineStepContext(argHandle, this._client);
            await callback(arg);
    ...
    /** Adds a pipeline step to the resource */
    withPipelineStepFactory(stepName: string, callback: (arg: PipelineStepContext) => Promise<void>, options?: WithPipelineStepFactoryOptions): KubernetesEnvironmentResourcePromise {
        const dependsOn = options?.dependsOn;
        const requiredBy = options?.requiredBy;
        const tags = options?.tags;
        const description = options?.description;
        return new KubernetesEnvironmentResourcePromise(this._withPipelineStepFactoryInternal(stepName, callback, dependsOn, requiredBy, tags, description));
    }

    /** @internal */
    private async _withPipelineConfigurationAsyncInternal(callback: (arg: PipelineConfigurationContext) => Promise<void>): Promise<KubernetesEnvironmentResource> {
        const callbackId = registerCallback(async (argData: unknown) => {
            const argHandle = wrapIfHandle(argData) as PipelineConfigurationContextHandle;
            const arg = new PipelineConfigurationContext(argHandle, this._client);
            await callback(arg);
    ...
    /** Configures pipeline step dependencies via an async callback */
    withPipelineConfigurationAsync(callback: (arg: PipelineConfigurationContext) => Promise<void>): KubernetesEnvironmentResourcePromise {
        return new KubernetesEnvironmentResourcePromise(this._withPipelineConfigurationAsyncInternal(callback));
    }

    /** @internal */
    private async _withPipelineConfigurationInternal(callback: (obj: PipelineConfigurationContext) => Promise<void>): Promise<KubernetesEnvironmentResource> {
        const callbackId = registerCallback(async (objData: unknown) => {
            const objHandle = wrapIfHandle(objData) as PipelineConfigurationContextHandle;
            const obj = new PipelineConfigurationContext(objHandle, this._client);
            await callback(obj);
    ...
    /** Configures pipeline step dependencies via a callback */
    withPipelineConfiguration(callback: (obj: PipelineConfigurationContext) => Promise<void>): KubernetesEnvironmentResourcePromise {
        return new KubernetesEnvironmentResourcePromise(this._withPipelineConfigurationInternal(callback));
    }
    ...
    /** @internal */
    private async _withPropertiesInternal(configure: (obj: KubernetesEnvironmentResource) => Promise<void>): Promise<KubernetesEnvironmentResource> {
        const configureId = registerCallback(async (objData: unknown) => {
            const objHandle = wrapIfHandle(objData) as KubernetesEnvironmentResourceHandle;
            const obj = new KubernetesEnvironmentResource(objHandle, this._client);
            await configure(obj);
        });
        const rpcArgs: Record<string, unknown> = { builder: this._handle, configure: configureId };
        const result = await this._client.invokeCapability<KubernetesEnvironmentResourceHandle>(
            'Aspire.Hosting.Kubernetes/withProperties',
            rpcArgs
        );
        return new KubernetesEnvironmentResource(result, this._client);
    }
    ...
    withProperties(configure: (obj: KubernetesEnvironmentResource) => Promise<void>): KubernetesEnvironmentResourcePromise {
        return new KubernetesEnvironmentResourcePromise(this._withPropertiesInternal(configure));
    }

}

/**
 * Thenable wrapper for KubernetesEnvironmentResource that enables fluent chaining.
 * @example
 * await builder.addSomething().withX().withY();
 */
export class KubernetesEnvironmentResourcePromise implements PromiseLike<KubernetesEnvironmentResource> {
    constructor(private _promise: Promise<KubernetesEnvironmentResource>) {}

    then<TResult1 = KubernetesEnvironmentResource, TResult2 = never>(
        onfulfilled?: ((value: KubernetesEnvironmentResource) => TResult1 | PromiseLike<TResult1>) | null,
        onrejected?: ((reason: unknown) => TResult2 | PromiseLike<TResult2>) | null
    ): PromiseLike<TResult1 | TResult2> {
        return this._promise.then(onfulfilled, onrejected);
    }
    ...
    /** Configures a resource to use a container registry */
    withContainerRegistry(registry: ResourceBuilderBase): KubernetesEnvironmentResourcePromise {
        return new KubernetesEnvironmentResourcePromise(this._promise.then(obj => obj.withContainerRegistry(registry)));
    }

    /** Sets the base image for a Dockerfile build */
    withDockerfileBaseImage(options?: WithDockerfileBaseImageOptions): KubernetesEnvironmentResourcePromise {
        return new KubernetesEnvironmentResourcePromise(this._promise.then(obj => obj.withDockerfileBaseImage(options)));
    }

    /** Adds a required command dependency */
    withRequiredCommand(command: string, options?: WithRequiredCommandOptions): KubernetesEnvironmentResourcePromise {
        return new KubernetesEnvironmentResourcePromise(this._promise.then(obj => obj.withRequiredCommand(command, options)));
    }

    /** Customizes displayed URLs via callback */
    withUrlsCallback(callback: (obj: ResourceUrlsCallbackContext) => Promise<void>): KubernetesEnvironmentResourcePromise {
        return new KubernetesEnvironmentResourcePromise(this._promise.then(obj => obj.withUrlsCallback(callback)));
    }

    /** Customizes displayed URLs via async callback */
    withUrlsCallbackAsync(callback: (arg: ResourceUrlsCallbackContext) => Promise<void>): KubernetesEnvironmentResourcePromise {
        return new KubernetesEnvironmentResourcePromise(this._promise.then(obj => obj.withUrlsCallbackAsync(callback)));
    }

    /** Adds or modifies displayed URLs */
    withUrl(url: string, options?: WithUrlOptions): KubernetesEnvironmentResourcePromise {
        return new KubernetesEnvironmentResourcePromise(this._promise.then(obj => obj.withUrl(url, options)));
    }

    /** Adds a URL using a reference expression */
    withUrlExpression(url: ReferenceExpression, options?: WithUrlExpressionOptions): KubernetesEnvironmentResourcePromise {
        return new KubernetesEnvironmentResourcePromise(this._promise.then(obj => obj.withUrlExpression(url, options)));
    }

    /** Customizes the URL for a specific endpoint via callback */
    withUrlForEndpoint(endpointName: string, callback: (obj: ResourceUrlAnnotation) => Promise<void>): KubernetesEnvironmentResourcePromise {
        return new KubernetesEnvironmentResourcePromise(this._promise.then(obj => obj.withUrlForEndpoint(endpointName, callback)));
    }

    /** Excludes the resource from the deployment manifest */
    excludeFromManifest(): KubernetesEnvironmentResourcePromise {
        return new KubernetesEnvironmentResourcePromise(this._promise.then(obj => obj.excludeFromManifest()));
    }

    /** Prevents resource from starting automatically */
    withExplicitStart(): KubernetesEnvironmentResourcePromise {
        return new KubernetesEnvironmentResourcePromise(this._promise.then(obj => obj.withExplicitStart()));
    }

    /** Adds a health check by key */
    withHealthCheck(key: string): KubernetesEnvironmentResourcePromise {
        return new KubernetesEnvironmentResourcePromise(this._promise.then(obj => obj.withHealthCheck(key)));
    }

    /** Adds a resource command */
    withCommand(name: string, displayName: string, executeCommand: (arg: ExecuteCommandContext) => Promise<ExecuteCommandResult>, options?: WithCommandOptions): KubernetesEnvironmentResourcePromise {
        return new KubernetesEnvironmentResourcePromise(this._promise.then(obj => obj.withCommand(name, displayName, executeCommand, options)));
    }

    /** Sets the parent relationship */
    withParentRelationship(parent: ResourceBuilderBase): KubernetesEnvironmentResourcePromise {
        return new KubernetesEnvironmentResourcePromise(this._promise.then(obj => obj.withParentRelationship(parent)));
    }

    /** Sets a child relationship */
    withChildRelationship(child: ResourceBuilderBase): KubernetesEnvironmentResourcePromise {
        return new KubernetesEnvironmentResourcePromise(this._promise.then(obj => obj.withChildRelationship(child)));
    }

    /** Sets the icon for the resource */
    withIconName(iconName: string, options?: WithIconNameOptions): KubernetesEnvironmentResourcePromise {
        return new KubernetesEnvironmentResourcePromise(this._promise.then(obj => obj.withIconName(iconName, options)));
    }

    /** Excludes the resource from MCP server exposure */
    excludeFromMcp(): KubernetesEnvironmentResourcePromise {
        return new KubernetesEnvironmentResourcePromise(this._promise.then(obj => obj.excludeFromMcp()));
    }

    /** Sets the remote image name for publishing */
    withRemoteImageName(remoteImageName: string): KubernetesEnvironmentResourcePromise {
        return new KubernetesEnvironmentResourcePromise(this._promise.then(obj => obj.withRemoteImageName(remoteImageName)));
    }

    /** Sets the remote image tag for publishing */
    withRemoteImageTag(remoteImageTag: string): KubernetesEnvironmentResourcePromise {
        return new KubernetesEnvironmentResourcePromise(this._promise.then(obj => obj.withRemoteImageTag(remoteImageTag)));
    }

    /** Adds a pipeline step to the resource */
    withPipelineStepFactory(stepName: string, callback: (arg: PipelineStepContext) => Promise<void>, options?: WithPipelineStepFactoryOptions): KubernetesEnvironmentResourcePromise {
        return new KubernetesEnvironmentResourcePromise(this._promise.then(obj => obj.withPipelineStepFactory(stepName, callback, options)));
    }

    /** Configures pipeline step dependencies via an async callback */
    withPipelineConfigurationAsync(callback: (arg: PipelineConfigurationContext) => Promise<void>): KubernetesEnvironmentResourcePromise {
        return new KubernetesEnvironmentResourcePromise(this._promise.then(obj => obj.withPipelineConfigurationAsync(callback)));
    }

    /** Configures pipeline step dependencies via a callback */
    withPipelineConfiguration(callback: (obj: PipelineConfigurationContext) => Promise<void>): KubernetesEnvironmentResourcePromise {
        return new KubernetesEnvironmentResourcePromise(this._promise.then(obj => obj.withPipelineConfiguration(callback)));
    }
    ...
    /** Configures properties of a Kubernetes environment */
    withProperties(configure: (obj: KubernetesEnvironmentResource) => Promise<void>): KubernetesEnvironmentResourcePromise {
        return new KubernetesEnvironmentResourcePromise(this._promise.then(obj => obj.withProperties(configure)));
    }
...
export class KubernetesResource extends ResourceBuilderBase<KubernetesResourceHandle> {
    constructor(handle: KubernetesResourceHandle, client: AspireClientRpc) {
        super(handle, client);
    }

    /** Gets the Parent property */
    parent = {
        get: async (): Promise<KubernetesEnvironmentResource> => {
            const handle = await this._client.invokeCapability<KubernetesEnvironmentResourceHandle>(
                'Aspire.Hosting.Kubernetes/KubernetesResource.parent',
                { context: this._handle }
            );
            return new KubernetesEnvironmentResource(handle, this._client);
        },
    };
    ...
    name = {
        get: async (): Promise<string> => {
            return await this._client.invokeCapability<string>(
                'Aspire.Hosting.Kubernetes/KubernetesResource.name',
                { context: this._handle }
            );
        },
    };
    ...
    /** @internal */
    private async _withContainerRegistryInternal(registry: ResourceBuilderBase): Promise<KubernetesResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, registry };
        const result = await this._client.invokeCapability<KubernetesResourceHandle>(
            'Aspire.Hosting/withContainerRegistry',
            rpcArgs
        );
        return new KubernetesResource(result, this._client);
    }

    /** Configures a resource to use a container registry */
    withContainerRegistry(registry: ResourceBuilderBase): KubernetesResourcePromise {
        return new KubernetesResourcePromise(this._withContainerRegistryInternal(registry));
    }

    /** @internal */
    private async _withDockerfileBaseImageInternal(buildImage?: string, runtimeImage?: string): Promise<KubernetesResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        if (buildImage !== undefined) rpcArgs.buildImage = buildImage;
        if (runtimeImage !== undefined) rpcArgs.runtimeImage = runtimeImage;
        const result = await this._client.invokeCapability<KubernetesResourceHandle>(
    ...
    /** Sets the base image for a Dockerfile build */
    withDockerfileBaseImage(options?: WithDockerfileBaseImageOptions): KubernetesResourcePromise {
        const buildImage = options?.buildImage;
        const runtimeImage = options?.runtimeImage;
        return new KubernetesResourcePromise(this._withDockerfileBaseImageInternal(buildImage, runtimeImage));
    }

    /** @internal */
    private async _withRequiredCommandInternal(command: string, helpLink?: string): Promise<KubernetesResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, command };
        if (helpLink !== undefined) rpcArgs.helpLink = helpLink;
        const result = await this._client.invokeCapability<KubernetesResourceHandle>(
            'Aspire.Hosting/withRequiredCommand',
    ...
    /** Adds a required command dependency */
    withRequiredCommand(command: string, options?: WithRequiredCommandOptions): KubernetesResourcePromise {
        const helpLink = options?.helpLink;
        return new KubernetesResourcePromise(this._withRequiredCommandInternal(command, helpLink));
    }

    /** @internal */
    private async _withUrlsCallbackInternal(callback: (obj: ResourceUrlsCallbackContext) => Promise<void>): Promise<KubernetesResource> {
        const callbackId = registerCallback(async (objData: unknown) => {
            const objHandle = wrapIfHandle(objData) as ResourceUrlsCallbackContextHandle;
            const obj = new ResourceUrlsCallbackContext(objHandle, this._client);
            await callback(obj);
    ...
    /** Customizes displayed URLs via callback */
    withUrlsCallback(callback: (obj: ResourceUrlsCallbackContext) => Promise<void>): KubernetesResourcePromise {
        return new KubernetesResourcePromise(this._withUrlsCallbackInternal(callback));
    }

    /** @internal */
    private async _withUrlsCallbackAsyncInternal(callback: (arg: ResourceUrlsCallbackContext) => Promise<void>): Promise<KubernetesResource> {
        const callbackId = registerCallback(async (argData: unknown) => {
            const argHandle = wrapIfHandle(argData) as ResourceUrlsCallbackContextHandle;
            const arg = new ResourceUrlsCallbackContext(argHandle, this._client);
            await callback(arg);
    ...
    /** Customizes displayed URLs via async callback */
    withUrlsCallbackAsync(callback: (arg: ResourceUrlsCallbackContext) => Promise<void>): KubernetesResourcePromise {
        return new KubernetesResourcePromise(this._withUrlsCallbackAsyncInternal(callback));
    }

    /** @internal */
    private async _withUrlInternal(url: string, displayText?: string): Promise<KubernetesResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, url };
        if (displayText !== undefined) rpcArgs.displayText = displayText;
        const result = await this._client.invokeCapability<KubernetesResourceHandle>(
            'Aspire.Hosting/withUrl',
    ...
    /** Adds or modifies displayed URLs */
    withUrl(url: string, options?: WithUrlOptions): KubernetesResourcePromise {
        const displayText = options?.displayText;
        return new KubernetesResourcePromise(this._withUrlInternal(url, displayText));
    }

    /** @internal */
    private async _withUrlExpressionInternal(url: ReferenceExpression, displayText?: string): Promise<KubernetesResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, url };
        if (displayText !== undefined) rpcArgs.displayText = displayText;
        const result = await this._client.invokeCapability<KubernetesResourceHandle>(
            'Aspire.Hosting/withUrlExpression',
    ...
    /** Adds a URL using a reference expression */
    withUrlExpression(url: ReferenceExpression, options?: WithUrlExpressionOptions): KubernetesResourcePromise {
        const displayText = options?.displayText;
        return new KubernetesResourcePromise(this._withUrlExpressionInternal(url, displayText));
    }

    /** @internal */
    private async _withUrlForEndpointInternal(endpointName: string, callback: (obj: ResourceUrlAnnotation) => Promise<void>): Promise<KubernetesResource> {
        const callbackId = registerCallback(async (objData: unknown) => {
            const obj = wrapIfHandle(objData) as ResourceUrlAnnotation;
            await callback(obj);
        });
    ...
    /** Customizes the URL for a specific endpoint via callback */
    withUrlForEndpoint(endpointName: string, callback: (obj: ResourceUrlAnnotation) => Promise<void>): KubernetesResourcePromise {
        return new KubernetesResourcePromise(this._withUrlForEndpointInternal(endpointName, callback));
    }

    /** @internal */
    private async _excludeFromManifestInternal(): Promise<KubernetesResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<KubernetesResourceHandle>(
            'Aspire.Hosting/excludeFromManifest',
            rpcArgs
    ...
    /** Excludes the resource from the deployment manifest */
    excludeFromManifest(): KubernetesResourcePromise {
        return new KubernetesResourcePromise(this._excludeFromManifestInternal());
    }

    /** @internal */
    private async _withExplicitStartInternal(): Promise<KubernetesResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<KubernetesResourceHandle>(
            'Aspire.Hosting/withExplicitStart',
            rpcArgs
    ...
    /** Prevents resource from starting automatically */
    withExplicitStart(): KubernetesResourcePromise {
        return new KubernetesResourcePromise(this._withExplicitStartInternal());
    }

    /** @internal */
    private async _withHealthCheckInternal(key: string): Promise<KubernetesResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, key };
        const result = await this._client.invokeCapability<KubernetesResourceHandle>(
            'Aspire.Hosting/withHealthCheck',
            rpcArgs
    ...
    /** Adds a health check by key */
    withHealthCheck(key: string): KubernetesResourcePromise {
        return new KubernetesResourcePromise(this._withHealthCheckInternal(key));
    }

    /** @internal */
    private async _withCommandInternal(name: string, displayName: string, executeCommand: (arg: ExecuteCommandContext) => Promise<ExecuteCommandResult>, commandOptions?: CommandOptions): Promise<KubernetesResource> {
        const executeCommandId = registerCallback(async (argData: unknown) => {
            const argHandle = wrapIfHandle(argData) as ExecuteCommandContextHandle;
            const arg = new ExecuteCommandContext(argHandle, this._client);
            return await executeCommand(arg);
    ...
    /** Adds a resource command */
    withCommand(name: string, displayName: string, executeCommand: (arg: ExecuteCommandContext) => Promise<ExecuteCommandResult>, options?: WithCommandOptions): KubernetesResourcePromise {
        const commandOptions = options?.commandOptions;
        return new KubernetesResourcePromise(this._withCommandInternal(name, displayName, executeCommand, commandOptions));
    }

    /** @internal */
    private async _withParentRelationshipInternal(parent: ResourceBuilderBase): Promise<KubernetesResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, parent };
        const result = await this._client.invokeCapability<KubernetesResourceHandle>(
            'Aspire.Hosting/withParentRelationship',
            rpcArgs
    ...
    /** Sets the parent relationship */
    withParentRelationship(parent: ResourceBuilderBase): KubernetesResourcePromise {
        return new KubernetesResourcePromise(this._withParentRelationshipInternal(parent));
    }

    /** @internal */
    private async _withChildRelationshipInternal(child: ResourceBuilderBase): Promise<KubernetesResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, child };
        const result = await this._client.invokeCapability<KubernetesResourceHandle>(
            'Aspire.Hosting/withChildRelationship',
            rpcArgs
    ...
    /** Sets a child relationship */
    withChildRelationship(child: ResourceBuilderBase): KubernetesResourcePromise {
        return new KubernetesResourcePromise(this._withChildRelationshipInternal(child));
    }

    /** @internal */
    private async _withIconNameInternal(iconName: string, iconVariant?: IconVariant): Promise<KubernetesResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, iconName };
        if (iconVariant !== undefined) rpcArgs.iconVariant = iconVariant;
        const result = await this._client.invokeCapability<KubernetesResourceHandle>(
            'Aspire.Hosting/withIconName',
    ...
    /** Sets the icon for the resource */
    withIconName(iconName: string, options?: WithIconNameOptions): KubernetesResourcePromise {
        const iconVariant = options?.iconVariant;
        return new KubernetesResourcePromise(this._withIconNameInternal(iconName, iconVariant));
    }

    /** @internal */
    private async _excludeFromMcpInternal(): Promise<KubernetesResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<KubernetesResourceHandle>(
            'Aspire.Hosting/excludeFromMcp',
            rpcArgs
    ...
    /** Excludes the resource from MCP server exposure */
    excludeFromMcp(): KubernetesResourcePromise {
        return new KubernetesResourcePromise(this._excludeFromMcpInternal());
    }

    /** @internal */
    private async _withRemoteImageNameInternal(remoteImageName: string): Promise<KubernetesResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, remoteImageName };
        const result = await this._client.invokeCapability<KubernetesResourceHandle>(
            'Aspire.Hosting/withRemoteImageName',
            rpcArgs
    ...
    /** Sets the remote image name for publishing */
    withRemoteImageName(remoteImageName: string): KubernetesResourcePromise {
        return new KubernetesResourcePromise(this._withRemoteImageNameInternal(remoteImageName));
    }

    /** @internal */
    private async _withRemoteImageTagInternal(remoteImageTag: string): Promise<KubernetesResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, remoteImageTag };
        const result = await this._client.invokeCapability<KubernetesResourceHandle>(
            'Aspire.Hosting/withRemoteImageTag',
            rpcArgs
    ...
    /** Sets the remote image tag for publishing */
    withRemoteImageTag(remoteImageTag: string): KubernetesResourcePromise {
        return new KubernetesResourcePromise(this._withRemoteImageTagInternal(remoteImageTag));
    }

    /** @internal */
    private async _withPipelineStepFactoryInternal(stepName: string, callback: (arg: PipelineStepContext) => Promise<void>, dependsOn?: string[], requiredBy?: string[], tags?: string[], description?: string): Promise<KubernetesResource> {
        const callbackId = registerCallback(async (argData: unknown) => {
            const argHandle = wrapIfHandle(argData) as PipelineStepContextHandle;
            const arg = new PipelineStepContext(argHandle, this._client);
            await callback(arg);
    ...
    /** Adds a pipeline step to the resource */
    withPipelineStepFactory(stepName: string, callback: (arg: PipelineStepContext) => Promise<void>, options?: WithPipelineStepFactoryOptions): KubernetesResourcePromise {
        const dependsOn = options?.dependsOn;
        const requiredBy = options?.requiredBy;
        const tags = options?.tags;
        const description = options?.description;
        return new KubernetesResourcePromise(this._withPipelineStepFactoryInternal(stepName, callback, dependsOn, requiredBy, tags, description));
    }

    /** @internal */
    private async _withPipelineConfigurationAsyncInternal(callback: (arg: PipelineConfigurationContext) => Promise<void>): Promise<KubernetesResource> {
        const callbackId = registerCallback(async (argData: unknown) => {
            const argHandle = wrapIfHandle(argData) as PipelineConfigurationContextHandle;
            const arg = new PipelineConfigurationContext(argHandle, this._client);
            await callback(arg);
    ...
    /** Configures pipeline step dependencies via an async callback */
    withPipelineConfigurationAsync(callback: (arg: PipelineConfigurationContext) => Promise<void>): KubernetesResourcePromise {
        return new KubernetesResourcePromise(this._withPipelineConfigurationAsyncInternal(callback));
    }

    /** @internal */
    private async _withPipelineConfigurationInternal(callback: (obj: PipelineConfigurationContext) => Promise<void>): Promise<KubernetesResource> {
        const callbackId = registerCallback(async (objData: unknown) => {
            const objHandle = wrapIfHandle(objData) as PipelineConfigurationContextHandle;
            const obj = new PipelineConfigurationContext(objHandle, this._client);
            await callback(obj);
    ...
    /** Configures pipeline step dependencies via a callback */
    withPipelineConfiguration(callback: (obj: PipelineConfigurationContext) => Promise<void>): KubernetesResourcePromise {
        return new KubernetesResourcePromise(this._withPipelineConfigurationInternal(callback));
    }
...
/**
 * Thenable wrapper for KubernetesResource that enables fluent chaining.
 * @example
 * await builder.addSomething().withX().withY();
 */
export class KubernetesResourcePromise implements PromiseLike<KubernetesResource> {
    constructor(private _promise: Promise<KubernetesResource>) {}

    then<TResult1 = KubernetesResource, TResult2 = never>(
        onfulfilled?: ((value: KubernetesResource) => TResult1 | PromiseLike<TResult1>) | null,
        onrejected?: ((reason: unknown) => TResult2 | PromiseLike<TResult2>) | null
    ): PromiseLike<TResult1 | TResult2> {
        return this._promise.then(onfulfilled, onrejected);
    }
    ...
    /** Configures a resource to use a container registry */
    withContainerRegistry(registry: ResourceBuilderBase): KubernetesResourcePromise {
        return new KubernetesResourcePromise(this._promise.then(obj => obj.withContainerRegistry(registry)));
    }

    /** Sets the base image for a Dockerfile build */
    withDockerfileBaseImage(options?: WithDockerfileBaseImageOptions): KubernetesResourcePromise {
        return new KubernetesResourcePromise(this._promise.then(obj => obj.withDockerfileBaseImage(options)));
    }

    /** Adds a required command dependency */
    withRequiredCommand(command: string, options?: WithRequiredCommandOptions): KubernetesResourcePromise {
        return new KubernetesResourcePromise(this._promise.then(obj => obj.withRequiredCommand(command, options)));
    }

    /** Customizes displayed URLs via callback */
    withUrlsCallback(callback: (obj: ResourceUrlsCallbackContext) => Promise<void>): KubernetesResourcePromise {
        return new KubernetesResourcePromise(this._promise.then(obj => obj.withUrlsCallback(callback)));
    }

    /** Customizes displayed URLs via async callback */
    withUrlsCallbackAsync(callback: (arg: ResourceUrlsCallbackContext) => Promise<void>): KubernetesResourcePromise {
        return new KubernetesResourcePromise(this._promise.then(obj => obj.withUrlsCallbackAsync(callback)));
    }

    /** Adds or modifies displayed URLs */
    withUrl(url: string, options?: WithUrlOptions): KubernetesResourcePromise {
        return new KubernetesResourcePromise(this._promise.then(obj => obj.withUrl(url, options)));
    }

    /** Adds a URL using a reference expression */
    withUrlExpression(url: ReferenceExpression, options?: WithUrlExpressionOptions): KubernetesResourcePromise {
        return new KubernetesResourcePromise(this._promise.then(obj => obj.withUrlExpression(url, options)));
    }

    /** Customizes the URL for a specific endpoint via callback */
    withUrlForEndpoint(endpointName: string, callback: (obj: ResourceUrlAnnotation) => Promise<void>): KubernetesResourcePromise {
        return new KubernetesResourcePromise(this._promise.then(obj => obj.withUrlForEndpoint(endpointName, callback)));
    }

    /** Excludes the resource from the deployment manifest */
    excludeFromManifest(): KubernetesResourcePromise {
        return new KubernetesResourcePromise(this._promise.then(obj => obj.excludeFromManifest()));
    }

    /** Prevents resource from starting automatically */
    withExplicitStart(): KubernetesResourcePromise {
        return new KubernetesResourcePromise(this._promise.then(obj => obj.withExplicitStart()));
    }

    /** Adds a health check by key */
    withHealthCheck(key: string): KubernetesResourcePromise {
        return new KubernetesResourcePromise(this._promise.then(obj => obj.withHealthCheck(key)));
    }

    /** Adds a resource command */
    withCommand(name: string, displayName: string, executeCommand: (arg: ExecuteCommandContext) => Promise<ExecuteCommandResult>, options?: WithCommandOptions): KubernetesResourcePromise {
        return new KubernetesResourcePromise(this._promise.then(obj => obj.withCommand(name, displayName, executeCommand, options)));
    }

    /** Sets the parent relationship */
    withParentRelationship(parent: ResourceBuilderBase): KubernetesResourcePromise {
        return new KubernetesResourcePromise(this._promise.then(obj => obj.withParentRelationship(parent)));
    }

    /** Sets a child relationship */
    withChildRelationship(child: ResourceBuilderBase): KubernetesResourcePromise {
        return new KubernetesResourcePromise(this._promise.then(obj => obj.withChildRelationship(child)));
    }

    /** Sets the icon for the resource */
    withIconName(iconName: string, options?: WithIconNameOptions): KubernetesResourcePromise {
        return new KubernetesResourcePromise(this._promise.then(obj => obj.withIconName(iconName, options)));
    }

    /** Excludes the resource from MCP server exposure */
    excludeFromMcp(): KubernetesResourcePromise {
        return new KubernetesResourcePromise(this._promise.then(obj => obj.excludeFromMcp()));
    }

    /** Sets the remote image name for publishing */
    withRemoteImageName(remoteImageName: string): KubernetesResourcePromise {
        return new KubernetesResourcePromise(this._promise.then(obj => obj.withRemoteImageName(remoteImageName)));
    }

    /** Sets the remote image tag for publishing */
    withRemoteImageTag(remoteImageTag: string): KubernetesResourcePromise {
        return new KubernetesResourcePromise(this._promise.then(obj => obj.withRemoteImageTag(remoteImageTag)));
    }

    /** Adds a pipeline step to the resource */
    withPipelineStepFactory(stepName: string, callback: (arg: PipelineStepContext) => Promise<void>, options?: WithPipelineStepFactoryOptions): KubernetesResourcePromise {
        return new KubernetesResourcePromise(this._promise.then(obj => obj.withPipelineStepFactory(stepName, callback, options)));
    }

    /** Configures pipeline step dependencies via an async callback */
    withPipelineConfigurationAsync(callback: (arg: PipelineConfigurationContext) => Promise<void>): KubernetesResourcePromise {
        return new KubernetesResourcePromise(this._promise.then(obj => obj.withPipelineConfigurationAsync(callback)));
    }

    /** Configures pipeline step dependencies via a callback */
    withPipelineConfiguration(callback: (obj: PipelineConfigurationContext) => Promise<void>): KubernetesResourcePromise {
        return new KubernetesResourcePromise(this._promise.then(obj => obj.withPipelineConfiguration(callback)));
    }
...
export class ProjectResource extends ResourceBuilderBase<ProjectResourceHandle> {
    ...
    /** @internal */
    private async _publishAsKubernetesServiceInternal(configure: (obj: KubernetesResource) => Promise<void>): Promise<ProjectResource> {
        const configureId = registerCallback(async (objData: unknown) => {
            const objHandle = wrapIfHandle(objData) as KubernetesResourceHandle;
            const obj = new KubernetesResource(objHandle, this._client);
            await configure(obj);
    ...
    /** Publishes the resource as a Kubernetes service */
    publishAsKubernetesService(configure: (obj: KubernetesResource) => Promise<void>): ProjectResourcePromise {
        return new ProjectResourcePromise(this._publishAsKubernetesServiceInternal(configure));
    }
...
export class ProjectResourcePromise implements PromiseLike<ProjectResource> {
    ...
    /** Publishes the resource as a Kubernetes service */
    publishAsKubernetesService(configure: (obj: KubernetesResource) => Promise<void>): ProjectResourcePromise {
        return new ProjectResourcePromise(this._promise.then(obj => obj.publishAsKubernetesService(configure)));
    }
...
export class ComputeResource extends ResourceBuilderBase<IComputeResourceHandle> {
    ...
    /** @internal */
    private async _publishAsKubernetesServiceInternal(configure: (obj: KubernetesResource) => Promise<void>): Promise<ComputeResource> {
        const configureId = registerCallback(async (objData: unknown) => {
            const objHandle = wrapIfHandle(objData) as KubernetesResourceHandle;
            const obj = new KubernetesResource(objHandle, this._client);
            await configure(obj);
    ...
    /** Publishes the resource as a Kubernetes service */
    publishAsKubernetesService(configure: (obj: KubernetesResource) => Promise<void>): ComputeResourcePromise {
        return new ComputeResourcePromise(this._publishAsKubernetesServiceInternal(configure));
    }
...
export class ComputeResourcePromise implements PromiseLike<ComputeResource> {
    ...
    /** Publishes the resource as a Kubernetes service */
    publishAsKubernetesService(configure: (obj: KubernetesResource) => Promise<void>): ComputeResourcePromise {
        return new ComputeResourcePromise(this._promise.then(obj => obj.publishAsKubernetesService(configure)));
    }
...
registerHandleWrapper('Aspire.Hosting.Kubernetes/Aspire.Hosting.Kubernetes.KubernetesEnvironmentResource', (handle, client) => new KubernetesEnvironmentResource(handle as KubernetesEnvironmentResourceHandle, client));
registerHandleWrapper('Aspire.Hosting.Kubernetes/Aspire.Hosting.Kubernetes.KubernetesResource', (handle, client) => new KubernetesResource(handle as KubernetesResourceHandle, client));
