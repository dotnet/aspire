...
export class DevTunnelResource extends ResourceBuilderBase<DevTunnelResourceHandle> {
    ...
    /** @internal */
    private async _withServiceReferenceNamedInternal(source: ResourceBuilderBase, name: string): Promise<DevTunnelResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, source, name };
        const result = await this._client.invokeCapability<DevTunnelResourceHandle>(
            'Aspire.Hosting/withServiceReferenceNamed',
            rpcArgs
    ...
    /** Adds a named service discovery reference */
    withServiceReferenceNamed(source: ResourceBuilderBase, name: string): DevTunnelResourcePromise {
        return new DevTunnelResourcePromise(this._withServiceReferenceNamedInternal(source, name));
    }
...
export class DevTunnelResourcePromise implements PromiseLike<DevTunnelResource> {
    ...
    /** Adds a named service discovery reference */
    withServiceReferenceNamed(source: ResourceBuilderBase, name: string): DevTunnelResourcePromise {
        return new DevTunnelResourcePromise(this._promise.then(obj => obj.withServiceReferenceNamed(source, name)));
    }
