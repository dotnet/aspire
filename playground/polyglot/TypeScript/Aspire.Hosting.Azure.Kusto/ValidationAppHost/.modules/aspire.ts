...
/** Handle to AzureKustoClusterResource */
type AzureKustoClusterResourceHandle = Handle<'Aspire.Hosting.Azure.Kusto/Aspire.Hosting.Azure.AzureKustoClusterResource'>;

/** Handle to AzureKustoEmulatorResource */
type AzureKustoEmulatorResourceHandle = Handle<'Aspire.Hosting.Azure.Kusto/Aspire.Hosting.Azure.AzureKustoEmulatorResource'>;

/** Handle to AzureKustoReadWriteDatabaseResource */
type AzureKustoReadWriteDatabaseResourceHandle = Handle<'Aspire.Hosting.Azure.Kusto/Aspire.Hosting.Azure.AzureKustoReadWriteDatabaseResource'>;
...
export interface AddReadWriteDatabaseOptions {
    databaseName?: string;
}
...
export class DistributedApplicationBuilder {
    ...
    /** @internal */
    async _addAzureKustoClusterInternal(name: string): Promise<AzureKustoClusterResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name };
        const result = await this._client.invokeCapability<AzureKustoClusterResourceHandle>(
            'Aspire.Hosting.Azure.Kusto/addAzureKustoCluster',
            rpcArgs
        );
        return new AzureKustoClusterResource(result, this._client);
    }

    addAzureKustoCluster(name: string): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._addAzureKustoClusterInternal(name));
    }
...
export class DistributedApplicationBuilderPromise implements PromiseLike<DistributedApplicationBuilder> {
    ...
    /** Adds an Azure Data Explorer (Kusto) cluster resource */
    addAzureKustoCluster(name: string): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._promise.then(obj => obj.addAzureKustoCluster(name)));
    }
...
export class AzureKustoClusterResource extends ResourceBuilderBase<AzureKustoClusterResourceHandle> {
    constructor(handle: AzureKustoClusterResourceHandle, client: AspireClientRpc) {
        super(handle, client);
    }
    ...
    isEmulator = {
        get: async (): Promise<boolean> => {
            return await this._client.invokeCapability<boolean>(
                'Aspire.Hosting.Azure/AzureKustoClusterResource.isEmulator',
                { context: this._handle }
            );
        },
    };
    ...
    uriExpression = {
        get: async (): Promise<ReferenceExpression> => {
            return await this._client.invokeCapability<ReferenceExpression>(
                'Aspire.Hosting.Azure/AzureKustoClusterResource.uriExpression',
                { context: this._handle }
            );
        },
    };
    ...
    connectionStringExpression = {
        get: async (): Promise<ReferenceExpression> => {
            return await this._client.invokeCapability<ReferenceExpression>(
                'Aspire.Hosting.Azure/AzureKustoClusterResource.connectionStringExpression',
                { context: this._handle }
            );
        },
    };
    ...
    get parameters(): AspireDict<string, any> {
        if (!this._parameters) {
            this._parameters = new AspireDict<string, any>(
                this._handle,
                this._client,
                'Aspire.Hosting.Azure/AzureKustoClusterResource.parameters',
                'Aspire.Hosting.Azure/AzureKustoClusterResource.parameters'
            );
        }
    ...
    get outputs(): AspireDict<string, any> {
        if (!this._outputs) {
            this._outputs = new AspireDict<string, any>(
                this._handle,
                this._client,
                'Aspire.Hosting.Azure/AzureKustoClusterResource.outputs',
                'Aspire.Hosting.Azure/AzureKustoClusterResource.outputs'
            );
        }
    ...
    get secretOutputs(): AspireDict<string, string> {
        if (!this._secretOutputs) {
            this._secretOutputs = new AspireDict<string, string>(
                this._handle,
                this._client,
                'Aspire.Hosting.Azure/AzureKustoClusterResource.secretOutputs',
                'Aspire.Hosting.Azure/AzureKustoClusterResource.secretOutputs'
            );
        }
    ...
    name = {
        get: async (): Promise<string> => {
            return await this._client.invokeCapability<string>(
                'Aspire.Hosting.Azure/AzureKustoClusterResource.name',
                { context: this._handle }
            );
        },
    };
    ...
    /** @internal */
    private async _withEndpointInternal(port?: number, targetPort?: number, scheme?: string, name?: string, env?: string, isProxied?: boolean, isExternal?: boolean, protocol?: ProtocolType): Promise<AzureKustoClusterResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
    ...
    withEndpoint(options?: WithEndpointOptions): AzureKustoClusterResourcePromise {
        ...
        return new AzureKustoClusterResourcePromise(this._withEndpointInternal(port, targetPort, scheme, name, env, isProxied, isExternal, protocol));
    }

    /** @internal */
    private async _withHttpEndpointInternal(port?: number, targetPort?: number, name?: string, env?: string, isProxied?: boolean): Promise<AzureKustoClusterResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        if (port !== undefined) rpcArgs.port = port;
        if (targetPort !== undefined) rpcArgs.targetPort = targetPort;
        if (name !== undefined) rpcArgs.name = name;
    ...
    withHttpEndpoint(options?: WithHttpEndpointOptions): AzureKustoClusterResourcePromise {
        const port = options?.port;
        const targetPort = options?.targetPort;
        const name = options?.name;
        const env = options?.env;
        const isProxied = options?.isProxied;
        return new AzureKustoClusterResourcePromise(this._withHttpEndpointInternal(port, targetPort, name, env, isProxied));
    }

    /** @internal */
    private async _withHttpsEndpointInternal(port?: number, targetPort?: number, name?: string, env?: string, isProxied?: boolean): Promise<AzureKustoClusterResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        if (port !== undefined) rpcArgs.port = port;
        if (targetPort !== undefined) rpcArgs.targetPort = targetPort;
        if (name !== undefined) rpcArgs.name = name;
    ...
    withHttpsEndpoint(options?: WithHttpsEndpointOptions): AzureKustoClusterResourcePromise {
        const port = options?.port;
        const targetPort = options?.targetPort;
        const name = options?.name;
        const env = options?.env;
        const isProxied = options?.isProxied;
        return new AzureKustoClusterResourcePromise(this._withHttpsEndpointInternal(port, targetPort, name, env, isProxied));
    }

    /** @internal */
    private async _withExternalHttpEndpointsInternal(): Promise<AzureKustoClusterResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<AzureKustoClusterResourceHandle>(
    ...
    withExternalHttpEndpoints(): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._withExternalHttpEndpointsInternal());
    }
    ...
    /** @internal */
    private async _asHttp2ServiceInternal(): Promise<AzureKustoClusterResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<AzureKustoClusterResourceHandle>(
    ...
    asHttp2Service(): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._asHttp2ServiceInternal());
    }

    /** @internal */
    private async _withUrlsCallbackInternal(callback: (obj: ResourceUrlsCallbackContext) => Promise<void>): Promise<AzureKustoClusterResource> {
        const callbackId = registerCallback(async (objData: unknown) => {
            const objHandle = wrapIfHandle(objData) as ResourceUrlsCallbackContextHandle;
            const obj = new ResourceUrlsCallbackContext(objHandle, this._client);
            await callback(obj);
    ...
    /** Customizes displayed URLs via callback */
    withUrlsCallback(callback: (obj: ResourceUrlsCallbackContext) => Promise<void>): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._withUrlsCallbackInternal(callback));
    }

    /** @internal */
    private async _withUrlsCallbackAsyncInternal(callback: (arg: ResourceUrlsCallbackContext) => Promise<void>): Promise<AzureKustoClusterResource> {
        const callbackId = registerCallback(async (argData: unknown) => {
            const argHandle = wrapIfHandle(argData) as ResourceUrlsCallbackContextHandle;
            const arg = new ResourceUrlsCallbackContext(argHandle, this._client);
            await callback(arg);
    ...
    /** Customizes displayed URLs via async callback */
    withUrlsCallbackAsync(callback: (arg: ResourceUrlsCallbackContext) => Promise<void>): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._withUrlsCallbackAsyncInternal(callback));
    }

    /** @internal */
    private async _withUrlInternal(url: string, displayText?: string): Promise<AzureKustoClusterResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, url };
        if (displayText !== undefined) rpcArgs.displayText = displayText;
        const result = await this._client.invokeCapability<AzureKustoClusterResourceHandle>(
            'Aspire.Hosting/withUrl',
    ...
    /** Adds or modifies displayed URLs */
    withUrl(url: string, options?: WithUrlOptions): AzureKustoClusterResourcePromise {
        const displayText = options?.displayText;
        return new AzureKustoClusterResourcePromise(this._withUrlInternal(url, displayText));
    }

    /** @internal */
    private async _withUrlExpressionInternal(url: ReferenceExpression, displayText?: string): Promise<AzureKustoClusterResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, url };
        if (displayText !== undefined) rpcArgs.displayText = displayText;
        const result = await this._client.invokeCapability<AzureKustoClusterResourceHandle>(
            'Aspire.Hosting/withUrlExpression',
    ...
    /** Adds a URL using a reference expression */
    withUrlExpression(url: ReferenceExpression, options?: WithUrlExpressionOptions): AzureKustoClusterResourcePromise {
        const displayText = options?.displayText;
        return new AzureKustoClusterResourcePromise(this._withUrlExpressionInternal(url, displayText));
    }

    /** @internal */
    private async _withUrlForEndpointInternal(endpointName: string, callback: (obj: ResourceUrlAnnotation) => Promise<void>): Promise<AzureKustoClusterResource> {
        const callbackId = registerCallback(async (objData: unknown) => {
            const obj = wrapIfHandle(objData) as ResourceUrlAnnotation;
            await callback(obj);
        });
    ...
    /** Customizes the URL for a specific endpoint via callback */
    withUrlForEndpoint(endpointName: string, callback: (obj: ResourceUrlAnnotation) => Promise<void>): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._withUrlForEndpointInternal(endpointName, callback));
    }

    /** @internal */
    private async _withUrlForEndpointFactoryInternal(endpointName: string, callback: (arg: EndpointReference) => Promise<ResourceUrlAnnotation>): Promise<AzureKustoClusterResource> {
        const callbackId = registerCallback(async (argData: unknown) => {
    ...
    withUrlForEndpointFactory(endpointName: string, callback: (arg: EndpointReference) => Promise<ResourceUrlAnnotation>): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._withUrlForEndpointFactoryInternal(endpointName, callback));
    }

    /** @internal */
    private async _withExplicitStartInternal(): Promise<AzureKustoClusterResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<AzureKustoClusterResourceHandle>(
            'Aspire.Hosting/withExplicitStart',
            rpcArgs
    ...
    /** Prevents resource from starting automatically */
    withExplicitStart(): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._withExplicitStartInternal());
    }

    /** @internal */
    private async _withHealthCheckInternal(key: string): Promise<AzureKustoClusterResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, key };
        const result = await this._client.invokeCapability<AzureKustoClusterResourceHandle>(
            'Aspire.Hosting/withHealthCheck',
            rpcArgs
    ...
    /** Adds a health check by key */
    withHealthCheck(key: string): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._withHealthCheckInternal(key));
    }

    /** @internal */
    private async _withHttpHealthCheckInternal(path?: string, statusCode?: number, endpointName?: string): Promise<AzureKustoClusterResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
    ...
    withHttpHealthCheck(options?: WithHttpHealthCheckOptions): AzureKustoClusterResourcePromise {
        const path = options?.path;
        const statusCode = options?.statusCode;
        const endpointName = options?.endpointName;
        return new AzureKustoClusterResourcePromise(this._withHttpHealthCheckInternal(path, statusCode, endpointName));
    }

    /** @internal */
    private async _withCommandInternal(name: string, displayName: string, executeCommand: (arg: ExecuteCommandContext) => Promise<ExecuteCommandResult>, commandOptions?: CommandOptions): Promise<AzureKustoClusterResource> {
        const executeCommandId = registerCallback(async (argData: unknown) => {
            const argHandle = wrapIfHandle(argData) as ExecuteCommandContextHandle;
            const arg = new ExecuteCommandContext(argHandle, this._client);
            return await executeCommand(arg);
    ...
    /** Adds a resource command */
    withCommand(name: string, displayName: string, executeCommand: (arg: ExecuteCommandContext) => Promise<ExecuteCommandResult>, options?: WithCommandOptions): AzureKustoClusterResourcePromise {
        const commandOptions = options?.commandOptions;
        return new AzureKustoClusterResourcePromise(this._withCommandInternal(name, displayName, executeCommand, commandOptions));
    }

    /** @internal */
    private async _withParentRelationshipInternal(parent: ResourceBuilderBase): Promise<AzureKustoClusterResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, parent };
        const result = await this._client.invokeCapability<AzureKustoClusterResourceHandle>(
            'Aspire.Hosting/withParentRelationship',
            rpcArgs
    ...
    /** Sets the parent relationship */
    withParentRelationship(parent: ResourceBuilderBase): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._withParentRelationshipInternal(parent));
    }
    ...
    /** @internal */
    private async _addReadWriteDatabaseInternal(name: string, databaseName?: string): Promise<AzureKustoReadWriteDatabaseResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name };
        if (databaseName !== undefined) rpcArgs.databaseName = databaseName;
        const result = await this._client.invokeCapability<AzureKustoReadWriteDatabaseResourceHandle>(
            'Aspire.Hosting.Azure.Kusto/addReadWriteDatabase',
            rpcArgs
        );
        return new AzureKustoReadWriteDatabaseResource(result, this._client);
    }

    /** Adds a Kusto read-write database resource */
    addReadWriteDatabase(name: string, options?: AddReadWriteDatabaseOptions): AzureKustoReadWriteDatabaseResourcePromise {
        const databaseName = options?.databaseName;
        return new AzureKustoReadWriteDatabaseResourcePromise(this._addReadWriteDatabaseInternal(name, databaseName));
    }

    /** @internal */
    private async _runAsEmulatorInternal(configureContainer?: (obj: AzureKustoEmulatorResource) => Promise<void>): Promise<AzureKustoClusterResource> {
        const configureContainerId = configureContainer ? registerCallback(async (objData: unknown) => {
            const objHandle = wrapIfHandle(objData) as AzureKustoEmulatorResourceHandle;
            const obj = new AzureKustoEmulatorResource(objHandle, this._client);
            await configureContainer(obj);
        }) : undefined;
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        if (configureContainer !== undefined) rpcArgs.configureContainer = configureContainerId;
        const result = await this._client.invokeCapability<AzureKustoClusterResourceHandle>(
            'Aspire.Hosting.Azure.Kusto/runAsEmulator',
            rpcArgs
        );
        return new AzureKustoClusterResource(result, this._client);
    }
    ...
    runAsEmulator(options?: RunAsEmulatorOptions): AzureKustoClusterResourcePromise {
        const configureContainer = options?.configureContainer;
        return new AzureKustoClusterResourcePromise(this._runAsEmulatorInternal(configureContainer));
    }
    ...
    /** @internal */
    private async _withParameterInternal(name: string): Promise<AzureKustoClusterResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name };
        const result = await this._client.invokeCapability<AzureKustoClusterResourceHandle>(
    ...
    withParameter(name: string): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._withParameterInternal(name));
    }

    /** @internal */
    private async _withParameterStringValueInternal(name: string, value: string): Promise<AzureKustoClusterResource> {
    ...
    withParameterStringValue(name: string, value: string): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._withParameterStringValueInternal(name, value));
    }

    /** @internal */
    private async _withParameterStringValuesInternal(name: string, value: string[]): Promise<AzureKustoClusterResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, value };
        const result = await this._client.invokeCapability<AzureKustoClusterResourceHandle>(
    ...
    withParameterStringValues(name: string, value: string[]): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._withParameterStringValuesInternal(name, value));
    }

    /** @internal */
    private async _withParameterFromParameterInternal(name: string, value: ParameterResource): Promise<AzureKustoClusterResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, value };
        const result = await this._client.invokeCapability<AzureKustoClusterResourceHandle>(
    ...
    withParameterFromParameter(name: string, value: ParameterResource): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._withParameterFromParameterInternal(name, value));
    }

    /** @internal */
    private async _withParameterFromConnectionStringInternal(name: string, value: ResourceBuilderBase): Promise<AzureKustoClusterResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, value };
        const result = await this._client.invokeCapability<AzureKustoClusterResourceHandle>(
    ...
    withParameterFromConnectionString(name: string, value: ResourceBuilderBase): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._withParameterFromConnectionStringInternal(name, value));
    }

    /** @internal */
    private async _withParameterFromOutputInternal(name: string, value: BicepOutputReference): Promise<AzureKustoClusterResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, value };
        const result = await this._client.invokeCapability<AzureKustoClusterResourceHandle>(
    ...
    withParameterFromOutput(name: string, value: BicepOutputReference): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._withParameterFromOutputInternal(name, value));
    }

    /** @internal */
    private async _withParameterFromReferenceExpressionInternal(name: string, value: ReferenceExpression): Promise<AzureKustoClusterResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, value };
        const result = await this._client.invokeCapability<AzureKustoClusterResourceHandle>(
    ...
    withParameterFromReferenceExpression(name: string, value: ReferenceExpression): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._withParameterFromReferenceExpressionInternal(name, value));
    }

    /** @internal */
    private async _withParameterFromEndpointInternal(name: string, value: EndpointReference): Promise<AzureKustoClusterResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, value };
        const result = await this._client.invokeCapability<AzureKustoClusterResourceHandle>(
    ...
    withParameterFromEndpoint(name: string, value: EndpointReference): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._withParameterFromEndpointInternal(name, value));
    }

    /** @internal */
    private async _configureInfrastructureInternal(configure: (obj: AzureResourceInfrastructure) => Promise<void>): Promise<AzureKustoClusterResource> {
    ...
    configureInfrastructure(configure: (obj: AzureResourceInfrastructure) => Promise<void>): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._configureInfrastructureInternal(configure));
    }

    /** @internal */
    private async _publishAsConnectionStringInternal(): Promise<AzureKustoClusterResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<AzureKustoClusterResourceHandle>(
            'Aspire.Hosting.Azure/publishAsConnectionString',
            rpcArgs
    ...
    /** Publishes an Azure resource to the manifest as a connection string */
    publishAsConnectionString(): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._publishAsConnectionStringInternal());
    }
    ...
    /** @internal */
    private async _clearDefaultRoleAssignmentsInternal(): Promise<AzureKustoClusterResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<AzureKustoClusterResourceHandle>(
            'Aspire.Hosting.Azure/clearDefaultRoleAssignments',
            rpcArgs
    ...
    /** Clears the default Azure role assignments from a resource */
    clearDefaultRoleAssignments(): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._clearDefaultRoleAssignmentsInternal());
    }
    ...
    /** @internal */
    private async _runAsExistingFromParametersInternal(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): Promise<AzureKustoClusterResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, nameParameter, resourceGroupParameter };
        const result = await this._client.invokeCapability<AzureKustoClusterResourceHandle>(
            'Aspire.Hosting.Azure/runAsExistingFromParameters',
            rpcArgs
    ...
    /** Marks an Azure resource as existing in run mode by using parameter resources */
    runAsExistingFromParameters(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._runAsExistingFromParametersInternal(nameParameter, resourceGroupParameter));
    }

    /** @internal */
    private async _runAsExistingInternal(name: string, resourceGroup: string): Promise<AzureKustoClusterResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, resourceGroup };
        const result = await this._client.invokeCapability<AzureKustoClusterResourceHandle>(
            'Aspire.Hosting.Azure/runAsExisting',
            rpcArgs
    ...
    /** Marks an Azure resource as existing in run mode */
    runAsExisting(name: string, resourceGroup: string): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._runAsExistingInternal(name, resourceGroup));
    }

    /** @internal */
    private async _publishAsExistingFromParametersInternal(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): Promise<AzureKustoClusterResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, nameParameter, resourceGroupParameter };
        const result = await this._client.invokeCapability<AzureKustoClusterResourceHandle>(
            'Aspire.Hosting.Azure/publishAsExistingFromParameters',
            rpcArgs
    ...
    /** Marks an Azure resource as existing in publish mode by using parameter resources */
    publishAsExistingFromParameters(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._publishAsExistingFromParametersInternal(nameParameter, resourceGroupParameter));
    }

    /** @internal */
    private async _publishAsExistingInternal(name: string, resourceGroup: string): Promise<AzureKustoClusterResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, resourceGroup };
        const result = await this._client.invokeCapability<AzureKustoClusterResourceHandle>(
            'Aspire.Hosting.Azure/publishAsExisting',
            rpcArgs
    ...
    /** Marks an Azure resource as existing in publish mode */
    publishAsExisting(name: string, resourceGroup: string): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._publishAsExistingInternal(name, resourceGroup));
    }

    /** @internal */
    private async _asExistingInternal(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): Promise<AzureKustoClusterResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, nameParameter, resourceGroupParameter };
        const result = await this._client.invokeCapability<AzureKustoClusterResourceHandle>(
            'Aspire.Hosting.Azure/asExisting',
            rpcArgs
    ...
    /** Marks an Azure resource as existing in both run and publish modes */
    asExisting(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._asExistingInternal(nameParameter, resourceGroupParameter));
    }

}

/**
 * Thenable wrapper for AzureKustoClusterResource that enables fluent chaining.
 * @example
 * await builder.addSomething().withX().withY();
 */
export class AzureKustoClusterResourcePromise implements PromiseLike<AzureKustoClusterResource> {
    constructor(private _promise: Promise<AzureKustoClusterResource>) {}

    then<TResult1 = AzureKustoClusterResource, TResult2 = never>(
        onfulfilled?: ((value: AzureKustoClusterResource) => TResult1 | PromiseLike<TResult1>) | null,
        onrejected?: ((reason: unknown) => TResult2 | PromiseLike<TResult2>) | null
    ): PromiseLike<TResult1 | TResult2> {
        return this._promise.then(onfulfilled, onrejected);
    }
    ...
    /** Adds a network endpoint */
    withEndpoint(options?: WithEndpointOptions): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._promise.then(obj => obj.withEndpoint(options)));
    }

    /** Adds an HTTP endpoint */
    withHttpEndpoint(options?: WithHttpEndpointOptions): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._promise.then(obj => obj.withHttpEndpoint(options)));
    }

    /** Adds an HTTPS endpoint */
    withHttpsEndpoint(options?: WithHttpsEndpointOptions): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._promise.then(obj => obj.withHttpsEndpoint(options)));
    }

    /** Makes HTTP endpoints externally accessible */
    withExternalHttpEndpoints(): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._promise.then(obj => obj.withExternalHttpEndpoints()));
    }
    ...
    /** Configures resource for HTTP/2 */
    asHttp2Service(): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._promise.then(obj => obj.asHttp2Service()));
    }

    /** Customizes displayed URLs via callback */
    withUrlsCallback(callback: (obj: ResourceUrlsCallbackContext) => Promise<void>): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._promise.then(obj => obj.withUrlsCallback(callback)));
    }

    /** Customizes displayed URLs via async callback */
    withUrlsCallbackAsync(callback: (arg: ResourceUrlsCallbackContext) => Promise<void>): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._promise.then(obj => obj.withUrlsCallbackAsync(callback)));
    }

    /** Adds or modifies displayed URLs */
    withUrl(url: string, options?: WithUrlOptions): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._promise.then(obj => obj.withUrl(url, options)));
    }

    /** Adds a URL using a reference expression */
    withUrlExpression(url: ReferenceExpression, options?: WithUrlExpressionOptions): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._promise.then(obj => obj.withUrlExpression(url, options)));
    }

    /** Customizes the URL for a specific endpoint via callback */
    withUrlForEndpoint(endpointName: string, callback: (obj: ResourceUrlAnnotation) => Promise<void>): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._promise.then(obj => obj.withUrlForEndpoint(endpointName, callback)));
    }

    /** Adds a URL for a specific endpoint via factory callback */
    withUrlForEndpointFactory(endpointName: string, callback: (arg: EndpointReference) => Promise<ResourceUrlAnnotation>): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._promise.then(obj => obj.withUrlForEndpointFactory(endpointName, callback)));
    }

    /** Prevents resource from starting automatically */
    withExplicitStart(): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._promise.then(obj => obj.withExplicitStart()));
    }

    /** Adds a health check by key */
    withHealthCheck(key: string): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._promise.then(obj => obj.withHealthCheck(key)));
    }

    /** Adds an HTTP health check */
    withHttpHealthCheck(options?: WithHttpHealthCheckOptions): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._promise.then(obj => obj.withHttpHealthCheck(options)));
    }

    /** Adds a resource command */
    withCommand(name: string, displayName: string, executeCommand: (arg: ExecuteCommandContext) => Promise<ExecuteCommandResult>, options?: WithCommandOptions): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._promise.then(obj => obj.withCommand(name, displayName, executeCommand, options)));
    }

    /** Sets the parent relationship */
    withParentRelationship(parent: ResourceBuilderBase): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._promise.then(obj => obj.withParentRelationship(parent)));
    }
    ...
    /** Adds a Kusto read-write database resource */
    addReadWriteDatabase(name: string, options?: AddReadWriteDatabaseOptions): AzureKustoReadWriteDatabaseResourcePromise {
        return new AzureKustoReadWriteDatabaseResourcePromise(this._promise.then(obj => obj.addReadWriteDatabase(name, options)));
    }

    /** Configures the Kusto cluster to run using the local emulator */
    runAsEmulator(options?: RunAsEmulatorOptions): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._promise.then(obj => obj.runAsEmulator(options)));
    }
    ...
    /** Adds a Bicep parameter without a value */
    withParameter(name: string): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._promise.then(obj => obj.withParameter(name)));
    }

    /** Adds a Bicep parameter with a string value */
    withParameterStringValue(name: string, value: string): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._promise.then(obj => obj.withParameterStringValue(name, value)));
    }

    /** Adds a Bicep parameter with a string list value */
    withParameterStringValues(name: string, value: string[]): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._promise.then(obj => obj.withParameterStringValues(name, value)));
    }

    /** Adds a Bicep parameter from a parameter resource builder */
    withParameterFromParameter(name: string, value: ParameterResource): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._promise.then(obj => obj.withParameterFromParameter(name, value)));
    }

    /** Adds a Bicep parameter from a connection string resource builder */
    withParameterFromConnectionString(name: string, value: ResourceBuilderBase): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._promise.then(obj => obj.withParameterFromConnectionString(name, value)));
    }

    /** Adds a Bicep parameter from another Bicep output reference */
    withParameterFromOutput(name: string, value: BicepOutputReference): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._promise.then(obj => obj.withParameterFromOutput(name, value)));
    }

    /** Adds a Bicep parameter from a reference expression */
    withParameterFromReferenceExpression(name: string, value: ReferenceExpression): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._promise.then(obj => obj.withParameterFromReferenceExpression(name, value)));
    }

    /** Adds a Bicep parameter from an endpoint reference */
    withParameterFromEndpoint(name: string, value: EndpointReference): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._promise.then(obj => obj.withParameterFromEndpoint(name, value)));
    }

    /** Configures the Azure provisioning infrastructure callback */
    configureInfrastructure(configure: (obj: AzureResourceInfrastructure) => Promise<void>): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._promise.then(obj => obj.configureInfrastructure(configure)));
    }

    /** Publishes an Azure resource to the manifest as a connection string */
    publishAsConnectionString(): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._promise.then(obj => obj.publishAsConnectionString()));
    }
    ...
    /** Clears the default Azure role assignments from a resource */
    clearDefaultRoleAssignments(): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._promise.then(obj => obj.clearDefaultRoleAssignments()));
    }
    ...
    /** Marks an Azure resource as existing in run mode by using parameter resources */
    runAsExistingFromParameters(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._promise.then(obj => obj.runAsExistingFromParameters(nameParameter, resourceGroupParameter)));
    }

    /** Marks an Azure resource as existing in run mode */
    runAsExisting(name: string, resourceGroup: string): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._promise.then(obj => obj.runAsExisting(name, resourceGroup)));
    }

    /** Marks an Azure resource as existing in publish mode by using parameter resources */
    publishAsExistingFromParameters(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._promise.then(obj => obj.publishAsExistingFromParameters(nameParameter, resourceGroupParameter)));
    }

    /** Marks an Azure resource as existing in publish mode */
    publishAsExisting(name: string, resourceGroup: string): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._promise.then(obj => obj.publishAsExisting(name, resourceGroup)));
    }

    /** Marks an Azure resource as existing in both run and publish modes */
    asExisting(nameParameter: ParameterResource, resourceGroupParameter: ParameterResource): AzureKustoClusterResourcePromise {
        return new AzureKustoClusterResourcePromise(this._promise.then(obj => obj.asExisting(nameParameter, resourceGroupParameter)));
    }
...
export class AzureKustoEmulatorResource extends ResourceBuilderBase<AzureKustoEmulatorResourceHandle> {
    constructor(handle: AzureKustoEmulatorResourceHandle, client: AspireClientRpc) {
        super(handle, client);
    }

    /** @internal */
    private async _withBindMountInternal(source: string, target: string, isReadOnly?: boolean): Promise<AzureKustoEmulatorResource> {
        ...
        const result = await this._client.invokeCapability<AzureKustoEmulatorResourceHandle>(
            'Aspire.Hosting/withBindMount',
            rpcArgs
        );
        return new AzureKustoEmulatorResource(result, this._client);
    }

    /** Adds a bind mount */
    withBindMount(source: string, target: string, options?: WithBindMountOptions): AzureKustoEmulatorResourcePromise {
        const isReadOnly = options?.isReadOnly;
        return new AzureKustoEmulatorResourcePromise(this._withBindMountInternal(source, target, isReadOnly));
    }

    /** @internal */
    private async _withEntrypointInternal(entrypoint: string): Promise<AzureKustoEmulatorResource> {
    ...
    withEntrypoint(entrypoint: string): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._withEntrypointInternal(entrypoint));
    }

    /** @internal */
    private async _withImageTagInternal(tag: string): Promise<AzureKustoEmulatorResource> {
    ...
    withImageTag(tag: string): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._withImageTagInternal(tag));
    }

    /** @internal */
    private async _withImageRegistryInternal(registry: string): Promise<AzureKustoEmulatorResource> {
    ...
    withImageRegistry(registry: string): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._withImageRegistryInternal(registry));
    }

    /** @internal */
    private async _withImageInternal(image: string, tag?: string): Promise<AzureKustoEmulatorResource> {
    ...
    withImage(image: string, options?: WithImageOptions): AzureKustoEmulatorResourcePromise {
        const tag = options?.tag;
        return new AzureKustoEmulatorResourcePromise(this._withImageInternal(image, tag));
    }

    /** @internal */
    private async _withContainerRuntimeArgsInternal(args: string[]): Promise<AzureKustoEmulatorResource> {
    ...
    withContainerRuntimeArgs(args: string[]): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._withContainerRuntimeArgsInternal(args));
    }

    /** @internal */
    private async _withLifetimeInternal(lifetime: ContainerLifetime): Promise<AzureKustoEmulatorResource> {
    ...
    withLifetime(lifetime: ContainerLifetime): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._withLifetimeInternal(lifetime));
    }

    /** @internal */
    private async _withImagePullPolicyInternal(pullPolicy: ImagePullPolicy): Promise<AzureKustoEmulatorResource> {
    ...
    withImagePullPolicy(pullPolicy: ImagePullPolicy): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._withImagePullPolicyInternal(pullPolicy));
    }

    /** @internal */
    private async _withContainerNameInternal(name: string): Promise<AzureKustoEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name };
        const result = await this._client.invokeCapability<AzureKustoEmulatorResourceHandle>(
    ...
    withContainerName(name: string): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._withContainerNameInternal(name));
    }

    /** @internal */
    private async _withEnvironmentInternal(name: string, value: string): Promise<AzureKustoEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, value };
        const result = await this._client.invokeCapability<AzureKustoEmulatorResourceHandle>(
    ...
    withEnvironment(name: string, value: string): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._withEnvironmentInternal(name, value));
    }

    /** @internal */
    private async _withEnvironmentExpressionInternal(name: string, value: ReferenceExpression): Promise<AzureKustoEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, name, value };
        const result = await this._client.invokeCapability<AzureKustoEmulatorResourceHandle>(
    ...
    withEnvironmentExpression(name: string, value: ReferenceExpression): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._withEnvironmentExpressionInternal(name, value));
    }

    /** @internal */
    private async _withEnvironmentCallbackInternal(callback: (obj: EnvironmentCallbackContext) => Promise<void>): Promise<AzureKustoEmulatorResource> {
        const callbackId = registerCallback(async (objData: unknown) => {
    ...
    withEnvironmentCallback(callback: (obj: EnvironmentCallbackContext) => Promise<void>): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._withEnvironmentCallbackInternal(callback));
    }

    /** @internal */
    private async _withEnvironmentCallbackAsyncInternal(callback: (arg: EnvironmentCallbackContext) => Promise<void>): Promise<AzureKustoEmulatorResource> {
        const callbackId = registerCallback(async (argData: unknown) => {
    ...
    withEnvironmentCallbackAsync(callback: (arg: EnvironmentCallbackContext) => Promise<void>): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._withEnvironmentCallbackAsyncInternal(callback));
    }

    /** @internal */
    private async _withArgsInternal(args: string[]): Promise<AzureKustoEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, args };
        const result = await this._client.invokeCapability<AzureKustoEmulatorResourceHandle>(
    ...
    /** Adds arguments */
    withArgs(args: string[]): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._withArgsInternal(args));
    }

    /** @internal */
    private async _withArgsCallbackInternal(callback: (obj: CommandLineArgsCallbackContext) => Promise<void>): Promise<AzureKustoEmulatorResource> {
        const callbackId = registerCallback(async (objData: unknown) => {
    ...
    withArgsCallback(callback: (obj: CommandLineArgsCallbackContext) => Promise<void>): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._withArgsCallbackInternal(callback));
    }

    /** @internal */
    private async _withArgsCallbackAsyncInternal(callback: (arg: CommandLineArgsCallbackContext) => Promise<void>): Promise<AzureKustoEmulatorResource> {
        const callbackId = registerCallback(async (argData: unknown) => {
    ...
    withArgsCallbackAsync(callback: (arg: CommandLineArgsCallbackContext) => Promise<void>): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._withArgsCallbackAsyncInternal(callback));
    }

    /** @internal */
    private async _withReferenceInternal(source: ResourceBuilderBase, connectionName?: string, optional?: boolean): Promise<AzureKustoEmulatorResource> {
    ...
    withReference(source: ResourceBuilderBase, options?: WithReferenceOptions): AzureKustoEmulatorResourcePromise {
        const connectionName = options?.connectionName;
        const optional = options?.optional;
        return new AzureKustoEmulatorResourcePromise(this._withReferenceInternal(source, connectionName, optional));
    }

    /** @internal */
    private async _withServiceReferenceInternal(source: ResourceBuilderBase): Promise<AzureKustoEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, source };
        const result = await this._client.invokeCapability<AzureKustoEmulatorResourceHandle>(
    ...
    withServiceReference(source: ResourceBuilderBase): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._withServiceReferenceInternal(source));
    }

    /** @internal */
    private async _withEndpointInternal(port?: number, targetPort?: number, scheme?: string, name?: string, env?: string, isProxied?: boolean, isExternal?: boolean, protocol?: ProtocolType): Promise<AzureKustoEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        if (port !== undefined) rpcArgs.port = port;
        if (targetPort !== undefined) rpcArgs.targetPort = targetPort;
        if (scheme !== undefined) rpcArgs.scheme = scheme;
    ...
    /** Adds a network endpoint */
    withEndpoint(options?: WithEndpointOptions): AzureKustoEmulatorResourcePromise {
        const port = options?.port;
        const targetPort = options?.targetPort;
        const scheme = options?.scheme;
        const name = options?.name;
        ...
        const isExternal = options?.isExternal;
        const protocol = options?.protocol;
        return new AzureKustoEmulatorResourcePromise(this._withEndpointInternal(port, targetPort, scheme, name, env, isProxied, isExternal, protocol));
    }

    /** @internal */
    private async _withHttpEndpointInternal(port?: number, targetPort?: number, name?: string, env?: string, isProxied?: boolean): Promise<AzureKustoEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        if (port !== undefined) rpcArgs.port = port;
        if (targetPort !== undefined) rpcArgs.targetPort = targetPort;
        if (name !== undefined) rpcArgs.name = name;
    ...
    /** Adds an HTTP endpoint */
    withHttpEndpoint(options?: WithHttpEndpointOptions): AzureKustoEmulatorResourcePromise {
        const port = options?.port;
        const targetPort = options?.targetPort;
        const name = options?.name;
        const env = options?.env;
        const isProxied = options?.isProxied;
        return new AzureKustoEmulatorResourcePromise(this._withHttpEndpointInternal(port, targetPort, name, env, isProxied));
    }

    /** @internal */
    private async _withHttpsEndpointInternal(port?: number, targetPort?: number, name?: string, env?: string, isProxied?: boolean): Promise<AzureKustoEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        if (port !== undefined) rpcArgs.port = port;
        if (targetPort !== undefined) rpcArgs.targetPort = targetPort;
        if (name !== undefined) rpcArgs.name = name;
    ...
    /** Adds an HTTPS endpoint */
    withHttpsEndpoint(options?: WithHttpsEndpointOptions): AzureKustoEmulatorResourcePromise {
        const port = options?.port;
        const targetPort = options?.targetPort;
        const name = options?.name;
        const env = options?.env;
        const isProxied = options?.isProxied;
        return new AzureKustoEmulatorResourcePromise(this._withHttpsEndpointInternal(port, targetPort, name, env, isProxied));
    }

    /** @internal */
    private async _withExternalHttpEndpointsInternal(): Promise<AzureKustoEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<AzureKustoEmulatorResourceHandle>(
            'Aspire.Hosting/withExternalHttpEndpoints',
            rpcArgs
    ...
    /** Makes HTTP endpoints externally accessible */
    withExternalHttpEndpoints(): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._withExternalHttpEndpointsInternal());
    }
    ...
    /** @internal */
    private async _asHttp2ServiceInternal(): Promise<AzureKustoEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<AzureKustoEmulatorResourceHandle>(
            'Aspire.Hosting/asHttp2Service',
            rpcArgs
    ...
    /** Configures resource for HTTP/2 */
    asHttp2Service(): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._asHttp2ServiceInternal());
    }

    /** @internal */
    private async _withUrlsCallbackInternal(callback: (obj: ResourceUrlsCallbackContext) => Promise<void>): Promise<AzureKustoEmulatorResource> {
        const callbackId = registerCallback(async (objData: unknown) => {
            const objHandle = wrapIfHandle(objData) as ResourceUrlsCallbackContextHandle;
            const obj = new ResourceUrlsCallbackContext(objHandle, this._client);
            await callback(obj);
    ...
    /** Customizes displayed URLs via callback */
    withUrlsCallback(callback: (obj: ResourceUrlsCallbackContext) => Promise<void>): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._withUrlsCallbackInternal(callback));
    }

    /** @internal */
    private async _withUrlsCallbackAsyncInternal(callback: (arg: ResourceUrlsCallbackContext) => Promise<void>): Promise<AzureKustoEmulatorResource> {
        const callbackId = registerCallback(async (argData: unknown) => {
            const argHandle = wrapIfHandle(argData) as ResourceUrlsCallbackContextHandle;
            const arg = new ResourceUrlsCallbackContext(argHandle, this._client);
            await callback(arg);
    ...
    /** Customizes displayed URLs via async callback */
    withUrlsCallbackAsync(callback: (arg: ResourceUrlsCallbackContext) => Promise<void>): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._withUrlsCallbackAsyncInternal(callback));
    }

    /** @internal */
    private async _withUrlInternal(url: string, displayText?: string): Promise<AzureKustoEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, url };
        if (displayText !== undefined) rpcArgs.displayText = displayText;
        const result = await this._client.invokeCapability<AzureKustoEmulatorResourceHandle>(
            'Aspire.Hosting/withUrl',
    ...
    /** Adds or modifies displayed URLs */
    withUrl(url: string, options?: WithUrlOptions): AzureKustoEmulatorResourcePromise {
        const displayText = options?.displayText;
        return new AzureKustoEmulatorResourcePromise(this._withUrlInternal(url, displayText));
    }

    /** @internal */
    private async _withUrlExpressionInternal(url: ReferenceExpression, displayText?: string): Promise<AzureKustoEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, url };
        if (displayText !== undefined) rpcArgs.displayText = displayText;
        const result = await this._client.invokeCapability<AzureKustoEmulatorResourceHandle>(
            'Aspire.Hosting/withUrlExpression',
    ...
    /** Adds a URL using a reference expression */
    withUrlExpression(url: ReferenceExpression, options?: WithUrlExpressionOptions): AzureKustoEmulatorResourcePromise {
        const displayText = options?.displayText;
        return new AzureKustoEmulatorResourcePromise(this._withUrlExpressionInternal(url, displayText));
    }

    /** @internal */
    private async _withUrlForEndpointInternal(endpointName: string, callback: (obj: ResourceUrlAnnotation) => Promise<void>): Promise<AzureKustoEmulatorResource> {
        const callbackId = registerCallback(async (objData: unknown) => {
            const obj = wrapIfHandle(objData) as ResourceUrlAnnotation;
            await callback(obj);
        });
    ...
    /** Customizes the URL for a specific endpoint via callback */
    withUrlForEndpoint(endpointName: string, callback: (obj: ResourceUrlAnnotation) => Promise<void>): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._withUrlForEndpointInternal(endpointName, callback));
    }

    /** @internal */
    private async _withUrlForEndpointFactoryInternal(endpointName: string, callback: (arg: EndpointReference) => Promise<ResourceUrlAnnotation>): Promise<AzureKustoEmulatorResource> {
        const callbackId = registerCallback(async (argData: unknown) => {
            const argHandle = wrapIfHandle(argData) as EndpointReferenceHandle;
            const arg = new EndpointReference(argHandle, this._client);
            return await callback(arg);
    ...
    /** Adds a URL for a specific endpoint via factory callback */
    withUrlForEndpointFactory(endpointName: string, callback: (arg: EndpointReference) => Promise<ResourceUrlAnnotation>): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._withUrlForEndpointFactoryInternal(endpointName, callback));
    }

    /** @internal */
    private async _waitForInternal(dependency: ResourceBuilderBase): Promise<AzureKustoEmulatorResource> {
    ...
    waitFor(dependency: ResourceBuilderBase): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._waitForInternal(dependency));
    }

    /** @internal */
    private async _withExplicitStartInternal(): Promise<AzureKustoEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<AzureKustoEmulatorResourceHandle>(
            'Aspire.Hosting/withExplicitStart',
            rpcArgs
    ...
    /** Prevents resource from starting automatically */
    withExplicitStart(): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._withExplicitStartInternal());
    }

    /** @internal */
    private async _waitForCompletionInternal(dependency: ResourceBuilderBase, exitCode?: number): Promise<AzureKustoEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, dependency };
    ...
    waitForCompletion(dependency: ResourceBuilderBase, options?: WaitForCompletionOptions): AzureKustoEmulatorResourcePromise {
        const exitCode = options?.exitCode;
        return new AzureKustoEmulatorResourcePromise(this._waitForCompletionInternal(dependency, exitCode));
    }

    /** @internal */
    private async _withHealthCheckInternal(key: string): Promise<AzureKustoEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, key };
        const result = await this._client.invokeCapability<AzureKustoEmulatorResourceHandle>(
            'Aspire.Hosting/withHealthCheck',
            rpcArgs
    ...
    /** Adds a health check by key */
    withHealthCheck(key: string): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._withHealthCheckInternal(key));
    }

    /** @internal */
    private async _withHttpHealthCheckInternal(path?: string, statusCode?: number, endpointName?: string): Promise<AzureKustoEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        if (path !== undefined) rpcArgs.path = path;
        if (statusCode !== undefined) rpcArgs.statusCode = statusCode;
        if (endpointName !== undefined) rpcArgs.endpointName = endpointName;
    ...
    /** Adds an HTTP health check */
    withHttpHealthCheck(options?: WithHttpHealthCheckOptions): AzureKustoEmulatorResourcePromise {
        const path = options?.path;
        const statusCode = options?.statusCode;
        const endpointName = options?.endpointName;
        return new AzureKustoEmulatorResourcePromise(this._withHttpHealthCheckInternal(path, statusCode, endpointName));
    }

    /** @internal */
    private async _withCommandInternal(name: string, displayName: string, executeCommand: (arg: ExecuteCommandContext) => Promise<ExecuteCommandResult>, commandOptions?: CommandOptions): Promise<AzureKustoEmulatorResource> {
        const executeCommandId = registerCallback(async (argData: unknown) => {
            const argHandle = wrapIfHandle(argData) as ExecuteCommandContextHandle;
            const arg = new ExecuteCommandContext(argHandle, this._client);
            return await executeCommand(arg);
    ...
    /** Adds a resource command */
    withCommand(name: string, displayName: string, executeCommand: (arg: ExecuteCommandContext) => Promise<ExecuteCommandResult>, options?: WithCommandOptions): AzureKustoEmulatorResourcePromise {
        const commandOptions = options?.commandOptions;
        return new AzureKustoEmulatorResourcePromise(this._withCommandInternal(name, displayName, executeCommand, commandOptions));
    }

    /** @internal */
    private async _withParentRelationshipInternal(parent: ResourceBuilderBase): Promise<AzureKustoEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, parent };
        const result = await this._client.invokeCapability<AzureKustoEmulatorResourceHandle>(
            'Aspire.Hosting/withParentRelationship',
            rpcArgs
    ...
    /** Sets the parent relationship */
    withParentRelationship(parent: ResourceBuilderBase): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._withParentRelationshipInternal(parent));
    }

    /** @internal */
    private async _withVolumeInternal(target: string, name?: string, isReadOnly?: boolean): Promise<AzureKustoEmulatorResource> {
    ...
    /** Adds a volume */
    withVolume(target: string, options?: WithVolumeOptions): AzureKustoEmulatorResourcePromise {
        const name = options?.name;
        const isReadOnly = options?.isReadOnly;
        return new AzureKustoEmulatorResourcePromise(this._withVolumeInternal(target, name, isReadOnly));
    }
    ...
    /** @internal */
    private async _withHostPortInternal(port: number): Promise<AzureKustoEmulatorResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, port };
        const result = await this._client.invokeCapability<AzureKustoEmulatorResourceHandle>(
            'Aspire.Hosting.Azure.Kusto/withHostPort',
            rpcArgs
        );
        return new AzureKustoEmulatorResource(result, this._client);
    }
    ...
    withHostPort(port: number): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._withHostPortInternal(port));
    }

    /** @internal */
    private async _withEnvironmentFromOutputInternal(name: string, bicepOutputReference: BicepOutputReference): Promise<AzureKustoEmulatorResource> {
    ...
    withEnvironmentFromOutput(name: string, bicepOutputReference: BicepOutputReference): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._withEnvironmentFromOutputInternal(name, bicepOutputReference));
    }

    /** @internal */
    private async _withEnvironmentFromKeyVaultSecretInternal(name: string, secretReference: ResourceBuilderBase): Promise<AzureKustoEmulatorResource> {
    ...
    withEnvironmentFromKeyVaultSecret(name: string, secretReference: ResourceBuilderBase): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._withEnvironmentFromKeyVaultSecretInternal(name, secretReference));
    }

    /** @internal */
    private async _withAzureUserAssignedIdentityInternal(identityResourceBuilder: AzureUserAssignedIdentityResource): Promise<AzureKustoEmulatorResource> {
    ...
    withAzureUserAssignedIdentity(identityResourceBuilder: AzureUserAssignedIdentityResource): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._withAzureUserAssignedIdentityInternal(identityResourceBuilder));
    }

}

/**
 * Thenable wrapper for AzureKustoEmulatorResource that enables fluent chaining.
 * @example
 * await builder.addSomething().withX().withY();
 */
export class AzureKustoEmulatorResourcePromise implements PromiseLike<AzureKustoEmulatorResource> {
    constructor(private _promise: Promise<AzureKustoEmulatorResource>) {}

    then<TResult1 = AzureKustoEmulatorResource, TResult2 = never>(
        onfulfilled?: ((value: AzureKustoEmulatorResource) => TResult1 | PromiseLike<TResult1>) | null,
        onrejected?: ((reason: unknown) => TResult2 | PromiseLike<TResult2>) | null
    ): PromiseLike<TResult1 | TResult2> {
        return this._promise.then(onfulfilled, onrejected);
    }
    ...
    /** Adds a bind mount */
    withBindMount(source: string, target: string, options?: WithBindMountOptions): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._promise.then(obj => obj.withBindMount(source, target, options)));
    }

    /** Sets the container entrypoint */
    withEntrypoint(entrypoint: string): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._promise.then(obj => obj.withEntrypoint(entrypoint)));
    }

    /** Sets the container image tag */
    withImageTag(tag: string): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._promise.then(obj => obj.withImageTag(tag)));
    }

    /** Sets the container image registry */
    withImageRegistry(registry: string): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._promise.then(obj => obj.withImageRegistry(registry)));
    }

    /** Sets the container image */
    withImage(image: string, options?: WithImageOptions): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._promise.then(obj => obj.withImage(image, options)));
    }

    /** Adds runtime arguments for the container */
    withContainerRuntimeArgs(args: string[]): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._promise.then(obj => obj.withContainerRuntimeArgs(args)));
    }

    /** Sets the lifetime behavior of the container resource */
    withLifetime(lifetime: ContainerLifetime): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._promise.then(obj => obj.withLifetime(lifetime)));
    }

    /** Sets the container image pull policy */
    withImagePullPolicy(pullPolicy: ImagePullPolicy): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._promise.then(obj => obj.withImagePullPolicy(pullPolicy)));
    }

    /** Sets the container name */
    withContainerName(name: string): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._promise.then(obj => obj.withContainerName(name)));
    }

    /** Sets an environment variable */
    withEnvironment(name: string, value: string): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._promise.then(obj => obj.withEnvironment(name, value)));
    }

    /** Adds an environment variable with a reference expression */
    withEnvironmentExpression(name: string, value: ReferenceExpression): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._promise.then(obj => obj.withEnvironmentExpression(name, value)));
    }

    /** Sets environment variables via callback */
    withEnvironmentCallback(callback: (obj: EnvironmentCallbackContext) => Promise<void>): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._promise.then(obj => obj.withEnvironmentCallback(callback)));
    }

    /** Sets environment variables via async callback */
    withEnvironmentCallbackAsync(callback: (arg: EnvironmentCallbackContext) => Promise<void>): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._promise.then(obj => obj.withEnvironmentCallbackAsync(callback)));
    }

    /** Adds arguments */
    withArgs(args: string[]): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._promise.then(obj => obj.withArgs(args)));
    }

    /** Sets command-line arguments via callback */
    withArgsCallback(callback: (obj: CommandLineArgsCallbackContext) => Promise<void>): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._promise.then(obj => obj.withArgsCallback(callback)));
    }

    /** Sets command-line arguments via async callback */
    withArgsCallbackAsync(callback: (arg: CommandLineArgsCallbackContext) => Promise<void>): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._promise.then(obj => obj.withArgsCallbackAsync(callback)));
    }

    /** Adds a reference to another resource */
    withReference(source: ResourceBuilderBase, options?: WithReferenceOptions): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._promise.then(obj => obj.withReference(source, options)));
    }

    /** Adds a service discovery reference to another resource */
    withServiceReference(source: ResourceBuilderBase): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._promise.then(obj => obj.withServiceReference(source)));
    }

    /** Adds a network endpoint */
    withEndpoint(options?: WithEndpointOptions): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._promise.then(obj => obj.withEndpoint(options)));
    }

    /** Adds an HTTP endpoint */
    withHttpEndpoint(options?: WithHttpEndpointOptions): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._promise.then(obj => obj.withHttpEndpoint(options)));
    }

    /** Adds an HTTPS endpoint */
    withHttpsEndpoint(options?: WithHttpsEndpointOptions): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._promise.then(obj => obj.withHttpsEndpoint(options)));
    }

    /** Makes HTTP endpoints externally accessible */
    withExternalHttpEndpoints(): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._promise.then(obj => obj.withExternalHttpEndpoints()));
    }
    ...
    /** Configures resource for HTTP/2 */
    asHttp2Service(): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._promise.then(obj => obj.asHttp2Service()));
    }

    /** Customizes displayed URLs via callback */
    withUrlsCallback(callback: (obj: ResourceUrlsCallbackContext) => Promise<void>): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._promise.then(obj => obj.withUrlsCallback(callback)));
    }

    /** Customizes displayed URLs via async callback */
    withUrlsCallbackAsync(callback: (arg: ResourceUrlsCallbackContext) => Promise<void>): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._promise.then(obj => obj.withUrlsCallbackAsync(callback)));
    }

    /** Adds or modifies displayed URLs */
    withUrl(url: string, options?: WithUrlOptions): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._promise.then(obj => obj.withUrl(url, options)));
    }

    /** Adds a URL using a reference expression */
    withUrlExpression(url: ReferenceExpression, options?: WithUrlExpressionOptions): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._promise.then(obj => obj.withUrlExpression(url, options)));
    }

    /** Customizes the URL for a specific endpoint via callback */
    withUrlForEndpoint(endpointName: string, callback: (obj: ResourceUrlAnnotation) => Promise<void>): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._promise.then(obj => obj.withUrlForEndpoint(endpointName, callback)));
    }

    /** Adds a URL for a specific endpoint via factory callback */
    withUrlForEndpointFactory(endpointName: string, callback: (arg: EndpointReference) => Promise<ResourceUrlAnnotation>): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._promise.then(obj => obj.withUrlForEndpointFactory(endpointName, callback)));
    }

    /** Waits for another resource to be ready */
    waitFor(dependency: ResourceBuilderBase): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._promise.then(obj => obj.waitFor(dependency)));
    }

    /** Prevents resource from starting automatically */
    withExplicitStart(): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._promise.then(obj => obj.withExplicitStart()));
    }

    /** Waits for resource completion */
    waitForCompletion(dependency: ResourceBuilderBase, options?: WaitForCompletionOptions): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._promise.then(obj => obj.waitForCompletion(dependency, options)));
    }

    /** Adds a health check by key */
    withHealthCheck(key: string): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._promise.then(obj => obj.withHealthCheck(key)));
    }

    /** Adds an HTTP health check */
    withHttpHealthCheck(options?: WithHttpHealthCheckOptions): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._promise.then(obj => obj.withHttpHealthCheck(options)));
    }

    /** Adds a resource command */
    withCommand(name: string, displayName: string, executeCommand: (arg: ExecuteCommandContext) => Promise<ExecuteCommandResult>, options?: WithCommandOptions): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._promise.then(obj => obj.withCommand(name, displayName, executeCommand, options)));
    }

    /** Sets the parent relationship */
    withParentRelationship(parent: ResourceBuilderBase): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._promise.then(obj => obj.withParentRelationship(parent)));
    }

    /** Adds a volume */
    withVolume(target: string, options?: WithVolumeOptions): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._promise.then(obj => obj.withVolume(target, options)));
    }
    ...
    /** Sets the host port for the Kusto emulator endpoint */
    withHostPort(port: number): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._promise.then(obj => obj.withHostPort(port)));
    }

    /** Sets an environment variable from a Bicep output reference */
    withEnvironmentFromOutput(name: string, bicepOutputReference: BicepOutputReference): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._promise.then(obj => obj.withEnvironmentFromOutput(name, bicepOutputReference)));
    }

    /** Sets an environment variable from an Azure Key Vault secret reference */
    withEnvironmentFromKeyVaultSecret(name: string, secretReference: ResourceBuilderBase): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._promise.then(obj => obj.withEnvironmentFromKeyVaultSecret(name, secretReference)));
    }

    /** Associates an Azure user-assigned identity with a compute resource */
    withAzureUserAssignedIdentity(identityResourceBuilder: AzureUserAssignedIdentityResource): AzureKustoEmulatorResourcePromise {
        return new AzureKustoEmulatorResourcePromise(this._promise.then(obj => obj.withAzureUserAssignedIdentity(identityResourceBuilder)));
    }
...
export class AzureKustoReadWriteDatabaseResource extends ResourceBuilderBase<AzureKustoReadWriteDatabaseResourceHandle> {
    constructor(handle: AzureKustoReadWriteDatabaseResourceHandle, client: AspireClientRpc) {
        super(handle, client);
    }

    /** Gets the Parent property */
    parent = {
        get: async (): Promise<AzureKustoClusterResource> => {
            const handle = await this._client.invokeCapability<AzureKustoClusterResourceHandle>(
                'Aspire.Hosting.Azure/AzureKustoReadWriteDatabaseResource.parent',
                { context: this._handle }
            );
            return new AzureKustoClusterResource(handle, this._client);
        },
    };
    ...
    connectionStringExpression = {
        get: async (): Promise<ReferenceExpression> => {
            return await this._client.invokeCapability<ReferenceExpression>(
                'Aspire.Hosting.Azure/AzureKustoReadWriteDatabaseResource.connectionStringExpression',
                { context: this._handle }
            );
        },
    };
    ...
    databaseName = {
        get: async (): Promise<string> => {
            return await this._client.invokeCapability<string>(
                'Aspire.Hosting.Azure/AzureKustoReadWriteDatabaseResource.databaseName',
                { context: this._handle }
            );
        },
    };
    ...
    name = {
        get: async (): Promise<string> => {
            return await this._client.invokeCapability<string>(
                'Aspire.Hosting.Azure/AzureKustoReadWriteDatabaseResource.name',
                { context: this._handle }
            );
        },
    };
    ...
    /** @internal */
    private async _withUrlsCallbackInternal(callback: (obj: ResourceUrlsCallbackContext) => Promise<void>): Promise<AzureKustoReadWriteDatabaseResource> {
        const callbackId = registerCallback(async (objData: unknown) => {
            const objHandle = wrapIfHandle(objData) as ResourceUrlsCallbackContextHandle;
            const obj = new ResourceUrlsCallbackContext(objHandle, this._client);
            await callback(obj);
    ...
    /** Customizes displayed URLs via callback */
    withUrlsCallback(callback: (obj: ResourceUrlsCallbackContext) => Promise<void>): AzureKustoReadWriteDatabaseResourcePromise {
        return new AzureKustoReadWriteDatabaseResourcePromise(this._withUrlsCallbackInternal(callback));
    }

    /** @internal */
    private async _withUrlsCallbackAsyncInternal(callback: (arg: ResourceUrlsCallbackContext) => Promise<void>): Promise<AzureKustoReadWriteDatabaseResource> {
        const callbackId = registerCallback(async (argData: unknown) => {
            const argHandle = wrapIfHandle(argData) as ResourceUrlsCallbackContextHandle;
            const arg = new ResourceUrlsCallbackContext(argHandle, this._client);
            await callback(arg);
    ...
    /** Customizes displayed URLs via async callback */
    withUrlsCallbackAsync(callback: (arg: ResourceUrlsCallbackContext) => Promise<void>): AzureKustoReadWriteDatabaseResourcePromise {
        return new AzureKustoReadWriteDatabaseResourcePromise(this._withUrlsCallbackAsyncInternal(callback));
    }

    /** @internal */
    private async _withUrlInternal(url: string, displayText?: string): Promise<AzureKustoReadWriteDatabaseResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, url };
        if (displayText !== undefined) rpcArgs.displayText = displayText;
        const result = await this._client.invokeCapability<AzureKustoReadWriteDatabaseResourceHandle>(
            'Aspire.Hosting/withUrl',
    ...
    /** Adds or modifies displayed URLs */
    withUrl(url: string, options?: WithUrlOptions): AzureKustoReadWriteDatabaseResourcePromise {
        const displayText = options?.displayText;
        return new AzureKustoReadWriteDatabaseResourcePromise(this._withUrlInternal(url, displayText));
    }

    /** @internal */
    private async _withUrlExpressionInternal(url: ReferenceExpression, displayText?: string): Promise<AzureKustoReadWriteDatabaseResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, url };
        if (displayText !== undefined) rpcArgs.displayText = displayText;
        const result = await this._client.invokeCapability<AzureKustoReadWriteDatabaseResourceHandle>(
            'Aspire.Hosting/withUrlExpression',
    ...
    /** Adds a URL using a reference expression */
    withUrlExpression(url: ReferenceExpression, options?: WithUrlExpressionOptions): AzureKustoReadWriteDatabaseResourcePromise {
        const displayText = options?.displayText;
        return new AzureKustoReadWriteDatabaseResourcePromise(this._withUrlExpressionInternal(url, displayText));
    }

    /** @internal */
    private async _withUrlForEndpointInternal(endpointName: string, callback: (obj: ResourceUrlAnnotation) => Promise<void>): Promise<AzureKustoReadWriteDatabaseResource> {
        const callbackId = registerCallback(async (objData: unknown) => {
            const obj = wrapIfHandle(objData) as ResourceUrlAnnotation;
            await callback(obj);
        });
    ...
    /** Customizes the URL for a specific endpoint via callback */
    withUrlForEndpoint(endpointName: string, callback: (obj: ResourceUrlAnnotation) => Promise<void>): AzureKustoReadWriteDatabaseResourcePromise {
        return new AzureKustoReadWriteDatabaseResourcePromise(this._withUrlForEndpointInternal(endpointName, callback));
    }

    /** @internal */
    private async _withExplicitStartInternal(): Promise<AzureKustoReadWriteDatabaseResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle };
        const result = await this._client.invokeCapability<AzureKustoReadWriteDatabaseResourceHandle>(
            'Aspire.Hosting/withExplicitStart',
            rpcArgs
    ...
    /** Prevents resource from starting automatically */
    withExplicitStart(): AzureKustoReadWriteDatabaseResourcePromise {
        return new AzureKustoReadWriteDatabaseResourcePromise(this._withExplicitStartInternal());
    }

    /** @internal */
    private async _withHealthCheckInternal(key: string): Promise<AzureKustoReadWriteDatabaseResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, key };
        const result = await this._client.invokeCapability<AzureKustoReadWriteDatabaseResourceHandle>(
            'Aspire.Hosting/withHealthCheck',
            rpcArgs
    ...
    /** Adds a health check by key */
    withHealthCheck(key: string): AzureKustoReadWriteDatabaseResourcePromise {
        return new AzureKustoReadWriteDatabaseResourcePromise(this._withHealthCheckInternal(key));
    }

    /** @internal */
    private async _withCommandInternal(name: string, displayName: string, executeCommand: (arg: ExecuteCommandContext) => Promise<ExecuteCommandResult>, commandOptions?: CommandOptions): Promise<AzureKustoReadWriteDatabaseResource> {
        const executeCommandId = registerCallback(async (argData: unknown) => {
            const argHandle = wrapIfHandle(argData) as ExecuteCommandContextHandle;
            const arg = new ExecuteCommandContext(argHandle, this._client);
            return await executeCommand(arg);
    ...
    /** Adds a resource command */
    withCommand(name: string, displayName: string, executeCommand: (arg: ExecuteCommandContext) => Promise<ExecuteCommandResult>, options?: WithCommandOptions): AzureKustoReadWriteDatabaseResourcePromise {
        const commandOptions = options?.commandOptions;
        return new AzureKustoReadWriteDatabaseResourcePromise(this._withCommandInternal(name, displayName, executeCommand, commandOptions));
    }

    /** @internal */
    private async _withParentRelationshipInternal(parent: ResourceBuilderBase): Promise<AzureKustoReadWriteDatabaseResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, parent };
        const result = await this._client.invokeCapability<AzureKustoReadWriteDatabaseResourceHandle>(
            'Aspire.Hosting/withParentRelationship',
            rpcArgs
    ...
    /** Sets the parent relationship */
    withParentRelationship(parent: ResourceBuilderBase): AzureKustoReadWriteDatabaseResourcePromise {
        return new AzureKustoReadWriteDatabaseResourcePromise(this._withParentRelationshipInternal(parent));
    }
    ...
    /** @internal */
    private async _withCreationScriptInternal(script: string): Promise<AzureKustoReadWriteDatabaseResource> {
        const rpcArgs: Record<string, unknown> = { builder: this._handle, script };
        const result = await this._client.invokeCapability<AzureKustoReadWriteDatabaseResourceHandle>(
            'Aspire.Hosting.Azure.Kusto/withCreationScript',
            rpcArgs
        );
        return new AzureKustoReadWriteDatabaseResource(result, this._client);
    }
    ...
    withCreationScript(script: string): AzureKustoReadWriteDatabaseResourcePromise {
        return new AzureKustoReadWriteDatabaseResourcePromise(this._withCreationScriptInternal(script));
    }

}

/**
 * Thenable wrapper for AzureKustoReadWriteDatabaseResource that enables fluent chaining.
 * @example
 * await builder.addSomething().withX().withY();
 */
export class AzureKustoReadWriteDatabaseResourcePromise implements PromiseLike<AzureKustoReadWriteDatabaseResource> {
    constructor(private _promise: Promise<AzureKustoReadWriteDatabaseResource>) {}

    then<TResult1 = AzureKustoReadWriteDatabaseResource, TResult2 = never>(
        onfulfilled?: ((value: AzureKustoReadWriteDatabaseResource) => TResult1 | PromiseLike<TResult1>) | null,
        onrejected?: ((reason: unknown) => TResult2 | PromiseLike<TResult2>) | null
    ): PromiseLike<TResult1 | TResult2> {
        return this._promise.then(onfulfilled, onrejected);
    }
    ...
    /** Customizes displayed URLs via callback */
    withUrlsCallback(callback: (obj: ResourceUrlsCallbackContext) => Promise<void>): AzureKustoReadWriteDatabaseResourcePromise {
        return new AzureKustoReadWriteDatabaseResourcePromise(this._promise.then(obj => obj.withUrlsCallback(callback)));
    }

    /** Customizes displayed URLs via async callback */
    withUrlsCallbackAsync(callback: (arg: ResourceUrlsCallbackContext) => Promise<void>): AzureKustoReadWriteDatabaseResourcePromise {
        return new AzureKustoReadWriteDatabaseResourcePromise(this._promise.then(obj => obj.withUrlsCallbackAsync(callback)));
    }

    /** Adds or modifies displayed URLs */
    withUrl(url: string, options?: WithUrlOptions): AzureKustoReadWriteDatabaseResourcePromise {
        return new AzureKustoReadWriteDatabaseResourcePromise(this._promise.then(obj => obj.withUrl(url, options)));
    }

    /** Adds a URL using a reference expression */
    withUrlExpression(url: ReferenceExpression, options?: WithUrlExpressionOptions): AzureKustoReadWriteDatabaseResourcePromise {
        return new AzureKustoReadWriteDatabaseResourcePromise(this._promise.then(obj => obj.withUrlExpression(url, options)));
    }

    /** Customizes the URL for a specific endpoint via callback */
    withUrlForEndpoint(endpointName: string, callback: (obj: ResourceUrlAnnotation) => Promise<void>): AzureKustoReadWriteDatabaseResourcePromise {
        return new AzureKustoReadWriteDatabaseResourcePromise(this._promise.then(obj => obj.withUrlForEndpoint(endpointName, callback)));
    }

    /** Prevents resource from starting automatically */
    withExplicitStart(): AzureKustoReadWriteDatabaseResourcePromise {
        return new AzureKustoReadWriteDatabaseResourcePromise(this._promise.then(obj => obj.withExplicitStart()));
    }

    /** Adds a health check by key */
    withHealthCheck(key: string): AzureKustoReadWriteDatabaseResourcePromise {
        return new AzureKustoReadWriteDatabaseResourcePromise(this._promise.then(obj => obj.withHealthCheck(key)));
    }

    /** Adds a resource command */
    withCommand(name: string, displayName: string, executeCommand: (arg: ExecuteCommandContext) => Promise<ExecuteCommandResult>, options?: WithCommandOptions): AzureKustoReadWriteDatabaseResourcePromise {
        return new AzureKustoReadWriteDatabaseResourcePromise(this._promise.then(obj => obj.withCommand(name, displayName, executeCommand, options)));
    }

    /** Sets the parent relationship */
    withParentRelationship(parent: ResourceBuilderBase): AzureKustoReadWriteDatabaseResourcePromise {
        return new AzureKustoReadWriteDatabaseResourcePromise(this._promise.then(obj => obj.withParentRelationship(parent)));
    }
    ...
    /** Defines the KQL script used to create the database */
    withCreationScript(script: string): AzureKustoReadWriteDatabaseResourcePromise {
        return new AzureKustoReadWriteDatabaseResourcePromise(this._promise.then(obj => obj.withCreationScript(script)));
    }
...
registerHandleWrapper('Aspire.Hosting.Azure.Kusto/Aspire.Hosting.Azure.AzureKustoClusterResource', (handle, client) => new AzureKustoClusterResource(handle as AzureKustoClusterResourceHandle, client));
registerHandleWrapper('Aspire.Hosting.Azure.Kusto/Aspire.Hosting.Azure.AzureKustoEmulatorResource', (handle, client) => new AzureKustoEmulatorResource(handle as AzureKustoEmulatorResourceHandle, client));
registerHandleWrapper('Aspire.Hosting.Azure.Kusto/Aspire.Hosting.Azure.AzureKustoReadWriteDatabaseResource', (handle, client) => new AzureKustoReadWriteDatabaseResource(handle as AzureKustoReadWriteDatabaseResourceHandle, client));
