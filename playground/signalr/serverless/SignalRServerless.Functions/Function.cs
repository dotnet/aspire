...
public class Functions
{
    ...
    public static HttpResponseData Negotiate([HttpTrigger(AuthorizationLevel.Anonymous)] HttpRequestData req,
        [SignalRConnectionInfoInput(HubName = "serverless", ConnectionStringSetting = "SignalR_ConnectionString")] string connectionInfo)
    {
        var response = req.CreateResponse(HttpStatusCode.OK);
    ...
    [Function("broadcast")]
    [SignalROutput(HubName = "serverless", ConnectionStringSetting = "SignalR_ConnectionString")]
