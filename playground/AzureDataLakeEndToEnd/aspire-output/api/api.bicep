...
param azure_storage_outputs_datalakeendpoint string
      ...
      containers: [
        {
          ...
          env: [
            ...
            {
              name: 'ConnectionStrings__data-lake'
              value: azure_storage_outputs_datalakeendpoint
            }
            {
              name: 'ConnectionStrings__data-lake-file-system'
              value: 'Endpoint=${azure_storage_outputs_datalakeendpoint};FileSystemName=data-lake-file-system'
            }
            {
