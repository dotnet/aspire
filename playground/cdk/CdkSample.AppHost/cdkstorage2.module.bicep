...
resource roleAssignment_EseUFxJfd 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  scope: storageAccount_Tn41yfrBn
  name: guid('storageAccount_Tn41yfrBn', principalId, subscriptionResourceId('Microsoft.Authorization/roleDefinitions', 'ba92f5b4-2d11-453d-a403-e96b0029c9fe'))
  properties: {
...
resource roleAssignment_EseUFxJfd 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  scope: storageAccount_Tn41yfrBn
  name: guid('storageAccount_Tn41yfrBn', principalId, subscriptionResourceId('Microsoft.Authorization/roleDefinitions', '0a9a7e1f-b9d0-4cc4-a60d-0319b160aaa3'))
  properties: {
...
resource roleAssignment_EseUFxJfd 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  scope: storageAccount_Tn41yfrBn
  name: guid('storageAccount_Tn41yfrBn', principalId, subscriptionResourceId('Microsoft.Authorization/roleDefinitions', '974c5e8b-45b9-4653-ba55-5f855dd0fb88'))
  properties: {
