...
| `ASPIRE_MANAGED_PATH` | Aspire-managed binary path | `/opt/aspire/managed/aspire-managed` |
...
Bundle CLI ────► runs ────► .NET AppHost (new Aspire.Hosting)
     ...
     │ sets ASPIRE_MANAGED_PATH  │ reads ASPIRE_MANAGED_PATH
     │                           │
...
|-----------|------------------|--------------|
| **CLI** | Before launching AppHost | Sets `ASPIRE_DCP_PATH`, `ASPIRE_MANAGED_PATH` env vars |
...
| `ASPIRE_MANAGED_PATH` | Aspire-managed override | Works in both modes |
