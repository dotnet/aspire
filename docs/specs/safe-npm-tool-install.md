...
| **Workflow ref** | `predicate.buildDefinition.externalParameters.workflow.ref` | `refs/tags/v{version}` (e.g., `refs/tags/v0.1.1`) | The build was triggered from a version tag matching the package version, not an arbitrary branch or commit |
