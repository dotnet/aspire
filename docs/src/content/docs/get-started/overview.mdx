...
<Aside type="tip">
  Creating reusable Aspire integrations is just like creating a reusable UI component. It can be as simple or complex as you need, and is fully shareable. Learn more about [creating custom resources for Aspire](/TODO).
</Aside>
