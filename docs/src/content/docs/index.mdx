...
import { Code, Card, CardGrid, Tabs, TabItem, LinkButton } from '@astrojs/starlight/components';
...
<video autoplay loop muted>
  <source src="src/assets/dashboard-graph.mp4" type="video/mp4" />
</video>

## Ready for liftoff?

<LinkButton href="/get-started/installation" icon="rocket" iconPlacement="start">
	  Liftoff
</LinkButton>
<LinkButton href="/reference/example" icon="open-book" variant="secondary" iconPlacement="start">
    View Docs
</LinkButton>