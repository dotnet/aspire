...
Get deep insights into your app while you build it—backed with OpenTelemetry, GitHub Copilot, D3.js resource graphs, and more. The dashboard includes logs, metrics, and traces, providing a comprehensive view of your application's performance.
...
<CardGrid>
  <LinkCard
    ...
    title="Get Aspire"
    description="Get started with Aspire and streamline your development workflow."
  />
  <LinkCard
    icon="open-book"
    variant="secondary"
    ...
    title="View Docs"
    description="Explore the documentation to learn how to model, run, and deploy your applications with Aspire."
  />
</CardGrid>
