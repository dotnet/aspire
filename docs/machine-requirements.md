...
> :warning: Aspire currently only directly supports the x64/amd64 architecture for Apline/musl. If you want to build or run Apsire in Alpine on ARM64, you may need to use an arm64/x64 compatibility layer like `qemu`.
